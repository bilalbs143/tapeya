...
export const users = [
  {
    ...
    review: `Our users' feedback is a testament to our commitment to quality
  ...
  },
  {
    ...
    review: `The platform has been incredibly easy to use, and the features have
                helped me stay organized and productive every single day.`
  },
  {
    name: 'Kristin Watson',
    img: '/assets/images/profile/user-3.jpg',
    review: `I love the clean design and intuitive workflow. It has simplified my
                tasks and improved my overall efficiency.`
  },
  {
    name: 'Darlene Robertson',
    img: '/assets/images/profile/user-4.jpg',
    review: `Excellent support team! They responded quickly and made sure all my
                questions were resolved without any hassle.`
  },
  {
    name: 'Jacob Jones',
    img: '/assets/images/profile/user-5.jpg',
    review: `A fantastic experience from start to finish. The tool delivers
                exactly what it promises, and even more.`
  },
];

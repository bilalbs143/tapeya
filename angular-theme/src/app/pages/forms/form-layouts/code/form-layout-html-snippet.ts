...
export const BASIC_HEADER_HTML_SNIPPET = `    <div class="p-4 bg-light-primary rounded-sm">
    ...
    <div class="p-4 bg-light-primary rounded-sm my-5">
      <h5 class="text-sm text-primary flex items-center font-semibold">
        <i-tabler name="info-circle" class="size-5! me-2 flex"></i-tabler
        >Address
      </h5>
...
export const LEFT_ICON_HTML_SNIPPET = `   <form>
          ...
          <div class="flex items-center gap-8 mt-2 border-t border-border pt-5">
            <button mat-flat-button color="primary">Submit</button>
            <button mat-flat-button class="bg-error text-white!">Cancel</button>
          </div>
        </form>
...
export const RIGHT_ICON_HTML_SNIPPET = `   <form>
          ...
          <div
            class="flex items-center gap-8 mt-2 border-t border-border pt-5"
          >
            <button mat-flat-button color="primary">Submit</button>
            <button mat-flat-button class="bg-error text-white!">Cancel</button>
          </div>

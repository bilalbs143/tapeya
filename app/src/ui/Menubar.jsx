...
const menu = 'z-50 min-w-[8rem] overflow-hidden rounded-md border bg-white p-1 shadow-md';
const _trigger =
...
const _separator = '-mx-1 my-1 h-px bg-slate-200';
const _subTrigger =
...
export function MenubarRoot({ className = '', ...props }) {
  return <MenubarPrimitive.Root className={`${root} ${className}`} {...props} />;
}

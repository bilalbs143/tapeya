  ...
  return (
    <div className="relative [&_input::-webkit-search-cancel-button]:hidden [&_input::-webkit-search-decoration]:hidden">
      <input
        ...
        className="h-12 w-full rounded-[6px] bg-surface pr-20 pl-4 text-white placeholder:text-muted/47 focus:ring-2 focus:ring-brand/50 focus:outline-none [&::-webkit-search-cancel-button]:hidden [&::-webkit-search-decoration]:hidden"
      ...
      {value.length > 0 ? (
        <button
          type="button"
          onClick={onClear}
          className="absolute top-0 right-10 bottom-0 flex w-10 items-center justify-center text-muted transition-colors hover:text-white active:opacity-80"

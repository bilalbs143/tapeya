...
export function FreeHitIndicator({ pendingFreeHit }) {
  ...
  return (
    ...
    >
      {/* Lightning bolt icon */}
      <svg className="h-5 w-5 shrink-0 text-[#DA9811]" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
        <path d="M13 2L4.5 13H11L10 22L19.5 11H13L13 2Z" />
      </svg>
      <span className="animate-pulse text-[13px] font-bold tracking-widest text-[#DA9811] uppercase">Free Hit</span>
      <svg className="h-5 w-5 shrink-0 text-[#DA9811]" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
        <path d="M13 2L4.5 13H11L10 22L19.5 11H13L13 2Z" />
      </svg>
    </div>

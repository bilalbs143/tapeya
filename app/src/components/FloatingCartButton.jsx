    ...
    <button
      ...
      >
        <span className="relative inline-flex items-center justify-center">
          ...
          {count > 0 && (
            <span
              className={`absolute -right-2.5 -top-3.5 flex h-[18px] w-[18px] items-center justify-center rounded-full bg-white px-1 py-0.5 text-[12px] font-bold leading-none text-[#DA9811] ${isPopping ? 'animate-badge-pop' : ''}`}
              aria-hidden
            >
              {count > 99 ? '99+' : count}
            </span>

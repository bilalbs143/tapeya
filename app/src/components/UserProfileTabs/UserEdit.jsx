      ...
      <DialogContentProfile>
        <div className="flex min-h-0 flex-1 flex-col">
          <div className="flex items-center justify-between py-4 px-5 shrink-0">
            <DialogTitle className="text-[16px] font-bold uppercase tracking-wide text-[#DA9811]">
              EDIT PROFILE
            </DialogTitle>
            <DialogClose
              className="rounded p-1 text-white/60 transition-colors hover:text-white focus:outline-none focus:ring-2 focus:ring-[#FFB703]"
              aria-label="Close"
            >
          ...
          <div className="flex flex-col gap-4">
            ...
            <FormField label="Category" htmlFor="category" variant="edit">
              <Select value={category} onValueChange={setCategory}>
                <SelectTrigger id="category" className={`max-w-none ${selectTriggerInputClass}`}>
            ...
            <FormField label="Email (Optional)" htmlFor="email" variant="edit">
              <Input
                id="email"
                type="email"

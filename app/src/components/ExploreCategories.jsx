      ...
      <div className="grid grid-cols-4 gap-3 md:grid-cols-5 md:gap-4">
        {EXPLORE_CATEGORIES.map(({ path, label }) => (
          <Link
            key={path}
            to={path}
            className="bg-surface hover:bg-surface-raised flex min-h-[90px] w-full flex-col items-center justify-center gap-2 rounded-[17px] transition-colors duration-200 ease-out active:opacity-90 md:h-auto md:min-h-[72px] md:flex-row md:items-center md:gap-3 md:px-4 md:hover:bg-[#2C2C2C]"
          >

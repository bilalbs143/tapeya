...
import { getMigratedCommandKeys, PROCESSOR_MAP, PROCESSOR_REGISTRY } from '@/graphics/core/processorMap';
import { processAnimation, processFstAnimation } from '@/graphics/core/processorRegistry';

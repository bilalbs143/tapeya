...
import { ControllerBar, DecisionPendingFlash, useFrameTransition } from '../../primitives';
import { BroadcastShell } from '../../primitives/BroadcastShell';

export default function FST_DECISION({ isOverlay, tokens, ...props }) {
  ...
  return (
    <BroadcastShell stage="flash" header={() => (resolvedFrame.event ? <DecisionPendingFlash compact={false} fixed /> : null)}>

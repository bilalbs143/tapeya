...
import { ControllerBar, useFrameTransition, WicketFlash } from '../../primitives';
...
export default function FST_OUT({ isOverlay, tokens, ...props }) {
  ...
  return (
    <BroadcastShell stage="flash" header={() => (resolvedFrame.event ? <WicketFlash compact={false} fixed /> : null)}>

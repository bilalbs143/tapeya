...
import { ControllerBar, FiftyUpFlash, useFrameTransition } from '../../primitives';
...
export default function FST_FIFTY({ isOverlay, tokens, ...props }) {
  ...
  return (
    <BroadcastShell stage="flash" header={() => (resolvedFrame.event ? <FiftyUpFlash compact={false} fixed /> : null)}>

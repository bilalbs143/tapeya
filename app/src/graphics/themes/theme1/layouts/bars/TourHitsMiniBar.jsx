  ...
  return (
    ...
    >
      <span
        className={cn(
          DISPLAY_FONT,
          'max-w-[5.5rem] text-center text-[2.125rem] leading-none font-extrabold tracking-[0.12em] text-white uppercase',
          textGlowClass('badge'),
        )}
      >
        {shortCode}
            ...
            <div className="flex w-fit items-center gap-4 py-4 pr-6 pl-5">
              ...
              <div className="flex flex-col items-start justify-center gap-0.5 pr-2">
                <span
                  className={cn(
                    UI_FONT,
                    'text-[1.125rem] leading-[1.1] font-bold tracking-[0.12em] text-[var(--text-secondary)]',
                  )}
                >
                  {label}
                </span>

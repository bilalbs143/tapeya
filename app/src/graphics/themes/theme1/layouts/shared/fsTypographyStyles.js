...
import { TEXT_PRIMARY, TEXT_SECONDARY } from './textStyles';
...
export const FS_HEADER_SUB = cn('m-0 font-semibold tracking-[0.06em] uppercase', TEXT_SECONDARY, UI_FONT);

export const FS_HEADER_SUB_CENTERED = cn('mt-2 mb-0 font-semibold tracking-[0.06em] uppercase', TEXT_SECONDARY, UI_FONT);
...
export const FS_PANEL_SUB = cn('mt-1.5 mb-0 font-semibold tracking-[0.06em] uppercase', TEXT_SECONDARY, UI_FONT);
...
export const FS_PLAYER_FIRST = cn('font-semibold leading-none tracking-[0.02em] uppercase', TEXT_SECONDARY, DISPLAY_FONT);
...
export const FS_DISMISSAL = cn('font-semibold tracking-[0.08em] uppercase', TEXT_SECONDARY, UI_FONT);

export const FS_GOLD_BAND = cn('font-extrabold tracking-[0.06em] text-[#0a0e17] uppercase', 'whitespace-nowrap', DISPLAY_FONT);

export const FS_SCORE_STRIP_LABEL = cn('font-semibold tracking-[0.14em] whitespace-nowrap uppercase', TEXT_SECONDARY, UI_FONT);

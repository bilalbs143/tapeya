...
export const CHART_AXIS_TICK = cn('font-bold', TEXT_SECONDARY, DISPLAY_FONT);

export const CHART_AXIS_LABEL = cn('font-semibold tracking-[0.12em] uppercase', TEXT_SECONDARY, UI_FONT);

export const CHART_X_LABEL = cn('font-bold', TEXT_PRIMARY, DISPLAY_FONT);

export const WAGON_SECTION_LABEL = cn('font-bold tracking-[0.2em] uppercase', TEXT_SECONDARY, UI_FONT);

export const WAGON_PLAYER_NAME = cn('mt-1.5 leading-none font-extrabold text-white', DISPLAY_FONT);

export const WAGON_PLAYER_META = cn('mt-1', TEXT_SECONDARY, UI_FONT);

export const WAGON_STAT_LABEL = cn('font-semibold tracking-[0.14em] uppercase', TEXT_SECONDARY, UI_FONT);

export const WAGON_STAT_VALUE = cn('mt-1 leading-none font-extrabold', DISPLAY_FONT);

export const WAGON_LEGEND_LABEL = cn('font-semibold tracking-[0.04em] uppercase', TEXT_SECONDARY, UI_FONT);

export const WAGON_ZONE_LABEL = cn('min-w-0 font-semibold tracking-[0.07em] uppercase', TEXT_SECONDARY, UI_FONT);

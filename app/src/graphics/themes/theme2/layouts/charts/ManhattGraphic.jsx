      ...
      {badge != null ? (
        <span
          className={cn(
            ...
            'rounded-full bg-white text-[24px] font-extrabold',
...
function TeamStrip({ name, score, accent }) {
  return (
    <div
      className="flex h-[70px] flex-1 items-center rounded px-7"
      style={{
...
export function ManhattGraphic({ data }) {
  const { title, sub, logoUrl, teams, chart, summary } = data;
  ...
  return (
    <FSStage>
      ...
      <div className="absolute right-[400px] bottom-12 left-[70px] flex flex-col gap-3.5">
        <TeamStrip

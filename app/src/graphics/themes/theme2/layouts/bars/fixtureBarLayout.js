...
export const fixtureVsClass = cn('shrink-0', UI, 'font-extrabold tracking-[0.16em] text-[var(--text)]');

export const fixtureVsStyle = { fontSize: ltFixtureBar.vsLabelFont };

export const fixtureDetailBaseClass = cn('text-center text-[var(--text)]', UI);

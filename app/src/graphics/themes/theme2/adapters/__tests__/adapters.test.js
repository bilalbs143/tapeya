...
describe('theme2 officials adapter', () => {
...
describe('theme2 scoreBar adapter', () => {
  it('maps scoreboard processor output to frame/teams/match', () => {
    ...
    expect(bundle.frame.oversText).toBe('15.2');
    expect(bundle.frame.oversLimit).toBe('20');
...
describe('theme2 matchFixture adapter', () => {
...
describe('theme2 fullScreen adapter fixtures', () => {
  ...
  it('derives current partnership FS batters from live batters array', () => {
    ...
    expect(bundle?.data?.batters[0].onStrike).toBe(true);
    expect(bundle?.data?.batters[1].onStrike).toBe(false);
  ...
  it('maps broadcast partnership_history to partnership list rows', () => {
    const bundle = toPartnershipListBundle(
      ...
      { homeBgColor: '#112233', awayBgColor: '#445566', enableImages: true },
    );

    expect(bundle?.data?.accent).toBe('#112233');
    expect(bundle?.data?.partnerships).toHaveLength(2);
    expect(bundle?.data?.partnerships[0].balls).toBe(47);
...
describe('theme2 miniScoreCard adapter', () => {
...
describe('theme2 pointTable adapter', () => {
...
describe('theme2 strategicTimeout adapter', () => {
  it('maps processor output to countdown graphic bundle', () => {
    ...
    expect(bundle?.data.showTimer).toBe(true);
    expect(bundle?.data.timerSeconds).toBe(300);
...
describe('theme2 player match LT adapters', () => {
  const tokens = {
    homeBgColor: '#0055ff',
    awayBgColor: '#ff5500',
  };
...
describe('theme2 leaderboard adapter', () => {
...
describe('theme2 fallOfWickets adapter', () => {
  const tokens = {
    homeBgColor: '#9b7bff',
    awayBgColor: '#f0a93c',
  };
...
describe('theme2 playing11 adapter', () => {

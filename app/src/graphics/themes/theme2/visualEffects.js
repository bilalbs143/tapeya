...
const TEXT_GLOW = {
  ...
  hero: '[text-shadow:0_0_calc(20px*var(--glow))_rgba(196,0,56,0.5)]',
  heroMd: '[text-shadow:0_0_calc(18px*var(--glow))_rgba(196,0,56,0.6)]',
  heroLg: '[text-shadow:0_0_calc(40px*var(--glow))_rgba(196,0,56,0.65)]',
  ...
  badge: '[text-shadow:0_0_calc(16px*var(--glow))_rgba(201,162,39,0.55)]',
  accent: '[text-shadow:0_0_calc(18px*var(--glow))_rgba(196,0,56,0.55)]',
  vsNeon: '[text-shadow:0_0_calc(26px*var(--glow))_rgba(201,162,39,0.55)]',
};
...
export function panelDepthShadow(extra = '') {
  ...
  const halo = '0 0 calc(22px * var(--glow)) rgba(196, 0, 56, 0.22)';

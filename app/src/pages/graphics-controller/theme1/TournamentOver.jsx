        ...
        <div className="relative w-full overflow-hidden px-4 py-2 sm:px-10 sm:py-4" style={panelStyle}>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <p className="text-[12px] leading-none font-extrabold text-[#DA9811] sm:text-[24px]">{homeName}</p>
            </div>
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              <p className="text-right text-[12px] leading-none font-extrabold text-[#DA9811] sm:text-[24px]">{awayName}</p>

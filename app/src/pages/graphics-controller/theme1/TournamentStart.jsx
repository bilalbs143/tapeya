...
export default function TournamentStart({ homeTeam = {}, awayTeam = {}, matchNumber = '', venue = '', tournamentName = '' }) {
  ...
  return (
    <div className="bg-page flex min-h-screen items-center justify-center p-3 sm:p-5">
      ...
      >
        {tournamentName ? (
          <h1 className="text-brand mb-8 text-center text-[28px] leading-none font-bold tracking-[0.02em] uppercase sm:mb-10 sm:text-[31px]">
            {tournamentName}
          </h1>
        ) : null}
        ...
        <div className="mb-6 flex w-full max-w-[448px] items-center justify-between sm:mb-8">
          ...
          <span className="text-brand px-3 text-[45px] leading-none font-bold uppercase sm:text-[54px]">VS</span>
        ...
        <div className="mb-5 flex w-full max-w-[510px] items-center justify-between bg-black/70 px-3 sm:mb-6 sm:px-6">
          ...
          <span className="bg-brand min-w-[100px] rounded-[10px] border border-white px-6 py-3 text-center text-[20px] leading-none font-bold text-black uppercase sm:min-w-[120px] sm:px-8 sm:text-[22px]">
            VS
          </span>

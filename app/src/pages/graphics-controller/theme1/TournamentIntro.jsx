          ...
          <div className="flex flex-col">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 sm:gap-4">
                ...
                <p className="text-brand text-[8px] leading-none font-extrabold sm:text-[24px]">{homeName}</p>
              </div>

              <p className="text-[8px] leading-none font-extrabold text-white uppercase sm:text-[30px]">VS</p>

              <div className="flex items-center gap-2 sm:gap-4">
                <p className="text-brand text-right text-[8px] leading-none font-extrabold sm:text-[24px]">{awayName}</p>

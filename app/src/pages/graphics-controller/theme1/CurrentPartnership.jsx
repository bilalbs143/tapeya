        ...
        <div className="relative z-10 mx-auto flex w-full items-stretch px-1.5 py-1 sm:px-6 sm:py-3">
          ...
          <div className="ml-auto flex items-center">
            <div className="px-2 text-left sm:px-8">
              <p className="text-[8px] leading-none font-semibold text-[#E8E8E8] sm:text-[18px]">Current</p>
              <p className="mt-0.5 text-[8px] leading-none font-semibold text-[#E8E8E8] sm:mt-1 sm:text-[18px]">Partnership</p>
            </div>
            <div className="flex items-end gap-2 px-1 text-right sm:px-5">
              <p className="text-[15px] leading-none font-extrabold text-white sm:text-[28px]">{partnershipRuns}</p>
              <p className="mt-0.5 text-[10px] leading-none font-semibold text-[#E8E8E8] sm:text-[20px]">{partnershipBalls}</p>
            </div>
            <div className="mx-1 w-px self-stretch sm:mx-3" style={separatorStyle} />

            <div className="px-2 sm:px-6">
              <p className="text-[12px] leading-none font-extrabold text-white sm:text-[28px]">{bowlingName}</p>
            </div>
            <img
              src={bowlingLogo}

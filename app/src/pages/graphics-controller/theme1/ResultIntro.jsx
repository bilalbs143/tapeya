        ...
        >
          <div className="flex flex-col gap-2 sm:gap-3">
            <div className="flex items-center justify-between gap-2">
              <div
                className={`flex min-w-0 flex-1 items-center gap-2 sm:gap-4 ${homeDim ? 'opacity-45' : ''}`}
              >
                <img
                  src={homeLogo}
                  alt={homeName}
                  className="h-14 w-14 shrink-0 rounded-full object-cover sm:h-18 sm:w-18"
                />
              ...
              <div className="max-w-[46%] shrink-0 px-1 text-center sm:max-w-[42%] sm:px-2">
                {hasResult ? (
                  <p className="text-[9px] leading-tight font-bold text-white sm:text-[16px]">
                    {resultLine}
                  </p>
                ) : (
              ...
              <div
                className={`flex min-w-0 flex-1 items-center justify-end gap-2 sm:gap-4 ${awayDim ? 'opacity-45' : ''}`}
              >

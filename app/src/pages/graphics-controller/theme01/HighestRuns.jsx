...
const rankingRows = [
  { rank: 1, runs: 276, name: 'Mani', team: 'Royal Stars' },
  { rank: 2, runs: 215, name: 'Mani', team: 'Royal Stars' },
  { rank: 3, runs: 186, name: 'Mani', team: 'Royal Stars' },
  { rank: 4, runs: 162, name: 'Mani', team: 'Royal Stars' },
  { rank: 5, runs: 120, name: 'Mani', team: 'Royal Stars' },
];
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="mt-5 grid grid-cols-[1fr_140px] gap-3 sm:mt-7 sm:grid-cols-[1fr_228px] sm:gap-7">
            <div>
              {rankingRows.map(({ rank, runs, name, team }, index) => (
                <div
                  key={rank}

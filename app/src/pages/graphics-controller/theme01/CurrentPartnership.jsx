      ...
      <section className="absolute right-0 bottom-0 left-0 overflow-hidden text-white">
        ...
        <div className="relative z-10 mx-auto flex w-full items-stretch px-1.5 py-1 sm:px-6 sm:py-3">
          ...
          <div className="ml-auto flex items-center">
            ...
            <div className="px-1 text-right flex gap-2 items-end  sm:px-5">
              <p className="text-[15px] leading-none font-extrabold text-white sm:text-[28px]">96</p>
              <p className="mt-0.5 text-[10px] leading-none font-semibold text-[#E8E8E8] sm:text-[20px]">32</p>
            </div>
            <div className="mx-1 w-px self-stretch sm:mx-3" style={separatorStyle} />

            <div className="px-2 sm:px-6">
              <p className="text-[12px] leading-none font-extrabold text-white sm:text-[28px]">KKR</p>
            </div>
            <img
              src={teamLogo}

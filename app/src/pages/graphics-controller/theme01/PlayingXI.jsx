const TEAM_ONE_PLAYERS = Array.from({ length: 11 }, (_, index) => `Player ${index + 1}`);
const TEAM_TWO_PLAYERS = Array.from({ length: 11 }, (_, index) => `Player ${index + 1}`);
    ...
    <div className="flex min-h-screen items-center justify-center bg-[#1D1E22] p-3 sm:p-5">
      <section className="relative w-full max-w-[677px] overflow-hidden bg-[#0D0806]  pt-10 pb-8 text-white  sm:pt-11 sm:pb-10">
        <div className="pointer-events-none absolute inset-0">
          ...
          <div className="absolute bottom-14 right-10 h-24 w-24 rounded-full bg-[#E8A020]/30 blur-2xl" />
        </div>

        <div className="relative z-10">
          <div className="px-8 sm:px-12">
             <p className="mb-2 text-[18px] leading-none font-normal text-[#E9E9E9]">Playing XI</p>

        ...
        <div className="relative z-10 mx-auto flex w-full items-stretch px-1.5 py-1 sm:px-6 sm:py-3">
          ...
          <div className="ml-auto flex items-center">
            <div className="px-2 text-center sm:px-14">
              <p className="text-[8px] leading-none font-semibold text-[#E8E8E8] uppercase sm:text-[18px]">
                WIN
              </p>
            ...
            <div className="px-2 text-center sm:px-14">
              <p className="text-[8px] leading-none font-semibold text-[#E8E8E8] uppercase sm:text-[20px]">
                KKR
              </p>

  ...
  return (
    <div className="bg-black">
      ...
      <Container className="pb-8">
        <p className="mb-4 text-[13px] leading-snug text-muted md:text-[14px]">
          {hasWhatsApp ? (
            <>
        ...
        {hasWhatsApp ? (
          <>
            <div className="mb-6 rounded-[6px] border border-[#FF9700]/45 bg-surface p-4 shadow-[0_0_0_1px_rgba(255,151,0,0.12)]">
              <p className="text-[12px] font-bold tracking-wide text-muted">WhatsApp</p>
              <a
                href={whatsAppHref}
                target="_blank"
              ...
              >
                <span className="flex min-w-0 flex-col gap-0.5">
                  <span className="text-[11px] font-medium text-muted">Tap to open chat</span>
              ...
              <p className="mt-3 text-[12px] leading-snug text-muted/90">Opens WhatsApp on your phone or web.</p>
            </div>
            ...
            <div aria-hidden="true" className="mb-6 flex items-center gap-3">
              ...
              <span className="shrink-0 text-[11px] font-bold tracking-wider text-muted uppercase">Or use the form</span>
              <div className="h-px flex-1 bg-[linear-gradient(to_right,transparent,#FFFFFF33,transparent)]" />
            </div>
          </>
        ) : null}
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <FileUploadField
            label={
              <>
                Attachment <span className="font-normal text-muted/70">(optional)</span>
              </>
            }
            value={attachment}
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <p className="text-[12px] text-muted">We will only use your details to respond to your request.</p>
            <Button
              type="submit"

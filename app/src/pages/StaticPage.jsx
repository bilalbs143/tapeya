...
export default function StaticPage() {
    ...
    return (
      <div className="bg-black">
        ...
        <Container className="pb-8">
          <p className="text-[13px] text-muted md:text-[14px]">This page could not be found.</p>
        </Container>
      </div>
    );
  }
  ...
  return (
    <div className="bg-black">
      ...
      <Container className="pb-8">
        {busy && <p className="text-[13px] text-muted md:text-[14px]">Loading…</p>}

        {!busy && error && (
          <p className="text-[13px] leading-snug text-muted md:text-[14px]">

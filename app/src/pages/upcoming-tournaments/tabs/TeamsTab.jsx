...
export function TeamsTab({ tournamentId }) {
  ...
  if (!hasValidId) {
    return (
      <div className="mt-4 pb-6">
        <p className="py-4 text-center text-[13px] text-[#A2A6AB]">Teams are not available for this sample tournament.</p>
      </div>
    );
  }
  ...
  if (isLoading) {
    return (
      <div className="mt-4 pb-6">
        <p className="py-4 text-center text-[13px] text-[#A2A6AB]">Loading teams…</p>
      </div>
    );
  }
  ...
  return (
    <div className="mt-4 pb-6">
      <h2 className="border-b border-[#1A1A1A] pb-4 text-left text-[13px] font-bold tracking-wide text-white uppercase">Teams</h2>

      <div className="border border-[#1A1A1A]">
        <div className="bg-[#141412] px-4 py-3 text-[13px] font-bold text-white">Teams in this tournament</div>

      ...
      <Container>
        <div className="space-y-6">
          <p className="text-[14px] leading-relaxed text-[#B0B0B0]">
            ...
            <span className="font-semibold text-[#DA9811]">Payment Screenshot</span> as the payment reference and send on this
            WhatsApp: <span className="font-bold text-[#DA9811]">{WHATSAPP}</span>. Your order won't be shipped until the funds
          ...
          <div>
            <p className="text-[14px] font-bold text-[#A2A6AB] uppercase">ORDER TOTAL</p>
            <p className="mt-1 text-[16px] font-bold text-[#DA9811]">{formatPrice(order.total)}</p>
          </div>

          <div className="space-y-4">
            <div>
              <p className="text-[14px] font-bold text-[#A2A6AB] uppercase">BANK NAME</p>
              <p className="mt-1 text-[14px] text-[#B0B0B0]">{BANK_NAME}</p>
            </div>
            <div>
              <p className="text-[14px] font-bold text-[#A2A6AB] uppercase">Account Number</p>
              <p className="mt-1 text-[14px] break-all text-[#B0B0B0]">{IBAN}</p>
            </div>
            <div>
              <p className="text-[14px] font-bold text-[#A2A6AB] uppercase">ACCOUNT TITLE</p>

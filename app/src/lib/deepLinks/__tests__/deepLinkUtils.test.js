...
describe('deepLinkRegistry', () => {
  it('builds known routes', () => {
    ...
    expect(buildDeepLinkPath('liveBroadcast', { streamId: 44 })).toBe('/live/broadcast/44');
  });
  ...
  it('allows registered paths only', () => {
    ...
    expect(isAllowedDeepLinkPath('/live/broadcast/44')).toBe(true);
  ...
  it('allows notification navigate paths for push / in-app taps', () => {
    ...
    expect(isSafeNotificationNavigatePath('/live/broadcast/44')).toBe(true);
...
describe('deepLinkUtils', () => {
  it('builds https and scheme URLs from a path', () => {
    ...
    expect(buildAppSchemeDeepLink('/live/broadcast/44')).toBe('tapeya://live/broadcast/44');
  });
  ...
  it('parses https and custom-scheme deep links', () => {
    ...
    expect(pathFromDeepLinkUrl('https://tapeya.com/live/broadcast/44')).toBe('/live/broadcast/44');
    expect(pathFromDeepLinkUrl('tapeya://live/broadcast/44')).toBe('/live/broadcast/44');
  });
});

 ...
 *
 * @typedef {'full_scorecard'|'change_squad'|'revise_target'|'replace_batting_stats'|'replace_bowling_stats'|'end_innings'|'add_breaks'|'cancel_match'|'change_wicket_keeper'|'substitute_player'|'give_penalty_runs'|'add_additional_runs'|'match_rules'|'match_notes'|'declare_results'} ScoringActionId
 */

/** @type {Array<{ id: ScoringActionId, label: string, icon: string }>} */
export const SCORING_ACTION_MENU_ITEMS = [
  { id: 'full_scorecard', label: 'Full Scorecard', icon: 'scorecard' },
  { id: 'change_squad', label: 'Change Squad', icon: 'squad' },
  { id: 'revise_target', label: 'Revise Target', icon: 'revise' },
  { id: 'replace_batting_stats', label: 'Replace Batting Stats', icon: 'bat' },
  { id: 'replace_bowling_stats', label: 'Replace Bowling Stats', icon: 'bowl' },

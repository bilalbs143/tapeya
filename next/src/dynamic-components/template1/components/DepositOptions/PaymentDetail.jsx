...
const AccountDetailField = memo(({ label, value, canCopy = false, onCopy }) => (
  <div className="mb-6 flex flex-col md:flex-row md:items-center md:gap-4">
    ...
    <div className="flex h-[46px] w-full items-center justify-between gap-2 rounded-[12px] border border-transparent bg-[#372A84] px-3 text-white md:w-2/3">
...
const DropdownOption = memo(({ option, onSelect, field }) => (
  <div
    key={option}
    className="cursor-pointer px-3 py-2 text-xs text-white transition-colors duration-150 hover:bg-[#FC7E09] md:text-sm"
    onClick={() => {
  ...
  return (
    <div className="space-y-6 text-white">
      ...
      <div className="mb-4 flex flex-wrap items-center gap-2 sm:gap-4">
        <button
          onClick={handleBack}
          className="rounded text-white transition-colors hover:text-gray-300 focus:ring-2 focus:ring-[#FC7E09] focus:outline-none"
        >
          <Image
      ...
      <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                render={({ field }) => (
                  <div className="flex w-full flex-col gap-1">
                    <div className="relative w-full" ref={sendingDropdownRef}>
                      <div
                        className={`relative flex h-[46px] w-full cursor-pointer appearance-none items-center justify-between rounded-[12px] border px-3 py-3 text-white focus:z-10 focus:ring-1 focus:outline-none sm:text-sm ${
                          errors.sendingOption
                            ? 'border-red-500 focus:border-red-500 focus:ring-red-500'
                            : 'border-[#5343B1] focus:border-[#FC7E09] focus:ring-[#FC7E09]'
                        }`}
                      ...
                      {isSendingOpen && (
                        <div className="absolute z-20 mt-1 max-h-56 w-full overflow-auto rounded-[12px] border border-[#5343B1] bg-[#241866] shadow-xl">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Input
                    ...
                    className="relative block h-[46px] w-full appearance-none rounded-[12px] border border-[#5343B1] px-3 py-3 text-white placeholder:text-xs placeholder:text-[#B3A6FF] focus:z-10 focus:border-[#FC7E09] focus:ring-1 focus:ring-[#FC7E09] focus:outline-none sm:text-sm md:placeholder:text-sm"
            ...
            <div className="mb-4 sm:mb-6">
              ...
              <Controller
                ...
                render={({ field: { onChange } }) => (
                  <div className="flex w-full flex-col gap-1">
                    <div
                      className={`flex w-full flex-wrap items-center gap-3 rounded-[12px] border px-3 py-2 transition-colors focus-within:z-10 focus-within:ring-1 focus-within:outline-none ${
                        errors.receiptFile
                          ? 'border-red-500 focus-within:border-red-500 focus-within:ring-red-500'
                          : 'border-[#5343B1] focus-within:border-[#FC7E09] focus-within:ring-[#FC7E09] hover:border-[#FC7E09]'
                      }`}
                      onDragOver={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                    ...
                    >
                      <div
                        className={`btn-hover-fill rounded-md px-4 py-2 text-xs text-white transition-opacity focus-within:ring-2 focus-within:ring-[#FC7E09] focus-within:outline-none ${
                          isFileDialogOpening
                      ...
                      <input
                        ...
                        ref={fileInputRef}
                      />
                      <span className="text-xs break-words text-[#B3A6FF] sm:text-sm">
            ...
            <div className="mt-6 space-y-3">
                      ...
                      <span
                        ...
                        className={`grid h-5 w-5 flex-shrink-0 place-items-center rounded-[3px] border-2 transition-all duration-200 ${
                          field.value
                            ...
                            : 'border-[#5343B1] bg-transparent hover:border-[#FC7E09]'
                        }`}
                      >
                        <svg
                          viewBox="0 0 24 24"
              ...
              <div className="mt-6 flex flex-row justify-center gap-3 sm:gap-4">
                <button
                  type="button"
                  onClick={handleBack}
                  className="btn-hover-outline inline-flex items-center justify-center rounded-[8px] border border-[#FC7E09] bg-[#1f1556] px-6 py-3 text-[14px] text-white transition-colors hover:bg-white/5"
                >
                  {t('back')}
                </button>
                <button
        ...
        <div className="order-1 h-max rounded-[16px] bg-[#241866] p-5 md:sticky md:top-4 md:order-2">
          ...
          <div className="mt-4 text-[12px]">
            <span className="font-semibold text-[#FC7E09]">{t('note')}:</span>
            <span className="text-[#B6AAFF] italic">
              {' '}

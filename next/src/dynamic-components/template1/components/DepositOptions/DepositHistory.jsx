...
import TransactionDetail from '@/dynamic-components/template1/components/TransactionDetail/TransactionDetail';
        ...
        <>
          ...
          <div className="show-scrollbar h-[400px] overflow-x-auto overflow-y-auto md:h-[500px]">
            ...
            <div className="overflow-x-auto md:overflow-x-visible">
              <div className="inline-block w-full min-w-[600px] align-top">
                {/* Table Header - Fixed */}
                      ...
                      <tbody>
                        {requestInfoLoader ? (
                          ...
                          requestInfoData.data.map((item, index) => (
                            ...
                            >
                              <td className="px-1 py-2 text-center whitespace-nowrap text-white md:px-2 md:py-3">
                                {calculateIndex(
                                  index,
                                  currentPage,
                                  rowsPerPage,
                              ...
                              <td className="px-2 py-2 whitespace-nowrap md:px-2 md:py-3">

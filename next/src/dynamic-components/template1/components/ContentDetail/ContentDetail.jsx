      ...
      return (
        <div className={`flex flex-col gap-2 ${className}`}>
          ...
          <div className="flex-1">
            <div
              className={`min-h-[120px] w-full rounded-[12px] border border-transparent bg-[#372A84] px-3 py-3 text-white ${contentClassName}`}
    ...
    <div className="rounded-[10px] border-2 border-[#452FCD] bg-[#241866] p-5">
      ...
      <div className="">
        ...
        >
          ...
          {hasReply && (
            <div className="rounded-[9px] border border-[#452FCD] p-4">
              <div className="mb-4 text-[15px] font-semibold text-white">
                {t('response_details')}
              </div>
              ...
              <div className="mb-6">
                ...
                <div
                  className="min-h-[180px] w-full rounded-[12px] border border-transparent bg-[#372A84] px-3 py-3 text-white"
                  style={{ borderRadius: 12 }}
                >
                  <div
                    className="text-xs break-words md:text-sm"
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                ...
                <div>
                  ...
                  <div
                    className="h-[46px] w-full rounded-[12px] border border-transparent bg-[#372A84] px-3 py-3 text-white placeholder-white/60"
                    style={{ borderRadius: 12 }}
                  >

...
function GameProviders() {
  ...
  const providesNames = {
    ...
    gtf: 'https://d3emlo5tm9es2f.cloudfront.net/next/logos/GTF.png',
    spade: 'https://d3emlo5tm9es2f.cloudfront.net/next/logos/spade+gaming.png',
    yellowbat: 'https://d3emlo5tm9es2f.cloudfront.net/next/logos/yellowbet.png',
    advantplay:
      'https://d3emlo5tm9es2f.cloudfront.net/next/logos/advant+play.png',
    askmeslot: 'https://d3emlo5tm9es2f.cloudfront.net/next/logos/askme.png',
    bgaming: 'https://d3emlo5tm9es2f.cloudfront.net/next/logos/bgaming.png',
    gpk7mj: 'https://d3emlo5tm9es2f.cloudfront.net/next/logos/7mojos.png',
    booming:
      'https://d3emlo5tm9es2f.cloudfront.net/next/logos/booming+games.png',
    spinomenal:
      'https://d3emlo5tm9es2f.cloudfront.net/next/logos/spinomenal.png',
    dbgame: 'https://d3emlo5tm9es2f.cloudfront.net/next/logos/db+gaming.png',
    live22: 'https://d3emlo5tm9es2f.cloudfront.net/next/logos/live+22.png',
    cg: 'https://d3emlo5tm9es2f.cloudfront.net/next/logos/creative+gaming.png',
    thunderkick:
      'https://d3emlo5tm9es2f.cloudfront.net/next/logos/thunderkick.png',
  };

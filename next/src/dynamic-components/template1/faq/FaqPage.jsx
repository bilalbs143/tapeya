...
function FaqPage() {
  ...
  const Section = ({ items }) => (
    <div className="space-y-4">
      {items.map((item, idx) => (
        <div key={idx} className="rounded-lg border border-[#FC7E09]">
          <div className="mobile-faq-question px-4 py-3 text-[#FC7E09]">
            {item.q}
          </div>
  ...
  return (
    <div className="min-h-screen text-white">
      <div className="container mx-auto px-4 py-8">
        <h1 className="mobile-title mb-2 mb-8 text-[#FC7E09]">
              ...
              <button
                ...
                className={`mobile-tab-button rounded-lg px-6 py-3 transition-colors ${
                  activeTab === tab.key
                    ...
                    : 'bg-transparent text-gray-300 hover:bg-[#5343B1]/20 hover:text-white'
                }`}
              >
                {tab.label}
              </button>
        ...
        <div className="rounded-lg border border-[#5343b15e] p-6">
          {(() => {

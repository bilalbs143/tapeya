...
function TermsOfUsePage() {
  const termsContent = {
    en: {
      ...
      generalContent8:
        'These Terms and Conditions may be published in a number of languages and shall reflect the same principles. This is for information purposes and to help the Account Holder. It is however only the English version that is the legal basis of the relationship between you and KOKOBET777. In case of any discrepancy between the English version and the non-English version of these Terms and Conditions, the English version shall always prevail.',
      yourObligations: 'Your Obligations',
      obligationsContent1:
        'You may only open one Account at any time on the Website. KOKOBET777 retains the right to terminate any duplicate Account.',
      obligationsContent2:
        'If you open or attempt to open more than one Account, for whatever reason, KOKOBET777 may block or close any or all of your Accounts at its discretion.',
      obligationsContent3:
        'If you notice that you have more than one registered Account you must notify us immediately.',
      obligationsContent4:
        'Failure to do so may lead to your Account being blocked and/ or closed. In the event that we consider that multiple Accounts have been opened in genuine error, KOKOBET777 may, at its sole discretion, agree to credit the first Account which you would have opened with us with any balance remaining in your additional Account(s).',
      obligationsContent5:
      ...
      obligationsContent6:
        'You are solely responsible for your Account details and the use of your Account via such details. This includes but shall not be limited to the username and password and/or any other means to access your Account via the respective Website. Where you have a suspicion that such information may have been compromised, you must inform KOKOBET777 and take proper actions to prohibit or prevent any unauthorises access to any part of your Account or funds.',
      obligationsContent7:
        'You shall use our Service on your own behalf and not on behalf of any other person or entity. An Account may only be held by a natural person. For the avoidance of doubt, company accounts are not permitted. Moreover, you shall not allow any other natural person to access and/or use your Account or accept any prize or access and participate in any of the KOKOBET777 services. You understand that you shall be fully liable for any losses incurred by a third party on your Account and you shall immediately inform us should you suspect that a third party has obtained access to your Account, take proper actions to prohibit or prevent any unauthorises access to any part of your Account or funds, and assist us fully in our investigations into the matter.',
      obligationsContent8:
      ...
      obligationsContent9:
        "You are aware that the right to access and use our Service, may be considered illegal in certain countries or that access to our Service from certain countries may mandate limitations due to such a country's status in any recognised index or ranking in the field of financial crime. You are responsible for determining whether your accessing and using our Service is compliant with the applicable laws in your country and you warrant to us that gambling is not illegal in the territory where you reside. KOKOBET777 also prohibits persons located in (including temporary visitors) or residents of certain jurisdictions. For the avoidance of doubt, access and registration from countries that do not feature on the dropdown options available at registration stage, is strictly prohibited. Your participation in the Games in a jurisdiction where such participation is prohibited by law or in a jurisdiction which, despite participation not being prohibited, may result in the imposition of limitations on your participation and/or access to the Games in any manner, shall not affect any stakes or payments made to and accrued for the benefit of KOKOBET777.",
      ...
      obligationsContent11:
        'As an Account Holder, you are responsible for providing KOKOBET777 with correct personal details. To this effect you agree that all information that you give to us, such as but not limited to, an address and email address that is complete and true, and that you will immediately notify KOKOBET777 should there be changes to such information. You are hereby notified that we carry out verification procedures and, should KOKOBET777 become aware that you have failed to provide to us correct information, we retain the right to block the Account and refuse to process any refunds or winnings.',
      ...
      obligationsContent16:
        'You understand and acknowledge that it is not permissible for you to play any Games offered by KOKOBET777 on credit.',
    ...
    id: {
      ...
      generalContent3:
        'KOKOBET777 berhak untuk memodifikasi Syarat dan Ketentuan dari waktu ke waktu karena sejumlah alasan, termasuk untuk mematuhi undang-undang dan peraturan yang berlaku, serta persyaratan peraturan lainnya. Akibatnya, kami dapat mengubah Perjanjian kapan saja. Namun, setiap kali perubahan substansial dibuat pada Syarat dan Ketentuan, kami akan memberi tahu Anda melalui pemberitahuan di Website saat login Akun dan sebelum perubahan mulai berlaku. Setelah diberi tahu, Anda kemudian akan diminta untuk mengkonfirmasi ulang penerimaan Anda atas isi di dalamnya. Jika Anda tidak setuju dengan Syarat dan Ketentuan yang diperbarui, Anda tidak akan dapat menggunakan Layanan lagi. Syarat dan Ketentuan lengkap tersedia di halaman depan Website setiap saat. Selalu disarankan untuk memeriksa Syarat dan Ketentuan sebelum menggunakan Layanan untuk memastikan bahwa Anda setuju dengan mereka. Semua versi diberi tanggal dan cap waktu.',
      generalContent4:
      ...
      generalContent8:
        'Syarat dan Ketentuan ini dapat diterbitkan dalam sejumlah bahasa dan harus mencerminkan prinsip yang sama. Ini untuk tujuan informasi dan untuk membantu Pemegang Akun. Namun, hanya versi bahasa Inggris yang menjadi dasar hukum dari hubungan antara Anda dan KOKOBET777. Dalam hal ada perbedaan antara versi bahasa Inggris dan versi non-bahasa Inggris dari Syarat dan Ketentuan ini, versi bahasa Inggris akan selalu berlaku.',
      yourObligations: 'Kewajiban Anda',
      obligationsContent1:
        'Anda hanya dapat membuka satu Akun pada satu waktu di Website. KOKOBET777 mempertahankan hak untuk mengakhiri Akun duplikat apa pun.',
      obligationsContent2:
        'Jika Anda membuka atau mencoba membuka lebih dari satu Akun, untuk alasan apa pun, KOKOBET777 dapat memblokir atau menutup Akun Anda apa pun atau semua atas kebijaksanaan tunggalnya.',
      obligationsContent3:
        'Jika Anda melihat bahwa Anda memiliki lebih dari satu Akun terdaftar, Anda harus segera memberi tahu kami.',
      obligationsContent4:
        'Kegagalan untuk melakukannya dapat menyebabkan Akun Anda diblokir dan/atau ditutup. Jika kami menganggap bahwa beberapa Akun telah dibuka dalam kesalahan yang sebenarnya, KOKOBET777 dapat, atas kebijaksanaan tunggalnya, setuju untuk mengkreditkan Akun pertama yang akan Anda buka dengan kami dengan saldo yang tersisa di Akun tambahan Anda.',
      obligationsContent5:
      ...
      obligationsContent14:
        'Anda bertanggung jawab penuh untuk mematuhi proses pelaporan apa pun yang terkait dengan pembayaran pajak dan/atau biaya lain yang mungkin dikenakan pada kemenangan yang Anda terima dari KOKOBET777, jika dan di mana berlaku.',
      obligationsContent15:
      ...
      obligationsContent16:
        'Anda memahami dan mengakui bahwa tidak diizinkan bagi Anda untuk memainkan Permainan apa pun yang ditawarkan oleh KOKOBET777 secara kredit.',
      obligationsContent17:
      ...
      obligationsContent18:
        'Anda menyatakan bahwa Anda tidak dan tidak akan terlibat dalam atau terkait langsung dengan aktivitas penipuan, kolusif, fixing atau ilegal lainnya sehubungan dengan partisipasi Anda atau pihak ketiga dalam Permainan apa pun dan tidak akan menggunakan metode atau teknik yang dibantu perangkat lunak atau perangkat keras untuk partisipasi Anda dalam Permainan apa pun. Kami dengan ini berhak untuk membatalkan taruhan dan kesepakatan apa pun yang kami anggap sesuai dengan dana apa pun, jika kami mencurigai perilaku tersebut. Selain itu, Pemegang Akun mana pun yang memiliki alasan yang wajar untuk mencurigai bahwa Pemegang Akun lain mengambil keuntungan yang tidak adil melalui kecurangan atau kolusi harus melaporkan kecurigaan tersebut ke KOKOBET777 Contact Support.',
      footer:
        'Syarat dan Ketentuan ini membentuk perjanjian yang mengikat secara hukum antara Anda dan KOKOBET777. Dengan menggunakan Layanan kami, Anda mengakui bahwa Anda telah membaca, memahami, dan setuju untuk terikat dengan ketentuan ini. Untuk pertanyaan atau klarifikasi mengenai ketentuan ini, silakan hubungi tim dukungan kami.',
    },
    ko: {
      title: '이용약관',
      introduction: '소개',
      introContent1:
        '이 문서에 정의된 이용약관은 www.prgmainbet.com 및 기타 URL, 모바일 전화 애플리케이션 또는 KOKOBET777("웹사이트")에 라이선스되거나 소유하거나 제공하는 기타 제품 및 서비스를 통해 제공되는 게임("게임")의 사용을 규제합니다(통칭하여 "서비스").',
      introContent2:
        '이 이용약관, 웹사이트의 모든 게임에 적용되는 규칙("게임 규칙") 및 그 안에서 명시적으로 언급된 모든 문서, 그리고 웹사이트에 게시된 모든 가이드라인이나 규칙은 당사자 간의 계약과 이해를 구성하며 KOKOBET777과 서비스 계정 소유자("계정 소유자") 간의 계약 관계를 관리합니다(그리고 이 문서에서 통칭하여 "계약"이라고 합니다). 계약(이 이용약관 포함)을 주의 깊게 읽고 이해했는지 확인하세요. 내용에 동의하지 않는 경우 서비스를 더 이상 사용하지 마세요.',
      general: '일반',
      generalContent1:
      ...
      generalContent3:
        'KOKOBET777은 적용 가능한 법률 및 규정을 준수하고 기타 규제 요구사항을 포함한 여러 가지 이유로 이용약관을 수시로 수정할 권리를 보유합니다. 결과적으로 언제든지 계약을 수정할 수 있습니다. 그러나 이용약관에 실질적인 수정이 이루어질 때마다 계정 로그인 시 웹사이트에 통지하고 변경사항이 발효되기 전에 알려드리겠습니다. 통지를 받으면 내용에 대한 수락을 재확인해야 합니다. 업데이트된 이용약관에 동의하지 않으면 더 이상 서비스를 사용할 수 없습니다. 전체 이용약관은 항상 웹사이트의 첫 페이지에서 확인할 수 있습니다. 서비스 사용 전에 이용약관을 확인하여 동의하는지 확인하는 것이 항상 권장됩니다. 모든 버전은 날짜와 시간이 표시됩니다.',
      generalContent4:
      ...
      generalContent8:
        '이 이용약관은 여러 언어로 게시될 수 있으며 동일한 원칙을 반영해야 합니다. 이는 정보 제공 목적이며 계정 소유자를 돕기 위함입니다. 그러나 영어 버전만이 귀하와 KOKOBET777 간의 관계의 법적 기반입니다. 이 이용약관의 영어 버전과 비영어 버전 간에 불일치가 있는 경우 영어 버전이 항상 우선합니다.',
      yourObligations: '귀하의 의무',
      obligationsContent1:
        '웹사이트에서 언제든지 하나의 계정만 열 수 있습니다. KOKOBET777은 중복 계정을 종료할 권리를 보유합니다.',
      obligationsContent2:
  ...
  return (
    <div className="text-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="">
          {/* Border Container */}
          <div className="overflow-hidden rounded-[6px] border-1 border-[#6456BD]">
            <div className="p-8 md:p-12">
              {/* Header */}
              <div className="mb-8">
                <h1 className="mobile-title mb-4 text-[#FC7E09]">
              ...
              <div className="space-y-6">
                <section>
                  <h2 className="mobile-section-heading mb-4 text-white">
                    {currentContent.introduction}
                  </h2>
                  <p className="mobile-content text-gray-300">
                    {currentContent.introContent1}
                  </p>
                  <p className="mobile-content mt-4 text-gray-300">

...
function PrivacyPolicyPage() {
  const privacyContent = {
    en: {
      ...
      intro1:
        'KOKOBET777 ("KOKOBET777", the "Company", "we", "our") is committed to maintaining the highest standards of data privacy, confidentiality and information security. Protecting the confidentiality and integrity of information and of personal data is taken seriously at all times.',
      intro2:
      ...
      principlesIntro:
        'As KOKOBET777 is based in Malta, we follow the rules of the GDPR. This means that whenever we handle your personal data, we always follow the GDPR principles:',
      ...
      purposeLimitationContent:
        'KOKOBET777 is clear about what the purposes for processing information are from the start of the relationship.',
      ...
      storageLimitationContent:
        'KOKOBET777 has established retention periods in a separate Data Retention Policy, which outlines the duration of data retention ensuring that no data is kept long than required.',
      ...
      accountabilityContent:
        'KOKOBET777 has the appropriate measures and records in place to be able to demonstrate our compliance.',
      dataCollection: 'Data Collection at Registration',
      dataCollectionIntro1:
        'When you register for an account with KOKOBET777 you enter into a contract with us, as we explain in our Terms and Conditions. For us to be able to perform this contract and provide you with access to our services, we need to collect and process some personal information about you.',
    ...
    id: {
      ...
      intro1:
        'KOKOBET777 ("KOKOBET777", "Perusahaan", "kami", "kami") berkomitmen untuk mempertahankan standar tertinggi privasi data, kerahasiaan dan keamanan informasi. Melindungi kerahasiaan dan integritas informasi serta data pribadi diambil serius setiap saat.',
      intro2:
      ...
      principlesIntro:
        'Karena KOKOBET777 berbasis di Malta, kami mengikuti aturan GDPR. Ini berarti bahwa setiap kali kami menangani data pribadi Anda, kami selalu mengikuti prinsip GDPR:',
      ...
      purposeLimitationContent:
        'KOKOBET777 jelas tentang apa tujuan pemrosesan informasi dari awal hubungan.',
      ...
      storageLimitationContent:
        'KOKOBET777 telah menetapkan periode retensi dalam Kebijakan Retensi Data terpisah, yang menguraikan durasi retensi data memastikan bahwa tidak ada data yang disimpan lebih lama dari yang diperlukan.',
    ...
    ko: {
      title: '개인정보 보호정책',
      intro1:
        'KOKOBET777("KOKOBET777", "회사", "우리", "저희")은 데이터 개인정보 보호, 기밀성 및 정보 보안의 최고 기준을 유지하는 데 전념하고 있습니다. 정보와 개인 데이터의 기밀성과 무결성을 보호하는 것은 항상 진지하게 다뤄집니다.',
      intro2:
      ...
      principlesIntro:
        'KOKOBET777은 몰타에 기반을 두고 있기 때문에 GDPR 규칙을 따릅니다. 이는 개인 데이터를 처리할 때마다 항상 GDPR 원칙을 따른다는 것을 의미합니다:',
      ...
      purposeLimitationContent:
        'KOKOBET777은 관계 시작부터 정보 처리 목적이 무엇인지 명확합니다.',
      ...
      storageLimitationContent:
        'KOKOBET777은 별도의 데이터 보존 정책에 보존 기간을 설정했으며, 이는 데이터가 필요한 것보다 오래 보관되지 않도록 데이터 보존 기간을 설명합니다.',
      integrityConfidentiality: '무결성 및 기밀성:',
      integrityConfidentialityContent:
        '개인에 대한 개인 데이터를 보호하기 위한 적절한 보안 조치가 갖춰져 있는지 확인합니다.',
      accountability: '책임성:',
      accountabilityContent:
        'KOKOBET777은 준수 상황을 입증할 수 있도록 적절한 조치와 기록을 갖추고 있습니다.',
      dataCollection: '등록 시 데이터 수집',
      dataCollectionIntro1:
        'KOKOBET777에서 계정을 등록할 때 이용약관에서 설명하는 대로 저희와 계약을 체결합니다. 이 계약을 수행하고 서비스에 대한 액세스를 제공하기 위해 귀하에 대한 일부 개인 정보를 수집하고 처리해야 합니다.',
      dataCollectionIntro2:
          ...
          <div className="overflow-hidden rounded-[6px] border-1 border-[#6456BD]">
            <div className="p-8 md:p-12">
              ...
              <div className="space-y-6">
                ...
                <h2 className="mobile-section-heading mt-8 mb-4 text-[#FC7E09]">
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="mobile-subsection-heading mb-2 text-white">
                ...
                <ul className="ml-4 list-inside list-disc space-y-2">
                  {currentContent.requiredData.map((item, index) => (
                    <li key={index} className="mobile-list-item text-gray-300">
                      {item}
                    </li>
                  ))}
                </ul>

                <h3 className="mobile-subsection-heading mt-6 mb-2 text-white">

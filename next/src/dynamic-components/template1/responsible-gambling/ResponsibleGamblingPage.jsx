...
function ResponsibleGamblingPage() {
  const responsibleGamblingContent = {
    en: {
      ...
      underageContent:
        "It's strictly forbidden for persons under the age of 18 to open an account at KOKOBET777.",
      reminder:
    ...
    id: {
      ...
      underageContent:
        'Sangat dilarang bagi orang di bawah usia 18 tahun untuk membuka akun di KOKOBET777.',
      reminder:
    ...
    ko: {
      ...
      underageContent:
        '18세 미만의 사람이 KOKOBET777에서 계정을 여는 것은 엄격히 금지됩니다.',
      reminder:

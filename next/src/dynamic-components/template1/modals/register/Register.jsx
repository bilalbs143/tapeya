...
export default function Register(props) {
  ...
  return (
    <div
      className={`register-modal scrollbar-hide mx-auto max-h-[80vh] w-full max-w-[400px] transform overflow-x-visible overflow-y-visible rounded-[24px] bg-[#312577] p-4 text-white shadow-xl transition-all duration-300 ease-out sm:max-w-[600px] sm:p-6 lg:max-w-[800px] lg:p-8 xl:max-w-[890px] ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'}`}
    >
      <div className="space-y-4 sm:space-y-6">
        ...
        <form
          className="relative space-y-3 overflow-visible rounded-[3px] border-2 border-[#452FCD] p-4 sm:space-y-4 sm:p-6"
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Input
                    ...
                    className="relative block w-full appearance-none rounded-[12px] border border-[#5343B1] px-3 py-3 text-white placeholder:text-xs placeholder:text-[#B3A6FF] focus:z-10 focus:border-[#FC7E09] focus:ring-1 focus:ring-[#FC7E09] focus:outline-none sm:text-sm md:placeholder:text-sm"
            ...
            <div>
              ...
              <Controller
                ...
                render={({ field }) => (
                  ...
                  >
                    <SelectTrigger className="relative block w-full items-center justify-between rounded-[12px] border border-[#5343B1] bg-transparent px-3 py-3 text-white focus:z-10 focus:border-[#FC7E09] focus:ring-1 focus:ring-[#FC7E09] focus:outline-none">
                      <SelectValue
                    ...
                    <SelectContent className="z-[60] max-h-[150px] w-full border-[#5343B1] bg-[#22195A]">
                      {allBanksLoader ? (
                        ...
                        allBanksData.map((bank) => (
                          <SelectItem
                            ...
                            className="text-white hover:bg-[#FC7E09]"
                          >
                            {getBankName(bank)}
                          </SelectItem>
                        ))

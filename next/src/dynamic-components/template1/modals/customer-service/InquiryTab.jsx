...
import ContentDetail from '@/dynamic-components/template1/components/ContentDetail/ContentDetail';
        ...
        <div className="space-y-6">
          ...
          >
              ...
              <Controller
                ...
                render={({ field }) => (
                  <textarea
                    ...
                    rows="4"
                    className="relative block min-h-[46px] w-full resize-none appearance-none rounded-[12px] border border-[#5343B1] px-3 py-3 text-white placeholder:!text-xs placeholder:text-[#B3A6FF] focus:z-10 focus:border-[#FC7E09] focus:ring-1 focus:ring-[#FC7E09] focus:outline-none sm:text-sm md:placeholder:!text-sm"
                  />
                )}
              />
            ...
            <div className="mt-6 flex justify-end">
              <button
                type="submit"
                className="btn-hover-fill inline-flex h-[46px] items-center justify-center rounded-[8px] px-6 text-[14px] whitespace-nowrap text-white transition-opacity sm:shrink-0"
                data-hover={t('submit')}
              >
                {t('submit')}
              </button>
          ...
          <div className="space-y-4">
            {/* Separator Line */}
            <div className="my-10 h-px w-full bg-[#4B51A3]" />

            {/* Table Container with Fixed Height and Scroll */}
            <div className="overflow-hidden rounded-2xl border border-[#5343B1]">
                  ...
                  <tbody>
                    {allCustomerInquiriesLoader ? (
                      ...
                      inquiriesData.map((inquiry, index) => (
                        <tr
                          key={`row-${inquiry.id}`}
                          className="cursor-pointer border-b border-[#5343B1] transition-all duration-300 hover:border-[#FC7E09] hover:shadow-[0_0_10px_0_#FC7E09_inset]"
                        ...
                        >
                          ...
                          <td className="px-2 py-2 text-center text-white md:px-2 md:py-3">
                            <button className="btn-hover-outline rounded-full border border-[#FC7E09] bg-transparent px-3 py-1 text-xs font-medium text-white transition-colors duration-200 hover:bg-[#FC7E09] hover:text-white">
                              {t('details')}
                            </button>
                          </td>
                          <td className="px-1 py-2 text-white md:px-2 md:py-3">

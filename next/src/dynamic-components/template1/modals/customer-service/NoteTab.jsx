    ...
    <div className="flex h-full min-h-0 flex-col">
      ...
      {showNoteDetails ? (
        ...
        <>
          ...
          <div className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-2xl border border-[#5343B1]">
            <div className="show-scrollbar min-h-0 flex-1 overflow-x-auto overflow-y-auto">

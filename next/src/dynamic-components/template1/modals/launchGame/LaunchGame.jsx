      ...
      <div className="space-y-4 sm:space-y-6">
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={handleCloseModal}
            aria-label={t('close')}
            className="flex h-6 w-6 flex-shrink-0 cursor-pointer items-center justify-center rounded-sm bg-[#FC7E09] leading-none font-bold text-[2xl] text-white sm:h-7 sm:w-7"
          >
            <svg
              width="16"
              height="16"
        ...
        <div className="flex flex-col gap-3">
          <button
            ...
            className="flex h-12 w-full cursor-pointer items-center justify-center rounded-lg bg-[#FF8200] text-sm font-semibold text-white transition-colors hover:bg-[#E67500] disabled:opacity-50 sm:h-14 sm:text-base"
          >
            {isGameLaunching ? (

...
import PendingExchangeAlert from '@/dynamic-components/template1/components/AlertSections/PendingExchangeAlert';
import UnreadNotesAlert from '@/dynamic-components/template1/components/AlertSections/UnreadNotesAlert';
      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="space-y-6">
              ...
              <div className="text-center">
                ...
                {modalProps.data?.exchangeRequest && (
                  <div className="mt-4 space-y-3">
                    {/* Amount Details */}
                    <div className="rounded-[12px] bg-[#2E2070] px-6 py-8">
                      ...
                      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div
                          className={`rounded-[10px] bg-[#372A84] px-4 py-4 ${modalProps.type !== 'exchange_approved' || !modalProps.data.exchangeRequest.approved_money ? 'md:col-span-2' : ''}`}
                        >
            ...
            <div className="space-y-4">
              <div className="text-center">
                ...
                {modalProps?.data?.customerInquiry && (
                  <div className="mt-4 space-y-3">
                    <div className="rounded-[12px] bg-[#2E2070] px-6 py-4">
                      <div className="mb-2 text-[14px] font-bold text-white">
                        {t('inquiry_title')}
                      </div>
              ...
              <button
                ...
                className="btn-hover-fill w-full cursor-pointer rounded-full px-4 py-3 text-sm font-normal text-white transition-all duration-150 active:scale-95 active:shadow-inner"
          ...
          {hasUnreadNotes &&
            ...
            !isCustomerInquiryReplyAlert && (
            <div className="space-y-4">
              <h3 className="border-b border-[#FC7E09] pb-1 text-sm font-medium text-[#FC7E09]">
                {t('unread_messages')}
              </h3>
              <UnreadNotesAlert

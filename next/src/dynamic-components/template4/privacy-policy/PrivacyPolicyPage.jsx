          ...
          >
            <div className="p-6 md:p-12">
              ...
              <div className="space-y-6">
                ...
                <h2 className="mobile-section-heading mt-8 mb-4 bg-gradient-to-r from-[#55BC55] via-[#55BC55] to-[#55BC55] bg-clip-text font-bold text-transparent">
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="mobile-subsection-heading mb-2 bg-gradient-to-r from-[#55BC55] via-[#55BC55] to-[#55BC55] bg-clip-text font-bold text-transparent">
                ...
                <h3 className="mobile-subsection-heading mt-6 mb-2 bg-gradient-to-r from-[#55BC55] via-[#55BC55] to-[#55BC55] bg-clip-text font-bold text-transparent">

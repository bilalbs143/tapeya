                    ...
                    <tbody>
                      {transactionHistoryLoader ? (
                        ...
                        requestInfoData.map((item, index) => (
                          <tr
                            key={item.id || index}
                            className="border-b border-[#FFFFFF66] transition-all duration-300 last:border-b-0 hover:border-[#55BC55] hover:shadow-[0_5px_30px_0_rgba(85,188,85,0.46)_inset]"
                          >

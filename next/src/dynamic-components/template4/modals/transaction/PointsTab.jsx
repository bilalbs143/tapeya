    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-5">
        ...
        <button
          ...
          className="filled-hover-effect flex cursor-pointer items-center justify-center rounded-[10px] bg-[#55BC55] px-6 pt-3 pb-3 text-[14px] font-semibold text-black transition-all duration-200 active:scale-95"
        >
                    ...
                    <tbody>
                      {transactionHistoryLoader ? (
                        ...
                        requestInfoData.map((item, index) => (
                          <tr
                            key={item.id || index}
                            className="cursor-pointer border border-[#FFFFFF66] transition-all duration-300 last:border-b-0 hover:border-[#5AB25A] hover:shadow-[0_5px_30px_0_rgba(85,188,85,0.46)_inset]"
                          >

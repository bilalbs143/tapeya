...
export default function Announcement() {
  ...
  return (
    <div className="announcement-modal relative mx-auto flex h-[80vh] w-full flex-col overflow-hidden rounded-[5px] border-2 border-[#03c72c4d] bg-[#060D0D] text-white shadow-xl">

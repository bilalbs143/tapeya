...
export default function Register(props) {
  ...
  return (
    <div
      className={`register-modal scrollbar-hide mx-auto w-full max-w-[400px] transform overflow-visible rounded-[5px] border-2 border-[#03C72C4D] bg-[#060D0D] text-white shadow-xl transition-all duration-300 ease-out sm:max-w-[600px] lg:max-w-[800px] xl:max-w-[890px] ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'}`}
    >
          ...
          >
              ...
              <div className="relative">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    ...
                    >
                      <SelectTrigger className="relative block h-[46px] w-full items-center justify-between rounded-[5px] border border-[#054516] bg-transparent px-3 py-3 text-white shadow-none focus:border-[#55BC55] focus:ring-0 focus:ring-transparent focus:outline-none lg:h-[55px]">
                        <SelectValue
                      ...
                      <SelectContent
                        className="z-[60] max-h-[105px] w-full border-[#55BC55] bg-black"
                        side="bottom"
                        align="start"
                      >
                        {allBanksLoader ? (
                          <div className="px-3 py-2 text-sm text-[#55BC55]">
                            {t('loading_banks')}
                          </div>
                          ...
                          allBanksData.map((bank) => (
                            <SelectItem
                              ...
                              className="text-white hover:bg-[#55BC55]"
                            >
                              {getBankName(bank)}
                            </SelectItem>
                          ))
            ...
            <div className="mt-6">
              <button
                ...
                className="filled-hover-effect flex w-full cursor-pointer items-center justify-center rounded-[10px] bg-[#55BC55] px-4 pt-3 pb-4 text-base font-semibold text-black transition-all duration-200 active:scale-95 disabled:opacity-50"

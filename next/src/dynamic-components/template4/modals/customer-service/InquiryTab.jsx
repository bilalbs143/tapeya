          ...
          <div className="rounded-[10px] border border-[#FFFFFF66] p-3 md:p-4 lg:p-6">
            ...
            >
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <textarea
                      ...
                      rows="4"
                      className="relative block min-h-[46px] w-full resize-none appearance-none rounded-[5px] border border-[#054516] bg-transparent px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFF66] focus:border-[#55BC55] focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:min-h-[55px]"
                    />
                  )}
                />
              ...
              <div className="mt-6 flex justify-end">
                <button
                  type="submit"
                  className="filled-hover-effect flex cursor-pointer items-center justify-center rounded-[10px] bg-[#55BC55] px-8 pt-2 pb-2 text-[16px] font-semibold text-black transition-all duration-200 active:scale-95"
                  data-hover={t('submit')}
                >
                  <span>{t('submit')}</span>
                </button>

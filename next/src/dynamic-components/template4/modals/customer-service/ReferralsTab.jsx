      ...
      <div className="mb-5 grid grid-cols-1 gap-4 md:grid-cols-12">
        <div className="md:col-span-9">
          ...
          <div className="mt-2 pt-4 text-[14px] text-white italic lg:pt-8 lg:text-[16px]">
            <span className="font-semibold text-[#55BC55] not-italic">
              {t('note')}:
            </span>{' '}
          ...
          <div className="flex h-full flex-col items-center justify-center md:items-end">
            <div className="flex flex-col items-center gap-2">
              ...
              <button
                ...
                className="filled-hover-effect flex w-[220px] cursor-pointer items-center justify-center gap-2 rounded-[10px] bg-[#55BC55] px-4 pt-2 pb-2 text-xs font-semibold text-black active:scale-95"
              >
        ...
        <div className="flex h-[400px] flex-col md:h-[500px]">
          <div className="overflow-x-auto md:overflow-x-visible">
            <div className="inline-block w-full min-w-[900px] align-top md:min-w-[1100px]">
              ...
              {/* Table Body */}
              <div className="show-scrollbar flex-1 overflow-y-auto rounded-b-2xl border border-t-0 border-[#FFFFFF66]">
                {referralsLoader ? (
                    ...
                    <tbody>
                      {items.length === 0 ? (
                        ...
                        items.map((item, index) => (
                          <tr
                            key={item.id || index}
                            className="border-b border-[#FFFFFF66] transition-all duration-300 last:border-b-0 hover:border-[#5AB25A] hover:shadow-[0_5px_30px_0_rgba(85,188,85,0.46)_inset]"
                          >
                            ...
                            <td className="px-1 py-2 whitespace-nowrap text-white md:px-2 md:py-3">
                              <span className="text-[#55BC55] transition-all duration-200">

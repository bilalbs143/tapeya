...
import TransactionDetail from '@/dynamic-components/template4/components/TransactionDetail/TransactionDetail.jsx';
                    ...
                    requestInfoData.data.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-1 py-2 md:px-2 md:py-3">
                          <span className="text-[#5AB25A] transition-all duration-200">
                        ...
                        <td className="px-2 py-2 text-center md:px-2 md:py-3">
                          <button className="btn-hover-outline rounded-[6px] border border-[#03c72c4d] bg-transparent px-3 py-1 text-xs font-medium text-white transition-colors duration-200 hover:bg-[#55BC55] hover:text-black">
                            {t('details')}
                          </button>
                        </td>
                      </tr>

...
import CryptoSelect from '@/dynamic-components/template4/components/CryptoSelect/CryptoSelect';
import CryptoWithdrawalDetails from '@/dynamic-components/template4/components/CryptoWithdrawalDetails/CryptoWithdrawalDetails';
          ...
          <Controller
            ...
            render={({ field }) => (
              <Input
                ...
                className="relative block h-[46px] w-full appearance-none rounded-[5px] border border-[#03c72c4d] bg-transparent px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFF66] focus:border-[#55BC55] focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:h-[55px]"

...
import GameCard from '@/dynamic-components/template4/components/GameCard/GameCard';
        ...
        <div className="mt-6 flex flex-col items-center justify-center gap-4">
          {hasMore && (
            <button
              ...
              className="inline-flex transform cursor-pointer items-center justify-center rounded-[5px] bg-[#5AB25A] px-8 py-3 font-semibold text-black transition-all hover:scale-105 hover:bg-[#03c72ca6] active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
            >
        ...
        {currentPage === 1 &&
          ...
          <div className="py-16">
            <div className="flex flex-col items-center space-y-4">
              <CommonLoader size="xl" border="border-[#55BC55]" />

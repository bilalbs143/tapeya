...
export default function CryptoSelect({
  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      {showCategories && (
        <div className="mb-[10px] rounded-[10px] bg-[#5AB25A] p-[1px]">
            ...
            {loadingCurrencies ? (
              ...
              visibleCoins.map((c) => (
                <button
                  ...
                  className={`group flex min-h-[80px] w-full items-center justify-between gap-3 rounded-[5px] border border-[#03c72c4d] bg-transparent px-4 py-4 text-[#cfd8df] transition-all duration-300 hover:border-[#5AB25A] hover:shadow-[0_5px_30px_0_rgba(85,188,85,0.46)_inset] sm:px-4 ${
                    selectedCurrency === c.code
                      ? 'border-[#5AB25A] shadow-[0_5px_30px_0_rgba(85,188,85,0.46)_inset]'
                      : ''
                  }`}
                >
                  ...
                  {c.icon ? (
                    ...
                    <div
                      ...
                      style={{ backgroundColor: c.color || '#5AB25A' }}
                    >

...
const GameCard = ({ game, showDivider = false }) => {
  ...
  return (
    <div className="relative w-80 flex-shrink-0">
      <div className="flex overflow-hidden bg-[#55BC55] transition-colors duration-200">
        <div className="relative m-auto h-20 w-28 overflow-hidden">
          <LazyImage
            src={game.image}
            alt={game.name}
            fill
        ...
        <div className="flex flex-1 flex-col justify-between bg-[#55BC55] p-2">
          <div className="mb-1 flex justify-start">
            <div className="flex min-w-fit items-center gap-2 rounded-[4px] border border-[#03c72c4d] bg-[#0A1818] px-3 py-2 text-[10px] font-semibold text-white">
              <LazyImage
                src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/coin-4.svg"
                alt={t('money')}
                width={18}
                height={18}
      ...
      {showDivider && (
        <div className="absolute top-0 bottom-0 -left-[6px] z-10 w-[1px] bg-[#060D0D]" />
      )}
    </div>
  );
};
    ...
    <div className="px-2 pb-8 sm:px-4">
        ...
        <div className="container mx-auto">
          <div className="flex items-center gap-3 px-0 py-0 md:px-2 md:py-1">
            ...
            <div className="flex items-center gap-3 rounded-none bg-transparent px-0 py-0">
              <h2
                className="text-center text-[24px] font-semibold tracking-wide text-white uppercase md:text-[24px]"
                style={{
                  fontFamily: 'var(--font-alatsi)',
                  WebkitTextStroke: '1px #5AB25A',
                  textStroke: '1px #5AB25A',
                }}
              >
                {t('try_your_luck_now_many_users_winning')}
              </h2>
            </div>

            {/* Right line */}
            <div className="h-[2px] flex-1 bg-[#5AB25A]" />
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto">
        <div className="relative overflow-hidden">
          {/* <div className="h-[2px] w-full bg-[#5AB25A]" /> */}

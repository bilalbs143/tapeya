...
function SubNavbar() {
  ...
  return (
    <nav className="relative z-[1] bg-[#000304] px-2 md:px-6">
      <div className="z-[1] mb-4 rounded-[5px] border-2 border-[#03c72c4d] bg-[#060D0D] px-2 py-2 md:mb-0 md:px-3">
        {/* Desktop Layout */}
        <div className="hidden items-center md:grid md:[grid-template-columns:650px_1fr]">
          {/* Left: Announcement pill (fixed width 650px) */}
          <div className="flex justify-start">
            <div className="flex w-full items-center gap-3 overflow-hidden rounded-full py-2 pr-4 text-[#5AB25A] transition-colors">
              <Image
                src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/announce-icon-4.svg"
                alt={t('announcement')}
                width={16}
                height={16}
              />
              <span className="h-4 w-px flex-shrink-0 bg-[#5AB25A]" />
              <div
          ...
          <div className="flex items-center justify-end gap-2">
            <div className="flex h-[35px] items-center px-3 md:h-[30px]">
              {(() => {
                ...
                return (
                  <span className="bg-white bg-clip-text text-[12px] font-medium whitespace-nowrap text-transparent sm:text-[13px] md:text-[14px]">
                    {datePart} {timePart}
                  </span>
                );
              })()}
            </div>
            {/* Language switcher with transparent bg and solid #03c72c4d border */}
            <div className="bg-[#060D0D ] flex h-[40px] items-center rounded-[6px] border-2 border-[#03c72c4d] px-1 text-white hover:shadow-[inset_0_0_6px_1px_#55BC55]">
        ...
        <div className="flex items-center justify-between md:hidden">
          ...
          <Link
            href="#"
            className={`relative z-10 inline-flex items-center gap-3 overflow-hidden rounded-full py-2 pr-2 text-[12px] text-[#5AB25A] transition-colors hover:text-white ${

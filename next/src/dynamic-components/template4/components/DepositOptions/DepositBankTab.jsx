...
export default function DepositBankTab() {
  ...
  const PaymentMethodCard = ({ method, methodType }) => (
    <button
      ...
      className="flex h-[64px] w-full cursor-pointer items-center justify-center rounded-lg border border-[#03c72c4d] bg-white transition-all duration-300 hover:border-[#55BC55] hover:shadow-[0_0_10px_0_#55BC55_inset] sm:h-[75px]"
    >
    ...
    return (
      <div className="mb-3 space-y-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-[#55BC55] md:text-sm">
            ({approvalType})
          </span>
        </div>

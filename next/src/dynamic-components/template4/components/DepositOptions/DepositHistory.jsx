...
import TransactionDetail from '@/dynamic-components/template4/components/TransactionDetail/TransactionDetail';
                    ...
                    requestInfoData.data.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-2 py-2 text-center md:px-2 md:py-3">
                          <button className="btn-hover-outline rounded-[6px] border border-[#5AB25A] bg-transparent px-3 py-1 text-xs font-medium text-white transition-colors duration-200 hover:bg-[#5AB25A] hover:text-white">
                            {t('details')}
                          </button>
                        </td>
                      </tr>

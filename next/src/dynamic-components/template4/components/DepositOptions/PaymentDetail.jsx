...
const DropdownOption = memo(({ option, onSelect, field }) => (
  <div
    key={option}
    className="cursor-pointer px-3 py-2 text-xs text-white transition-colors duration-150 hover:bg-[#5AB25A] md:text-sm"
    onClick={() => {
  ...
  return (
    <div className="space-y-6 text-white">
      ...
      <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                render={({ field }) => (
                  <div className="flex w-full flex-col gap-1">
                    <div className="relative w-full" ref={sendingDropdownRef}>
                      <div
                        className={`relative flex h-[46px] w-full cursor-pointer appearance-none items-center justify-between rounded-[5px] border px-3 py-3 text-white shadow-none focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm lg:h-[55px] ${
                          errors.sendingOption
                            ...
                            : 'border-[#FFFFFF66] bg-transparent focus:border-[#03c72c4d]'
                        }`}
                      ...
                      {isSendingOpen && (
                        <div className="absolute z-20 mt-1 max-h-56 w-full overflow-auto rounded-[5px] border border-[#03c72c4d] bg-[#1a1a1a] shadow-xl">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Input
                    ...
                    className="relative block h-[46px] w-full appearance-none rounded-[5px] border border-[#FFFFFF66] bg-transparent px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFF66] placeholder:capitalize focus:border-[#5AB25A] focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:h-[55px]"
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Input
                    ...
                    className="relative block h-[46px] w-full appearance-none rounded-[5px] border border-[#FFFFFF66] bg-transparent px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFF66] focus:border-[#5AB25A] focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:h-[55px]"
              ...
              <Controller
                ...
                render={({ field: { onChange } }) => (
                  <div className="flex w-full flex-col gap-1">
                    <div
                      className={`flex w-full flex-wrap items-center gap-3 rounded-[5px] border px-3 py-2 shadow-none transition-colors focus-within:ring-0 focus-within:ring-transparent focus-within:outline-none ${
                        errors.receiptFile
                          ...
                          : 'border-[#FFFFFF66] bg-transparent focus-within:border-[#5AB25A] hover:border-[#5AB25A]'
                      }`}
                      onDragOver={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                    ...
                    >
                      <div
                        className={`filled-hover-effect btn-style901 rounded-md bg-[#5AB25A] px-4 py-2 text-xs font-semibold text-black transition-opacity focus-within:ring-2 focus-within:ring-[#4A9B4A] focus-within:outline-none active:scale-95 ${
                          isFileDialogOpening
            ...
            <div className="mt-6 space-y-3">
                      ...
                      <span
                        ...
                        className={`grid h-5 w-5 flex-shrink-0 place-items-center rounded-[3px] border-2 transition-all duration-200 ${
                          field.value
                            ...
                            : 'border-[#03c72c4d] bg-transparent hover:border-[#55BC55]'
                        }`}
                      >
                        <svg
                          viewBox="0 0 24 24"
              ...
              <div className="mt-8 flex w-full flex-row justify-center gap-3 sm:gap-4">
                <button
                  type="button"
                  onClick={handleBack}
                  className="outline-hover-effect inline-flex h-[52px] w-full max-w-[394px] items-center justify-center rounded-[10px] bg-[#0A1818] text-[16px] font-semibold text-white transition-all duration-200 active:scale-95"
                >
                  <span>{t('back')}</span>
                </button>
                ...
                <button
                  ...
                  className="filled-hover-effect flex h-[52px] w-full max-w-[394px] items-center justify-center rounded-[10px] bg-[#55BC55] text-[16px] font-semibold text-black transition-all duration-200 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
        ...
        <div className="order-1 h-max rounded-[5px] border border-[#55BC55] bg-[#0A1818] p-5 md:sticky md:top-4 md:order-2">
          ...
          <div className="mt-4 text-[12px]">
            <span className="font-semibold text-[#55BC55]">{t('note')}:</span>

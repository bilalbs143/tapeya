...
import { LanguageSwitcher } from '@/dynamic-components/template22/components/LanguageSwitcher/LanguageSwitcher';
import LazyImage from '@/dynamic-components/template22/components/LazyImage/LazyImage';
import WalletDropdown from '@/dynamic-components/template22/components/WalletDropdown/WalletDropdown';
...
function Navbar() {
  ...
  return (
    <>
      {/* Main Navbar */}
      <nav
        className={`relative z-[100] border-b-2 border-[#2e2e50] bg-[#121212] ${
          ...
          <div className="flex items-center justify-between gap-4">
              ...
              {!isAuth ? (
                ...
                >
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <input
                          ...
                          className="h-[30px] w-[100px] rounded-[3px] border border-black bg-white px-3 text-sm text-gray-900 placeholder:text-gray-500 focus:border-black focus:outline-none"
                        />
                      )}
                    />
                  </div>
                  ...
                  <SimpleImageCaptcha
                    ...
                    height={30}
                    inputWidth={60}
                    imageClassName="rounded-[3px] border border-black"
                    inputClassName="h-[30px] shrink-0 rounded-[3px] border border-black bg-white px-1 text-left text-sm text-gray-900 placeholder:text-gray-500 focus:border-black focus:outline-none"
                  />
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="relative" ref={userMenuRef}>
                    <button
                      ...
                      ref={userButtonRef}
                      className="group flex h-[45px] cursor-pointer items-center gap-3 rounded-[5px] border border-[#ec4d49]/60 bg-[#121212] px-3 py-2 text-base font-medium text-white transition-all hover:shadow-[0_0_10px_rgba(236,77,73,0.35)]"
                    >
            ...
            <div className="relative z-[1000] flex items-center gap-3 md:hidden">
              ...
              <button
                ...
                className="flex h-[30px] w-[30px] flex-shrink-0 cursor-pointer items-center justify-center rounded-[3px] bg-[linear-gradient(#f17a77,#ee5f5b_60%,#ec4d49)] text-white shadow-none transition-opacity duration-200 hover:opacity-90"
                ...
                >
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <input
                          ...
                          autoComplete="username"
                          placeholder={t('username') || 'Username'}
                          className="h-[30px] w-full rounded-[3px] border border-black bg-white px-3 text-sm text-gray-900 placeholder:text-gray-500 focus:border-black focus:outline-none"
                        />
                      )}
                    />
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    <SimpleImageCaptcha
                      ...
                      imageClassName="rounded-[3px] border border-black"
                      inputClassName="h-[30px] shrink-0 rounded-[3px] border border-black bg-white px-2 text-left text-sm text-gray-900 placeholder:text-gray-500 focus:border-black focus:outline-none"
                    />
                  </div>

    ...
    return (
      <div ref={dropdownRef} className="relative z-[1001] inline-block">
        <button
          ...
          className={`group inline-flex h-[30px] items-center gap-2 rounded-[3px] px-3 ${
            appearance === 'outline'
        ...
        {open && !isSavingToBackend && (
          <div className="absolute right-0 z-[1002] mt-2 w-32">
            <div
              className="overflow-hidden rounded-[3px] border border-[#ec4d49] bg-[#121212] shadow-none"
              role="listbox"
            ...
            >
              {locales.map((locale, idx) => (
                <button
                  ...
                  className={`group flex w-full items-center justify-between px-3 py-2 text-left text-white transition-all hover:bg-[#ec4d49]/30 ${
                    idx < locales.length - 1
                      ? 'border-b border-[#2e2e50]'
                      : ''
                ...
                >
                  <span className="flex items-center gap-2 text-white group-hover:text-white">
                    <Image

...
export default function DepositBankTab() {
  ...
  return (
    <div className="space-y-6 overflow-hidden">
      {/* Tabs */}
      <div className="mb-4 flex flex-wrap items-center gap-6 border-b md:mb-10 md:gap-10" style={{ borderBottom: '1px solid #1c1e22' }}>
        {depositTabs.map((tab) => {
          ...
          return (
            <button
              ...
              className="relative pb-1 font-extrabold transition-colors duration-200 text-white"
              style={{
                backgroundColor: isActive ? '#3e444c' : 'transparent',
                border: isActive ? '1px solid #1c1e22' : '1px solid transparent',
                color: '#ffffff',
                fontSize: '14px',

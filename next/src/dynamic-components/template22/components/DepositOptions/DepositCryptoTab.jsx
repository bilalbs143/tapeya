...
import CryptoPaymentDetails from '@/dynamic-components/template22/components/CryptoPaymentDetails/CryptoPaymentDetails';
import CryptoSelect from '@/dynamic-components/template22/components/CryptoSelect/CryptoSelect';
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-center">
            ...
            <button
              ...
              className="flex w-full cursor-pointer items-center justify-center rounded-[10px] px-6 pt-3 pb-4 text-[14px] font-semibold text-white transition-all duration-200 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 md:w-auto"
              style={{

...
export default function Announcement() {
  ...
  return (
    <div className="announcement-modal relative mx-auto flex h-[80vh] w-full flex-col overflow-hidden rounded-[12px] p-[1px] text-white shadow-xl" style={{ backgroundImage: 'linear-gradient(#74cae3, #5bc0de 60%, #4ab9db)' }}>
      <div className="flex min-h-0 flex-1 flex-col space-y-4 rounded-[12px] bg-black p-4 sm:space-y-6 md:p-6 lg:p-8">
        {/* Header */}
        ...
        <div className="flex min-h-0 flex-1 flex-col space-y-6">
          <div className="min-h-0 flex-1 rounded-[10px] border border-[#FFFFFF66]">
            <div className="h-full space-y-4 p-3 md:space-y-6 md:p-4 lg:p-6">
              <div className="grid h-full min-h-0 grid-cols-1 gap-4 md:grid-cols-2 md:gap-6">
                ...
                <div className="flex min-h-0 flex-col">
                  ...
                  <div className="scrollbar-hide min-h-0 flex-1 overflow-y-auto rounded-lg border border-[#FFFFFF66] bg-transparent p-3 md:p-5">
                            ...
                            <button
                              ...
                              className={`w-full cursor-pointer rounded-[10px] px-3 py-2 text-left transition-all duration-300 md:px-4 md:py-3 ${
                                selectedAnnouncement === item.id
                                  ? 'text-white'
                                  : 'border border-[#E8D25E] bg-transparent text-white'
                              }`}
                              style={selectedAnnouncement === item.id ? { backgroundImage: 'linear-gradient(#74cae3, #5bc0de 60%, #4ab9db)' } : {}}
                            >
                              <div className="flex items-center justify-between">

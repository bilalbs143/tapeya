          ...
          >
            ...
            >
              ...
              <button
                ...
                aria-label={t('close')}
                className="flex h-8 w-8 flex-shrink-0 cursor-pointer items-center justify-center rounded-full leading-none font-bold text-white transition-all duration-300 hover:opacity-90 hover:scale-110"
                style={{
            ...
            >
              <button
                ...
                className="flex w-full cursor-pointer items-center justify-center rounded-b-lg px-4 pt-3 pb-4 text-sm font-semibold text-white active:scale-95"
                style={{
                  backgroundImage: 'linear-gradient(#74cae3, #5bc0de 60%, #4ab9db)',
                }}
              >

...
import DashboardTabs from '@/dynamic-components/template22/dashboard/DashboardTabs';
import UserHomeData from '@/dynamic-components/template22/dashboard/UserHomeData';

...
import Timer from '@/dynamic-components/template12/components/Timer/Timer';
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="rounded-[10px] bg-[#E8D25E] px-4 pt-2 pb-3 text-sm font-semibold text-black [box-shadow:inset_0_-6px_0_#876800] transition-all duration-200 hover:pb-2 hover:[box-shadow:0_0_10px_0_#876800_inset,0_0_20px_2px_#876800] hover:outline hover:outline-2 hover:outline-[#876800] sm:px-6 sm:text-base"
              >
              ...
              <button
                ...
                aria-label={t('close')}
                className="group flex h-8 w-8 flex-shrink-0 cursor-pointer items-center justify-center rounded-sm border border-[rgba(135,104,0,0.30)] bg-[#141414] text-xl leading-none font-bold transition-all duration-300 sm:h-10 sm:w-10"
              >
                <svg
                  width="16"
                  height="16"

...
import Pagination from '@/dynamic-components/template12/components/Pagination/Pagination';
          ...
          <div className="flex h-full flex-col items-center justify-center md:items-end">
            <div className="flex flex-col items-center gap-2">
              ...
              <button
                ...
                className="flex w-[220px] cursor-pointer items-center justify-center gap-2 rounded-[10px] bg-[#E8D25E] px-4 pt-2 pb-3 text-xs font-semibold text-black [box-shadow:inset_0_-4px_0_#876800] active:scale-95"
              >

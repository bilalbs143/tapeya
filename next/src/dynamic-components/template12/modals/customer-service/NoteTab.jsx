...
import ContentDetail from '@/dynamic-components/template12/components/ContentDetail/ContentDetail';
                    ...
                    notesData.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-2 py-2 text-center text-white md:px-2 md:py-3">
                          <button className="btn-hover-outline rounded-[6px] border border-[#E8D25E] bg-transparent px-3 py-1 text-xs font-medium text-white transition-colors duration-200 hover:bg-[#E8D25E] hover:text-black">
                            {t('details')}
                          </button>
                        </td>
                      </tr>

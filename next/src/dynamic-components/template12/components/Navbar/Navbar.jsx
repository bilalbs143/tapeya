...
import { LanguageSwitcher } from '@/dynamic-components/template12/components/LanguageSwitcher/LanguageSwitcher';
import LazyImage from '@/dynamic-components/template12/components/LazyImage/LazyImage';
import WalletDropdown from '@/dynamic-components/template12/components/WalletDropdown/WalletDropdown';
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden items-center gap-4 md:flex">
              ...
              <div className="flex items-center gap-3">
                <Tooltip text={t('promotion') || 'Promotion'} position="bottom">
                  <Link
                    href="/promotions"
                  ...
                  >
                    <Image
                      src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/pro-icon-3.svg"
                      alt={t('promotion') || 'Promotion'}
                      width={25}
                      height={25}
                ...
                <Tooltip text={t('slots') || 'Slots'} position="bottom">
                  <Link
                    href="/slot-providers"
                    className="flex h-[45px] w-[45px] cursor-pointer items-center justify-center rounded-[6px] bg-[#0B0B0B] text-white transition-transform duration-200 hover:scale-105"
                  >
                    <Image
                      src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/slot-icon-3.svg"
                      alt={t('slots') || 'Slots'}
                      width={25}
                      height={25}
                      className="h-[35px] w-[35px] transition-transform duration-200 hover:scale-110 hover:rotate-[5deg]"
                    />
                  </Link>
                </Tooltip>
                ...
                <Tooltip text={t('casino') || 'Casino'} position="bottom">
                  <Link
                    href="/live-casino"
                    className="flex h-[45px] w-[45px] cursor-pointer items-center justify-center rounded-[6px] bg-[#0B0B0B] text-white transition-transform duration-200 hover:scale-105"
                  >
                    <Image
                      src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/casino-icon-3.svg"
                      alt={t('casino') || 'Casino'}
                      width={25}
                      height={25}
          ...
          >
            ...
            <div className="mt-auto space-y-3 p-4">
              ...
              <div className="relative mb-8">
                ...
                {/* APK download link */}
                <a
                  href="https://thestaticfile.com/uploads/MPONUSA188.apk"
                  download

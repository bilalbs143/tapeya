...
function SubNavbar() {
  ...
  return (
    <nav className="relative z-[1] bg-[#000304]">
      ...
      <div className="container mx-auto px-4 py-2">
        ...
        <div className="hidden items-center md:grid md:[grid-template-columns:650px_1fr]">
          ...
          <div className="flex items-center justify-end gap-2">
            <div className="flex h-[35px] items-center bg-[#000304] px-3 md:h-[30px]">
              {(() => {
        ...
        <div className="flex items-center justify-between md:hidden">
          ...
          <Link
            href="#"
            className={`relative z-10 inline-flex items-center gap-3 overflow-hidden rounded-full py-2 pr-2 text-[12px] text-[#E8D25E] transition-colors hover:text-white ${

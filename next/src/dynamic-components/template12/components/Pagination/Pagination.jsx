  ...
  return (
    <div className={`flex items-center justify-end gap-4 ${className}`}>
      ...
      <div className="text-xs text-white/60 md:text-sm">
        {t('rows_per_page')}:
        <select
          className="text-grey-400 ml-2 rounded border border-[#FFFFFF66] bg-black px-2 py-1 text-xs md:text-sm"
          value={rowsPerPage}
      ...
      {/* Page information */}
      <div className="text-grey-400 flex items-center gap-2 text-xs md:text-sm">
        <span>

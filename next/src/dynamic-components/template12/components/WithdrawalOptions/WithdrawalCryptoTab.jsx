...
import CryptoSelect from '@/dynamic-components/template12/components/CryptoSelect/CryptoSelect';
import CryptoWithdrawalDetails from '@/dynamic-components/template12/components/CryptoWithdrawalDetails/CryptoWithdrawalDetails';
...
export default function WithdrawalCryptoTab() {
  ...
  const verifyButtonClassName = useMemo(() => {
    ...
    return `${baseClasses} bg-[#E8D25E] text-black font-semibold [box-shadow:inset_0_-3px_0_#876800]`;
  }, [addressVerificationStatus]);

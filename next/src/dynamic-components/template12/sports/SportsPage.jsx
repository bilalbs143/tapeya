  ...
  const sportsProviders = [
    {
      ...
      icon: 'Sports-1-3.png',
      logo: 'SBOBET.png',
      background: 'https://d3emlo5tm9es2f.cloudfront.net/next/icons/Sports-1-3.png',
      isLive: false,
    },
    {
      key: 'sports-2',
      ...
      icon: 'Sports-1-4.png',
      logo: '568WIN.png',
      background: 'https://d3emlo5tm9es2f.cloudfront.net/next/icons/Sports-2-3.png',
      isLive: false,
    },
    {
      key: 'sports-3',
      ...
      background: 'https://d3emlo5tm9es2f.cloudfront.net/next/icons/Sports-3-3.png',
      isLive: false,
    },
    {
      key: 'sports-4',
      ...
      icon: 'Sports-1-6.png',
      logo: 'AFB.png',
      background: 'https://d3emlo5tm9es2f.cloudfront.net/next/icons/Sports-4-3.png',
      isLive: false,
    },
    {
      key: 'sports-5',
      ...
      background: 'https://d3emlo5tm9es2f.cloudfront.net/next/icons/Sports-5-3.png',
      isLive: false,
    },
    {
      key: 'sports-6',
      ...
      icon: 'Sports-1-8.png',
      logo: 'VGAMING.png',
      background: 'https://d3emlo5tm9es2f.cloudfront.net/next/icons/Sports-6-3.png',
      isLive: false,
    },
    {
      key: 'sports-7',
      ...
      icon: 'Sports-1-9.png',
      logo: 'BTI-SPORTS.png',
      background: 'https://d3emlo5tm9es2f.cloudfront.net/next/icons/Sports-7-3.png',
      isLive: false,
    },
    {
      key: 'sports-8',
      ...
      background: 'https://d3emlo5tm9es2f.cloudfront.net/next/icons/Sports-8-3.png',
      isLive: false,
    },
    {
      key: 'sports-9',
      ...
      background: 'https://d3emlo5tm9es2f.cloudfront.net/next/icons/Sports-9-3.png',
      isLive: false,
    },
  ];

  // Virtual Sports providers data
  const virtualSportsProviders = [
    {
      key: 'virtual-sports-1',
      name: 'Saba Virtual Sports',
      provider: t('virtual_sports', 'Virtual Sports'),
      icon: 'VSports-1-3.png',
      logo: 'SABA-SPORTS.png',
      background: 'https://d3emlo5tm9es2f.cloudfront.net/next/icons/VSports-1-3.png',
      isLive: false,
    },
  ];
  ...
  return (
    <div className="text-white">
      ...
      <div className="relative w-full overflow-hidden">
        ...
        <Image
          src={`${baseUrl}/backgrounds/sports-top-banner-12.png`}
        ...
        <Image
          src={`${baseUrl}/backgrounds/sports-top-banner-mob-12.png`}
          alt={t('sports_top_banner', 'Sports Top Banner')}
          width={1920}
          height={400}
      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
            {filteredProviders.map((provider) => (
              <div
                ...
                className={`group relative w-full overflow-hidden rounded-xl border border-transparent bg-black/20 shadow-sm transition-all duration-300 hover:border-[#E8D25E] hover:shadow-[0_0_10px_0_#FC7E09_inset] ${
                ...
                <div className="relative w-full bg-transparent">
                  ...
                  <div className="absolute inset-0 z-30 flex flex-col items-center justify-center gap-4 bg-[#6d6936c9] opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                    ...
                    <button
                      ...
                      className="rounded-md border-2 border-black px-5 py-2 text-sm font-semibold text-black shadow-md hover:brightness-110 disabled:opacity-50"
                      style={{
                        background: '#E8D25E',
                      }}
        ...
        <div className="my-16">
          <div className="relative overflow-hidden">
            {/* Desktop Banner - Hidden on mobile (<=768px) */}
            <Image
              src={`${baseUrl}/backgrounds/sports-bottom-banner-12.png`}
              alt={t('sports_bottom_banner', 'Sports Bottom Banner')}
              width={1920}
              height={400}
              className="hidden h-auto w-full object-cover md:block"
              sizes="100vw"
            ...
            {/* Mobile Banner - Only visible on mobile (<=768px) */}
            <Image
              src={`${baseUrl}/backgrounds/sports-bottom-banner-mob-12.png`}
              alt={t('sports_bottom_banner', 'Sports Bottom Banner')}
              width={1920}
              height={400}
              className="block h-auto w-full object-cover md:hidden"

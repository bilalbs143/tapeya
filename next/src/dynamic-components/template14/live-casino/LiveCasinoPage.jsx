  ...
  const tableGameProviders = [
    {
      ...
      provider: 'Micro LIVE',
      name: 'Microgaming',
      background: 'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/micro-gaming-7.webp',
      isLive: true,
    },
  ];
            ...
            <div className="relative z-30 flex flex-shrink-0 items-center gap-1.5 md:gap-3">
              ...
              <div className="relative flex-shrink-0">
                <UiSelect
                  value={category}
                  onValueChange={(val) =>
                    router.push(getTemplate14CategoryRoute(val))
                  }
                >
                  <SelectTrigger
                  ...
                  >
                    <SelectValue
                      ...
                      className={
                          category ? 'text-white' : 'text-[#FFFFFF66]'
                      }
                    />
                  </SelectTrigger>
                  <SelectContent

      ...
      <div className="container mx-auto px-4 py-7 md:px-4">
        <div className="mb-4 flex items-center justify-center sm:hidden">
          <button
            ...
            className="angled-button angled-button-blue flex h-[37px] w-[138px] w-full items-center justify-center font-extrabold text-white transition-all duration-300"
            data-hover="Back to Home"
          >
            <div className="angled-button-inner flex items-center gap-2">
              <svg
                width="13"
                height="8"
                viewBox="0 0 13 8"
              ...
              <span className="angled-button-text">Back to Home</span>
            </div>
          </button>
        </div>

...
import CryptoPaymentDetails from '@/dynamic-components/template14/components/CryptoPaymentDetails/CryptoPaymentDetails';
...
export default function DepositCryptoTab({ isActive }) {
  ...
  const renderAmountInfo = () => {
    ...
    return (
      <div className="mt-2 rounded-lg bg-[#101010] p-3">
        {minimumAmountLoader ? (
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-center">
            <Controller
              ...
              render={({ field }) => (
                <Input
                  ...
                  className="relative block h-[46px] w-[99%] appearance-none rounded-[5px] border border-[#3E1D88] bg-transparent px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFF66] focus:border-[#661BB5] focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:h-[55px]"
            ...
            <button
              ...
              className="angled-button angled-button-pinks fancy-hover-effect-orange flex h-[48px] min-w-[160px] cursor-pointer items-center justify-center rounded-[10px] px-5 text-[14px] font-semibold text-white transition-all duration-200 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 md:w-auto"
            >

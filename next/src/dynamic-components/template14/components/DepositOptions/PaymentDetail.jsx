...
const getAccountDetailsForBank = (bankName, bankAccountsData, paymentType) => {
  ...
  return {
    ...
    qrCode: selectedBank.qr_code_path || null,
...
const DropdownOption = memo(({ option, onSelect, field }) => (
  <div
    key={option}
    className="cursor-pointer px-3 py-2 text-xs text-white transition-colors duration-150 hover:bg-[#661BB5] md:text-sm"
    onClick={() => {
    ...
    <div className="space-y-6 text-white">
      ...
      <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <div className="order-2 md:order-1">
          <div className="h-max rounded-[5px] border border-[#3E1D88] bg-[#331369] p-5 shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)] md:sticky md:top-4">
            <div className="mb-6 flex flex-wrap items-center gap-2 sm:gap-4">
              <button
                onClick={handleBack}
                className="fancy-hover-effect-orange flex items-center justify-center rounded-[4px] bg-[#641AB9] px-6 py-1.5 font-extrabold text-white transition-all duration-300"
              >
            ...
            >
              <div className="mb-4 sm:mb-2">
                <Label
                  ...
                  className="mb-1 block text-[14px] font-bold text-white"
                >
                  {config.sendingLabel} *
                </Label>
                <Controller
                  ...
                  render={({ field }) => (
                    <div className="flex w-full flex-col gap-1">
                      <div className="relative w-full" ref={sendingDropdownRef}>
                        <div
                          className={`relative flex h-[46px] w-full cursor-pointer appearance-none items-center justify-between rounded-[5px] border px-3 py-3 text-white shadow-none focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm lg:h-[55px] ${
                            errors.sendingOption
                              ...
                              : 'border-[#3E1D88] bg-transparent focus:border-[#661BB5]'
                          }`}
                        ...
                        {isSendingOpen && (
                          <div className="absolute z-20 mt-1 max-h-56 w-full overflow-auto rounded-[5px] border border-[#3E1D88] bg-[#3E1D88] shadow-xl">
                          ...
                          <div
                            className={`relative flex h-[46px] w-full cursor-pointer appearance-none items-center justify-between rounded-[5px] border px-3 py-3 text-white shadow-none focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm lg:h-[55px] ${
                              errors.receivingOption
                                ? 'border-red-500 focus:border-red-500'
                                : 'border-[#3E1D88] bg-transparent focus-within:border-[#661BB5] focus:border-[#661BB5]'
                            }`}
              ...
              <div className="mb-4 sm:mb-2">
                <Label
                  ...
                  className="mb-1 block text-[14px] font-bold text-white capitalize"
                >
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input
                      ...
                      className="relative block h-[46px] w-full appearance-none rounded-[5px] border border-[#3E1D88] bg-transparent px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFF66] placeholder:capitalize focus:border-[#661BB5] focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:h-[55px]"
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input
                      ...
                      className="relative block h-[46px] w-full appearance-none rounded-[5px] border border-[#3E1D88] bg-transparent px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFF66] focus:border-[#661BB5] focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:h-[55px]"
                ...
                <Controller
                  ...
                  render={({ field: { onChange } }) => (
                    <div className="flex w-full flex-col gap-1">
                      <div
                        className={`flex w-full flex-wrap items-center gap-3 rounded-[5px] border px-3 py-2 shadow-none transition-colors focus-within:ring-0 focus-within:ring-transparent focus-within:outline-none ${
                          errors.receiptFile
                            ...
                            : 'border-[#3E1D88] bg-transparent focus-within:border-[#661BB5] hover:border-[#661BB5]'
                        }`}
                        onDragOver={(e) => {
                          e.preventDefault();
                          e.stopPropagation();
                      ...
                      >
                        <div
                          className={`fancy-hover-effect-orange rounded-md bg-[#641AB9] px-4 py-2 text-xs font-semibold text-white transition-opacity focus-within:ring-2 focus-within:ring-[#3E1D88] focus-within:outline-none active:scale-95 ${
                            isFileDialogOpening
              ...
              <div className="mt-2 space-y-3">
                      ...
                      >
                        ...
                        <span
                          ...
                          className={`grid h-5 w-5 flex-shrink-0 place-items-center rounded-[3px] border-2 transition-all duration-200 ${
                            field.value
                              ? 'border-[#641AB9] bg-[#3E1D88]'
                              : 'border-[#641AB9] bg-[#641AB9] hover:border-[#661BB5]'
                          }`}
                        >
                          <svg
                            viewBox="0 0 24 24"
                ...
                <div className="mt-8 flex w-full flex-row justify-center">
                  <button
                    ...
                    className="angled-button angled-button-pinks flex h-[52px] w-[554px] items-center justify-center rounded-[6px] text-[16px] font-semibold text-white transition-all duration-200 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
                    data-hover={isSubmitting ? t('processing') : t('send')}
                  >
        ...
        <div className="order-1 h-max rounded-[5px] border border-[#3E1D88] bg-[#3E1D88] p-5 shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)] md:sticky md:top-4 md:order-2">
          <div className="mb-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <span className="text-xs md:text-sm">
                {t('status')}:{' '}
                <span className="text-[#7351FF]">{t('status_online')}</span>
              </span>
              <Image
                src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/green-check.svg"
                alt="online"
          ...
          <div className="mt-8 text-[12px]">
            <span className="font-semibold text-[#7351FF]">{t('note')}:</span>
      ...
      {isQRPreviewOpen && accountDetails?.qrCode && (
        ...
        >
          ...
          {/* Modal content */}
          <div
            className="relative z-10 flex flex-col items-center justify-center rounded-lg border border-[#641AB9] bg-[#00111A] p-4"
          ...
          >
            ...
            <button
              type="button"
              onClick={() => setIsQRPreviewOpen(false)}
              className="absolute top-2 right-2 flex h-8 w-8 items-center justify-center rounded-full bg-[#641AB9] text-white transition-opacity hover:opacity-80"

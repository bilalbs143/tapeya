...
export const LanguageSwitcher = ({
  ...
  if (variant === 'dropdown') {
    return (
      <div ref={dropdownRef} className="relative z-[1001] inline-block px-4">
        <button
          ...
          <div className="absolute right-0 z-[1002] mt-2 w-34">
            ...
            >
              <div className="rounded-[10px]">
                <div className="rounded-[10px]">
                  <div
                    className="overflow-hidden bg-[#0d1028]"
                    role="listbox"
                  ...
                  >
                    {locales.map((locale, idx) => (
                      <button
                        ...
                        className={`group flex w-full items-center justify-between px-3 py-2 text-left text-white transition-all hover:bg-[#7351FF] ${

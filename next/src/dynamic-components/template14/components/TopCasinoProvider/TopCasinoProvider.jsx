...
function TopCasinoProvider() {
  const { t } = useTranslations();
  const router = useRouter();

  // Top Casino Providers with new S3 image links
  const casinoProviders = [
    {
      key: 'pragmatic_casino',
      name: 'Pragmatic Play',
      image:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/tcp-1-5.webp',
    },
    {
      key: 'evolution',
      name: 'Evolution',
      image:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/tcp-2-5.webp',
    },
    {
      key: 'sexy_gaming',
      name: 'Sexy Gaming',
      image:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/tcp-3-5.webp',
    },
    {
      key: 'cq9_casino',
      name: 'CQ9 Gaming',
      image:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/tcp-4-5.webp',
    },
  ];

  const handleProviderClick = (provider) => {
    router.push('/live-casino?q=live');
  };
    ...
    <section className="relative pt-6 md:pt-10">
      ...
      >
        ...
        <div className="mb-6 w-full">
          ...
          >
            {t('top_casino_providers') || 'Top Casino Providers'}
          </h3>
        </div>
...
export default TopCasinoProvider;

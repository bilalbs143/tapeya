  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mt-4 space-y-4">
        ...
        <div className="rounded-[5px] border border-[#331369] bg-[#331369] p-3 shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)] md:p-4 lg:p-6">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                  <div>
                    ...
                    <input
                      ...
                      disabled
                      type="text"
                      className="h-[46px] w-full cursor-not-allowed rounded-[3px] border border-[#3E1D88] bg-[#331369] px-3 py-3 text-[12px] text-[#FFFFFF80] shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)] placeholder:text-[#FFFFFF66] sm:text-sm md:placeholder:text-sm lg:h-[55px]"
                    />
                  </div>
              ...
              <div className="flex w-full flex-col gap-2">
                ...
                <div className="flex w-full flex-col sm:flex-row sm:items-center sm:gap-3">
                  ...
                  <button
                    ...
                    className="angled-button angled-button-pinks fancy-hover-effect-orange mt-2 flex h-[44px] min-w-[160px] cursor-pointer items-center justify-center rounded-[10px] px-6 text-[14px] font-extrabold text-white transition-all duration-200 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 sm:mt-0 sm:h-[55px]"
                    data-hover={
                      transactionRequestLoader
                        ? t('processing')
                        : t('send_your_request')
                  ...
                  >
                    <div className="angled-button-inner flex items-center justify-center">
                      <span className="angled-button-text flex items-center">
                        {transactionRequestLoader ? (
                          <>
                            <CommonLoader
                              size="sm"

...
const GlobalPageLoader = () => {
      ...
      <div className="relative flex items-center justify-center">
        ...
        <div className="absolute">
          ...
          <div
            style={{
              ...
              borderTopColor: '#EE7AF4',
              borderRightColor: '#A855F7',
              animation: 'spinForward 3s linear infinite',
              filter: 'drop-shadow(0 0 15px rgba(238, 122, 244, 0.6))',
            }}
          />
        </div>
        ...
        <div className="absolute">
          <div
            style={{
              ...
              borderRadius: '50%',
              border: '3px solid transparent',
              borderBottomColor: '#7C30E6',
              borderLeftColor: '#EE7AF4',
              animation: 'spinBackward 2.5s linear infinite',
              filter: 'drop-shadow(0 0 12px rgba(124, 48, 230, 0.6))',
            }}
          />
        </div>
        ...
        <div
          ...
          style={{
            ...
            height: '50px',
            borderRadius: '50%',
            background: 'linear-gradient(135deg, #EE7AF4 0%, #7C30E6 100%)',
            boxShadow: `
              0 0 30px rgba(238, 122, 244, 0.8),
              0 0 60px rgba(124, 48, 230, 0.4),
          ...
          >
            <div
              style={{
                ...
                borderRadius: '50%',
                background:
                  i === 0 ? '#EE7AF4' : i === 1 ? '#A855F7' : '#7C30E6',
                boxShadow: `0 0 10px ${i === 0 ? '#EE7AF4' : i === 1 ? '#A855F7' : '#7C30E6'}`,
              }}
            />
          </div>
        ))}
  ...
  return (
    <div
      className="fixed inset-0 z-[9999] flex items-center justify-center overflow-hidden bg-[#0d0f29]"
      style={{
        display: 'flex',
        position: 'fixed',
        top: 0,
    ...
    >
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(circle at 50% 50%, rgba(238, 122, 244, 0.12) 0%, transparent 50%),
            radial-gradient(circle at 20% 80%, rgba(124, 48, 230, 0.08) 0%, transparent 40%),
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle at 50% 50%, rgba(238, 122, 244, 0.05) 0%, transparent 70%)',
        ...
        <div className="mt-8 flex min-h-[24px] flex-col items-center justify-center text-center sm:mt-10">
          {isTranslationReady ? (
            <p
              ...
              style={{
                color: '#EE7AF4',
                textShadow: '0 0 10px rgba(238, 122, 244, 0.5)',
              }}
            >
            ...
            <div className="flex items-center space-x-3">
              {[...Array(3)].map((_, i) => (
                <div
                  ...
                  style={{
                    background: `radial-gradient(circle, ${i === 1 ? '#EE7AF4' : '#7C30E6'}, ${i === 1 ? '#7C30E6' : '#A855F7'})`,
                    boxShadow: `
                      0 0 15px ${i === 1 ? 'rgba(238, 122, 244, 0.8)' : 'rgba(124, 48, 230, 0.8)'},
                      0 0 30px ${i === 1 ? 'rgba(238, 122, 244, 0.4)' : 'rgba(124, 48, 230, 0.4)'}
                    `,

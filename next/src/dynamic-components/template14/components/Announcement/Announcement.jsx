...
function Announcement() {
  ...
  return (
    <section className="pt-6 md:pt-10">
      <div className="z-[1] rounded-[5px] border border-[#7351FF] bg-[#1E1451] md:rounded-[10px]">
        {/* Desktop Layout */}
        <div className="hidden items-center md:flex md:gap-2">
          {/* Announcement pill */}
          <div className="flex items-center border-r border-[#7351FF] px-6 py-6">
        ...
        <div className="flex items-center justify-center md:hidden">
          ...
          <div className="relative z-10 inline-flex items-center justify-center gap-2 overflow-hidden border-r border-[#7351FF] px-2 py-4">

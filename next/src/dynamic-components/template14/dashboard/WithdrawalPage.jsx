...
import WithdrawalBankTab from '@/dynamic-components/template14/components/WithdrawalOptions/WithdrawalBankTab.jsx';
import WithdrawalCryptoTab from '@/dynamic-components/template14/components/WithdrawalOptions/WithdrawalCryptoTab.jsx';
        ...
        <div className="rounded-[5px] border border-[#3E1D88] bg-[linear-gradient(90deg,rgba(41,18,135,0.40)_0.48%,rgba(87,61,193,0.40)_49.87%,rgba(41,18,135,0.40)_96.31%)] px-4 py-3 md:px-6 md:py-6">
          ...
          <div>
            ...
            <div className="mb-2 flex flex-col items-center md:flex-row md:justify-between">
              ...
              {/* Desktop Tabs */}
              {/* Tab switcher commented out - Withdraw Bank view displayed by default */}

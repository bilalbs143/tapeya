  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mt-4 space-y-4">
        ...
        <div className="rounded-[5px] border border-[#2DFA1A4D] bg-[#0F1B1B] p-3 shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)] md:p-4 lg:p-6">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="mb-0 space-y-4">
              {/* Receiving Bank Information */}
              <div className="space-y-6">
                <h4 className="text-[15px] font-bold text-white md:text-[20px]">
                  {t('receiving_bank')}
                </h4>
                <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                  <div>
                    ...
                    <input
                      ...
                      disabled
                      type="text"
                      className="h-[46px] w-full cursor-not-allowed rounded-[3px] border border-[#2DFA1A4D] bg-[#060D0D] px-3 py-3 text-[12px] text-[#FFFFFF80] shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)] placeholder:text-[#FFFFFF66] sm:text-sm md:placeholder:text-sm lg:h-[55px]"
                    />
                  </div>
              ...
              <div className="flex w-full flex-col gap-2">
                ...
                <div className="flex w-full flex-col sm:flex-row sm:items-center sm:gap-3">
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        ...
                        className="relative block h-[46px] w-full appearance-none rounded-[3px] border border-[#2DFA1A4D] bg-[#060D0D] px-3 py-3 text-white shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)] placeholder:text-xs placeholder:text-[#FFFFFF66] focus:border-[#2DFA1A] focus:ring-0 focus:ring-transparent focus:outline-none sm:h-[55px] sm:flex-1 sm:text-sm md:w-[98%] md:placeholder:text-sm"
                        step="1000"
                  ...
                  <button
                    ...
                    className="template8-filled-button-hover flex cursor-pointer items-center justify-center rounded-[4px] bg-[#2DFA1A] px-6 pt-2 pb-2 text-[13px] font-extrabold text-black transition-all duration-200 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
                    data-hover={
                      transactionRequestLoader
                        ? t('processing')
                        : t('send_your_request')
      ...
      <div className="flex h-full flex-col">
        <h3 className="font-bring-race mb-4 text-[15px] text-white md:text-[25px]">
          {t('withdraw_history')}
        </h3>
        <WithdrawalHistory />
      </div>

...
import { LanguageSwitcher } from '@/dynamic-components/template8/components/LanguageSwitcher/LanguageSwitcher';
import LazyImage from '@/dynamic-components/template8/components/LazyImage/LazyImage';
import WalletButton from '@/dynamic-components/template8/components/WalletButton/WalletButton';
import WalletDropdown from '@/dynamic-components/template8/components/WalletDropdown/WalletDropdown';
...
function Navbar() {
  ...
  const activeFill = (href) => (isActive(href) ? 'fill-black' : '');
  const activeStroke = (href) => (isActive(href) ? 'stroke-black' : '');
  ...
  const sidebarApkSrc = useMemo(() => {
    if (currentLocale === 'id') {
      return 'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/apk-new-banner-mob-8.webp';
    }
    if (currentLocale === 'ko') {
      return 'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/apk-new-banner-mob-8.webp';
    }
  ...
  return (
    <>
      ...
      >
                ...
                {!isAuth ? (
                  <>
                    <button
                      ...
                      className="template8-filled-button-hover h-[50px] w-[130px] rounded-[4px] bg-[#2DFA1A] px-4 font-bold text-black"
                    >
                      Login
                    </button>
                    ...
                    <button
                      ...
                      className="template8-bordered-button-hover h-[50px] w-[130px] rounded-[4px] bg-[#0A1414] px-4 font-bold text-white"
                      style={{
                  ...
                  <div className="flex items-center gap-4">
                    <div
                      className="relative h-[50px] rounded-[4px] bg-[#0A1414] p-1"
                      ref={userMenuRef}
                      style={{
                        pointerEvents: 'auto',
                        border: '1px solid rgba(45, 250, 26, 0.30)',
                    ...
                    >
                      <button
                        ...
                        ref={userButtonRef}
                        className="flex h-[40px] w-[40px] items-center justify-center rounded-[4px] bg-[#2DFA1A]"
                      >
                          ...
                          >
                            <div className="overflow-hidden rounded-[5px] p-3">
                              <Link
                                ...
                                style={{
                                  borderColor: 'rgba(45, 250, 26, 0.30)',
                                }}
                              >
                                <span className="flex items-center gap-3">
                                  <svg
                                    ...
                                    viewBox="0 0 16 16"
                                    fill="currentColor"
                                    className="h-4 w-4 text-[#636363] transition-colors group-hover:!text-[#2DFA1A]"
                                  >
        ...
        {/* Mobile Navbar */}
        <div className="m-0 border-b border-[rgb(45,250,26)]/30 bg-[#0A1414] px-3 py-3 [box-shadow:0_4px_14px_0_rgba(0,0,0,0.25)_inset] lg:hidden">
          <div className="flex items-center justify-between">
            {/* Mobile Hamburger Menu - Left */}
            <button
              onClick={toggleMobileMenu}
              className="flex h-[40px] w-[45px] items-center justify-center rounded-[4px] bg-transparent"
              style={{
                border: '1px solid rgba(45, 250, 26, 0.30)',
              }}
            >
            ...
            <div className="template8-mobile-lang-button">
              <div style={{ pointerEvents: 'auto' }}>
                <LanguageSwitcher variant="dropdown" appearance="filled" />
              </div>
            </div>
      ...
      >
        {/* Drawer Content */}
        <div
          className={`absolute top-0 left-0 h-full w-80 border border-[rgb(45,250,26)]/30 bg-[#0A1414] shadow-xl ${
        ...
        >
          ...
          >
            ...
            <div className="border-b border-[rgb(45,250,26)]/30 p-4">
              <div className="flex items-center justify-between">
                <Link href="/" className="flex items-center">
                  <Image
                    src={headerLogo}
                ...
                <button
                  onClick={toggleMobileMenu}
                  className="group flex h-8 w-8 cursor-pointer items-center justify-center rounded-sm border border-[rgb(45,250,26)]/30 bg-transparent transition-colors"
                >
                  <svg
              ...
              <div className="px-0 py-0">
                <div className="flex items-center gap-3">
                  <div className="flex w-full items-center gap-3 rounded-[0px] px-3 py-3">
                    <button
                      onClick={handleOpenLoginModal}
                      className="template8-filled-button-hover h-[50px] flex-1 rounded-[4px] bg-[#2DFA1A] px-4 font-bold text-black"
                    >
                      Login
                    </button>
                    ...
                    <button
                      onClick={handleOpenRegisterModal}
                      className="template8-bordered-button-hover h-[50px] flex-1 rounded-[4px] bg-[#0A1414] px-4 font-bold text-white"
                      style={{
                        border: '1px solid rgba(45, 250, 26, 0.30)',
                      }}
                    >
            ...
            <div className="space-y-2 p-4">
              <Link
                ...
                className={`group template8-menu-item-angled ${isActive('/') ? 'template8-menu-item-angled-active' : ''}`}
              >
                <div
                  className={`template8-menu-item-angled-inner before:content-[''] ${isActive('/') ? 'before:!bg-[#2DFA1A]' : ''} group-hover:before:!bg-[#2DFA1A]`}
                >
                  <div className="template8-menu-item-content">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 35 36"
                      fill="none"
                    ...
                    >
                      <path
                        ...
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        className={`transition-all duration-300 group-hover:stroke-black ${activeStroke('/')}`}
                      />
                    </svg>
                    <span
                      className={`${isActive('/') ? 'text-black' : 'text-[#636363]'} font-bold transition-colors duration-300 group-hover:text-black`}
                    >
                      {t('home') || 'Home'}
                    </span>
                  </div>
                  ...
                  >
                    <path
                      d="M0.369995 0.336334L3.53543 3.81831C4.57567 4.96258 4.57567 6.71009 3.53543 7.85435L0.369995 11.3363"
                      stroke="#636363"
                      strokeWidth="1"
                      className={`transition-all duration-300 group-hover:stroke-black ${activeStroke('/')}`}
                    />
              ...
              <Link
                ...
                className={`group template8-menu-item-angled ${isActive('/dashboard/withdrawal') ? 'template8-menu-item-angled-active' : ''}`}
              >
                <div
                  className={`template8-menu-item-angled-inner before:content-[''] ${isActive('/dashboard/withdrawal') ? 'before:!bg-[#2DFA1A]' : ''} group-hover:before:!bg-[#2DFA1A]`}
                >
                  <div className="template8-menu-item-content">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    >
                      <path
                        ...
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        className={`transition-all duration-300 group-hover:stroke-black ${activeStroke('/dashboard/withdrawal')}`}
                      />
                      <path
                        d="M0.5 5.75H21.5"
                        stroke="#636363"
                      ...
                      <path
                        ...
                        fill="#636363"
                        className={`transition-all duration-300 group-hover:fill-black ${activeFill('/dashboard/withdrawal')}`}
                      />
                    </svg>
                    <span
                      className={`${isActive('/dashboard/withdrawal') ? 'text-black' : 'text-[#636363]'} font-bold transition-colors duration-300 group-hover:text-black`}
                    >
                      {t('withdrawal')}
                    </span>
                  </div>
              ...
              <Link
                ...
                className={`group template8-menu-item-angled ${isActive('/dashboard/deposit') ? 'template8-menu-item-angled-active' : ''}`}
              >
                <div
                  className={`template8-menu-item-angled-inner before:content-[''] ${isActive('/dashboard/deposit') ? 'before:!bg-[#2DFA1A]' : ''} group-hover:before:!bg-[#2DFA1A]`}
                >
                  <div className="template8-menu-item-content">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    >
                      <path
                        ...
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        className={`transition-all duration-300 group-hover:stroke-black ${activeStroke('/dashboard/deposit')}`}
                      />
                      <path
                        d="M0.5 5.74998H21.5"
                        stroke="#636363"
                      ...
                      <path
                        ...
                        fill="#636363"
                        className={`transition-all duration-300 group-hover:group-hover:group-hover:fill-black ${activeFill('/dashboard/deposit')}`}
                      />
                    </svg>
                    <span
                      className={`${isActive('/dashboard/deposit') ? 'text-black' : 'text-[#636363]'} font-bold transition-colors duration-300 group-hover:text-black`}
                    >
                      {t('deposit') || 'Deposit'}
                    </span>
                  </div>
              ...
              <Link
                ...
                className={`group template8-menu-item-angled ${isActive('/dashboard/coupons') ? 'template8-menu-item-angled-active' : ''}`}
              >
                <div
                  className={`template8-menu-item-angled-inner before:content-[''] ${isActive('/dashboard/coupons') ? 'before:!bg-[#2DFA1A]' : ''} group-hover:before:!bg-[#2DFA1A]`}
                >
                  <div className="template8-menu-item-content">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    >
                      <path
                        ...
                        fill="#636363"
                        className={`transition-all duration-300 group-hover:group-hover:fill-black ${activeFill('/dashboard/coupons')}`}
                      />
                    </svg>
                    <span
                      className={`${isActive('/dashboard/coupons') ? 'text-black' : 'text-[#636363]'} font-bold transition-colors duration-300 group-hover:text-black`}
                    >
                      {t('coupons') || 'Coupons'}
                    </span>
                  </div>
                  ...
                  >
                    <path
                      ...
                      stroke="#636363"
                      strokeWidth="1"
                      className={`transition-all duration-300 group-hover:group-hover:stroke-black ${activeStroke('/dashboard/coupons')}`}
                    />
                  </svg>
                </div>
              </Link>
              ...
              <Link
                ...
                className={`group template8-menu-item-angled ${isActive('/dashboard/customer-inquiry') ? 'template8-menu-item-angled-active' : ''}`}
              >
                <div
                  className={`template8-menu-item-angled-inner before:content-[''] ${isActive('/dashboard/customer-inquiry') ? 'before:!bg-[#2DFA1A]' : ''} group-hover:before:!bg-[#2DFA1A]`}
                >
                  <div className="template8-menu-item-content">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    >
                      <path
                        ...
                        stroke="#636363"
                        strokeWidth="1.5"
                        className={`transition-all duration-300 group-hover:stroke-black ${activeStroke('/dashboard/customer-inquiry')}`}
                      />
                      <path
                    ...
                    <span
                      className={`${isActive('/dashboard/customer-inquiry') ? 'text-black' : 'text-[#636363]'} font-bold transition-colors duration-300 group-hover:text-black`}
                    >
              ...
              <Link
                ...
                className={`group template8-menu-item-angled ${isActive('/dashboard/note') ? 'template8-menu-item-angled-active' : ''}`}
              >
                <div
                  className={`template8-menu-item-angled-inner before:content-[''] ${isActive('/dashboard/note') ? 'before:!bg-[#2DFA1A]' : ''} group-hover:before:!bg-[#2DFA1A]`}
                >
                  <div className="template8-menu-item-content">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    >
                      <path
                        ...
                        stroke="#636363"
                        strokeWidth="1.5"
                        className={`transition-all duration-300 group-hover:stroke-black ${activeStroke('/dashboard/note')}`}
                      />
                    </svg>
                    <span
                      className={`${isActive('/dashboard/note') ? 'text-black' : 'text-[#636363]'} font-bold transition-colors duration-300 group-hover:text-black`}
                    >
                      {t('notes') || 'Notes'}
                    </span>
                  </div>
              ...
              <Link
                ...
                className={`group template8-menu-item-angled ${isActive('/announcements') ? 'template8-menu-item-angled-active' : ''}`}
              >
                <div
                  className={`template8-menu-item-angled-inner before:content-[''] ${isActive('/announcements') ? 'before:!bg-[#2DFA1A]' : ''} group-hover:before:!bg-[#2DFA1A]`}
                >
                  <div className="template8-menu-item-content">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    >
                      <path
                        ...
                        fill="#636363"
                        className={`transition-all duration-300 group-hover:fill-black ${activeFill('/announcements')}`}
                      />
                    </svg>
                    <span
                      className={`${isActive('/announcements') ? 'text-black' : 'text-[#636363]'} font-bold transition-colors duration-300 group-hover:text-black`}
                    >
                  ...
                  >
                    <path
                      ...
                      stroke="#636363"
                      strokeWidth="1"
                      className={`transition-all duration-300 group-hover:stroke-black ${activeStroke('/announcements')}`}
                    />
                  </svg>
                </div>
              </Link>
              ...
              <Link
                ...
                className={`group template8-menu-item-angled ${isActive('/faq') ? 'template8-menu-item-angled-active' : ''}`}
              >
                <div
                  className={`template8-menu-item-angled-inner before:content-[''] ${isActive('/faq') ? 'before:!bg-[#2DFA1A]' : ''} group-hover:before:!bg-[#2DFA1A]`}
                >
                  <div className="template8-menu-item-content">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    >
                      <path
                        ...
                        fill="#636363"
                        className={`transition-all duration-300 group-hover:fill-black ${activeFill('/faq')}`}
                      />
                      <path
                    ...
                    <span
                      className={`${isActive('/faq') ? 'text-black' : 'text-[#636363]'} font-bold transition-colors duration-300 group-hover:text-black`}
                    >
                      {t('faq') || "FAQ's"}
                    </span>
                  </div>
                  ...
                  >
                    <path
                      ...
                      stroke="#636363"
                      strokeWidth="1"
                      className={`transition-all duration-300 group-hover:stroke-black ${activeStroke('/faq')}`}
                    />
                  </svg>
                </div>
              </Link>
            ...
            {isAuth && (
              <div className="px-4">
                <div className="relative" ref={userMenuRef}>
                  <div
                    className="flex h-[50px] w-full items-center rounded border bg-[#0A1414] px-3 pl-1"
                    style={{ borderColor: 'rgba(45, 250, 26, 0.30)' }}
                  >
                    <button
                      onClick={toggleUserMenu}
                      className="group flex h-full w-full cursor-pointer items-center gap-3 border-none bg-transparent px-0 py-0 text-base font-medium text-white transition-all"
                    >
                      <div
                        className="flex h-[40px] w-[40px] items-center justify-center rounded-[4px] bg-[#2DFA1A] p-1"
                        style={{
                          border: '1px solid rgba(45, 250, 26, 0.30)',
                        }}
                      >
                      ...
                      <div className="px-4">
                        <Image
                          src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/drop-green-8.svg"
                          ...
                          >
                            <span className="flex items-center gap-3">
                              <svg
                                ...
                                viewBox="0 0 16 16"
                                fill="#636363"
                                className="h-4 w-4 text-white/50 transition-colors group-hover:!text-[#2DFA1A]"
                              >
                                <path d="M10.4724 8.47335C11.1259 7.95912 11.603 7.25396 11.8372 6.45597C12.0713 5.65799 12.051 4.80686 11.7789 4.02099C11.5068 3.23513 10.9965 2.55361 10.3191 2.07125C9.64161 1.58889 8.83066 1.32968 7.99902 1.32968C7.16739 1.32968 6.35643 1.58889 5.67897 2.07125C5.00152 2.55361 4.49125 3.23513 4.21916 4.02099C3.94707 4.80686 3.9267 5.65799 4.16086 6.45597C4.39503 7.25396 4.87209 7.95912 5.52569 8.47335C4.40574 8.92204 3.42855 9.66625 2.69828 10.6266C1.96802 11.587 1.51206 12.7276 1.37902 13.9267C1.36939 14.0142 1.3771 14.1028 1.4017 14.1874C1.42631 14.272 1.46733 14.3508 1.52243 14.4196C1.6337 14.5583 1.79554 14.6472 1.97235 14.6667C2.14917 14.6861 2.32646 14.6345 2.46524 14.5233C2.60401 14.412 2.69291 14.2502 2.71235 14.0733C2.85874 12.7701 3.48015 11.5666 4.45783 10.6925C5.43552 9.81853 6.70095 9.33537 8.01235 9.33537C9.32376 9.33537 10.5892 9.81853 11.5669 10.6925C12.5446 11.5666 13.166 12.7701 13.3124 14.0733C13.3305 14.2372 13.4086 14.3885 13.5318 14.498C13.6549 14.6076 13.8142 14.6677 13.979 14.6667H14.0524C14.2271 14.6466 14.3868 14.5582 14.4967 14.4208C14.6066 14.2835 14.6578 14.1083 14.639 13.9333C14.5053 12.7308 14.0469 11.5873 13.3129 10.6255C12.5789 9.66363 11.597 8.91967 10.4724 8.47335ZM7.99902 8.00001C7.4716 8.00001 6.95603 7.84362 6.5175 7.5506C6.07897 7.25758 5.73718 6.8411 5.53534 6.35384C5.33351 5.86657 5.2807 5.33039 5.38359 4.81311C5.48649 4.29582 5.74046 3.82067 6.1134 3.44773C6.48634 3.07479 6.9615 2.82081 7.47878 2.71792C7.99606 2.61502 8.53224 2.66783 9.01951 2.86967C9.50678 3.0715 9.92325 3.41329 10.2163 3.85182C10.5093 4.29036 10.6657 4.80593 10.6657 5.33335C10.6657 6.04059 10.3847 6.71887 9.88464 7.21896C9.38454 7.71906 8.70626 8.00001 7.99902 8.00001Z" />
                              </svg>
                              <span className="text-[12px] text-[#7D7D7D] transition-colors group-hover:text-white">
                            ...
                            <svg
                              ...
                              viewBox="0 0 6 13"
                              fill="none"
                              className="text-white/50 transition-colors group-hover:!text-[#2DFA1A]"
                            >
                              <path
                                d="M0.46875 0.470703L4.7858 4.78776C5.52108 5.52304 5.52108 6.71516 4.7858 7.45044L0.46875 11.7675"
                                stroke="#636363"
                          ...
                          >
                            <span className="flex items-center gap-3">
                              <svg
                                ...
                                viewBox="0 0 16 16"
                                fill="#636363"
                                className="h-4 w-4 text-white/50 transition-colors group-hover:!text-[#7351FF]"
                              >
                                <path d="M8 2.5C11.0375 2.5 13.5 4.9625 13.5 8.00001C13.5 11.0375 11.0375 13.5 8 13.5C4.9625 13.5 2.5 11.0375 2.5 8.00001C2.5 7.84534 2.50633 7.69234 2.519 7.54101C2.52438 7.47554 2.51682 7.40966 2.49674 7.34712C2.47667 7.28457 2.44447 7.2266 2.40198 7.1765C2.3595 7.12641 2.30757 7.08517 2.24915 7.05514C2.19073 7.02512 2.12696 7.00689 2.0615 7.0015C1.99604 6.99612 1.93015 7.00368 1.86761 7.02376C1.80507 7.04384 1.7471 7.07604 1.697 7.11852C1.6469 7.161 1.60566 7.21294 1.57564 7.27136C1.54561 7.32978 1.52738 7.39354 1.522 7.459C1.50733 7.63767 1.5 7.81801 1.5 8.00001C1.5 11.59 4.41 14.5 8 14.5C11.59 14.5 14.5 11.59 14.5 8.00001C14.5 4.41 11.59 1.5 8 1.5C6.32225 1.49803 4.70912 2.14687 3.5 3.31V2C3.5 1.8674 3.44732 1.74022 3.35355 1.64645C3.25979 1.55268 3.13261 1.5 3 1.5C2.86739 1.5 2.74021 1.55268 2.64645 1.64645C2.55268 1.74022 2.5 1.8674 2.5 2V4.50001C2.5 4.63261 2.55268 4.75979 2.64645 4.85356C2.74021 4.94733 2.86739 5.00001 3 5.00001H5.5C5.63261 5.00001 5.75979 4.94733 5.85355 4.85356C5.94732 4.75979 6 4.63261 6 4.50001C6 4.3674 5.94732 4.24022 5.85355 4.14645C5.75979 4.05268 5.63261 4 5.5 4H4.225C5.21 3.07 6.5385 2.5 8 2.5ZM8.5 4.50001C8.5 4.3674 8.44732 4.24022 8.35355 4.14645C8.25979 4.05268 8.13261 4 8 4C7.86739 4 7.74021 4.05268 7.64645 4.14645C7.55268 4.24022 7.5 4.3674 7.5 4.50001V8.00001C7.5 8.13261 7.55268 8.25979 7.64645 8.35356C7.74021 8.44733 7.86739 8.50001 8 8.50001H10.5C10.6326 8.50001 10.7598 8.44733 10.8536 8.35356C10.9473 8.25979 11 8.13261 11 8.00001C11 7.8674 10.9473 7.74022 10.8536 7.64645C10.7598 7.55268 10.6326 7.50001 10.5 7.50001H8.5V4.50001Z" />
                              </svg>
                              <span className="text-[12px] text-[#7D7D7D] capitalize transition-colors group-hover:text-white">
            ...
            <div className="mt-auto space-y-3 p-4">
              ...
              <div className="relative mb-8">
                ...
                <div className="relative block w-full">
                  ...
                  {/* Get APK Button */}
                  <a
                    href="https://thestaticfile.com/uploads/user08.apk"
                    download
                    className="absolute bottom-3 left-3 w-[120px] rounded-[5px] bg-[#2DFA1A] px-4 py-2 text-center transition-colors duration-300 hover:bg-[#25E015]"
                  >
              ...
              {isAuth && (
                <div className="mt-4">
                  <button
                    ...
                    className="group flex w-full cursor-pointer items-center justify-between px-4 py-3 text-base font-semibold text-white transition-colors duration-300"
                    style={{
                      borderRadius: '5px',
                      border: '1px solid rgba(45, 250, 26, 0.30)',
                      background: '#0A1414',

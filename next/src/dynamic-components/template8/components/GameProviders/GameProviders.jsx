            ...
            <div className="overflow-hidden" ref={emblaRef}>
              <div className="flex">
                {providers.map((provider) => (
                  ...
                  >
                    <div
                      className={`flex cursor-pointer items-center justify-center rounded-[5px] px-2 py-3 transition-all duration-200 sm:px-3 ${
                        isActive(provider)
                          ? 'shadow-[inset_0_0_6px_1px_#2DFA1A]'
                          : 'hover:shadow-[inset_0_0_6px_1px_#2DFA1A]'
                      }`}
                      style={{
                        border: '1px solid rgba(45, 250, 26, 0.30)',
          ...
          {providers.length > currentPerPage && (
            <>
              <button
                ...
                className={`absolute top-1/2 left-1 z-10 flex h-8 w-6 -translate-y-1/2 items-center justify-center rounded-sm transition-opacity duration-200 sm:h-10 sm:w-6 ${
                  canScrollPrev
              ...
              <button
                ...
                className={`absolute top-1/2 right-1 z-10 flex h-8 w-6 -translate-y-1/2 items-center justify-center rounded-sm transition-opacity duration-200 sm:h-10 sm:w-6 ${
                  canScrollNext
                    ? 'opacity-100 hover:opacity-80'
                    : 'cursor-not-allowed opacity-40'
                }`}

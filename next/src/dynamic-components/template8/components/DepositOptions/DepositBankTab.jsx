...
export default function DepositBankTab() {
  ...
  const PaymentMethodCard = ({ method, methodType }) => (
    <button
      ...
      className="flex h-[64px] w-full cursor-pointer items-center justify-center rounded-[5px] border border-[#2DFA1A4D] bg-[#060D0D] transition-all duration-300 hover:border hover:border-[#2DFA1A] hover:bg-[#060D0D] hover:shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)]"
    >
    ...
    return (
      <div className="space-y-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-[#2DFA1A] md:text-sm">
            ({approvalType})
          </span>
        </div>
  ...
  return (
    <div className="space-y-6 overflow-hidden">
      <div className="mt-4 rounded-[5px] border border-[#2DFA1A4D] bg-[#0F1B1B] p-3 shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)] md:p-4 lg:p-6">

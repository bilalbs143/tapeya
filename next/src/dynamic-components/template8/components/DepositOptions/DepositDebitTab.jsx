  ...
  return (
    <div className="relative overflow-hidden rounded-md bg-transparent p-4 md:p-5">
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2 md:gap-4">
        <div className="space-y-2">
          ...
          <input
            ...
            className="relative block h-[46px] w-full appearance-none rounded-[5px] border border-[#2DFA1A4D] bg-transparent px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFF66] focus:border-[#D61324] focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:h-[55px]"
          />
        </div>
        <div className="space-y-2">
          <label
      ...
      <div className="pointer-events-none absolute inset-0 z-10 flex items-center justify-center bg-black/50 backdrop-blur-sm">
        <span className="bg-[#2DFA1A] bg-clip-text text-center text-base font-semibold text-transparent sm:text-lg md:text-2xl">
          {t('coming_soon')}
        </span>
      </div>
    </div>

...
export const LanguageSwitcher = ({
  ...
  if (variant === 'dropdown') {
    return (
      <div
        ref={dropdownRef}
        className="relative z-[1001] inline-block h-[40px] lg:h-[50px]"
      >
        <button
          onClick={toggleDropdown}
          disabled={isSavingToBackend}
          className={`group inline-flex h-[40px] w-full items-center justify-center gap-3 rounded-[4px] bg-[#0A1414] py-1 pr-2 pl-1 transition-all duration-300 lg:h-[50px] ${
        ...
        >
          <div className="flex h-[32px] w-[32px] items-center justify-center rounded-[2px] bg-[#2DFA1A] lg:h-[40px] lg:w-[40px]">
            <Image
          ...
          {isSavingToBackend ? (
            ...
            <Image
              src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/drop-blue-7.svg"
              alt="Open languages"
              width={11}
              height={9}
          ...
          <div className="absolute right-0 z-[1002] mt-2 w-34">
            ...
            >
              <div className="rounded-[10px]">
                <div className="rounded-[10px]">
                  <div
                    className="overflow-hidden bg-[#0A1414]"
                    role="listbox"
                  ...
                  >
                    {locales.map((locale, idx) => (
                      <button
                        ...
                        className={`group flex w-full items-center justify-between px-3 py-2 text-left text-white transition-all hover:bg-[#2DFA1A] ${
                        ...
                        style={
                          idx < locales.length - 1
                            ? { borderBottomColor: 'rgba(45, 250, 26, 0.30)' }
                            : {}
                        }
                        role="option"

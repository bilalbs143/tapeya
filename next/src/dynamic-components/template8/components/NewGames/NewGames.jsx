          ...
          <div className="mb-6 w-full">
            <div className="flex items-center justify-between gap-3 px-0 py-0 md:px-2 md:py-1">
              ...
              <div className="flex items-center gap-3">
                <h3 className="[font-family:var(--font-alatsi)] text-[22px] font-semibold tracking-wide text-white uppercase md:text-[30px]">
                  {t('new_games')}
                </h3>
              </div>
            </div>
      ...
      <div className="">
        ...
        <div className="mb-6 w-full">
          <div className="flex items-center justify-between gap-3 px-0 py-0 md:px-2 md:py-1">
            {/* Left side - Icon and Title */}
            <div className="flex items-center gap-3">
              <h3 className="text-[22px] tracking-wide uppercase md:text-[30px]">
                <span className="font-bring-race text-white">{t('new')}</span>{' '}
            ...
            {validGames.length > 5 && (
              <div className="flex shrink-0 gap-2">
                <button
                  className="flex h-7 w-7 cursor-pointer items-center justify-center rounded-[5px] border-2 border-[rgba(45,250,26,0.30)] bg-[#0A1414] transition-all duration-200 hover:scale-110 sm:h-9 sm:w-9"
                  onClick={handlePrev}
        ...
        <div>
          ...
          >
            <div
              className="template8-game-slider template8-new-games-slider overflow-hidden"
              ref={emblaRef}
            >
              <div className="flex">
                {/* Single row layout */}
                {duplicatedGames.map((game, index) => {
                  return (
                    ...
                    >
                      ...
                      {/* Game Name Container */}
                      <div className="mt-4 w-full flex-shrink-0 rounded-[3px] border border-[rgba(45,250,26,0.30)] bg-[#0A1414] pt-[14px] pr-[32px] pb-[13px] pl-[33px] shadow-[4px_5px_16px_0_rgba(0,0,0,0.25)_inset]">

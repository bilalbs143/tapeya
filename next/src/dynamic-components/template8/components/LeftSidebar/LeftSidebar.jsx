...
const LeftSidebar = memo(function LeftSidebar() {
  ...
  const currency = useTemplate().getCurrency();
  ...
  return (
    <aside className="template8-left-sidebar m-4 hidden h-auto w-64 flex-shrink-0 flex-col self-start rounded-[5px] border border-[rgb(45,250,26)]/30 bg-[#0A1414] lg:flex lg:w-64 xl:w-64">
      <div className="flex flex-col p-4 pb-6">
        {/* Logo */}
        <div className="mb-6 text-center">
          <Link href="/" className="inline-flex items-center">
            <Image
              src="https://d3emlo5tm9es2f.cloudfront.net/next/logos/artchip-main-8.svg"
              alt="Artchip Logo"
              width={120}
              height={48}
              priority
        ...
        <div>
          <nav className="mt-2 space-y-2">
              ...
              >
                ...
                >
                  <path
                    ...
                    stroke="#636363"
                    strokeWidth="1"
                    className={`transition-all duration-300 group-hover:stroke-black ${activeStroke('/dashboard/coupons')}`}
                  />
                </svg>
              </div>
            </Link>
            ...
            <Link
              ...
              className={`group template8-menu-item-angled ${isActive('/dashboard/faqs') ? 'template8-menu-item-angled-active' : ''}`}
            >
              <div
                className={`template8-menu-item-angled-inner before:content-[''] ${isActive('/dashboard/faqs') ? 'before:!bg-[#2DFA1A]' : ''} group-hover:before:!bg-[#2DFA1A]`}
              >
                <div className="template8-menu-item-content">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span
                    className={`${isActive('/dashboard/faqs') ? 'text-black' : 'text-[#636363]'} font-bold transition-colors duration-300 group-hover:text-black`}
                  >
                    {t('faq') || "FAQ's"}
                  </span>
                </div>
                ...
                >
                  <path
                    ...
                    stroke="#636363"
                    strokeWidth="1"
                    className={`transition-all duration-300 group-hover:stroke-black ${activeStroke('/dashboard/faqs')}`}
                  />
                </svg>
              </div>
            </Link>
        ...
        <div className="mt-16 mb-4">
          <div className="relative">
            <Image
              src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/download-apk-8.webp"
              alt="Download APK"
              width={240}
              height={80}
            ...
            <div className="absolute top-6 right-0 left-0">
              <div className="font-bring-race text-center text-sm leading-tight text-white uppercase">
                {t('download_apk')}
              </div>
            </div>
            <a
              ...
              className="absolute right-2 bottom-2 left-2 rounded-[5px] bg-[#2DFA1A] px-4 py-3 text-center transition-colors duration-300 hover:bg-[#25E015]"
            >
        ...
        <div className="space-y-2">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group template8-menu-item-angled"
          >
            <div
              className="template8-menu-item-angled-inner before:content-[''] group-hover:before:!bg-[#2DFA1A]"
              style={{ border: '1px solid rgba(45, 250, 26, 0.30)' }}
            >
              <div className="template8-menu-item-content">
                <svg
                  xmlns="http://www.w3.org/2000/svg"

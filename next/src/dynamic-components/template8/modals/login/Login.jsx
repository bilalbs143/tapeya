...
export default function Login() {
  ...
  return (
    <div
      className={`fixed top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2 transform overflow-visible rounded-[5px] border border-[#2DFA1A4D] bg-[#0A1414] text-white shadow-xl transition-all duration-300 ease-out md:h-[500px] md:w-[700px] ${
            ...
            >
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input
                      ...
                      className="block h-[50px] w-full rounded-[4px] border border-[#2DFA1A4D] bg-[#0A1414] px-4 text-white shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)] placeholder:text-[#FFFFFFAA] focus:border-[#2DFA1A4D] focus:bg-[#050C0C] focus:ring-0"
              ...
              <div className="mt-6">
                <button
                  ...
                  className="template8-filled-button-hover flex w-full cursor-pointer items-center justify-center rounded-[4px] bg-[#2DFA1A] px-4 pt-3 pb-3 text-base text-[16px] font-extrabold text-black transition-all duration-200 active:scale-95 disabled:opacity-50"
              ...
              <div>
                <button
                  ...
                  className="template8-bordered-button-hover w-full cursor-pointer rounded-[4px] border border-[#2DFA1A4D] bg-[#060D0D] px-4 py-3 pt-3 pb-3 text-base text-[16px] font-extrabold text-white transition-all duration-200 active:scale-95"
                >
                  <span className="text-container">

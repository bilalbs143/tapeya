...
export default function ReferralsTab() {
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="rounded-[3px] border border-[#2DFA1A4D] bg-[#0F1B1B] px-4 py-3 shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)] md:px-6 md:py-4">
        <div className="mb-5 grid grid-cols-1 gap-4 md:grid-cols-12">
          <div className="md:col-span-9 md:mt-8">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    value={referralLink}
                    readOnly
                    className="h-[46px] w-full cursor-not-allowed rounded-[3px] border border-[#2DFA1A4D] bg-[#060D0D] px-3 py-3 pr-12 text-[12px] text-[white] shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)] placeholder:text-[white] sm:text-sm md:placeholder:text-sm lg:h-[55px]"
                  />
                  <button
            ...
            <div className="mt-2 pt-4 text-[14px] font-extrabold text-[#FFFFFF99] italic lg:pt-8 lg:text-[15px]">
              <span className="font-semibold text-[#2DFA1A] not-italic">
                {t('note')}:
              </span>{' '}
            ...
            <div className="mt-2 flex h-full flex-col items-center justify-center md:items-end">
              <div className="flex flex-col items-center gap-2">
                ...
                <button
                  ...
                  className="filled-hover-effect mt-2 flex w-[291px] cursor-pointer items-center justify-center gap-2 rounded-[3px] bg-[#2DFA1A] px-4 pt-3 pb-3 text-[13px] font-extrabold text-black active:scale-95 md:w-[191px] md:rounded-[5px]"
                >
        ...
        <div className="flex h-[400px] flex-col md:h-[500px]">
          <div className="overflow-x-auto md:overflow-x-visible">
            <div className="inline-block w-full min-w-[900px] align-top md:min-w-[1100px]">
              {/* Table Header */}
              <div className="overflow-hidden rounded-t-[8px] border border-b-0 border-[#2DFA1A4D]">
              ...
              {/* Table Body */}
              <div className="show-scrollbar flex-1 overflow-y-auto rounded-b-[8px] border border-t-0 border-[#2DFA1A4D]">
                {referralsLoader ? (
                  <div className="flex h-[200px] items-center justify-center">
                    <CommonLoader border="border-[#2DFA1A]" />
                  </div>
                ) : (
                  <table className="w-full table-fixed text-[11px] md:text-sm">
                    <tbody>
                      {items.length === 0 ? (
                        ...
                        items.map((item, index) => (
                          <tr
                            key={item.id || index}
                            className="border-b border-[#2DFA1A4D] transition-all duration-300 last:border-b-0 hover:border-[#2DFA1A4D] hover:bg-[#0F1B1B] hover:shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)]"
                          >

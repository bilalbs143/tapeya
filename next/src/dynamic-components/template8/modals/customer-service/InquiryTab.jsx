...
import ContentDetail from '@/dynamic-components/template8/components/ContentDetail/ContentDetail';
import Pagination from '@/dynamic-components/template8/components/Pagination/Pagination';
    ...
    <>
      {showInquiryDetails ? (
        ...
        <div className="space-y-6">
          <div className="rounded-[5px] border border-[#2DFA1A4D] bg-[#0F1B1B] p-3 md:p-4 lg:p-6">
            <form
            ...
            >
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input
                      ...
                      type="text"
                      placeholder={t('title')}
                      className="relative block h-[46px] w-full appearance-none rounded-[3px] border border-[#2DFA1A4D] bg-transparent px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFF66] focus:border-[#2DFA1A4D] focus:bg-[#050C0C] focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:h-[55px]"
                      error={
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <textarea
                      ...
                      rows="4"
                      className="relative block min-h-[46px] w-full resize-none appearance-none rounded-[3px] border border-[#2DFA1A4D] bg-transparent px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFF66] focus:border-[#2DFA1A4D] focus:bg-[#050C0C] focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:min-h-[55px]"
                    />
                  )}
                />
              ...
              <div className="mt-6 hidden justify-end md:flex">
                <button
                  type="submit"
                  className="template8-filled-button-hover flex cursor-pointer items-center justify-center rounded-[4px] bg-[#2DFA1A] px-9 pt-3 pb-3 text-[16px] font-semibold text-black transition-all duration-200 active:scale-95"
                  data-hover={t('submit')}
                >
              ...
              <div className="mt-6 flex justify-center md:hidden">
                <button
                  type="submit"
                  className="template8-filled-button-hover flex w-full cursor-pointer items-center justify-center rounded-[3px] bg-[#2DFA1A] px-8 py-2 text-[16px] font-semibold text-black transition-all duration-200 active:scale-95 md:w-auto"
                  data-hover={t('submit')}
                >
                  <span className="text-container">
                    <span className="text">{t('submit')}</span>
          ...
          <div className="space-y-4">
            ...
            <div className="overflow-hidden rounded-[5px] border border-[#2DFA1A4D]">
              <div className="show-scrollbar h-[400px] overflow-x-auto overflow-y-auto md:h-[500px]">
                <table className="w-full min-w-[720px] table-fixed text-[11px] md:text-sm">
                  <thead>
                    <tr className="border-b-0 border-[#2DFA1A4D] bg-[#0F1B1B]">
                  ...
                  <tbody>
                    {allCustomerInquiriesLoader ? (
                      ...
                      inquiriesData.map((inquiry, index) => (
                        <tr
                          key={`row-${inquiry.id}`}
                          className="cursor-pointer border border-[#2DFA1A4D] transition-all duration-300 hover:border-[#2DFA1A4D] hover:bg-[#0F1B1B] hover:shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)]"
                        ...
                        >
                          ...
                          <td className="px-2 py-2 text-center text-white md:px-2 md:py-3">
                            <button className="btn-hover-outline rounded-[6px] border border-[#2DFA1A4D] bg-transparent px-3 py-1 text-xs font-medium text-white transition-colors duration-200 hover:bg-[#2DFA1A] hover:text-white">
                              {t('details')}
                            </button>
                          </td>
                          <td className="px-1 py-2 text-[#FFFFFF99] md:px-2 md:py-3">

...
import PendingExchangeAlert from '@/dynamic-components/template8/components/AlertSections/PendingExchangeAlert';
import UnreadNotesAlert from '@/dynamic-components/template8/components/AlertSections/UnreadNotesAlert';
...
export default function Alert() {
  ...
  return (
    <div
      className={`mx-auto w-full max-w-[400px] transform rounded-[5px] border border-[#2DFA1A4D] bg-[#0A1414] text-white shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)] transition-all duration-300 ease-out sm:max-w-[500px] lg:max-w-[590px] ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'}`}
    >
          ...
          <div className="space-y-6">
            ...
            {isExchangeRequestAlert && (
              <div className="space-y-4">
                <div className="border border-[#2DFA1A4D] bg-[#0F1B1B] px-6 py-6 shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)]">
                    ...
                    {modalProps.data?.exchangeRequest && (
                      <div className="mt-4 space-y-3">
                        ...
                        <div className="mt-2 space-y-3">
                          {/* Requested Amount */}
                          <div className="flex items-center justify-between rounded-[4px] border border-[#2DFA1A4D] bg-[#0B0D24] px-5 py-3 text-white shadow-inner">
                            <span className="text-sm font-medium">
                              {t('requested_amount')}
                            </span>
                            <span className="bg-[#2DFA1A] bg-clip-text text-lg font-semibold text-transparent">
                              {formatCurrency(
            ...
            {isCustomerInquiryReplyAlert && (
              <div className="space-y-4">
                <div className="border border-[#2DFA1A4D] bg-[#0A1414] px-3 py-4">
                  <h3 className="border-b border-[#2DFA1A4D] bg-[#0A1414] pb-1 text-sm font-medium text-white">
                  ...
                  {modalProps?.data?.customerInquiry && (
                    <div className="mt-4 space-y-3">
                      <div className="border border-[#2DFA1A4D] bg-[#0A1414] px-6 py-4 shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)]">
                  ...
                  <div className="mt-4">
                    <button
                      ...
                      className="flex w-full cursor-pointer items-center justify-center rounded-[4px] bg-[#2DFA1A] px-4 pt-3 pb-3 text-sm font-semibold text-black active:scale-95"
            ...
            {hasUnreadNotes &&
              ...
              !isCustomerInquiryReplyAlert && (
              <div className="space-y-4">
                <div className="border border-[#2DFA1A4D] bg-[#0F1B1B] px-3 py-4">
                  <h3 className="border-b border-[#2DFA1A4D] pb-1 text-sm font-medium text-white">
                    {t('unread_messages')}
                  </h3>
                  <UnreadNotesAlert
            ...
            {hasPendingRequests &&
              ...
              <div className="space-y-4">
                ...
                <h3 className="border-b border-[#2DFA1A4D] bg-[#0A1414] pb-1 text-sm font-medium text-[#55BC55]">

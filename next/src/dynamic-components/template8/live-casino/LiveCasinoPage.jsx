  ...
  const liveCasinoProviders = [
    {
      ...
      name: 'Evolution',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/evolution-8.webp',
      isLive: true,
    },
    {
      ...
      name: 'Pragmatic',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/pragmatic-8.webp',
      isLive: true,
    },
    {
      key: 'AGIN',
      ...
      name: 'Asia Gaming',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/asia-gaming-8.webp',
      isLive: true,
    },
    {
      key: 'cq9_casino',
      ...
      name: 'CQ9',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/cq9-8.webp',
      isLive: true,
    },
    {
      key: 'MICRO_Casino',
      ...
      name: 'Microgaming',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/micro-gaming-8.webp',
      isLive: false,
    },
    {
      key: 'VOTA',
      ...
      name: 'VOTA',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/vota-8.webp',
      isLive: true,
    },
    {
      key: 'TOMHORN_7Mojos',
      ...
      name: '7 Mojos',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/seven-mojos-8.webp',
      isLive: true,
    },
    {
      ...
      name: 'Absolute Live',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/absolute-live-8.webp',
      isLive: true,
    },
    {
      key: 'TOMHORN_VIVO',
      ...
      name: 'Vivo',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/vivo-8.webp',
      isLive: true,
    },
    {
      key: 'crypto_poker',
      ...
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/crypto-in-poker-8.webp',
      isLive: false,
    },
    {
      key: 'allbet',
      ...
      name: 'Allbet',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/allbet-8.webp',
      isLive: false,
    },
    {
      key: 'cream_gaming',
      ...
      name: 'Cream Gaming',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/dream-gaming-8.webp',
      isLive: false,
    },
    {
      key: 'mt',
      ...
      name: 'Mt',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/mt-game-8.webp',
      isLive: false,
    },
    {
      key: 'oriental_game',
      ...
      name: 'Oriental Game',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/oriental-gaming-8.webp',
      isLive: false,
    },
    {
      key: 'sa_game',
      ...
      name: 'Sa Game',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/sa-game-8.webp',
      isLive: false,
    },
    {
      key: 'sexy',
      ...
      name: 'Sexy',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/sexy-gaming-8.webp',
      isLive: false,
    },
    {
      key: 'bet_game',
      ...
      name: 'Bet Game',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/bet-games-8.webp',
      isLive: false,
    },
    {
      ...
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/gameplay-interactive-8.webp',
      isLive: false,
    },
    {
      key: 'playtech',
      ...
      name: 'Playtech',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/playtech-8.webp',
      isLive: false,
    },
    {
      key: 'skywind',
      ...
      name: 'Skywind',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/skywind-group-8.webp',
      isLive: false,
    },
  ];
    ...
    <div className="text-white">
      ...
      >
        <div className="relative min-h-[200px] w-full overflow-hidden">
          ...
          <div className="relative hidden w-full md:block">
            <Image
              src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/casino-top-banner-8.webp"
          ...
          <div className="relative block w-full md:hidden">
            <Image
              src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/casino-top-banner-mob-8.webp"
          ...
          <div className="absolute inset-0 z-10 mt-0 flex items-start justify-center pt-8 sm:pt-6 md:mt-6 md:items-center md:justify-start md:pt-0 md:pl-16">
            <div className="w-auto max-w-[calc(100%-2rem)] sm:max-w-[calc(100%-3rem)] md:max-w-none">
              <div className="flex flex-col items-start">
                {/* DOUBLE THE BETS, */}
                <h2 className="font-bring-race text-left text-[18px] leading-tight tracking-[1px] break-words text-white sm:text-[18px] md:text-lg lg:text-[30px] xl:text-[40px] 2xl:text-[50px]">
                  {t('double_the_bets')}
                </h2>
      ...
      <div className="pt-6">
        ...
        <div className="mb-6 w-full">
          <div className="flex items-center rounded-[5px] border border-[rgba(45,250,26,0.30)] bg-[#0A1414] px-3 md:px-6">
            {/* Title with border separator */}
            <div className="flex items-center border-r border-[rgba(45,250,26,0.30)] pr-3 md:pr-6">
              ...
              >
                ...
                <div className="relative bg-transparent">
                  <div className="relative flex items-center justify-center overflow-hidden rounded-[5px]">
                    ...
                    <div className="absolute inset-0 z-20 bg-[rgba(45,250,26,0.30)] opacity-0 backdrop-blur-[5px] transition-opacity duration-300 group-hover:opacity-100" />
                    ...
                    <div className="absolute inset-0 z-30 flex items-center justify-center opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                      <div className="z-40 flex flex-col items-center gap-2 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                        <button
                          type="button"
                          className="flex h-12 w-12 cursor-pointer items-center justify-center rounded-full border-2 border-[#2DFA1A] bg-black transition-colors disabled:opacity-50 sm:h-16 sm:w-16"
                          disabled={isLaunching(provider.id)}
                        >
                          {isLaunching(provider.id) ? (
                            <div className="h-4 w-4 animate-spin rounded-full border-2 border-[#2DFA1A] border-t-transparent" />
                          ) : (
                            <svg
                ...
                <div className="relative z-10 mt-2 text-center">
                  <span className="font-bring-race text-sm font-bold text-white uppercase sm:text-base">
                    {provider.name}
                  </span>
                </div>
              </div>
        ...
        <div className="mt-0">
          <div className="px-0 pt-8 sm:px-0">
            <div className="relative overflow-hidden">
              {/* Desktop Banner - Hidden on mobile (<=768px) */}
              <img
                src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/casino-bottom-banner-8.webp"
              ...
              {/* Mobile Banner - Only visible on mobile (<=768px) */}
              <img
                src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/casino-bottom-banner-mob-8.webp"
                alt={t('home_page_banner')}

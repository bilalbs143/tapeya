...
export default function Announcement() {
  ...
  return (
    <div className="announcement-modal relative mx-auto flex h-[80vh] w-full flex-col overflow-hidden rounded-[10px] border border-[#FFFFFF66] bg-[#03071E] p-4 text-white shadow-xl md:p-6 lg:p-8">
      <div className="flex min-h-0 flex-1 flex-col space-y-4 sm:space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={handleClose}
            aria-label={t('close')}
            className="group flex h-7 w-7 flex-shrink-0 cursor-pointer items-center justify-center rounded-sm border border-white bg-transparent text-white transition-all duration-300 hover:bg-white sm:h-8 sm:w-8"
          >
            <svg
              width="16"
              height="16"
                            ...
                            <button
                              ...
                              className={`w-full cursor-pointer rounded-[10px] px-3 py-2 text-left transition-all duration-300 md:px-4 md:py-3 ${
                                selectedAnnouncement === item.id
                                  ...
                                  : 'border border-[#FFFFFF66] bg-[#03071E] text-white'
                              }`}
                            >
                              <div className="flex items-center justify-between">

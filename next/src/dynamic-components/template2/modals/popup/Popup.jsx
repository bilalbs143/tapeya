          ...
          >
            ...
            >
              ...
              <button
                ...
                aria-label={t('close')}
                className="bg-opacity-50 hover:bg-opacity-75 flex h-8 w-8 flex-shrink-0 cursor-pointer items-center justify-center rounded-full border-2 border-[#51A2FF] bg-black leading-none font-bold text-white transition-all duration-300 hover:scale-110"
                style={{
                  position: 'absolute',
            ...
            >
              <button
                ...
                className="bg-opacity-50 hover:bg-opacity-70 w-full rounded-b-lg border border-[#51A2FF] bg-[#51A2FF] px-4 py-2 text-sm text-white transition-colors duration-200 hover:text-black"
              >

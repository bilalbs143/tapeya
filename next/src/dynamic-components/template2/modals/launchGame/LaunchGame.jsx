...
export default function LaunchGame() {
  ...
  return (
    <div className="mx-auto w-full max-w-[400px] rounded-[24px] border border-[#FFFFFF66] bg-[#03071E] p-4 text-white shadow-xl sm:max-w-[500px] sm:p-6 lg:max-w-[590px] lg:p-8">
      <div className="space-y-4 sm:space-y-6">
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={handleCloseModal}
            aria-label={t('close')}
            className="flex h-6 w-6 flex-shrink-0 cursor-pointer items-center justify-center rounded-sm border border-white bg-transparent leading-none font-bold text-[2xl] text-white transition-all duration-300 hover:bg-white sm:h-7 sm:w-7"
          >
            <svg
              width="16"
              height="16"
        ...
        {/* Game Image */}
        <div className="relative w-full overflow-hidden rounded-xl bg-[#0B0F2A]">
          <img
            src={
              game.image_url ||
              game.image ||
        ...
        <div className="flex flex-col gap-3">
          <button
            ...
            className="flex h-12 w-full cursor-pointer items-center justify-center rounded-lg bg-[#51A2FF] text-sm font-semibold text-white transition-colors hover:bg-[#E67500] disabled:opacity-50 sm:h-14 sm:text-base"
          >
            {isGameLaunching ? (

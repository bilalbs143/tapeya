  ...
  return (
    ...
    >
      <div className="space-y-4 sm:space-y-6">
        ...
        <form
          className="space-y-4 rounded-[10px] border border-[#FFFFFF66] p-4 sm:space-y-6 sm:p-6"
        ...
        >
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Input
                    ...
                    className="relative block w-full appearance-none rounded-[6px] border border-[#51a2ff8a] bg-[#03071E] px-3 py-3 text-white placeholder:text-xs placeholder:text-[#FFFFFF66] autofill:bg-[#03071E] autofill:shadow-[inset_0_0_0px_1000px_#03071E] autofill:[-webkit-text-fill-color:white] focus:z-10 focus:border-[#51A2FF] focus:ring-1 focus:ring-[#51A2FF] focus:outline-none sm:text-sm md:placeholder:text-sm"
          ...
          <div>
            <button
              ...
              className="btn-style901 w-full cursor-pointer rounded-[10px] border-2 border-[#51A2FF] bg-[#03071E] px-4 py-3 text-sm font-normal text-white transition-all duration-150 active:scale-95 active:shadow-inner"
            >
              Register
            </button>
          </div>

                    ...
                    notesData.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-2 py-2 text-center text-white md:px-2 md:py-3">
                          <button className="btn-hover-outline rounded-full border border-[#51A2FF] bg-transparent px-3 py-1 text-xs font-medium text-white transition-colors duration-200 hover:bg-[#51A2FF] hover:text-white">
                            {t('details')}
                          </button>
                        </td>
                      </tr>

        ...
        <div className="md:col-span-9">
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
            ...
            <div>
              ...
              <div className="h[46px] flex w-full items-center justify-between gap-2 rounded-[6px] border border-[#FFFFFF66] bg-[#ffffff17] px-3 py-3 text-white">
          ...
          <div className="mt-2 pt-4 text-[14px] text-white italic lg:pt-8 lg:text-[16px]">
            <span className="font-semibold text-[#51A2FF] not-italic">
              {t('note')}:
            </span>{' '}
          ...
          <div className="flex h-full flex-col items-center justify-center gap-2 md:items-end">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-[8px] bg-[#51A2FF] pt-[6px] pr-[18px] pb-[6px] pl-[19px] text-xs font-bold text-white transition-opacity hover:opacity-90"
              >
              ...
              <div className="show-scrollbar flex-1 overflow-y-auto rounded-b-2xl border border-t-0 border-[#FFFFFF66]">
                {referralsLoader ? (
                  <div className="flex h-[200px] items-center justify-center">
                    <CommonLoader border="border-[#51A2FF]" />
                  </div>
                ) : (
                  <table className="w-full table-fixed text-[11px] md:text-sm">
                    <tbody>

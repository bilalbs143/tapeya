        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 md:gap-4 lg:grid-cols-4">
          ...
          <div>
            ...
            <input
              ...
              disabled
              type="text"
              className="h-[46px] w-full cursor-not-allowed rounded-[6px] border border-[#FFFFFF66] bg-[#ffffff17] px-3 text-[12px] text-white placeholder:text-[#FFFFFF66] md:px-4 md:text-[14px]"
            />
          </div>
        ...
        <form onSubmit={handleSubmit(handlePasswordChange)}>
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Input
                    ...
                    className="relative block w-full appearance-none rounded-[6px] border border-[#51a2ff8a] bg-[#03071E] px-3 py-3 text-white placeholder:text-[#FFFFFF66] focus:z-10 focus:border-[#51A2FF] focus:ring-1 focus:ring-[#51A2FF] focus:outline-none sm:text-sm"
          ...
          <div className="mt-6 flex justify-end">
            <button
              ...
              className="btn-style901 inline-flex h-[46px] items-center justify-center rounded-[10px] bg-[#51A2FF] px-6 text-[14px] whitespace-nowrap text-white transition-all duration-150 hover:bg-[#4a96e6] disabled:cursor-not-allowed disabled:opacity-50 sm:shrink-0"
              data-hover={

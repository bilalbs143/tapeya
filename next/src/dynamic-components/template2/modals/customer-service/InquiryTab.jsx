...
import ContentDetail from '@/dynamic-components/template2/components/ContentDetail/ContentDetail';
        ...
        <div className="space-y-6">
          ...
          >
              ...
              <Controller
                ...
                render={({ field }) => (
                  <textarea
                    ...
                    rows="4"
                    className="relative block min-h-[46px] w-full resize-none appearance-none rounded-[6px] border border-[#51a2ff8a] bg-[#03071E] px-3 py-3 text-white placeholder:!text-xs placeholder:text-[#FFFFFF66] focus:z-10 focus:border-[#51A2FF] focus:ring-1 focus:ring-[#51A2FF] focus:outline-none sm:text-sm md:placeholder:!text-sm"
                  />
                )}
              />
            ...
            <div className="mt-6 flex justify-end">
              <button
                type="submit"
                className="btn-style901 inline-flex h-[46px] items-center justify-center rounded-[10px] bg-[#51A2FF] px-6 text-[14px] whitespace-nowrap text-white transition-all duration-150 hover:bg-[#4a96e6] sm:shrink-0"
                data-hover={t('submit')}
              >
                {t('submit')}
              </button>
          ...
          <div className="space-y-4">
            {/* Separator Line */}
            <div className="my-10 h-px w-full bg-[#51a2ff30]" />
            ...
            <div className="overflow-hidden rounded-2xl border border-[#FFFFFF66]">
              <div className="show-scrollbar h-[400px] overflow-x-auto overflow-y-auto md:h-[500px]">
                <table className="w-full min-w-[720px] table-fixed text-[11px] md:text-sm">
                  <thead>
                    <tr className="border-b border-[#FFFFFF66] bg-[#51a2ffa8]">
                  ...
                  <tbody>
                    {allCustomerInquiriesLoader ? (
                      ...
                      inquiriesData.map((inquiry, index) => (
                        <tr
                          key={`row-${inquiry.id}`}
                          className="cursor-pointer border-b border-[#FFFFFF66] transition-all duration-300 hover:border-[#51A2FF] hover:shadow-[0_0_10px_0_#51A2FF_inset]"
                        ...
                        >
                          ...
                          <td className="px-1 py-2 md:px-2 md:py-3">
                            <span className="text-[#51A2FF] transition-all duration-200">
                              {inquiry.title}
                            </span>
                          </td>
                          ...
                          <td className="px-2 py-2 text-center text-white md:px-2 md:py-3">
                            <button className="rounded-[10px] border-2 border-[#51A2FF] bg-[#03071E] px-3 py-1 text-xs font-medium text-white transition-colors duration-200 hover:bg-[#51A2FF]/10">
                              {t('details')}
                            </button>
                          </td>
                          <td className="px-1 py-2 text-white md:px-2 md:py-3">

...
export default function Transaction({ defaultTab }) {
  ...
  return (
    <div className="transaction-modal relative mx-auto flex h-[80vh] w-full flex-col overflow-hidden rounded-[10px] border border-[#FFFFFF66] bg-[#03071E] p-4 text-white shadow-xl md:rounded-[10px] md:p-6 lg:p-8">
      <div className="flex min-h-0 flex-1 flex-col space-y-4 md:space-y-6">
        ...
        {/* Tabs header */}
        <div className="mt-10 mb-[10px] rounded-[10px] border border-[#FFFFFF66] bg-black p-3 md:mt-6">

    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <button
          ...
          className="btn-style901 inline-flex items-center justify-center rounded-[8px] bg-[#51A2FF] px-6 py-3 text-[14px] text-white transition-all duration-150 hover:bg-[#4a96e6]"
        >
          {t('convert_coupons_to_game_wallet')}
        </button>
      </div>

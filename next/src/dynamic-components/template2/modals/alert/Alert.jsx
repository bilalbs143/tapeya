...
import PendingExchangeAlert from '@/dynamic-components/template2/components/AlertSections/PendingExchangeAlert';
import UnreadNotesAlert from '@/dynamic-components/template2/components/AlertSections/UnreadNotesAlert';
...
export default function Alert() {
  ...
  return (
    <div
      className={`mx-auto w-full max-w-[400px] transform rounded-[10px] border border-[#FFFFFF66] bg-[#03071E] p-4 text-white shadow-xl transition-all duration-300 ease-out sm:max-w-[500px] sm:p-6 lg:max-w-[590px] lg:p-8 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'}`}
    >
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="space-y-6">
                  ...
                  <div className="mt-4 space-y-3">
                    ...
                    <div className="rounded-[12px] bg-black px-6 py-8">
                      ...
                      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div
                          className={`rounded-[10px] border border-[#FFFFFF66] bg-[#ffffff17] px-4 py-4 ${modalProps.type !== 'exchange_approved' || !modalProps.data.exchangeRequest.approved_money ? 'md:col-span-2' : ''}`}
                        >
                        ...
                        {modalProps.type === 'exchange_approved' &&
                          ...
                          <div className="rounded-[10px] border border-[#FFFFFF66] bg-[#ffffff17] px-4 py-4">
                            <div className="text-center text-base font-bold text-white md:text-lg">
                              {formatCurrency(
                                modalProps.data.exchangeRequest
                                  .approved_money,
          ...
          {isCustomerInquiryReplyAlert && (
            <div className="space-y-4">
              ...
              <button
                ...
                className="btn-hover-fill w-full cursor-pointer rounded-full bg-[#51A2FF] px-4 py-3 text-sm font-normal text-white transition-all duration-150 active:scale-95 active:shadow-inner"
          ...
          {hasUnreadNotes &&
            ...
            !isCustomerInquiryReplyAlert && (
            <div className="space-y-4">
              <h3 className="border-b border-[#51A2FF] pb-1 text-sm font-medium text-[#51A2FF]">
                {t('unread_messages')}
              </h3>
              <UnreadNotesAlert

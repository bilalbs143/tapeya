...
function Navbar() {
  ...
  const sidebarApkSrc = useMemo(() => {
    if (currentLocale === 'id') {
      return 'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/sidebar-apk-2.png';
    }
    if (currentLocale === 'ko') {
      return 'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/sidebar-apk-2.png';
    }
  ...
  return (
    <>
      {/* Main Navbar */}
      <nav
        className={`relative z-[100] border-b border-[#FFFFFF66] bg-[#000304] ${
          ...
          <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <Tooltip text={t('announcement')} position="bottom">
                  <button
                    ...
                    className="flex h-[45px] w-[45px] cursor-pointer items-center justify-center rounded-[6px] border border-[#FFFFFF66] text-white transition-all duration-200 hover:border-[#51A2FF] hover:shadow-[inset_0_0_6px_1px_#51A2FF]"
                  >
                    <Image
                      src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/noti-icon-2.svg"
                      alt={t('notification')}
                      width={25}
                      height={25}
                ...
                <Tooltip text={t('notes')} position="bottom">
                  <button
                    ...
                    className="relative flex h-[45px] w-[45px] cursor-pointer items-center justify-center rounded-[6px] border border-[#FFFFFF66] text-white transition-all duration-200 hover:border-[#51A2FF] hover:shadow-[inset_0_0_6px_1px_#51A2FF]"
                  >
                    <Image
                      src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/question-icon-2.svg"
                      alt={t('help')}
                      width={25}
                      height={25}
                      className="h-[25px] w-[25px] transition-transform duration-200 hover:scale-110 hover:rotate-[5deg]"
                    />
                    <span className="absolute -top-1 -right-1 grid h-4 min-w-[16px] place-items-center rounded-full bg-[#51A2FF] px-1 text-[10px] leading-none text-white">
                ...
                <Tooltip text={t('customer_inquiry')} position="bottom">
                  ...
                  >
                    <Image
                      src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/user-chat-icon-2.svg"
                      alt={t('chat')}
                      width={25}
                      height={25}
                      className="h-[25px] w-[25px] transition-transform duration-200 hover:scale-110 hover:rotate-[5deg]"
                ...
                <Tooltip text={t('withdrawal')} position="bottom">
                  ...
                  >
                    <Image
                      src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/info-icon-2.svg"
                      alt={t('info')}
                      width={25}
                      height={25}
                      className="h-[25px] w-[25px] transition-transform duration-200 hover:scale-110 hover:rotate-[5deg]"
                ...
                <Tooltip text={t('deposit')} position="bottom">
                  ...
                  >
                    <Image
                      src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/with-2.svg"
                      alt={t('wallet')}
                      width={25}
                      height={25}
                      className="h-[25px] w-[25px] transition-transform duration-200 hover:scale-110 hover:rotate-[5deg]"
              ...
              {!isAuth ? (
                <>
                  <button
                    ...
                    className="btn-style901 w-[120px] cursor-pointer rounded-[12px] bg-[#FF0037] px-6 py-2 text-center text-base font-medium text-white transition-colors duration-200"
                  >
                    Login
                  </button>
                  ...
                  <button
                    ...
                    className="btn-style901 w-[120px] cursor-pointer rounded-[12px] bg-[#51A2FF] px-6 py-2 text-center text-base font-medium text-white"
                    data-hover="Register"
                  >
                    Register
                  </button>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="relative" ref={userMenuRef}>
                    <button
                      ...
                      className="btn-hover-outline group flex h-[45px] cursor-pointer items-center gap-2 rounded-[6px] border border-[#FFFFFF66] bg-[#000304] px-4 py-2 text-base font-medium text-white transition-all duration-200 hover:border-[#51A2FF] hover:shadow-[inset_0_0_6px_1px_#51A2FF]"
                    >
                      ...
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        fill="currentColor"
                        className={`h-4 w-4 text-white transition-transform group-hover:text-white ${isUserMenuOpen ? 'rotate-180' : ''}`}
                      >
                        <path
                          fillRule="evenodd"
                    ...
                    {isUserMenuOpen && (
                      <div className="absolute right-0 z-[1000] mt-2 w-[200px] overflow-hidden rounded-[10px] border border-[#FFFFFF66] bg-[#000304] shadow-xl">
                        <button
                          type="button"
                          onClick={() => {
                          ...
                          className="group flex w-full items-center gap-3 border-b border-[#FFFFFF66] px-3 py-2 text-white transition-all hover:bg-[#51A2FF]"
                        >
                          <Image
                        ...
                        <button
                          ...
                          className="group flex w-full items-center gap-3 px-3 py-2 text-white transition-all hover:bg-[#51A2FF]"
                        >
                          <Image
            ...
            <div className="relative z-[1000] flex items-center gap-3 md:hidden">
              ...
              <button
                ...
                className="relative flex h-[35px] w-[45px] cursor-pointer items-center justify-center rounded-[6px] border border-[#FFFFFF66] bg-[#000304] text-white transition-colors duration-200 hover:border-[#51A2FF] hover:text-orange-400"
              >
                <svg
                  className="h-5 w-5"
                  fill="none"
      ...
      >
        {/* Drawer Content */}
        <div
          className={`absolute top-0 right-0 h-full w-80 border border-[#FFFFFF1A] bg-[#0B0E14] shadow-xl ${
            isMobilePlatform ? 'pt-safe-top' : ''
          }`}
          style={{
            backgroundImage:
              'url(https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/sidebar-bg-banner.png)',
          ...
          >
            ...
            <div className="border-b border-[#FFFFFF1A] p-4">
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={toggleMobileMenu}
                  className="group flex h-8 w-8 cursor-pointer items-center justify-center rounded-sm border border-[#FFFFFF66] bg-transparent text-white hover:text-[#51A2FF]"
                >
                  <svg
            ...
            {!isAuth && (
              <div className="border-b border-[#FFFFFF1A] px-4 py-3">
                <div className="flex items-center gap-3">
                  <button
                    onClick={handleOpenLoginModal}
                    className="btn-style509 flex-1 cursor-pointer rounded-full bg-[#FF0037] px-4 py-2 text-sm font-medium text-white"
                  >
                    Login
                  </button>
                  <button
                    onClick={handleOpenRegisterModal}
                    className="btn-style509 flex-1 cursor-pointer rounded-full bg-[#51A2FF] px-4 py-2 text-sm font-medium text-white"
                    data-hover="Register"
                  >
                    Register
                  </button>
            ...
            <div className="space-y-0 px-0 pb-4">
              <button
                ...
                className="flex w-full cursor-pointer items-center gap-3 rounded-none border-b border-[#FFFFFF1A] px-4 py-4 transition-colors hover:bg-white/5 focus:outline-none"
              >
                <Image
                  src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/with-2.svg"
                  alt={t('deposit')}
              ...
              <div className="px-4 pt-2">
                <div className="grid grid-cols-2 gap-3">
                  <Link
                    ...
                    className="flex items-center justify-center gap-2 rounded-md border border-[#FFFFFF1A] bg-[#121621] px-4 py-3 text-white transition-all duration-200 hover:border-[#51A2FF] hover:bg-white/5"
                  >
                    <img
            ...
            <div className="mt-auto space-y-3 p-4">
              ...
              >
                <LazyImage
                  ...
                  width={25}
                  height={25}
                  className="animate-float h-auto w-full rounded-[10px] shadow-[0_0_20px_#51A2FF]"
                />
              </a>
              ...
              {isAuth && (
                <div className="border-t border-[#6456bd54] pt-4">
                  <button
                    ...
                    className="btn-hover-outline w-full cursor-pointer rounded-full border border-[#FF0037] bg-[#FF0037] px-6 py-3 text-base font-medium text-white transition-colors duration-200"
                  >
                    {t('logout')}
                  </button>
                </div>

...
const AccountDetailField = memo(({ label, value, canCopy = false, onCopy }) => (
  <div className="mb-6 flex flex-col md:flex-row md:items-center md:gap-4">
    ...
    <div className="flex h-[46px] w-full items-center justify-between gap-2 rounded-[6px] border border-[#FFFFFF66] bg-[#ffffff17] px-3 text-white md:w-2/3">
      <span className="text-xs break-all sm:text-sm">{value}</span>
      {canCopy && (
        <button
...
const DropdownOption = memo(({ option, onSelect, field }) => (
  <div
    key={option}
    className="cursor-pointer px-3 py-2 text-xs text-white transition-colors duration-150 hover:bg-[#51A2FF] md:text-sm"
    onClick={() => {
  ...
  return (
    <div className="space-y-6 text-white">
      ...
      <div className="mb-4 flex flex-wrap items-center gap-2 sm:gap-4">
        <button
          onClick={handleBack}
          className="rounded text-white transition-colors hover:text-gray-300 focus:ring-2 focus:ring-[#51A2FF] focus:outline-none"
        >
          <Image
        ...
        <div className="flex items-center gap-2 rounded bg-[#241866] px-3 py-2 text-xs sm:text-sm">
          <Image
      ...
      <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                render={({ field }) => (
                  <div className="flex w-full flex-col gap-1">
                    <div className="relative w-full" ref={sendingDropdownRef}>
                      <div
                        className={`relative flex h-[46px] w-full cursor-pointer appearance-none items-center justify-between rounded-[6px] border px-3 py-3 text-white focus:z-10 focus:ring-1 focus:outline-none sm:text-sm ${
                          errors.sendingOption
                            ? 'border-red-500 focus:border-red-500 focus:ring-red-500'
                            : 'border-[#51a2ff8a] bg-[#03071E] focus:border-[#51A2FF] focus:ring-[#51A2FF]'
                        }`}
                        onClick={() => setIsSendingOpen(!isSendingOpen)}
                      >
                        <span
                          className={`text-xs md:text-sm ${
                            field.value ? 'text-white' : 'text-[#B3A6FF]'
                          }`}
                        >
                      ...
                      {isSendingOpen && (
                        <div className="absolute z-20 mt-1 max-h-56 w-full overflow-auto rounded-[6px] border border-[#51a2ff8a] bg-[#241866] shadow-xl">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Input
                    ...
                    className="relative block h-[46px] w-full appearance-none rounded-[6px] border border-[#51a2ff8a] bg-[#03071E] px-3 py-3 text-white placeholder:text-xs placeholder:text-[#FFFFFF66] placeholder:capitalize focus:z-10 focus:border-[#51A2FF] focus:ring-1 focus:ring-[#51A2FF] focus:outline-none sm:text-sm md:placeholder:text-sm"
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Input
                    ...
                    className="relative block h-[46px] w-full appearance-none rounded-[6px] border border-[#51a2ff8a] bg-[#03071E] px-3 py-3 text-white placeholder:text-xs placeholder:text-[#FFFFFF66] focus:z-10 focus:border-[#51A2FF] focus:ring-1 focus:ring-[#51A2FF] focus:outline-none sm:text-sm md:placeholder:text-sm"
            ...
            <div className="mb-4 sm:mb-6">
              ...
              <Controller
                ...
                render={({ field: { onChange } }) => (
                  <div className="flex w-full flex-col gap-1">
                    <div
                      className={`flex w-full flex-wrap items-center gap-3 rounded-[6px] border px-3 py-2 transition-colors focus-within:z-10 focus-within:ring-1 focus-within:outline-none ${
                        errors.receiptFile
                          ? 'border-red-500 focus-within:border-red-500 focus-within:ring-red-500'
                          : 'border-[#51a2ff8a] bg-[#03071E] focus-within:border-[#51A2FF] focus-within:ring-[#51A2FF] hover:border-[#51A2FF]'
                      }`}
                      onDragOver={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                    ...
                    >
                      <div
                        className={`btn-style901 rounded-md bg-[#51A2FF] px-4 py-2 text-xs text-white transition-opacity focus-within:ring-2 focus-within:ring-[#51A2FF] focus-within:outline-none hover:bg-[#4a96e6] ${
                          isFileDialogOpening
            ...
            <div className="mt-6 space-y-3">
                      ...
                      <span
                        ...
                        className={`grid h-5 w-5 flex-shrink-0 place-items-center rounded-[3px] border-2 transition-all duration-200 ${
                          field.value
                            ...
                            : 'border-[#5343B1] bg-transparent hover:border-[#51A2FF]'
                        }`}
                      >
                        <svg
                          viewBox="0 0 24 24"
              ...
              <div className="mt-6 flex flex-row justify-center gap-3 sm:gap-4">
                <button
                  type="button"
                  onClick={handleBack}
                  className="btn-style503 btn-style901 inline-flex items-center justify-center rounded-[8px] border border-[#51A2FF] bg-transparent px-6 py-3 text-[14px] text-white transition-colors hover:bg-[#51A2FF]/10"
                >
                  {t('back')}
                </button>
                <button
                  ...
                  className="btn-style901 inline-flex items-center justify-center rounded-[8px] bg-[#51A2FF] px-6 py-3 text-[14px] text-white transition-opacity hover:bg-[#4a96e6] disabled:cursor-not-allowed disabled:opacity-50"
        ...
        <div className="order-1 h-max rounded-[16px] border border-[#FFFFFF66] bg-black p-5 md:sticky md:top-4 md:order-2">
          ...
          <div className="mt-4 text-[12px]">
            <span className="font-semibold text-[#51A2FF]">{t('note')}:</span>

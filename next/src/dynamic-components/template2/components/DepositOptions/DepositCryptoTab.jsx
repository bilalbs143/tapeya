...
import CryptoPaymentDetails from '@/dynamic-components/template2/components/CryptoPaymentDetails/CryptoPaymentDetails';
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-center">
            ...
            <button
              ...
              className="btn-style901 inline-flex h-[46px] w-full items-center justify-center rounded-[8px] bg-[#51A2FF] px-6 text-[14px] text-white transition-opacity hover:bg-[#4a96e6] disabled:cursor-not-allowed disabled:opacity-50 md:w-auto"
            >
              {renderButtonContent()}
            </button>
          </div>

...
import { cancelCryptoDeposit } from '@/website/websiteAction.js';
...
const CryptoPaymentDetails = ({ paymentData, onClose, onCancelSuccess }) => {
  ...
  const renderAmountDisplay = () => (
    <div className="rounded-[10px] border border-[#FFFFFF66] bg-black px-4 py-4">
      <div className="text-center text-base font-bold md:text-lg">
        ...
        <span className="text-[#51A2FF]">{displayAmount.currency}</span>
      </div>
    </div>
  );
  ...
  const renderCryptoAmountDisplay = () => (
    <div className="rounded-[10px] border border-[#FFFFFF66] bg-black px-4 py-4">
      <div className="text-center text-base font-bold md:text-lg">
        ...
        <span className="text-[#51A2FF]">{cryptoAmount.currency}</span>
      </div>
    </div>
  );
  ...
  const renderQRCode = () => {
    ...
    return (
      <div className="flex flex-col items-center">
        ...
        <div className="mt-3 text-xs tracking-wide text-[#51A2FF] uppercase">
          {t('scan_to_pay')}
        </div>
      </div>
    );
  ...
  const renderAddressSection = () => (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-stretch">
      ...
      <button
        className="btn-style901 w-full rounded-[10px] bg-[#51A2FF] px-5 py-3 text-sm font-bold text-white hover:bg-[#51A2FF] sm:w-[270px]"
        onClick={() => copyToClipboard(paymentData.pay_address)}
      >
        {t('copy')}
      </button>
    ...
    <div className="rounded-[16px] border border-[#FFFFFF66] bg-transparent p-5">
        ...
        <div className="md:col-span-2">
          ...
          <div className="rounded-[8px] border border-[#FFFFFF66] bg-transparent px-6 py-8 text-white">
            <div className="flex flex-col gap-3 md:flex-row md:items-center">
              ...
              <div className="text-center text-2xl font-bold text-[#51A2FF] select-none md:hidden">
                =
              </div>
              <div className="hidden px-2 text-center text-2xl font-bold text-[#51A2FF] select-none md:block">
                =
              </div>
      ...
      <div className="mt-6">
        <button
          ...
          className="w-full rounded-[10px] border-2 border-[#51A2FF] bg-transparent px-5 py-3 text-sm font-bold text-white transition-all hover:bg-[#51A2FF] hover:text-white disabled:cursor-not-allowed disabled:opacity-50"
        >

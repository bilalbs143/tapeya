      ...
      <div className="rounded-[16px] bg-[#241866] p-5">
        <div className="mb-4 flex items-center justify-between">
          ...
          <button
            onClick={onClose}
            aria-label="close"
            className="btn-hover-outline group flex h-7 w-7 items-center justify-center rounded-md border border-[#51A2FF] bg-transparent text-white"
          >
            <svg
              width="16"
              height="16"
  ...
  return (
    <div className="rounded-[16px] bg-[#241866] p-5">
      ...
      <div className="mb-6">
        ...
        <div className="rounded-[12px] bg-[#2E2070] px-5 py-4 text-white">
      ...
      <div className="">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-stretch">
          ...
          <button
            className="w-full rounded-[10px] bg-[#FF8C24] px-5 py-3 text-sm font-bold text-white hover:bg-[#51A2FF] disabled:opacity-50 sm:w-[270px]"
            onClick={() =>
              copyToClipboard(withdrawalData?.withdraw_address || '')
            }
            disabled={!withdrawalData?.withdraw_address}

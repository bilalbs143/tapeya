      ...
      <div className="space-y-4">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div className="mb-0 space-y-4">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                <div>
                  ...
                  <input
                    ...
                    disabled
                    type="text"
                    className="h-[46px] w-full cursor-not-allowed rounded-[6px] border border-[#FFFFFF66] bg-[#ffffff17] px-3 text-[12px] text-white md:px-4 md:text-[14px]"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    disabled
                    type="text"
                    className="h-[46px] w-full cursor-not-allowed rounded-[6px] border border-[#FFFFFF66] bg-[#ffffff17] px-3 text-[12px] text-white placeholder:text-xs placeholder:text-[#FFFFFF66] md:px-4 md:text-[14px]"
                  />
                </div>
            ...
            {/* Separator Line */}
            <div className="my-8 h-px w-full bg-[#51a2ff30]" />
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input
                      ...
                      className="relative block h-[46px] w-[100%] appearance-none rounded-[5px] border border-[#51a2ff8a] bg-[#03071E] px-3 py-3 text-white placeholder:text-xs placeholder:text-[#FFFFFF66] autofill:bg-[#03071E] autofill:shadow-[inset_0_0_0px_1000px_#03071E] autofill:[-webkit-text-fill-color:white] focus:z-10 focus:border-[#51A2FF] focus:ring-1 focus:ring-[#51A2FF] focus:outline-none sm:text-sm md:px-4 md:text-[14px] md:placeholder:text-sm"
                      step="1000"
        ...
        {/* Separator Line */}
        <div className="mt-8 h-px w-full bg-[#51a2ff30]" />
      </div>

...
import GameCard from '@/dynamic-components/template2/components/GameCard/GameCard';
        ...
        {selectedProviderId && (
          <div className="mb-4 flex items-center gap-2 sm:gap-3">
            <div className="flex items-center justify-center">
              <LazyImage
                src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/game-title-icon.svg"
                alt="Provider icon"
                width={24}
                height={24}
            ...
            <h3 className="text-lg leading-tight font-extrabold text-white sm:text-xl md:text-2xl">
        ...
        <div className="mt-6 flex flex-col items-center justify-center gap-4">
          {hasMore && (
            <button
              ...
              className="inline-flex transform cursor-pointer items-center justify-center rounded-full bg-[#51A2FF] px-8 py-3 font-semibold text-white transition-all hover:scale-105 hover:bg-[#51A2FF]/90 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
            >
          ...
          {accumulatedGames.length > 60 && (
            <button
              onClick={scrollToTop}
              className="inline-flex transform cursor-pointer items-center justify-center rounded-full border-2 border-[#51A2FF] bg-[#51A2FF]/10 px-6 py-3 font-semibold text-[#51A2FF] transition-all hover:scale-105 hover:bg-[#51A2FF]/20 active:scale-95"
            >
              <svg
        ...
        {currentPage === 1 &&
          ...
          <div className="py-16">
            <div className="flex flex-col items-center space-y-4">
              <CommonLoader size="xl" border="border-[#51A2FF]" />
          ...
          <div className="py-8 text-center">
            <div className="mx-auto max-w-md">
              ...
              <button
                ...
                className="btn-hover-fill rounded-full bg-[#51A2FF] px-4 py-2 text-white"

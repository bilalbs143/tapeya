    ...
    return (
      <div ref={dropdownRef} className="relative z-[1001] inline-block">
        <button
          ...
          className={`btn-hover-outline group inline-flex h-[35px] items-center gap-2 rounded-[6px] border border-[#FFFFFF66] bg-[#000304] pr-2 pl-4 text-white transition-all hover:border-[#51A2FF] hover:shadow-[inset_0_0_6px_1px_#51A2FF] md:h-[30px] ${
        ...
        {open && !isSavingToBackend && (
          <div
            className="absolute right-0 z-[1002] mt-2 w-32 overflow-hidden rounded-[10px] border border-[#FFFFFF66] bg-[#000304] shadow-lg"
            role="listbox"
          ...
          >
            {locales.map((locale, idx) => (
              <button
                ...
                className={`group flex w-full items-center gap-2 px-3 py-2 text-left text-white transition-all hover:bg-[#51A2FF] ${
                  idx < locales.length - 1 ? 'border-b border-[#FFFFFF66]' : ''

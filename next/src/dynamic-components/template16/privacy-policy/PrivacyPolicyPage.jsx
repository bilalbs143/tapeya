      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="">
          ...
          <div
            ...
            style={{ borderColor: 'rgba(211, 175, 55, 0.28)' }}
          >
            <div className="p-8 md:p-12">
              {/* Header */}
              <div className="mb-8">
                <h1 className="mobile-title mb-4 bg-[#E8D25E] bg-clip-text text-[25px] font-semibold text-transparent">
              ...
              <div className="space-y-6">
                ...
                <h2 className="mobile-section-heading mt-8 mb-4 bg-gradient-to-r from-[#D3AF37] via-[#FFF788] to-[#D3AF37] bg-clip-text font-bold text-transparent">
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="mobile-subsection-heading mb-2 bg-gradient-to-r from-[#D3AF37] via-[#FFF788] to-[#D3AF37] bg-clip-text font-bold text-transparent">
                ...
                <h3 className="mobile-subsection-heading mt-6 mb-2 font-bold text-white">

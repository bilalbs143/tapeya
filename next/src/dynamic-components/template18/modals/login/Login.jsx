...
export default function Login() {
  ...
  return (
    <div
      className={`fixed top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2 transform bg-[#080E1B] text-white shadow-xl transition-all duration-300 ease-out md:h-[561px] md:w-[920px] ${
    ...
    >
      ...
      <div className="grid h-full w-full grid-cols-1 overflow-hidden rounded-[5px] md:grid-cols-[1fr_420px]">
          ...
          <div className="w-full max-w-[440px] px-2">
            ...
            <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
              <Controller
                ...
                render={({ field }) => (
                  <Input
                    ...
                    className="h-[50px] w-full rounded-[3px] border border-[#FFB7034D] bg-[#0F50451A] px-4 text-white placeholder:text-[#FFFFFFAA] focus:border-[#FFB703]"
              ...
              <button
                ...
                className="template18-filled-button-hover w-full rounded-[50px] bg-[#FFB703] py-3.5 text-[16px] font-extrabold text-white transition-all active:scale-95 disabled:opacity-50"
              >
              ...
              <button
                ...
                className="template18-bordered-button-hover w-full rounded-[50px] bg-[#14213D] py-3.5 text-[16px] font-extrabold transition-all active:scale-95"
              >
        ...
        <div className="relative hidden md:block">
          {/* Image */}
          <img
            src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/Login-15.png"
            alt="Login Visual"

...
export default function Register(props) {
  ...
  return (
    <div
      className={`mx-auto max-h-[90vh] w-full max-w-[1026px] transform overflow-y-auto bg-[#080E1B] text-white shadow-xl transition-all duration-300 ease-out md:h-[480px] md:max-h-[480px] md:overflow-visible ${
          ...
          <div className="w-full max-w-[935px]">
            ...
            <form className="space-y-4 pt-2" onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        ...
                        className="w-full rounded-[4px] border border-[#FFB7034D] bg-[#0F50451A] focus:border-[#FFB703] focus:ring-0 focus:outline-none"
                      />
                    )}
                  />
                </div>
                ...
                <div className="overflow-visible">
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      ...
                      >
                        <SelectTrigger className="w-full rounded-[4px] border border-[#FFB7034D] bg-[#0F50451A]">
                          <SelectValue placeholder={t('select_bank')} />
                        </SelectTrigger>

                        {/* select bank*/}
                        <SelectContent className="z-[9999] border-[#FFB7034D] bg-[#0E0E0E] text-white">
              ...
              <button
                ...
                className="template18-filled-button-hover mt-5 w-full rounded-[50px] bg-[#FFB703] py-3 font-semibold text-white transition active:scale-95 disabled:opacity-50"
              >

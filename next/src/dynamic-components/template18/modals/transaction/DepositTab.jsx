...
import DepositBankTab from '@/dynamic-components/template18/components/DepositOptions/DepositBankTab';
import DepositCryptoTab from '@/dynamic-components/template18/components/DepositOptions/DepositCryptoTab';
import DepositDebitTab from '@/dynamic-components/template18/components/DepositOptions/DepositDebitTab';
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-4">
        {/* Tabs header */}
        <div className="mt-4 mb-[12px] rounded-[5px] border border-[#11234D] p-[2px] md:mt-4">

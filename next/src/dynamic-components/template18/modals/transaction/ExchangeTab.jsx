...
export default function ExchangeTab() {
  ...
  return (
    <div className="space-y-6 rounded-[5px] border border-[#11234D] p-4">
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2 md:gap-4">
        <div>
          ...
          <div className="relative" ref={convertDropdownRef}>
            <div
              id="convert-select"
              className="relative flex h-[46px] w-full cursor-pointer appearance-none items-center justify-between rounded-[5px] border border-[#FFB7034D] bg-[#14213D] px-3 py-3 text-[12px] text-white focus:border-[#FFB703] focus:ring-1 focus:ring-[#FFB703] focus:outline-none md:text-[14px] lg:h-[55px]"
            ...
            {isConvertDropdownOpen && (
              <div className="scrollbar-hide absolute z-[99999] mt-1 max-h-[150px] w-full overflow-y-auto rounded-[5px] border border-[#FFB7034D] bg-[#14213D] shadow-lg">
                <div
                  className="cursor-pointer px-3 py-2 text-[12px] text-white transition-colors duration-150 hover:bg-[#FFB703] md:text-[14px]"
                  onClick={() => {
                    setConvertType('points_exchange');
                    setIsConvertDropdownOpen(false);
                  }}
        ...
        <div>
          ...
          <div
            id="available-amount"
            className="flex h-[46px] w-full items-center rounded-[5px] border border-[#FFB7034D] bg-[#14213D] px-3 py-3 text-[12px] text-[#FFFFFF80] sm:text-sm md:placeholder:text-sm lg:h-[55px]"
          >
            {convertType === 'points_exchange' ? (
        ...
        <form onSubmit={handleSubmitConvert} className="space-y-4">
          <div className="">
            ...
            <input
              ...
              className="relative block h-[46px] w-full appearance-none rounded-[5px] border border-[#FFB7034D] bg-[#14213D] px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFF66] focus:border-[#FFB703] focus:ring-0 focus:ring-transparent focus:outline-none sm:flex-1 sm:text-sm md:placeholder:text-sm lg:h-[55px]"
              min="1"
              step="1"
            />
          </div>
          <div className="flex justify-end">
            <button
              ...
              className="filled-hover-effect flex cursor-pointer items-center justify-center rounded-[6px] bg-[#FFB703] px-6 pt-3 pb-3 text-[14px] font-semibold text-black transition-all duration-200 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
            >
              <span>

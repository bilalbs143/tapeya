...
export default function CustomerService({
  ...
  return (
    <div className="customer-service-modal relative mx-auto flex h-[80vh] w-full max-w-[1479px] flex-col overflow-hidden bg-[#080E1B] text-white shadow-xl">
      <div className="flex min-h-0 flex-1 flex-col space-y-4 p-4 md:space-y-6 md:p-6 lg:p-8">
        ...
        {/* Content Box */}
        <div className="scrollbar-hide mt-3 min-h-0 flex-1 overflow-y-auto rounded-[7px] border border-[#11234D80] p-3 md:p-4 lg:p-4">
          {/*  Profile */}
          {activeTab === 'profile' && (

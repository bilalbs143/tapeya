            ...
            return (
              <div
                ...
                className={`overflow-hidden rounded-[3px] border text-white transition-colors duration-200 ${
                  isOpen
                    ? 'border-[#11234D4D] bg-[#081126] p-3'
                    : 'border-[#11234D80] py-2'
                }`}
              >
                <button
                ...
                >
                  <div className="flex w-full items-center justify-between px-4 py-3">
                    ...
                    {/* + / − icon  */}
                    <span
                      className={`flex h-6 w-6 items-center justify-center rounded-full ${isOpen ? 'text-[#FFB703]' : 'text-[#003199]'} `}
                    >
                  ...
                  {isOpen && (
                    <div className="mx-auto mb-1 h-[1px] w-[90%] bg-[#11234D] md:w-[97%]" />
                  )}
                </button>

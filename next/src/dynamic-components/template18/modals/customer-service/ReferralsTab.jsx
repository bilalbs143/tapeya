...
export default function ReferralsTab() {
  ...
  return (
    <div className="flex h-full flex-col p-3">
          ...
          <div className="flex h-full flex-col items-center justify-center md:items-end">
            <div className="flex flex-col items-center gap-2">
              ...
              <button
                ...
                className="filled-hover-effect mt-2 flex w-[291px] cursor-pointer items-center justify-center gap-2 rounded-[3px] bg-[#FFB703] px-4 pt-2.5 pb-2.5 text-[13px] font-extrabold text-white active:scale-95 md:w-[191px] md:rounded-[5px]"
              >
      ...
      <div className="mx-auto mb-7 h-[1px] bg-[#11234D80] md:w-full" />
        ...
        <div className="flex h-[400px] flex-col md:h-[500px]">
          <div className="overflow-x-auto md:overflow-x-visible">
            <div className="inline-block w-full min-w-[900px] align-top md:min-w-[1100px]">
              {/* Table Header */}
              <div className="overflow-hidden rounded-t-[8px] border border-b-0 border-[#11234D]">
              ...
              {/* Table Body */}
              <div className="show-scrollbar flex-1 overflow-y-auto rounded-b-[8px] border border-t-0 border-[#11234D]">
                {referralsLoader ? (

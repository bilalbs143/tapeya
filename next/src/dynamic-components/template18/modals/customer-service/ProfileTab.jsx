...
export default function ProfileTab() {
  ...
  return (
    <div className="space-y-6 rounded-[3px] border border-[#11234D80] p-6">
      ...
      {/* Separator Line */}
      <div className="my-8 h-px w-full bg-[#11234D80]" />
        ...
        <form onSubmit={handleSubmit(handlePasswordChange)}>
          ...
          <div className="mt-6 flex justify-end">
            ...
            <button
              ...
              className="filled-hover-effect hidden cursor-pointer items-center justify-center rounded-[4px] bg-[#FFB703] px-7 pt-3 pb-3 text-[14px] font-extrabold text-black transition-all duration-200 hover:bg-[#FFB703] active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 sm:flex"
              data-hover={
            ...
            <button
              type="submit"
              disabled={updatePasswordLoader}
              className="filled-hover-effect mx-auto flex w-[98%] cursor-pointer items-center justify-center rounded-[4px] bg-[#FFB703] pt-3 pb-3 text-[14px] font-extrabold text-white transition-all duration-200 hover:bg-[#FFB703] active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 sm:hidden"
              data-hover={
                updatePasswordLoader ? t('processing') : t('change_password')
              }
            >

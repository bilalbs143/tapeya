        ...
        <div className="mt-6 flex flex-col items-center justify-center gap-4">
          {hasMore && (
            <button
              ...
              className="inline-flex transform cursor-pointer items-center justify-center rounded-[5px] bg-[#FFB703] px-8 py-3 font-semibold text-[#000000] transition-all hover:scale-105 hover:bg-[#F1A800] active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
            >
          ...
          {accumulatedGames.length > 60 && (
            <button
              onClick={scrollToTop}
              className="inline-flex transform cursor-pointer items-center justify-center rounded-[10px] bg-[#FFB703] px-6 py-3 font-semibold text-[#000000] transition-all hover:scale-105 hover:bg-[#F1A800] active:scale-95"
            >
              {t('back_to_top')}
            </button>
          )}

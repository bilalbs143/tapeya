...
import TransactionDetail from '@/dynamic-components/template18/components/TransactionDetail/TransactionDetail.jsx';
    ...
    <div className="space-y-6">
      {showDetails ? (
        ...
        <>
          ...
          <div className="overflow-hidden rounded-[9px] border border-[#11234D]">
                    ...
                    requestInfoData.data.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-1 py-2 md:px-2 md:py-3">
                          <span className="text-[#FFB703] transition-all duration-200">
                        ...
                        <td className="px-2 py-2 text-center md:px-2 md:py-3">
                          <button className="btn-hover-outline hover:bg-[#FFB703] hover:text-black rounded-[6px] border border-[#11234D] bg-transparent px-3 py-1 text-xs font-medium text-white transition-colors duration-200">
                            {t('details')}
                          </button>
                        </td>
                      </tr>

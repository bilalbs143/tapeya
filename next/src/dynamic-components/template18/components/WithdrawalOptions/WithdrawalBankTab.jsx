                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                  <div>
                    ...
                    <input
                      ...
                      disabled
                      type="text"
                      className="h-[46px] w-full cursor-not-allowed rounded-[3px] border border-[#FFB7034D] bg-[#14213D] px-3 py-3 text-[12px] text-[#FFFFFF80] shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)] placeholder:text-[#FFFFFF66] focus:border-[#FFB703] sm:text-sm md:placeholder:text-sm lg:h-[55px]"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      disabled
                      type="text"
                      className="h-[46px] w-full cursor-not-allowed rounded-[3px] border border-[#FFB7034D] bg-[#14213D] px-3 py-3 text-[12px] text-[#FFFFFF80] shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)] placeholder:text-[#FFFFFF66] focus:border-[#CBBC91] sm:text-sm md:placeholder:text-sm lg:h-[55px]"
                    />
                  </div>
              ...
              <div className="flex w-full flex-col gap-2">
                ...
                <div className="flex w-full flex-col sm:flex-row sm:items-center sm:gap-3">
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        ...
                        className="relative block h-[46px] w-full appearance-none rounded-[3px] border border-[#FFB7034D] bg-[#14213D] px-3 py-3 text-white placeholder:text-xs placeholder:text-[#FFFFFF66] focus:border-[#FFB703] focus:ring-0 focus:ring-transparent focus:outline-none sm:h-[55px] sm:flex-1 sm:text-sm md:w-[99%] md:placeholder:text-sm"
                        step="1000"
                  ...
                  <button
                    ...
                    className="template18-filled-button-hover flex cursor-pointer items-center justify-center rounded-[4px] bg-[#FFB703] px-6 pt-2 pb-2 text-[13px] font-normal text-black transition-all duration-200 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
                    data-hover={
                      transactionRequestLoader
                        ? t('processing')
                        : t('send_your_request')

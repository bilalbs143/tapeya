          ...
          <div className="flex flex-wrap gap-2">
            {tabs.map((tab) => (
              <button
                ...
                className={`mobile-tab-button rounded-[4px] border border-[#11234D] px-3 py-2 text-sm transition-colors duration-200 focus:ring-0 focus:outline-none focus-visible:outline-none sm:px-4 sm:py-3 sm:text-base ${
                  activeTab === tab.key

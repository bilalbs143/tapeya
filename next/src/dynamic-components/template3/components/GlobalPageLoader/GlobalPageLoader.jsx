...
const GlobalPageLoader = () => {
  ...
  // Animated loading dots component with golden theme
  const LoadingDots = () => (
    <div className="flex items-center space-x-2">
      <div
        className="h-3 w-3 rounded-full"
        style={{
          background: 'linear-gradient(135deg, #D3AF37, #FFF788)',
          boxShadow:
            '0 0 15px rgba(211, 175, 55, 0.6), 0 0 25px rgba(255, 247, 136, 0.4)',
      ...
      <div
        className="h-3 w-3 rounded-full"
        style={{
          background: 'linear-gradient(135deg, #FFF788, #D3AF37)',
          boxShadow:
            '0 0 15px rgba(255, 247, 136, 0.6), 0 0 25px rgba(211, 175, 55, 0.4)',
          animation: 'bounce 1s ease-in-out infinite',
        ...
        >
          {[...rotatedSymbols, ...rotatedSymbols].map((symbol, i) => (
            <div
              ...
              style={{
                textShadow: '0 0 20px rgba(211, 175, 55, 0.8)',
              }}
            >
              {symbol}
            </div>
    ...
    >
      ...
      <defs>
        <linearGradient
          ...
          y2="100%"
        >
          <stop offset="0%" stopColor="#D3AF37" />
          <stop offset="50%" stopColor="#FFF788" />
      ...
      <div className="relative z-10 flex flex-col items-center space-y-6 sm:space-y-8">
        ...
        <div
          ...
          style={{
            ...
            boxShadow:
              '0 10px 40px rgba(0, 0, 0, 0.6), 0 0 40px rgba(211, 175, 55, 0.2)',
            border: '2px solid #D3AF37',
          }}
        >
          {/* Slot Machine Header */}
          <div className="mb-3 text-center sm:mb-5">
            <div className="mb-2 flex items-center justify-center gap-1.5 text-lg sm:mb-3 sm:gap-2 sm:text-3xl">
              <span
                ...
                style={{
                  animation: 'bounce 1s ease-in-out infinite',
                  textShadow: '0 0 20px rgba(211, 175, 55, 0.9)',
                }}
              >
                🎰
              </span>
              <span
                ...
                style={{
                  background:
                    'linear-gradient(90deg, #D3AF37, #FFF788, #D3AF37)',
            ...
            <div className="h-1 w-full overflow-hidden rounded-full bg-black/80 sm:h-1.5">
              <div
                ...
                style={{
                  background:
                    'linear-gradient(90deg, #D3AF37, #FFF788, #D3AF37)',
                  boxShadow: '0 0 10px rgba(255, 247, 136, 0.5)',
            ...
            {['💎', '👑', '⭐'].map((symbol, i) => (
              <div
                ...
                style={{
                  ...
                  textShadow: '0 0 15px rgba(211, 175, 55, 0.8)',
                }}
              >
                {symbol}
              </div>

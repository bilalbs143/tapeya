          ...
          >
            ...
            >
              ...
              <button
                ...
                aria-label={t('close')}
                className="bg-opacity-50 hover:bg-opacity-75 flex h-8 w-8 flex-shrink-0 cursor-pointer items-center justify-center rounded-full border-2 border-[#D3AF37] bg-black leading-none font-bold text-white transition-all duration-300 hover:scale-110"
                style={{
                  position: 'absolute',
            ...
            >
              <button
                ...
                className="flex w-full cursor-pointer items-center justify-center rounded-b-lg bg-[#E8D25E] px-4 pt-3 pb-4 text-sm font-semibold text-black [box-shadow:inset_0_-6px_0_#876800] active:scale-95"
              >

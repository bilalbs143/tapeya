          ...
          <div className="flex flex-wrap gap-2">
            {tabs.map((tab) => (
              <button
                ...
                className={`flex items-center gap-2 border-b p-1 font-bold transition-all duration-300 focus:ring-0 focus:outline-none focus-visible:outline-none sm:px-4 sm:py-3 sm:text-base ${activeTab === tab.key
                  ? 'border-b-2 border-[#06D6A04D] text-[#06D6A0]'

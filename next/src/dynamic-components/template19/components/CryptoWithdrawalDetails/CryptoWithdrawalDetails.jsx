  ...
  return (
    <div className="rounded-[7px] border border-[rgba(6,214,160,0.3)] bg-[#14213D]/80 p-5">
      ...
      <div className="mb-8">
        ...
        <div className="rounded-[12px] border border-[rgba(6,214,160,0.3)] bg-transparent px-6 py-8 text-white">
      ...
      <div className="mb-6">
        ...
        <div className="rounded-[12px] bg-[#14213D] px-5 py-4 text-white">
      ...
      <div className="">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-stretch">
          <div className="flex-1 rounded-[12px] border border-[rgba(6,214,160,0.3)] bg-[#14213D] px-3 py-3 text-white">
          ...
          <button
            className="template10-filled-button-hover w-full rounded-[10px] bg-[#06D6A0] px-5 py-3 text-sm font-bold text-white transition-all duration-200 active:scale-95 disabled:opacity-50 sm:w-[270px]"
            onClick={() =>
              copyToClipboard(withdrawalData?.withdraw_address || '')
            }
            disabled={!withdrawalData?.withdraw_address}
      ...
      <div className="mt-6">
        ...
        <div className="text-grey-400 rounded-[12px] bg-[#14213D] px-5 py-4">

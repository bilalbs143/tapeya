...
export default function DepositBankTab() {
  ...
  const PaymentMethodCard = ({ method, methodType }) => (
    <button
      ...
      className="flex h-[64px] w-full cursor-pointer items-center justify-center rounded-[10px] border bg-white transition-all duration-300 hover:border-[#FFFFFF66] hover:shadow-[0_5.062px_30.375px_0_#4E5057_inset,0_4.05px_14.175px_0_rgba(0,0,0,0.25)] sm:h-[75px]"
    >
    ...
    return (
      <div className="mb-3 space-y-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-[#FEA803] md:text-sm">
            ({approvalType})
          </span>
        </div>
        ...
        {!isLast && (
          <div className="py-4">
            <div className="border-opacity-50 w-full border-b border-[rgba(6,214,160,0.3)]" />
          </div>
        )}
      </div>
    );

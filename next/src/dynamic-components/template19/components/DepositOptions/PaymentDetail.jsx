  ...
  <div className="mb-6 flex flex-col md:flex-row md:items-center md:gap-4">
    ...
    <div className="relative md:w-2/3">
      <input
        ...
        value={value}
        readOnly
        className="h-[46px] w-full cursor-not-allowed rounded-[5px] border border-[#272727] px-3 py-3 pr-12 text-[12px] text-[#FFFFFF80] placeholder:text-[#FFFFFF66] sm:text-sm md:placeholder:text-sm lg:h-[55px]"
      />
      {canCopy && (
        <button
...
const DropdownOption = memo(({ option, onSelect, field }) => (
  <div
    key={option}
    className="cursor-pointer px-3 py-2 text-xs text-white transition-colors duration-150 hover:bg-[#06D6A0] md:text-sm"
    onClick={() => {
...
export default function ConfirmPaymentDetail({
  ...
  return (
    <div className="space-y-6 text-white">
      {/* Header */}
      <div className="mb-4 flex flex-wrap items-center gap-2 sm:gap-4 md:p-4">
        <button
          onClick={handleBack}
          className="border-[#FFFFFF66] text-white transition-colors hover:text-gray-300 focus:ring-2 focus:ring-[#5AB25A] focus:outline-none"
        >
          <Image
        ...
        <div className="flex items-center gap-2 rounded border border-[rgba(6,214,160,0.1)] bg-[#14213D] px-3.5 py-2 text-xs sm:text-sm">
          <Image
        ...
        <span className="text-xs text-[#FFFFFF66] sm:text-sm">
          ({t('manual_approved')}) {t('deposit_amount')} {getCurrency()}
        </span>
      </div>

      {/* Two-column layout: left form, right account details */}
      <div className="mt-8 grid grid-cols-1 gap-6 px-2 md:grid-cols-2">
        ...
        <div className="order-2 md:order-1">
          ...
          >
                ...
                render={({ field }) => (
                  <div className="flex w-full flex-col gap-1">
                    <div className="relative w-full" ref={sendingDropdownRef}>
                      <div
                        className={`relative flex h-[46px] w-full cursor-pointer appearance-none items-center justify-between rounded-[5px] border px-3 py-3 text-white shadow-none focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm lg:h-[55px] ${
                          errors.sendingOption
                            ...
                            : 'border-[rgba(6,214,160,0.3)] bg-[#14213D] focus:border-[rgba(6,214,160,0.6)]'
                        }`}
                      ...
                      {isSendingOpen && (
                        <div className="absolute z-20 mt-1 max-h-56 w-full overflow-auto rounded-[5px] border border-[rgba(6,214,160,0.3)] bg-[#14213D] shadow-xl">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Input
                    ...
                    className="relative block h-[46px] w-full appearance-none rounded-[5px] border border-[rgba(6,214,160,0.3)] bg-[#14213D] px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFFB2] placeholder:capitalize focus:border-[rgba(6,214,160,0.6)] focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:h-[55px]"
              ...
              <Controller
                ...
                render={({ field: { onChange } }) => (
                  <div className="flex w-full flex-col gap-1">
                    <div
                      className={`flex w-full flex-wrap items-center gap-3 rounded-[5px] border px-3 py-2 shadow-none transition-colors focus-within:ring-0 focus-within:ring-transparent focus-within:outline-none ${
                          errors.receiptFile
                            ...
                            : 'border-[rgba(6,214,160,0.3)] bg-[#14213D] focus-within:border-[rgba(6,214,160,0.6)] hover:border-[#06D6A0]'
                      }`}
                      onDragOver={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                    ...
                    >
                      <div
                        className={`template10-filled-button-hover rounded-md bg-[#06D6A0] px-6 py-2 text-xs font-semibold text-white transition-opacity focus-within:ring-2 focus-within:ring-[#06D6A0] focus-within:outline-none active:scale-95 ${
                          isFileDialogOpening
            ...
            <div className="mt-6 space-y-3">
                    ...
                    >
                      ...
                      <span
                        ...
                        className={`grid h-5 w-5 flex-shrink-0 place-items-center rounded-[3px] border-2 transition-all duration-200 ${
                          field.value
                            ? 'border-[rgba(6,214,160,0.3)] bg-[#06D6A0]'
                            : 'border-[rgba(6,214,160,0.3)] bg-[#14213D] hover:border-[#06D6A0]'
                        }`}
                      >
                        <svg
                          viewBox="0 0 24 24"
              ...
              <div className="mt-8 flex w-full flex-row justify-center gap-3 sm:gap-4">
                <button
                  type="button"
                  onClick={handleBack}
                  className="inline-flex h-[52px] w-full max-w-[394px] items-center justify-center rounded-[10px] border border-[rgba(6,214,160,0.3)] bg-[#14213D] text-[16px] font-semibold text-white transition-all duration-200 hover:border-[#06D6A0] active:scale-95"
                >
                  <span>{t('back')}</span>
                </button>
                ...
                <button
                  ...
                  className="template10-filled-button-hover flex h-[52px] w-full max-w-[394px] items-center justify-center rounded-[10px] bg-[#06D6A0] text-[16px] font-semibold text-white transition-all duration-200 hover:bg-[#05C191] active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
                  data-hover={isSubmitting ? t('processing') : t('submit')}
                >
                  <span className="text-container">
                    <span className="text">{isSubmitting ? t('processing') : t('submit')}</span>
                  </span>
                </button>
              </div>
            </div>
        ...
        <div className="order-1 h-max rounded-[5px] bg-[#1E1E1E4D] p-5 md:sticky md:top-4 md:order-2">
          ...
          <div className="mt-4 text-[12px]">
            <span className="font-semibold text-[#06D6A0]">{t('note')}:</span>
            <span className="text-[#FFFFFF99] italic">
              {' '}

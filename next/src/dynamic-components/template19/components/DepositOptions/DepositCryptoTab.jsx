...
import CryptoPaymentDetails from '@/dynamic-components/template19/components/CryptoPaymentDetails/CryptoPaymentDetails';
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-center">
            ...
            <button
              ...
              className="template10-filled-button-hover flex w-full cursor-pointer items-center justify-center rounded-[4px] bg-[#06D6A0] px-16 pt-2.5 pb-2.5 text-[16px] font-semibold text-white transition-all duration-200 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 md:w-auto"
            >

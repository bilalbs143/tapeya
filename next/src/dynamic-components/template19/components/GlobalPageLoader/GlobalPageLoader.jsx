...
const GlobalPageLoader = () => {
  ...
  // Memoize theme-colored dots positions (template19 teal palette)
  ...
  // Animated loading dots component with template19 theme colors (teal)
  const LoadingDots = () => (
    <div className="flex items-center space-x-2">
      <div
        className="h-3 w-3 rounded-full"
        style={{
          background: 'linear-gradient(135deg, #06D6A0, #05C191)',
          boxShadow:
            '0 0 15px rgba(6, 214, 160, 0.6), 0 0 25px rgba(5, 193, 145, 0.4)',
      ...
      <div
        className="h-3 w-3 rounded-full"
        style={{
          background: 'linear-gradient(135deg, #05C191, #06D6A0)',
          boxShadow:
            '0 0 15px rgba(5, 193, 145, 0.6), 0 0 25px rgba(6, 214, 160, 0.4)',
          animation: 'bounce 1s ease-in-out infinite',
  ...
  // Poker Chip Component (template19 teal palette)
  const PokerChip = () => (
    <div className="relative">
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            '0 0 30px rgba(6, 214, 160, 0.6), 0 0 60px rgba(5, 193, 145, 0.3)',
        }}
      />
      {/* Middle ring */}
      <div
    ...
    >
        ...
        @keyframes glow {
          ...
          100% {
            box-shadow:
              ...
              0 0 40px rgba(5, 193, 145, 0.2);
          }
          50% {
            box-shadow:
              0 0 30px rgba(6, 214, 160, 0.6),
              0 0 60px rgba(5, 193, 145, 0.4);
          }
        }
        @keyframes slideIn {
          0% {
        ...
        {floatingSuits.map((suit) => (
          <div
            ...
            style={{
              ...
              color: suit.id % 2 === 0 ? '#06D6A0' : '#05C191',
      ...
      >
        ...
        <div className="w-64 sm:w-80 mb-4 sm:mb-6">
          <div className="h-1.5 w-full overflow-hidden rounded-full bg-[#14213D] sm:h-2">
            <div
              className="h-full"
              style={{
                background:
                  'linear-gradient(90deg, #06D6A0, #05C191, #06D6A0)',

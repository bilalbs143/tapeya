...
import TransactionDetail from '@/dynamic-components/template19/components/TransactionDetail/TransactionDetail.jsx';
                    ...
                    <tr>
                      ...
                      >
                        <div className="flex items-center justify-center py-8">
                          <CommonLoader size="lg" border="border-[#06D6A0]" />
                        </div>
                      </td>
                    </tr>
                    ...
                    requestInfoData.data.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-1 py-2 md:px-2 md:py-3">
                          <span className="text-[#06D6A0] transition-all duration-200">

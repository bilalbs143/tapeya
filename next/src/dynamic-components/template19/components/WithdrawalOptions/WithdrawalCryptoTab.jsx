...
import CryptoSelect from '@/dynamic-components/template19/components/CryptoSelect/CryptoSelect';
import CryptoWithdrawalDetails from '@/dynamic-components/template19/components/CryptoWithdrawalDetails/CryptoWithdrawalDetails';
...
export default function WithdrawalCryptoTab() {
  ...
  const verifyButtonClassName = useMemo(() => {
    ...
    return `${baseClasses} bg-[#06D6A0] text-white font-semibold hover:shadow-[0_5px_30px_0_rgba(6,214,160,0.46)_inset]`;
  }, [addressVerificationStatus]);
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              ...
              className="template10-filled-button-hover flex w-full cursor-pointer items-center justify-center rounded-[4px] bg-[#06D6A0] px-16 pt-2.5 pb-2.5 text-[16px] font-semibold text-white transition-all duration-200 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 md:w-auto md:self-end"
            >

  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <input
                        ...
                        disabled
                        type="text"
                        className="h-[46px] w-full cursor-not-allowed rounded-[5px] border border-[rgba(6,214,160,0.3)] bg-[#14213D] px-3 py-3 text-[12px] text-[#FFFFFF80] shadow-none placeholder:text-[#FFFFFFB2] focus:border-[rgba(6,214,160,0.6)] sm:text-sm md:placeholder:text-sm lg:h-[55px] mt-2 block"
                      />
                    </Label>
                  </div>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        ...
                        className="relative block h-[46px] w-full appearance-none rounded-[5px] border border-[rgba(6,214,160,0.3)] bg-[#14213D] px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFFB2] focus:border-[rgba(6,214,160,0.6)] focus:ring-0 focus:ring-transparent focus:outline-none sm:h-[55px] sm:flex-1 sm:text-sm md:w-[99%] md:placeholder:text-sm"
                        step="1000"
        ...
        {/* Separator Line */}
        <div className="mt-8 h-px w-full bg-[rgba(6,214,160,0.3)]" />
      </div>

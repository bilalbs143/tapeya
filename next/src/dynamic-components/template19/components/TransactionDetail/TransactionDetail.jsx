      ...
      <div className={`flex flex-col gap-2 ${className}`}>
        ...
        <div className="flex-1">
          <input
            ...
            value={displayValue}
            readOnly
            className={`h-[46px] w-full cursor-not-allowed rounded-[5px] border border-[rgba(6,214,160,0.3)] bg-[#14213D] px-3 py-3 text-[12px] text-[#FFFFFF80] placeholder:text-[#FFFFFFB2] sm:text-sm md:placeholder:text-sm lg:h-[55px] ${contentClassName}`}
          />
        </div>
      </div>
    );

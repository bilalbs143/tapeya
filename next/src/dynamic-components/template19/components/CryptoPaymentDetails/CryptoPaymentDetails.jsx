...
const CryptoPaymentDetails = ({ paymentData, onClose }) => {
  ...
  const renderAmountDisplay = () => (
    <div className="rounded-[10px] border border-[rgba(6,214,160,0.3)] bg-[#14213D] px-4 py-4">
      <div className="text-center text-base font-bold md:text-lg">
        <span className="text-[#06D6A0]">{displayAmount.amount}</span>{' '}
        <span className="text-[#06D6A0]">{displayAmount.currency}</span>
      </div>
    </div>
  );
  ...
  const renderCryptoAmountDisplay = () => (
    <div className="rounded-[10px] border border-[rgba(6,214,160,0.3)] bg-[#14213D] px-4 py-4">
      <div className="text-center text-base font-bold md:text-lg">
        <span className="text-[#06D6A0]">{cryptoAmount.amount}</span>{' '}
        <span className="text-[#06D6A0]">{cryptoAmount.currency}</span>
      </div>
    </div>
  );
  ...
  const renderQRCode = () => {
    ...
    return (
      <div className="flex flex-col items-center">
        ...
        <div className="mt-3 text-xs tracking-wide text-[#06D6A0] uppercase">
          {t('scan_to_pay')}
        </div>
      </div>
    );
  ...
  const renderAddressSection = () => (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-stretch">
      <div className="flex h-[46px] w-full items-center rounded-[6px] border border-[rgba(6,214,160,0.3)] bg-[#14213D] px-3 text-[12px] text-white md:text-[14px]">
      ...
      <button
        className="template10-filled-button-hover w-full rounded-[10px] bg-[#06D6A0] px-5 py-3 text-sm font-bold text-white transition-all duration-200 active:scale-95 sm:w-[270px]"
        onClick={() => copyToClipboard(paymentData.pay_address)}
        data-hover={t('copy')}
      >
  ...
  return (
    <div className="rounded-[7px] border border-[rgba(6,214,160,0.3)] bg-[#14213D]/80 p-5">
      {/* Header */}
      ...
      <div className="grid grid-cols-1 items-start gap-4 md:grid-cols-3">
        <div className="md:col-span-2">
          ...
          <div className="rounded-[8px] border border-[rgba(6,214,160,0.3)] bg-transparent px-6 py-8 text-white">
            <div className="flex flex-col gap-3 md:flex-row md:items-center">
              <div className="flex-1">{renderAmountDisplay()}</div>
              <div className="text-center text-2xl font-bold text-[#06D6A0] select-none md:hidden">
                =
              </div>
              <div className="hidden px-2 text-center text-2xl font-bold text-[#06D6A0] select-none md:block">
                =
              </div>
      ...
      <div className="mt-6">
        ...
        <div className="rounded-[8px] border border-[rgba(6,214,160,0.3)] bg-[#14213D] px-5 py-4 text-white">
          {renderInstructions()}
        </div>
      </div>
    </div>

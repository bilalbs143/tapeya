...
export default function CryptoSelect({
  ...
  return (
    <div className={`space-y-6 ${className}`}>
      {showAmount && (
        <div className="flex flex-col items-start gap-2 sm:flex-row sm:items-center sm:gap-4">
          ...
          <input
            ...
            className="relative block h-[46px] w-full appearance-none rounded-[5px] border border-[rgba(6,214,160,0.3)] bg-[#14213D] px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFFB2] focus:border-[rgba(6,214,160,0.6)] focus:ring-0 focus:ring-transparent focus:outline-none sm:w-auto sm:flex-1 sm:text-sm md:px-4 md:text-[14px] md:placeholder:text-sm lg:h-[55px]"
          />
        </div>
      )}
            ...
            <div className="flex flex-wrap gap-1 md:gap-3">
              {categories.map((cat) => (
                <button
                  ...
                  className={`flex-1 rounded-[5px] border px-4 py-2 text-[12px] font-semibold whitespace-nowrap transition-all duration-200 md:flex-none md:px-6 md:py-2.5 md:text-[14px] ${
                    category === cat.key
                      ? 'border-[#06D6A0] bg-[#14213D] text-white'
                      : 'border-[rgba(6,214,160,0.3)] bg-transparent text-[#CCCCCC] hover:border-[#06D6A0]'
                  }`}
                >
                  {cat.label}
                </button>
      ...
      <div className="rounded-[7px] border border-[rgba(6,214,160,0.3)] bg-transparent p-4 md:p-5">
                ...
                <button
                  ...
                  className={`group flex min-h-[80px] w-full items-center justify-between gap-3 rounded-[5px] border-2 px-4 py-4 text-[#cfd8df] transition-all duration-300 sm:px-4 ${
                    selectedCurrency === c.code
                      ? 'border-[#06D6A0] bg-[#14213D]'
                      : 'border-[rgba(6,214,160,0.3)] bg-transparent'
                  } hover:border-[#06D6A0] focus:border-[#06D6A0] focus:shadow-[inset_0_4.88px_29.278px_0_rgba(6,214,160,0.3),0_0_20px_rgba(6,214,160,0.4)]`}
                >

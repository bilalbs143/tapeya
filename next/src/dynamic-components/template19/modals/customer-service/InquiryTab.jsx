...
import ContentDetail from '@/dynamic-components/template19/components/ContentDetail/ContentDetail';
import Pagination from '@/dynamic-components/template19/components/Pagination/Pagination';
      ...
      {showInquiryDetails ? (
        ...
        <div className="space-y-6">
          <div className="rounded-[7px] border border-[rgba(6,214,160,0.3)] bg-[#14213D]/80 p-3 md:p-4 lg:p-6">
            ...
            >
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <textarea
                      ...
                      className="relative block min-h-[46px] w-full resize-none appearance-none rounded-[5px] border border-[rgba(6,214,160,0.3)] bg-[#14213D] px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFFB2] focus:border-[rgba(6,214,160,0.6)] focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:h-[55px]"
                    />
                  )}
                />
              ...
              <div className="mt-6 hidden justify-end md:flex">
                <button
                  type="submit"
                  className="template10-filled-button-hover flex cursor-pointer items-center justify-center rounded-[4px] bg-[#06D6A0] px-16 pt-2.5 pb-2.5 text-[16px] font-semibold text-white transition-all duration-200 active:scale-95"
                  data-hover={t('submit')}
                >
              ...
              <div className="mt-6 flex justify-center md:hidden">
                <button
                  type="submit"
                  className="template10-filled-button-hover flex w-full cursor-pointer items-center justify-center rounded-[3px] bg-[#06D6A0] px-8 py-2 text-[16px] font-semibold text-white transition-all duration-200 active:scale-95 md:w-auto"
                  data-hover={t('submit')}
                >
                  <span className="text-container">
                    <span className="text">{t('submit')}</span>
          ...
          <div className="space-y-4">
            ...
            <div className="overflow-hidden rounded-[5px] border border-[rgba(6,214,160,0.3)]">
              <div className="show-scrollbar h-[400px] overflow-x-auto overflow-y-auto md:h-[500px]">
                <table className="w-full min-w-[720px] table-fixed text-[11px] md:text-sm">
                  <thead>
                    <tr className="border-b-0 border-[rgba(6,214,160,0.3)] bg-[#0E1514]">
                  ...
                  <tbody>
                    {allCustomerInquiriesLoader ? (
                      ...
                      inquiriesData.map((inquiry, index) => (
                        <tr
                          key={`row-${inquiry.id}`}
                          className="cursor-pointer border border-[rgba(6,214,160,0.3)] transition-all duration-300 hover:border-[#06D6A0] hover:bg-[#0C0C0C] hover:shadow-[inset_0_4.88px_29.278px_0_rgba(6,214,160,0.3),0_0_20px_rgba(6,214,160,0.4)]"
                        ...
                        >
                          ...
                          <td className="px-2 py-2 text-center text-white md:px-2 md:py-3">
                            <button className="btn-hover-outline rounded-[6px] border border-[rgba(6,214,160,0.3)] bg-[#06D6A0] px-3 py-1 text-xs font-medium text-white transition-colors duration-200 hover:bg-[#05C191]">
                              {t('details')}
                            </button>
                          </td>
                          <td className="px-1 py-2 text-[#FFFFFF99] md:px-2 md:py-3">
                            <button
                              ...
                              className="cursor-pointer rounded-[4px] bg-[#06D6A0] px-3 py-1 text-xs font-medium text-white transition-colors duration-200 hover:bg-[#05C191] disabled:opacity-50"

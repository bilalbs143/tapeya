...
export default function BettingTab() {
  ...
  return (
    <div className="flex h-full flex-col">
      <h3 className="font-spy-agency mb-3 text-center text-[20px] sm:text-left sm:text-[35px] md:text-[25px]">
        {t('betting_management')}
      </h3>
      {/* Match Notes table UI: single bordered container with scrollable table */}
      <div className="overflow-hidden rounded-[9px] border border-[rgba(6,214,160,0.3)]">

        ...
        {faqs.length === 0 ? (
          ...
          faqs.map((faq) => {
            ...
            return (
              <div
                key={faq.id}
                className={`overflow-hidden rounded-[3px] border text-white transition-colors duration-200 ${isOpen
                    ? 'border-[rgba(6,214,160,0.3)] bg-[#14213D]/40 p-3'
                    : 'border-[rgba(6,214,160,0.3)] py-2'
                  }`}
              >
                <button
                ...
                >
                  <div className="flex w-full items-center justify-between px-4 py-3">
                    ...
                    {/* + / − icon  */}
                    <span className="flex h-6 w-6 items-center justify-center rounded-full text-[#06D6A0]">
                  ...
                  {isOpen && (
                    <div className="mx-auto mb-1 h-[1px] w-[90%] bg-[#06D6A0] md:w-[97%]" />
                  )}
                </button>

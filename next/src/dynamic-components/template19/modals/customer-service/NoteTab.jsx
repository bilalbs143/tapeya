                ...
                <tbody>
                  {notesData.length === 0 ? (
                    ...
                    notesData.map((item, index) => (
                      <tr
                        key={item.id || index}
                        className="cursor-pointer border-t border-b border-[rgba(6,214,160,0.3)] transition-all duration-300 hover:border-[#06D6A0] hover:bg-[#0C0C0C] hover:shadow-[inset_0_4.88px_29.278px_0_rgba(6,214,160,0.3),0_0_20px_rgba(6,214,160,0.4)]"

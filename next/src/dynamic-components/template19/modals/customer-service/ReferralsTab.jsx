  ...
  return (
    <div className="flex h-full flex-col p-3">
      ...
      <div className="mb-5 grid grid-cols-1 gap-4 md:grid-cols-12">
        <div className="md:col-span-9 md:mt-3">
          <div className="mt-1 mb-6 flex items-center justify-center sm:justify-between">
            {' '}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  value={referralLink}
                  readOnly
                  className="h-[46px] w-full cursor-not-allowed rounded-[5px] border border-[rgba(6,214,160,0.3)] bg-[#14213D] px-3 py-3 pr-12 text-[12px] text-white placeholder:text-[#FFFFFFB2] sm:text-sm md:placeholder:text-sm lg:h-[55px]"
                />
                <button
          ...
          <div className="flex h-full flex-col items-center justify-center md:items-end">
            <div className="flex flex-col items-center gap-2">
              ...
              <button
                ...
                className="filled-hover-effect mt-2 flex w-[291px] cursor-pointer items-center justify-center gap-2 rounded-[3px] bg-[#06D6A0] px-4 pt-2.5 pb-2.5 text-[13px] font-extrabold text-white active:scale-95 md:w-[191px] md:rounded-[5px]"
              >
      ...
      <div className="mx-auto mb-7 h-[1px] bg-[#06D6A0] md:w-full" />

      {/* Table */}
      <div className="space-y-4">
        <div className="mb-5 block text-[19px] font-bold text-white">
          {t('Recent Referrals')}
        </div>
        <div className="flex h-[400px] flex-col md:h-[500px]">
          <div className="overflow-x-auto md:overflow-x-visible">
            <div className="inline-block w-full min-w-[900px] align-top md:min-w-[1100px]">
              {/* Table Header */}
              <div className="overflow-hidden rounded-t-[8px] border border-b-0 border-[rgba(6,214,160,0.3)]">
              ...
              {/* Table Body */}
              <div className="show-scrollbar flex-1 overflow-y-auto rounded-b-[8px] border border-t-0 border-[rgba(6,214,160,0.3)]">
                {referralsLoader ? (
                    ...
                    <tbody>
                      {items.length === 0 ? (
                        ...
                        items.map((item, index) => (
                          <tr
                            key={item.id || index}
                            className="border-b border-[rgba(6,214,160,0.3)] transition-all duration-300 last:border-b-0 hover:border-[#06D6A0] hover:bg-[#0C0C0C] hover:shadow-[inset_0_4.88px_29.278px_0_rgba(6,214,160,0.3),0_0_20px_rgba(6,214,160,0.4)]"
                          >

...
export default function CustomerService({
  ...
  return (
    ...
    >
      <div className="customer-service-modal relative mx-auto flex h-[80vh] w-full flex-col overflow-hidden rounded-[7px] bg-transparent">
                ...
                <div className="hidden flex-wrap items-center gap-3 md:flex md:gap-5">
                  {tabs.map((tab) => (
                    <button
                      ...
                      className={`min-w-[200px] rounded-[5px] px-6 py-3.5 text-[14px] font-semibold transition-all duration-200 ${
                      activeTab === tab.key

...
import WithdrawalBankTab from '@/dynamic-components/template19/components/WithdrawalOptions/WithdrawalBankTab';
import WithdrawalCryptoTab from '@/dynamic-components/template19/components/WithdrawalOptions/WithdrawalCryptoTab';
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-4">
        {/* Tabs header */}
        <div className="mt-4 mb-[10px] rounded-[5px] border border-[rgba(6,214,160,0.3)] p-[2px] md:mt-4">

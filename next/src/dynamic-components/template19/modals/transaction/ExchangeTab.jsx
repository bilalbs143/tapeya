...
export default function ExchangeTab() {
  ...
  return (
    <div className="space-y-6 rounded-[7px] border border-[rgba(6,214,160,0.3)] bg-[#14213D]/80 p-4">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <h3 className="text-[15px] font-extrabold text-white md:text-[25px]">
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2 md:gap-4">
        <div>
          <label
            ...
            className="mb-2 block text-[16px] font-normal text-white"
          >
          ...
          <div className="relative" ref={convertDropdownRef}>
            <div
              id="convert-select"
              className="relative flex h-[46px] w-full cursor-pointer appearance-none items-center justify-between rounded-[5px] border border-[rgba(6,214,160,0.3)] bg-[#14213D] px-3 py-3 text-[12px] text-white focus:border-[rgba(6,214,160,0.6)] focus:ring-0 focus:ring-transparent focus:outline-none md:text-[14px] lg:h-[55px]"
            ...
            {isConvertDropdownOpen && (
              <div className="scrollbar-hide absolute z-[99999] mt-1 max-h-[150px] w-full overflow-y-auto rounded-[5px] border border-[rgba(6,214,160,0.3)] bg-[#14213D] shadow-lg">
                <div
                  className="cursor-pointer px-3 py-2 text-[12px] text-white transition-colors duration-150 hover:bg-[#06D6A0] md:text-[14px]"
                  onClick={() => {
                    setConvertType('points_exchange');
                    setIsConvertDropdownOpen(false);
                  }}
        ...
        <div>
          ...
          <div
            id="available-amount"
            className="flex h-[46px] w-full items-center rounded-[5px] border border-[rgba(6,214,160,0.3)] bg-[#14213D] px-3 py-3 text-[12px] text-[#FFFFFFB2] sm:text-sm md:placeholder:text-sm lg:h-[55px]"
          >
            {convertType === 'points_exchange' ? (
              ...
              <span className="text-[#FFFFFFB2]">{t('select_convert_type')}</span>
            )}
          </div>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmitConvert} className="space-y-4">
          <div className="">
            ...
            <input
              ...
              className="relative block h-[46px] w-full appearance-none rounded-[5px] border border-[rgba(6,214,160,0.3)] bg-[#14213D] px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFFB2] focus:border-[rgba(6,214,160,0.6)] focus:ring-0 focus:ring-transparent focus:outline-none sm:flex-1 sm:text-sm md:placeholder:text-sm lg:h-[55px]"
              min="1"
              step="1"
            />
          </div>
          <div className="flex justify-end">
            <button
              ...
              className="template10-filled-button-hover flex cursor-pointer items-center justify-center rounded-[4px] bg-[#06D6A0] px-16 pt-2.5 pb-2.5 text-[16px] font-semibold text-white transition-all duration-200 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
              data-hover={convertLoading ? t('processing') : t('send_your_request')}
            >

...
export default function PointsTab() {
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-[7px] border border-[rgba(6,214,160,0.3)] bg-[#14213D]/80 md:p-4">
        {/* Header */}
        <div className="flex flex-wrap items-center justify-between gap-5 md:mt-2 md:pl-4">
          <h3 className="text-[15px] font-bold text-white md:text-[25px]">
            {t('points')}
          </h3>
          <button
            onClick={handleConvertClick}
            className="template10-filled-button-hover flex cursor-pointer items-center justify-center rounded-[4px] bg-[#06D6A0] px-16 pt-2.5 pb-2.5 text-[16px] font-semibold text-white transition-all duration-200 active:scale-95 md:mr-4"
            data-hover={t('convert_to_game_wallet')}
          >
            <span className="text-container">
              <span className="text">{t('convert_to_game_wallet')}</span>
            </span>
          </button>
        </div>
            ...
            <div className="flex h-[400px] flex-col md:h-[500px]">
              ...
              <div className="overflow-x-auto md:overflow-x-visible">
                <div className="inline-block w-full min-w-[680px] align-top md:p-3">
                  {/* Table Header - Fixed */}
                  <div className="overflow-hidden rounded-t-[9px] border border-b-0 border-[rgba(6,214,160,0.3)]">
                  ...
                  <div className="show-scrollbar flex-1 overflow-y-auto">
                    <div className="overflow-hidden rounded-b-[9px] border border-t-0 border-[rgba(6,214,160,0.3)]">
                      <table className="w-full table-fixed text-[11px] md:text-sm">
                        <tbody>
                            ...
                            requestInfoData.map((item, index) => (
                              ...
                              >
                                ...
                                <td className="px-1 py-2 md:px-2 md:py-3">
                                  <span className="text-[12px] font-normal text-[#06D6A0] transition-all duration-200 hover:text-[#FFFFFF99]">

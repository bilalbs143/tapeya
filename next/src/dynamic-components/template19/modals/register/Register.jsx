...
export default function Register(props) {
  ...
  return (
    <div
      className={`relative mx-auto max-h-[90vh] w-full max-w-[1026px] transform overflow-y-auto rounded-[7px] border border-[rgba(6,214,160,0.3)] text-white shadow-xl transition-all duration-300 ease-out md:max-h-[90vh] ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'
        }`}
    >
      ...
      />
      <div className="relative z-10 flex w-full flex-col items-stretch rounded-[5px] bg-transparent">
        <div className="flex w-full flex-col items-center bg-transparent p-6 lg:p-8">
          <div className="w-full max-w-[935px]">
            {/* HEADER */}
            <div className="mt-2 mb-8 flex items-center justify-between">
              <h2 className="font-bring-race text-[18px] tracking-widest uppercase md:text-[20px]">
              ...
              <button
                ...
                aria-label={t('close')}
                className="flex h-[32px] w-[32px] items-center justify-center transition-all hover:scale-110"
              >
                <svg
            ...
            {/* FORM START */}
            <form className="space-y-4 pb-4 pt-2" onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        ...
                        className="w-full rounded-[4px] border border-[rgba(6,214,160,0.3)] bg-[#14213D] focus:border-[rgba(6,214,160,0.3)] focus:ring-0 focus:outline-none"
                      />
                    )}
                  />
                </div>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        ...
                        className="w-full rounded-[4px] border border-[rgba(6,214,160,0.3)] bg-[#14213D] focus:border-[rgba(6,214,160,0.3)] focus:ring-0 focus:outline-none"
                        eyeIconColor="rgba(6, 214, 160, 0.3)"
                      />
                    )}
                  />
                </div>
                ...
                <div className="overflow-visible">
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      ...
                      >
                        <SelectTrigger className="w-full rounded-[4px] border border-[rgba(6,214,160,0.3)] bg-[#14213D]">
                          <SelectValue placeholder={t('select_bank')} />
                        </SelectTrigger>

                        {/* select bank*/}
                        <SelectContent className="z-[9999] border-[#06D6A04D] bg-[#0E0E0E] text-white">
              ...
              <button
                ...
                className="template10-filled-button-hover mt-5 w-full rounded-[50px] bg-[#06D6A0] py-3 font-semibold text-white transition active:scale-95 disabled:opacity-50"
              >
              ...
              <button
                ...
                className="template10-bordered-button-hover mt-3 w-full rounded-[50px] border border-[rgba(6,214,160,0.3)] bg-[#14213D] py-3 text-[16px] font-extrabold transition-all active:scale-95"
              >

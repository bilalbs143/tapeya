...
export default function LaunchGame() {
  ...
  return (
    <div className="mx-auto w-full max-w-[400px]  bg-[#000000] text-white shadow-xl sm:max-w-[500px] lg:max-w-[590px]">
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              className="flex h-12 w-full cursor-pointer items-center justify-center rounded-lg bg-[#FFDAB9] text-sm font-semibold text-black transition-all duration-150 active:scale-95 disabled:opacity-50 sm:h-14 sm:text-base"
            >
              {isGameLaunching ? (

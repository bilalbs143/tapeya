...
export default function Announcement() {
  ...
  return (
    <div className="announcement-modal relative mx-auto flex h-[80vh] w-full max-w-[1479px] flex-col overflow-hidden bg-[#000000] text-white shadow-xl">
      <div className="flex min-h-0 flex-1 flex-col space-y-4 p-4 md:p-6 lg:p-8">
        ...
        <div className="flex min-h-0 flex-1 flex-col space-y-6">
          <div className="min-h-0 flex-1 overflow-hidden rounded-[5px] border border-[#5858584D]">
            <div className="h-full space-y-4 overflow-hidden p-3 md:space-y-6 md:p-4 lg:p-6">
              <div className="grid h-full min-h-0 grid-cols-1 gap-4 overflow-hidden md:grid-cols-2 md:gap-6">
                          ...
                          <button
                            ...
                            className={`w-full cursor-pointer rounded-[5px] px-3 py-2 text-left transition-all duration-300 md:px-4 md:py-3 ${
                              selectedAnnouncement === item.id
                                ? 'border border-[#D0000033] bg-[#D000001A]'
                                : 'border border-[#5858584D] bg-transparent text-white'
                            }`}
                          >
                            <div className="flex items-center justify-between">
                              <span
                ...
                <div className="flex min-h-0 flex-col overflow-hidden">
                  ...
                  {/* SCROLL WITHOUT SCROLLBAR */}
                  <div className="scrollbar-hide min-h-0 w-full flex-1 overflow-y-auto rounded-[5px] border border-[#5858584D] p-2 px-3 py-4 text-white md:px-5 md:py-6">
                    {allAnnouncementsLoader ? (

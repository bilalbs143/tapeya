...
export default function Transaction({ defaultTab }) {
  ...
  return (
    <div className="transaction-modal relative mx-auto flex h-[80vh] w-full max-w-[1479px] flex-col overflow-hidden bg-[#000000] text-white shadow-xl">
                  ...
                  return (
                    <button
                      ...
                      className={` ${isConvert ? 'min-w-[454px]' : 'min-w-[200px]'} rounded-[4px] px-6 py-3.5 text-[14px] font-semibold transition-all duration-200 ${
                        activeTab === tab.key
                          ? 'border border-[#D00000] bg-[#D000001A] text-[white]'

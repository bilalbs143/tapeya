...
import ContentDetail from '@/dynamic-components/template20/components/ContentDetail/ContentDetail';
    ...
    <>
      {showInquiryDetails ? (
        ...
        <div className="space-y-6">
          <div className="rounded-[3px] border border-[#5858584D] p-3 md:p-4 lg:p-6">
            <form
            ...
            >
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input
                      ...
                      type="text"
                      placeholder={t('title')}
                      className="relative block h-[46px] w-full appearance-none rounded-[3px] border border-[#D0000033] bg-[#D000001A] px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFFB2] focus:border-[#D00000] focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:h-[55px]"
                      error={
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <textarea
                      ...
                      className="relative block min-h-[46px] w-full resize-none appearance-none rounded-[3px] border border-[#D0000033] bg-[#D000001A] px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFFB2] focus:border-[#D00000] focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:h-[55px]"
                    />
                  )}
                />
              ...
              <div className="mt-6 hidden justify-end md:flex">
                <button
                  type="submit"
                  className="template20-filled-button-hover flex cursor-pointer items-center justify-center rounded-[10px] bg-[#D00000] px-16 pt-2.5 pb-2.5 text-[16px] font-semibold text-white transition-all duration-200 active:scale-95"
                  data-hover={t('submit')}
                >
              ...
              <div className="mt-6 flex justify-center md:hidden">
                <button
                  type="submit"
                  className="template20-filled-button-hover flex w-full cursor-pointer items-center justify-center rounded-[10px] bg-[#D00000] px-8 py-2 text-[16px] font-semibold text-white transition-all duration-200 active:scale-95 md:w-auto"
                  data-hover={t('submit')}
                >
                  <span className="text-container">
                    <span className="text">{t('submit')}</span>
          ...
          <div className="space-y-4">
            ...
            <div className="overflow-hidden rounded-[5px] border border-[#5858584D]">

  ...
  return (
    <div className="flex h-full flex-col p-3">
      ...
      <div className="mb-5 grid grid-cols-1 gap-4 md:grid-cols-12">
        <div className="md:col-span-9 md:mb-3">
          ...
          <div className="flex h-full flex-col items-center justify-center md:items-end">
            <div className="flex flex-col items-center gap-2">
              ...
              <button
                ...
                className="filled-hover-effect mt-2 flex w-[291px] cursor-pointer items-center justify-center gap-2 rounded-[3px] bg-[#D00000] px-4 pt-2.5 pb-2.5 text-[13px] font-extrabold text-white active:scale-95 md:w-[191px] md:rounded-[5px]"
              >
      ...
      <div className="mx-auto mb-7 h-[1px] bg-[#5858584D] md:w-full" />
        ...
        <div className="flex h-[400px] flex-col md:h-[500px]">
          <div className="overflow-x-auto md:overflow-x-visible">
            <div className="inline-block w-full min-w-[900px] align-top md:min-w-[1100px]">
              {/* Table Header */}
              <div className="overflow-hidden rounded-t-[8px] border border-b-0 border-[#5858584D]">
              ...
              {/* Table Body */}
              <div className="show-scrollbar flex-1 overflow-y-auto rounded-b-[8px] border border-t-0 border-[#5858584D]">
                {referralsLoader ? (
                    ...
                    <tbody>
                      {items.length === 0 ? (
                        ...
                        items.map((item, index) => (
                          <tr
                            key={item.id || index}
                            className="border-b border-[#5858584D] transition-all duration-300 hover:border-[#CBBC9133] hover:bg-[#0F50451A] hover:shadow-[inset_0_4px_24px_0_rgba(208,0,0,0.60)]"
                          >

  ...
  return (
    <section className="pt-4 md:pt-1">
      ...
      <div className="hidden justify-center md:flex">
        <div className="w-full max-w-[1925px] md:px-5">
          {/* Single Continuous Announcement Bar */}
          <div className="flex h-[60px] items-center overflow-hidden rounded-[10px] border border-[#FFDAB91A] bg-[#1A1A1A]">
            {/* Left Label - Announcements */}
            <div className="flex h-full items-center bg-[#C8102E] px-8">
            ...
            {/* Get Our App Button - Right Side */}
            <Link
              href="/download-app"
              className="flex h-full items-center justify-center bg-[#C8102E] px-8 text-[16px] font-bold text-white uppercase transition-opacity hover:opacity-90"
            >
              GET OUR APP
            </Link>
          </div>

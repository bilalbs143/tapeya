...
import PendingExchangeAlert from '@/dynamic-components/template20/components/AlertSections/PendingExchangeAlert';
import UnreadNotesAlert from '@/dynamic-components/template20/components/AlertSections/UnreadNotesAlert';
    ...
    return (
      <div className="mx-auto w-full max-w-[400px] transform rounded-[24px] border border-[#2DFA1A4D] bg-[#3E1D88] p-4 text-white shadow-xl">
        <div className="py-8 text-center">
          <div className="mx-auto mb-4 h-8 w-8 animate-spin rounded-full border-b-2 border-[#FFDAB9]" />

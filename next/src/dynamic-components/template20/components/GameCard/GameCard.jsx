...
const GameCard = React.memo(
  ({
    ...
    return (
      <div
        className={`group ${className} relative cursor-pointer overflow-hidden rounded-[10px] transition-all duration-300`}
      ...
      >
        <div className={`relative w-full ${imageClassName} bg-[#121212]`}>
          ...
          >
            <span className="min-w-[100px] translate-y-4 transform rounded-full bg-[#FFDAB9] px-6 py-2 text-center text-sm font-bold text-[#1a1a1a] opacity-0 shadow-lg transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
              Play
            </span>
          </div>
        </div>

...
import { LanguageSwitcher } from '@/dynamic-components/template20/components/LanguageSwitcher/LanguageSwitcher';
  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between">
              ...
              {isDesktopMenuOpen && (
                <>
                  ...
                  <div className="fixed top-[110px] left-1/2 z-[90] -translate-x-1/2">
                    <div
                      className="rounded-[20px] bg-gradient-to-b from-black to-[#1A000B] shadow-[0_40px_120px_rgba(0,0,0,0.85)]"
                      style={{
                        width: '1920px',
                        height: '403px',
                      }}
                          ...
                          <div className="flex h-full gap-[60px]">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="grid grid-cols-3 gap-[16px]">
                                {/* Home */}
                                <Link href="/">
                                  <button className="flex h-[54px] w-full items-center justify-between rounded-[10px] bg-[#D00000] px-5">
                                ...
                                <button
                                  ...
                                  className="group flex w-full cursor-pointer items-center justify-between rounded-[8px] border border-[#6363634D] bg-transparent px-5 py-4 transition-colors hover:border-[#FFDAB9] hover:bg-[#ffffff05]"
                                >
                                  <div className="flex items-center gap-3">
                                    <div className="flex h-6 w-6 items-center justify-center">
                                      <Image
                                ...
                                >
                                  <div className="flex items-center gap-3">
                                    ...
                                    {helpUnreadCount > 0 && (
                                      <span className="grid h-5 min-w-[20px] place-items-center rounded-full bg-[#FFDAB9] px-1.5 text-[10px] font-bold text-black">
                                        {helpUnreadCount > 99
                                          ? '99+'
                                          : helpUnreadCount}
                                      </span>
                            ...
                            <div className="w-[320px]">
                              ...
                              <div className="relative flex items-start">
                                ...
                                <div className="mt-5 flex flex-col items-center gap-3">
                                  ...
                                  {/* Download Button */}
                                  <button className="mt-12 rounded-full bg-[#FFDAB9] px-6 py-2 text-[13px] font-bold text-black transition-transform hover:scale-105">
                                    Download
                                  </button>
                                </div>
                                {/* Right side: Character Image */}
                                <div className="relative mt-2 h-[220px] w-[260px]">
                                  <img
                                    src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/Footer+download+Section+background.png"
                                    alt="Character"
                                    className="absolute right-[-15px] bottom-[-0px] h-[240px] w-auto max-w-none object-contain"
                                  />
                                </div>
                              </div>
                            </div>
              ...
              <Link href="/" className="inline-flex items-center">
                <div className="relative flex items-center justify-center">
                  ...
                  <img
                    ...
                    alt="Logo Background"
                    className="absolute h-[450%] w-auto max-w-none opacity-80"
                  />
                  <Image
            ...
            <div className="relative hidden items-center gap-3 md:flex">
              ...
              {isAuth && (
                <button
                  onClick={handleOpenAnnouncementModal}
                  className="relative flex h-11 w-11 items-center justify-center rounded-full border border-[#D000001A] bg-[#D000001A] transition-all hover:bg-[#D0000040]"
                >
                  <svg
                    width="22"
                    height="22"
                  ...
                  {announcementUnreadCount > 0 && (
                    <div className="absolute top-1.5 right-1.5 h-2.5 w-2.5 rounded-full border border-[#FFDAB9] bg-red-500" />
                  )}
                </button>
              )}
              ...
              {isAuth && (
                <div className="relative flex h-[49px] items-center justify-between gap-4 rounded-full border border-[#D000001A] bg-[#D000001A] pl-6 shadow-xl transition-all hover:bg-[#D0000040]">
                  ...
                  <button
                    onClick={handleOpenTransactionTab}
                    className="z-20 -mr-0.5 flex h-[50px] w-[50px] items-center justify-center rounded-full bg-[#FFDAB9] text-black shadow-[0_0_20px_rgba(255,183,3,0.4)] transition-transform hover:scale-105 active:scale-95"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
              ...
              {isAuth && (
                <div className="relative">
                  <button
                    ...
                    className="group relative flex h-[49px] items-center gap-4 rounded-full border border-[#D000001A] bg-[#D000001A] pr-5 transition-all hover:bg-[#D0000040]"
                  >
                    {/* Overlapping Gold Avatar */}
                    <div className="z-20 -ml-0.5 flex h-[50px] w-[50px] items-center justify-center rounded-full bg-[#FFDAB9] text-black shadow-[0_0_20px_rgba(255,183,3,0.4)] transition-transform">
                  ...
                  {isUserDropdownOpen && (
                    <>
                      <div
                        ...
                        onClick={toggleUserDropdown}
                      />
                      <div className="absolute top-[calc(100%+12px)] right-0 z-[100] w-[280px] rounded-[9px] border border-[#D000001A] bg-[#D000001A] p-2 shadow-2xl backdrop-blur-md">
                        {/* 1. Profile */}
                        <button
                          onClick={handleOpenProfileTab}
                          className="group flex w-full items-center justify-between rounded-[8px] px-4 py-3 transition-colors hover:bg-[#D0000040]"
                        >
                          <div className="flex items-center gap-3">
                            <svg
                              width="20"
                          ...
                          <svg
                            ...
                            viewBox="0 0 24 24"
                            fill="none"
                            className="stroke-[#666] transition-colors group-hover:stroke-[#FFDAB9]"
                          >
                            <path
                              d="M9 18L15 12L9 6"
                              strokeWidth="2"
                        ...
                        <button
                          ...
                          className="group hhover:bg-[#D0000040] flex w-full items-center justify-between rounded-[8px] px-4 py-3 transition-colors"
                        >
                          <div className="flex items-center gap-3">
                            <svg
                              width="20"
              ...
              {!isAuth && (
                <div className="flex items-center gap-4">
                  <button
                    ...
                    className="rounded-[10px] bg-[#FFDAB9] px-8 py-2 text-[14px] font-bold text-black transition-all hover:bg-[#FFCBA4] active:scale-95"
                  >
                    Register
                  </button>
                  <button
                    onClick={handleOpenLoginModal}
                    className="rounded-[10px] bg-[#D00000] px-8 py-2 text-[14px] font-bold text-white transition-all hover:bg-[#B00000] active:scale-95"
                  >
                    Login
                  </button>
                </div>
                ...
                <Link href="/" className="inline-flex items-center">
                  <div className="relative flex items-center justify-center">
                    ...
                    <img
                      src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/Ellipse+1.png"
                      alt="Logo Background"
                      className="absolute h-[350%] w-auto max-w-none opacity-80"
                    />
                    <Image
                      src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/logo.png"
                      alt="Artchip Logo"
              ...
              <div className="flex items-center gap-2">
                {!isAuth && (
                  <div className="flex items-center gap-2">
                    <button
                      onClick={handleOpenRegisterModal}
                      className="rounded-[2px] bg-[#FFDAB9] px-4 py-1.5 text-[13px] font-bold text-black transition-all active:scale-95"
                    >
                      REGISTER
                    </button>
                    <button
                      onClick={handleOpenLoginModal}
                      className="rounded-[2px] bg-[#D00000] px-4 py-1.5 text-[13px] font-bold text-white transition-all active:scale-95"
                    >
                      LOGIN
                    </button>
                  </div>
                ...
                {isAuth && (
                  <div className="relative" ref={userMenuRef}>
                    <button
                      ...
                      className="flex h-11 w-11 items-center justify-center rounded-full border border-[#D000001A] bg-[#D000001A] text-[18px] font-extrabold text-[#FFDAB9] shadow-[0_0_15px_rgba(255,183,3,0.2)] transition-all"
                    >
                      {userInitial || 'A'}
                    </button>
                    {isUserMenuOpen && (
                      <div className="absolute top-[calc(100%+8px)] right-0 z-[1000] w-[240px]">
                        <div className="rounded-[16px] border border-[#D000001A] bg-[#D000001A] p-2 shadow-2xl backdrop-blur-md">
                          {/* Profile */}
                          <button
                            onClick={() => {
      ...
      >
        {/* Drawer Content */}
        <div
          className={`absolute top-0 left-0 h-full w-80 border border-[#FFFFFF1A] shadow-xl ${isMobilePlatform ? 'pt-safe-top' : ''
          }`}
          style={{
            background: 'linear-gradient(180deg, #000 0%, #1A000B 100%)',
          }}
        >
          <div
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-6">
              ...
              <button
                onClick={toggleMobileMenu}
                className="group flex h-9 w-9 cursor-pointer items-center justify-center rounded-[6px] border border-[#FFDAB9] bg-[#18181A] text-white transition-colors hover:bg-[#FFDAB9] hover:text-black"
              >
                <svg
                  className="h-5 w-5"
                  fill="none"
              ...
              <div className="mb-4 border-b border-[#FFFFFF1A] px-0 py-0">
                <div className="flex items-center gap-3">
                  <div className="flex w-full items-center gap-3 rounded-[0px] px-3 py-3">
                    <button
                      onClick={handleOpenRegisterModal}
                      className="group flex flex-1 cursor-pointer items-center justify-center gap-3 rounded-[10px] bg-[#FFDAB9] px-3 py-2 text-base font-semibold text-black transition-colors"
                      data-hover="Register"
                    >
                      <span>Register</span>
                    </button>
                    ...
                    <button
                      onClick={handleOpenLoginModal}
                      className="outline-hover-effect group flex flex-1 cursor-pointer items-center justify-center gap-3 rounded-[10px] bg-[#D00000] px-3 py-2 text-base font-semibold text-white transition-colors"
                    >
                      <span>Login</span>
                    </button>
                  </div>
            ...
            {isAuth && (
              <div className="relative mx-4 mb-6 flex h-[62px] items-center justify-between rounded-full border border-[#D000001A] bg-[#D000001A] pl-6 shadow-lg">
                ...
                <button
                  onClick={handleOpenTransactionTab}
                  className="z-20 -mr-0.5 flex h-[55px] w-[55px] items-center justify-center rounded-full bg-[#FFDAB9] text-black shadow-[0_0_20px_rgba(255,183,3,0.4)] transition-transform hover:scale-105 active:scale-95"
                >
                  <svg
                    width="28"
                    height="28"
            ...
            <div className="flex flex-col gap-3 px-4 pb-4">
              ...
              <button
                onClick={handleOpenTransactionTab}
                className="group flex w-full cursor-pointer items-center gap-4 rounded-[8px] border border-[#2A2A2A] bg-transparent px-5 py-4 transition-colors hover:border-[#FFDAB9] hover:bg-[#ffffff05]"
              >
                <div className="flex h-6 w-6 items-center justify-center">
                  <Image
                    src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/Deposit-12.svg"
              ...
              >
                ...
                {helpUnreadCount > 0 && (
                  <span className="ml-auto grid h-5 min-w-[20px] place-items-center rounded-full bg-[#FFDAB9] px-1.5 text-[10px] font-bold text-black">
            ...
            <div className="mt-auto space-y-3 p-4">
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="relative flex items-start">
                  ...
                  {/* Right side: Character Image */}
                  <div className="relative -mt-10 h-[200px] w-[161px]">
                    <img
                      src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/Footer+download+Section+background.png"
                      alt="Character"
                      className="absolute right-[-26px] bottom-[-0px] h-[200px] w-auto max-w-none object-contain"
                    />
                  </div>
                </div>
              </div>

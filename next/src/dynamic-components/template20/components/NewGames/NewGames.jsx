      ...
      <div>
        ...
        >
          ...
          <div className="block w-full lg:hidden">
            ...
            >
              <Image
                src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/2+Mob.png"
          ...
          <div className="hidden flex-shrink-0 lg:flex lg:w-[280px] xl:w-[320px]">
            <Link
              href="/slot-providers"
              className="group/banner relative h-full w-full cursor-pointer overflow-hidden rounded-[5px] border border-[#D00000] transition-all duration-300 hover:rounded-[5px] hover:border-[#D00000]"
            >
              <div className="relative h-full w-full overflow-hidden rounded-[5px]">
                <Image
                  src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/2-Desktop.png"
                  alt="New Games Banner"
                  width={320}
                  height={650}
                ...
                <div className="pointer-events-none absolute top-1/2 right-0 bottom-0 left-0 origin-bottom scale-y-0 bg-gradient-to-t from-[#1A000B] to-transparent transition-all transition-transform duration-300 ease-in-out will-change-transform group-hover/banner:scale-y-100" />
              </div>

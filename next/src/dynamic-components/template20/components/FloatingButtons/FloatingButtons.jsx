      ...
      >
        ...
        >
          <div className="floating-button-inner">
            <div className="floating-button-content">
              <img
                src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/Deposit-20.svg"
                alt={t('deposit')}
                width="30"
                height="30"
                className="floating-button-icon"
      ...
      >
        ...
        >
          <div className="floating-button-inner">
            <div className="floating-button-content">
              <img
                src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/withdrawal-20.svg"
                alt={t('withdrawal')}
                width="20"
                height="20"
                className="floating-button-icon"
      ...
      >
        ...
        >
          <div className="floating-button-inner">
            <div className="floating-button-content">
              <img
                src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/CM_INQUIRY_20.png"
                alt={t('support')}
                width="20"
                height="20"
                className="floating-button-icon"
          ...
          <div className="floating-button-inner">
            <div className="floating-button-content">
              <div className="relative">
                <img
                  src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/Note-20.png"
                  alt={t('notes')}
                  width="20"
                  height="20"
                  className="floating-button-icon"

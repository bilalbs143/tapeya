    ...
    return (
      ...
      >
        <div>
          ...
          <CommonLoader border="border-[#FFDAB9]" />
        </div>
      </motion.section>
    );
  }
      ...
      <div>
        ...
        >
          ...
          <div className="block w-full lg:hidden">
            ...
            >
              <Image
                src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/1+Mob.png"
          ...
          <div className="hidden flex-shrink-0 lg:flex lg:w-[280px] xl:w-[320px]">
            ...
            >
              <div className="relative h-full w-full overflow-hidden">
                <Image
                  src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/1-Desktop.png"
                  alt="Top Games Banner"
                  width={320}
                  height={650}

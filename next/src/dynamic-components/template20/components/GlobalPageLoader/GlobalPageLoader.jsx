    ...
    <div className="flex items-center space-x-2">
      <div
        ...
        style={{
          ...
          boxShadow:
            '0 0 15px rgba(255, 218, 185, 0.6), 0 0 25px rgba(255, 228, 181, 0.4)',
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            '0 0 15px rgba(255, 228, 181, 0.6), 0 0 25px rgba(255, 218, 185, 0.4)',
          animation: 'bounce 1s ease-in-out infinite',
    ...
    return (
      ...
      >
        ...
        >
          {[...rotatedSymbols, ...rotatedSymbols].map((symbol, i) => (
            <div
              ...
              style={{
                textShadow: '0 0 20px rgba(255, 218, 185, 0.8)',
              }}
            >
              {symbol}
            </div>
        ...
        <div
          ...
          style={{
            height: '2px',
            boxShadow: '0 0 15px rgba(255, 218, 185, 0.6)',
            background:
              'linear-gradient(90deg, transparent, #FFDAB9 20%, #FFDAB9 80%, transparent)',
          }}
        />
      </div>
    );
    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#000000] via-[#0A0A0A] to-[#1A1410]">
      ...
      <style jsx>{`
        ...
        @keyframes glow {
          ...
          100% {
            box-shadow:
              0 0 20px rgba(255, 218, 185, 0.4),
              0 0 40px rgba(255, 228, 181, 0.2);
          }
          50% {
            box-shadow:
              0 0 30px rgba(255, 218, 185, 0.6),
              0 0 60px rgba(255, 228, 181, 0.4);
          }
        }
        @keyframes slideIn {
          0% {
      ...
      <div className="relative z-10 flex flex-col items-center space-y-6 sm:space-y-8">
        ...
        <div
          ...
          style={{
            ...
            boxShadow:
              '0 10px 40px rgba(0, 0, 0, 0.6), 0 0 40px rgba(255, 218, 185, 0.2)',
            border: '2px solid #FFDAB9',
          }}
        >
          {/* Slot Machine Header */}
          <div className="mb-3 text-center sm:mb-5">
            <div className="mb-2 flex items-center justify-center gap-1.5 text-lg sm:mb-3 sm:gap-2 sm:text-3xl">
              <span
                ...
                style={{
                  animation: 'bounce 1s ease-in-out infinite',
                  textShadow: '0 0 20px rgba(255, 218, 185, 0.9)',
                }}
              >
                🎰
              </span>
              <span
                ...
                style={{
                  background:
                    'linear-gradient(90deg, #FFDAB9, #FFE4B5, #FFDAB9)',
            ...
            <div className="h-1 w-full overflow-hidden rounded-full bg-black/80 sm:h-1.5">
              <div
                ...
                style={{
                  background:
                    'linear-gradient(90deg, #FFDAB9, #FFE4B5, #FFDAB9)',
                  boxShadow: '0 0 10px rgba(255, 218, 185, 0.5)',
            ...
            {['💎', '👑', '⭐'].map((symbol, i) => (
              <div
                ...
                style={{
                  ...
                  textShadow: '0 0 15px rgba(255, 218, 185, 0.8)',
                }}
              >
                {symbol}
              </div>

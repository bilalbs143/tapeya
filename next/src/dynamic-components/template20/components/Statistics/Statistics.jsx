            ...
            <div className="mb-4 flex w-full gap-2 overflow-x-auto rounded-[666px] bg-[#232E7C] px-3 py-3 sm:mb-6 sm:gap-3 sm:px-6 sm:py-4.5">
              {tabs.map((tab) => (
                <button
                  ...
                  className={`flex flex-1 cursor-pointer items-center justify-center gap-2 self-stretch rounded-full px-3 py-2 text-xs font-medium whitespace-nowrap transition-all duration-300 sm:gap-2.5 sm:rounded-[60px] sm:px-6 sm:py-4 sm:text-sm ${activeTab === tab.id
                      ...
                      <tr>
                        ...
                        >
                          <div className="flex justify-center">
                            <div className="h-8 w-8 animate-spin rounded-full border-b-2 border-[#FFDAB9]" />
                          </div>
                        </td>
                      </tr>

...
import Announcement from '@/dynamic-components/template7/components/Announcement/Announcement';
import Categories from '@/dynamic-components/template7/components/Categories/Categories';
import HeroSection from '@/dynamic-components/template7/components/HeroSection/HeroSection';
import NewGames from '@/dynamic-components/template7/components/NewGames/NewGames';
import PopularGames from '@/dynamic-components/template7/components/PopularGames/PopularGames';
import Statistics from '@/dynamic-components/template7/components/Statistics/Statistics';
import TopGames from '@/dynamic-components/template7/components/TopGames/TopGames';
  ...
  return (
    <div className="relative min-h-screen w-full overflow-x-hidden text-white">
      ...
      <div className="relative z-10 w-full">
        ...
        <div
          className="template7-home-content-bg relative z-10 w-full"
          style={{
            backgroundImage:

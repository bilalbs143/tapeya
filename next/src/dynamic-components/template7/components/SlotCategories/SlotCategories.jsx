...
import GameCard from '@/dynamic-components/template7/components/GameCard/GameCard';
        ...
        <div className="mt-6 flex flex-col items-center justify-center gap-4">
          {hasMore && (
            <button
              ...
              style={{
                border: '1px solid rgb(115, 81, 255)',
        ...
        {currentPage === 1 &&
          ...
          <div className="py-16">
            <div className="flex flex-col items-center space-y-4">
              <CommonLoader size="xl" border="border-[#EE7AF4]" />

...
import TransactionDetail from '@/dynamic-components/template7/components/TransactionDetail/TransactionDetail.jsx';
    ...
    <div className="space-y-6">
      {showDetails ? (
        ...
        <>
          ...
          <div className="overflow-hidden rounded-[9px] border border-[#3E1D88]">
                ...
                <tbody>
                  {requestInfoLoader ? (
                    ...
                    requestInfoData.data.map((item, index) => (
                      <tr
                        key={item.id || index}
                        className="cursor-pointer border border-[#3E1D88] transition-all duration-300 hover:border-[#EE7AF4] hover:bg-[#661BB5] hover:text-white"
                        onClick={() => {
                      ...
                      >
                        ...
                        <td className="px-1 py-2 md:px-2 md:py-3">
                          <span className="text-[#EE7AF4] transition-all duration-200">
                        ...
                        <td className="px-2 py-2 text-center md:px-2 md:py-3">
                          <button className="btn-hover-outline rounded-[6px] border border-[#3E1D88] bg-transparent px-3 py-1 text-xs font-medium text-white transition-colors duration-200 hover:bg-[#661BB5] hover:text-white">
                            {t('details')}
                          </button>
                        </td>
                      </tr>

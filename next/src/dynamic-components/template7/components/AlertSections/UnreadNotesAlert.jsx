  ...
  return (
    <div className="space-y-4">
      <div className="mt-3 flex items-center space-x-3">
        <div className="flex h-10 w-10 items-center justify-center rounded-[3px] border border-[#3E1D88] bg-[#3E1D88] shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)]">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
      ...
      <div className="rounded-[3px] bg-[#18202D] p-4">
      ...
      <button
        ...
        className="angled-button angled-button-pink mt-2 h-[45px] w-full disabled:cursor-not-allowed disabled:opacity-50 md:w-[500px]"
        data-hover={t('view_messages')}
      >
        <div className="angled-button-inner">
          <span className="angled-button-text">{t('view_messages')}</span>
        </div>
      </button>
    </div>
  );

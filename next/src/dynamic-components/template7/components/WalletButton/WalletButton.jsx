...
export default function WalletButton({ variant = 'desktop' }) {
  ...
  return (
    <div className="relative" ref={walletRef}>
      ...
      <button onClick={toggleWallet} className="template7-wallet-button group">
        <div className="template7-wallet-button-inner">
          {/* Left Section - Minus Button */}
          <button
            onClick={handleWithdrawalClick}
            className="template7-wallet-button-section template7-wallet-button-left"
            type="button"
          >
            <svg
          ...
          <div className="template7-wallet-button-section template7-wallet-button-center">
            {userLoader ? (
              <CommonLoader size="sm" border="border-white" />
            ) : hasWalletData ? (
              <span className="template7-wallet-button-value">
          ...
          <button
            ...
            className="template7-wallet-button-section template7-wallet-button-right"
            type="button"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      {/* Wallet Dropdown */}
      {isWalletOpen && (
        <div className="template7-wallet-dropdown">

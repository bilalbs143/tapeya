...
const LeftSidebar = memo(function LeftSidebar() {
  ...
  const [jackpotAmount, setJackpotAmount] = useState(() => {
    if (typeof window !== 'undefined') {
      const stored = localStorage.getItem('template7_jackpot');
      if (stored) {
  ...
  return (
    <aside className="template7-left-sidebar m-4 hidden h-auto w-64 flex-shrink-0 flex-col lg:flex lg:w-64 xl:w-64">
      <div className="flex flex-col p-4 pb-6">
        ...
        <div>
          <nav className="mt-2 space-y-2">
            ...
            <Link
              href="/"
              className={`group template7-menu-item-angled ${isActive('/') ? 'template7-menu-item-angled-active' : ''}`}
            >
            ...
            <Link
              ...
              className={`group template7-menu-item-angled ${isActive('/dashboard/deposit') ? 'template7-menu-item-angled-active' : ''}`}
            >
              <div className="template7-menu-item-angled-inner">
                <div className="template7-menu-item-content">
                  <svg
            ...
            <Link
              ...
              className={`group template7-menu-item-angled ${isActive('/dashboard/withdrawal') ? 'template7-menu-item-angled-active' : ''}`}
            >
              <div className="template7-menu-item-angled-inner">
                <div className="template7-menu-item-content">
                  <svg
            ...
            <Link
              ...
              className={`group template7-menu-item-angled ${isActive('/dashboard/coupons') ? 'template7-menu-item-angled-active' : ''}`}
            >
              <div className="template7-menu-item-angled-inner">
                <div className="template7-menu-item-content">
                  <svg
            ...
            <Link
              ...
              className={`group template7-menu-item-angled ${isActive('/dashboard/customer-inquiry') ? 'template7-menu-item-angled-active' : ''}`}
            >
              <div className="template7-menu-item-angled-inner">
                <div className="template7-menu-item-content">
                  <svg
            ...
            <Link
              ...
              className={`group template7-menu-item-angled ${isActive('/dashboard/note') ? 'template7-menu-item-angled-active' : ''}`}
            >
              <div className="template7-menu-item-angled-inner">
                <div className="template7-menu-item-content">
                  <svg
            ...
            <Link
              href="/announcements"
              className={`group template7-menu-item-angled ${isActive('/announcements') ? 'template7-menu-item-angled-active' : ''}`}
            >
              <div className="template7-menu-item-angled-inner">
                <div className="template7-menu-item-content">
                  <svg
            ...
            <Link
              ...
              className={`group template7-menu-item-angled ${isActive('/dashboard/faqs') ? 'template7-menu-item-angled-active' : ''}`}
            >
              <div className="template7-menu-item-angled-inner">
                <div className="template7-menu-item-content">
                  <svg
        ...
        <div className="space-y-2">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group template7-menu-item-angled"
          >
            <div className="template7-menu-item-angled-inner">
              <div className="template7-menu-item-content">
                <svg

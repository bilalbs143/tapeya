...
const Pagination = ({
  ...
  return (
    ...
    >
      <div className="group relative mr-1 inline-flex w-full items-center justify-center gap-4 px-6 py-2 text-[16px] font-semibold tracking-wide text-white uppercase before:absolute before:inset-0 before:-skew-x-[10deg] before:rounded-[3px] before:border before:border-[#3E1D88] before:bg-[rgba(51,19,105,0.7)] before:shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)] before:transition-all before:duration-300 md:w-auto">
        <button

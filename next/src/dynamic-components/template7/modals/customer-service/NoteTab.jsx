...
import ContentDetail from '@/dynamic-components/template7/components/ContentDetail/ContentDetail';
                ...
                <tbody>
                  {notesData.length === 0 ? (
                    ...
                    notesData.map((item, index) => (
                      <tr
                        key={item.id || index}
                        className="cursor-pointer border-t border-b border-[#3E1D88] transition-all duration-300 hover:border-[#EE7AF4] hover:bg-[#661BB5]"

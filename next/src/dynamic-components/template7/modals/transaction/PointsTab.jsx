        ...
        <div className="flex h-[400px] flex-col md:h-[500px]">
          ...
          <div className="overflow-x-auto md:overflow-x-visible">
            <div className="inline-block w-full min-w-[720px] align-top">
              {/* Table Header - Fixed */}
              <div className="overflow-hidden rounded-t-[7px] border border-b-0 border-[#3E1D88]">
              ...
              <div className="show-scrollbar flex-1 overflow-y-auto">
                <div className="overflow-hidden rounded-b-[7px] border border-t-0 border-[#3E1D88]">
                  <table className="w-full table-fixed text-[11px] md:text-sm">
                    <tbody>
                      {transactionHistoryLoader ? (
                        ...
                        requestInfoData.map((item, index) => (
                          <tr
                            key={item.id || index}
                            className="cursor-pointer border border-[#3E1D88] text-white transition-all duration-300 last:border-b-0 hover:border-[#EE7AF4] hover:bg-[#661BB5]"
                          >
                            ...
                            <td className="px-1 py-2 md:px-2 md:py-3">
                              <span className="text-[13px] font-normal text-[#EE7AF4] transition-all duration-200 hover:text-[#FFFFFF99]">

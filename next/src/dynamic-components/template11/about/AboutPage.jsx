      ...
      <div className="container mx-auto px-4 py-7 md:px-4">
        <div className="mb-6 flex sm:hidden">
          <button
            ...
            className="flex h-[37px] w-[138px] items-center justify-center gap-2 rounded-[3px] bg-[#DFA336] text-[10px] font-bold text-white transition-all duration-300 hover:border-[#E33A24] hover:bg-[#E33A24]"
            style={{
              padding: '0 10px',
              letterSpacing: '0.3px',
            }}

...
export default function Register(props) {
  ...
  return (
    <div
      className={`mx-auto max-h-[90vh] w-full max-w-[1026px] transform overflow-y-auto rounded-[7px] border border-[#FEA8034D] bg-[#0E0E0E] text-white shadow-xl transition-all duration-300 ease-out md:h-[480px] md:max-h-[480px] md:overflow-visible ${
          ...
          <div className="w-full max-w-[935px]">
            ...
            <form className="space-y-4 pt-2" onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        ...
                        className="w-full rounded-[4px] border border-[#FEA8034D] bg-transparent focus:border-[#FEA8034D] focus:bg-[#1A160D] focus:ring-0 focus:outline-none"
                      />
                    )}
                  />
                </div>
                ...
                <div className="overflow-visible">
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      ...
                      >
                        <SelectTrigger className="w-full rounded-[4px] border border-[#FEA8034D] bg-transparent focus:border-[#FEA8034D] focus:bg-[#1A160D] focus:ring-0 focus:outline-none">
                          <SelectValue placeholder={t('select_bank')} />
                        </SelectTrigger>
                        <SelectContent className="z-[9999] border-[#FEA8034D] bg-[#0E0E0E] text-white">
              ...
              <button
                ...
                className="template10-filled-button-hover mt-5 w-full rounded-[4px] bg-[#DFA336] py-2 font-semibold text-white transition active:scale-95 disabled:opacity-50"
              >

...
export default function PointsTab() {
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-[5px] border border-[#FEA8034D] md:p-4">
        {/* Header */}
        <div className="flex flex-wrap items-center justify-between gap-5 md:mt-2 md:pl-4">
          ...
          <button
            ...
            className="filled-hover-effect flex cursor-pointer items-center justify-center rounded-[6px] bg-[#FEA803] px-6 pt-3 pb-3 text-[14px] font-semibold text-white transition-all duration-200 active:scale-95 md:mr-4"
          >
            ...
            <div className="flex h-[400px] flex-col md:h-[500px]">
              ...
              <div className="overflow-x-auto md:overflow-x-visible">
                <div className="inline-block w-full min-w-[680px] align-top md:p-3">
                  {/* Table Header - Fixed */}
                  <div className="overflow-hidden rounded-t-[9px] border border-b-0 border-[#FEA8034D]">
                  ...
                  <div className="show-scrollbar flex-1 overflow-y-auto">
                    <div className="overflow-hidden rounded-b-[9px] border border-t-0 border-[#FEA8034D]">
                      <table className="w-full table-fixed text-[11px] md:text-sm">
                        <tbody>
                            ...
                            requestInfoData.map((item, index) => (
                              ...
                              >
                                ...
                                <td className="px-1 py-2 md:px-2 md:py-3">
                                  <span className="text-[12px] font-normal text-[#E8D25E] transition-all duration-200 hover:text-[#FFFFFF99]">

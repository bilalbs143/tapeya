...
export default function Transaction({ defaultTab }) {
  ...
  return (
    <div className="transaction-modal relative mx-auto flex h-[80vh] w-full max-w-[1479px] flex-col overflow-hidden rounded-[5px] border-2 border-[#FEA8034D] bg-[#0E0E0E] text-white shadow-xl">

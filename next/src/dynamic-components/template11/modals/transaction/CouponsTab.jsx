                ...
                <div className="inline-block w-full min-w-[680px] align-top md:p-3">
                  <div className="overflow-x-auto md:overflow-x-visible">
                    <div className="inline-block w-full min-w-[720px] align-top">
                      {/* Table Header */}
                      <div className="overflow-hidden rounded-t-[7px] border border-b-0 border-[#FEA8034D]">
                      ...
                      <div className="show-scrollbar flex-1 overflow-y-auto">
                        <div className="overflow-hidden rounded-b-[7px] border border-t-0 border-[#FEA8034D]">
                          <table className="w-full table-fixed text-[11px] md:text-sm">
                            <tbody>
                              {transactionHistoryLoader ? (
                                ...
                                requestInfoData.map((item, index) => (
                                  <tr
                                    key={item.id || index}
                                    className="border border-[#FEA8034D] transition-all duration-300 last:border-b-0 hover:border-[#DFA336] hover:bg-[#0C0C0C] hover:shadow-[inset_0_4.88px_29.278px_0_rgba(254,168,3,0.41)]"
                                  >
                                    ...
                                    <td className="px-1 py-2 md:px-2 md:py-3">
                                      <span className="text-[#E8D25E] transition-all duration-200 hover:text-gray-200">

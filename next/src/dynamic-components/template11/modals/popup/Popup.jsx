          ...
          >
            ...
            >
              <button
                ...
                className="flex w-full cursor-pointer items-center justify-center rounded-b-lg bg-[#DFA336] px-4 pt-3 pb-4 text-sm font-semibold text-black active:scale-95"
              >

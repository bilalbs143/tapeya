...
export default function NoteTab({ openMessageId }) {
  ...
  return (
    <div className="flex h-full flex-col">
      <h3 className="font-spy-agency mb-3 text-left text-[20px] sm:text-[25px] md:text-[25px]">
        {t('notes')}
      </h3>
      ...
      {showNoteDetails ? (
        ...
        <>
          ...
          <div className="overflow-hidden rounded-[9px] border border-[#FEA8034D]">
                ...
                <tbody>
                  {notesData.length === 0 ? (
                    ...
                    notesData.map((item, index) => (
                      <tr
                        key={item.id || index}
                        className="cursor-pointer border-t border-b border-[#FEA8034D] transition-all duration-300 hover:border-[#DFA336] hover:bg-[#0C0C0C] hover:shadow-[inset_0_4.88px_29.278px_0_rgba(254,168,3,0.41)]"

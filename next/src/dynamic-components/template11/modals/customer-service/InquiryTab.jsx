...
import ContentDetail from '@/dynamic-components/template11/components/ContentDetail/ContentDetail';
import Pagination from '@/dynamic-components/template11/components/Pagination/Pagination';
    ...
    <>
      {showInquiryDetails ? (
        ...
        <div className="space-y-6">
          <div className="rounded-[5px] bg-[#1E1E1E4D] p-3 md:p-4 lg:p-6">
            <form
            ...
            >
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input
                      ...
                      type="text"
                      placeholder={t('title')}
                      className="relative block h-[46px] w-full appearance-none rounded-[3px] border border-[#FEA8034D] bg-transparent px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFF66] focus:border-[#FEA8034D] focus:bg-[#1A160D] focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:h-[55px]"
                      error={
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <textarea
                      ...
                      rows="4"
                      className="relative block min-h-[46px] w-full resize-none appearance-none rounded-[3px] border border-[#FEA8034D] bg-transparent px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFF66] focus:border-[#FEA8034D] focus:bg-[#1A160D] focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:min-h-[55px]"
                    />
                  )}
                />
              ...
              <div className="mt-6 hidden justify-end md:flex">
                <button
                  type="submit"
                  className="template10-filled-button-hover flex cursor-pointer items-center justify-center rounded-[4px] bg-[#DFA336] px-16 pt-2.5 pb-2.5 text-[16px] font-semibold text-white transition-all duration-200 active:scale-95"
                  data-hover={t('submit')}
                >
              ...
              <div className="mt-6 flex justify-center md:hidden">
                <button
                  type="submit"
                  className="template10-filled-button-hover flex w-full cursor-pointer items-center justify-center rounded-[3px] bg-[#DFA336] px-8 py-2 text-[16px] font-semibold text-white transition-all duration-200 active:scale-95 md:w-auto"
                  data-hover={t('submit')}
                >
                  <span className="text-container">
                    <span className="text">{t('submit')}</span>
          ...
          <div className="space-y-4">
            ...
            <div className="overflow-hidden rounded-[5px] border border-[#FEA8034D]">
              <div className="show-scrollbar h-[400px] overflow-x-auto overflow-y-auto md:h-[500px]">
                <table className="w-full min-w-[720px] table-fixed text-[11px] md:text-sm">
                  <thead>
                    <tr className="border-b-0 border-[#FEA8034D] bg-[#FEA8031A]">
                  ...
                  <tbody>
                    {allCustomerInquiriesLoader ? (
                      <tr>
                        ...
                        >
                          <div className="flex items-center justify-center py-8">
                            <CommonLoader size="lg" border="border-[#DFA336]" />
                          </div>
                        </td>
                      </tr>
                      ...
                      inquiriesData.map((inquiry, index) => (
                        <tr
                          key={`row-${inquiry.id}`}
                          className="cursor-pointer border border-[#FEA8034D] transition-all duration-300 hover:border-[#DFA336] hover:bg-[#0C0C0C] hover:shadow-[inset_0_4.88px_29.278px_0_rgba(254,168,3,0.41)]"
                        ...
                        >
                          ...
                          <td className="px-2 py-2 text-center text-white md:px-2 md:py-3">
                            <button className="btn-hover-outline rounded-[6px] border border-[#FEA8034D] bg-transparent px-3 py-1 text-xs font-medium text-white transition-colors duration-200 hover:bg-[#DFA336] hover:text-white">
                              {t('details')}
                            </button>
                          </td>
                          <td className="px-1 py-2 text-[#FFFFFF99] md:px-2 md:py-3">

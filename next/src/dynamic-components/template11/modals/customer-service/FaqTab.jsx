            ...
            return (
              <div
                ...
                className={`overflow-hidden rounded-[3px] border text-white transition-colors duration-200 ${
                  isOpen
                    ? 'border-[#FEA8034D] bg-[#1E1E1E4D] p-3'
                    : 'border-[#FEA8034D]'
                }`}
              >
                <button
                ...
                >
                  <div className="flex w-full items-center justify-between px-4 py-3">
                    ...
                    {/* + / − icon inside circle */}
                    <span className="flex h-6 w-6 items-center justify-center rounded-full text-[#FEA803]">
                  ...
                  {isOpen && (
                    <div className="mx-auto mb-1 h-[1px] w-[90%] bg-[#FEA80326] md:w-[97%]" />
                  )}
                </button>

...
export default function ReferralsTab() {
  ...
  return (
    <div className="flex h-full flex-col p-3">
      ...
      <div className="mb-5 grid grid-cols-1 gap-4 md:grid-cols-12">
        <div className="md:col-span-9 md:mt-3">
          ...
          <div className="mt-2 pt-4 text-[14px] font-extrabold text-[#FFFFFF99] italic lg:pt-8 lg:text-[15px]">
            <span className="font-semibold text-[#DFA336] not-italic">
              {t('note')}:
            </span>{' '}
          ...
          <div className="flex h-full flex-col items-center justify-center md:items-end">
            <div className="flex flex-col items-center gap-2">
              ...
              <button
                ...
                className="filled-hover-effect mt-2 flex w-[291px] cursor-pointer items-center justify-center gap-2 rounded-[3px] bg-[#DFA336] px-4 pt-2.5 pb-2.5 text-[13px] font-extrabold text-white active:scale-95 md:w-[191px] md:rounded-[5px]"
              >
      ...
      <div className="mx-auto mb-8 h-[1px] bg-[#FEA8034D] md:w-full" />
        ...
        <div className="flex h-[400px] flex-col md:h-[500px]">
          <div className="overflow-x-auto md:overflow-x-visible">
            <div className="inline-block w-full min-w-[900px] align-top md:min-w-[1100px]">
              {/* Table Header */}
              <div className="overflow-hidden rounded-t-[8px] border border-b-0 border-[#FEA8034D]">
              ...
              {/* Table Body */}
              <div className="show-scrollbar flex-1 overflow-y-auto rounded-b-[8px] border border-t-0 border-[#FEA8034D]">
                {referralsLoader ? (
                  <div className="flex h-[200px] items-center justify-center">
                    <CommonLoader border="border-[#DFA336]" />
                  </div>
                ) : (
                  <table className="w-full table-fixed text-[11px] md:text-sm">
                    <tbody>
                      {items.length === 0 ? (
                        ...
                        items.map((item, index) => (
                          <tr
                            key={item.id || index}
                            className="border-b border-[#FEA8034D] transition-all duration-300 last:border-b-0 hover:border-[#DFA336] hover:bg-[#0C0C0C] hover:shadow-[inset_0_4.88px_29.278px_0_rgba(254,168,3,0.41)]"
                          >

...
const GlobalPageLoader = () => {
  ...
  const goldDots = useMemo(() => {
    return [...Array(100)].map((_, i) => ({
      ...
      color: i % 3 === 0 ? 'rgb(219, 180, 44)' : 'rgb(229, 200, 92)',
  ...
  // Animated loading dots component with gold theme
  const LoadingDots = () => (
    <div className="flex items-center space-x-2">
      <div
        ...
        style={{
          background:
            'linear-gradient(135deg, rgb(219, 180, 44), rgb(229, 200, 92))',
          boxShadow:
            '0 0 15px rgba(219, 180, 44, 0.6), 0 0 25px rgba(229, 200, 92, 0.4)',
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(135deg, rgb(229, 200, 92), rgb(219, 180, 44))',
          boxShadow:
            '0 0 15px rgba(229, 200, 92, 0.6), 0 0 25px rgba(219, 180, 44, 0.4)',
          animation: 'bounce 1s ease-in-out infinite',
  ...
  const SlotReel = ({ delay = 0, speed = 1, offset = 0 }) => {
    ...
    return (
      <div
        ...
        style={{
          background:
            'linear-gradient(180deg, rgb(18, 18, 18) 0%, rgb(24, 24, 24) 50%, rgb(18, 18, 18) 100%)',
          boxShadow:
            'inset 0 0 20px rgba(0, 0, 0, 0.9), 0 4px 12px rgba(0, 0, 0, 0.5)',
          border: '2px solid rgb(219, 180, 44)',
        }}
      >
        {/* Spinning symbols */}
        <div
        ...
        >
          {[...rotatedSymbols, ...rotatedSymbols].map((symbol, i) => (
            <div
              ...
              style={{
                textShadow: '0 0 20px rgba(219, 180, 44, 0.8)',
              }}
            >
              {symbol}
            </div>
        ...
        <div
          ...
          style={{
            height: '2px',
            boxShadow: '0 0 15px rgba(219, 180, 44, 0.6)',
            background:
              'linear-gradient(90deg, transparent, rgb(219, 180, 44) 20%, rgb(219, 180, 44) 80%, transparent)',
          }}
        />
      </div>
    );
    ...
    >
      ...
      <defs>
        <linearGradient
          ...
          y2="100%"
        >
          <stop offset="0%" stopColor="rgb(219, 180, 44)" />
          <stop offset="50%" stopColor="rgb(229, 200, 92)" />
          <stop offset="100%" stopColor="rgb(219, 180, 44)" />
        </linearGradient>
      </defs>
    </svg>
  );
    ...
    >
      ...
      <style jsx>{`
        ...
        @keyframes glow {
          ...
          100% {
            box-shadow:
              0 0 20px rgba(219, 180, 44, 0.4),
              0 0 40px rgba(229, 200, 92, 0.2);
          }
          50% {
            box-shadow:
              0 0 30px rgba(219, 180, 44, 0.6),
              0 0 60px rgba(229, 200, 92, 0.4);
          }
        }
        @keyframes slideIn {
          0% {
      ...
      <div className="relative z-10 flex flex-col items-center space-y-6 sm:space-y-8">
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(135deg, rgb(18, 18, 18) 0%, rgb(24, 24, 24) 50%, rgb(18, 18, 18) 100%)',
            boxShadow:
              '0 10px 40px rgba(0, 0, 0, 0.6), 0 0 40px rgba(219, 180, 44, 0.2)',
            border: '2px solid rgb(219, 180, 44)',
          }}
        >
          {/* Slot Machine Header */}
          <div className="mb-3 text-center sm:mb-5">
            <div className="mb-2 flex items-center justify-center gap-1.5 text-lg sm:mb-3 sm:gap-2 sm:text-3xl">
              <span
                ...
                style={{
                  animation: 'bounce 1s ease-in-out infinite',
                  textShadow: '0 0 20px rgba(219, 180, 44, 0.9)',
                }}
              >
                🎰
              </span>
              <span
                ...
                style={{
                  background:
                    'linear-gradient(90deg, rgb(219, 180, 44), rgb(229, 200, 92), rgb(219, 180, 44))',
            ...
            >
              <div
                ...
                style={{
                  background:
                    'linear-gradient(90deg, rgb(219, 180, 44), rgb(229, 200, 92), rgb(219, 180, 44))',
                  boxShadow: '0 0 10px rgba(219, 180, 44, 0.5)',
            ...
            {['💎', '👑', '⭐'].map((symbol, i) => (
              <div
                ...
                style={{
                  ...
                  textShadow: '0 0 15px rgba(219, 180, 44, 0.8)',
                }}
              >
                {symbol}
              </div>

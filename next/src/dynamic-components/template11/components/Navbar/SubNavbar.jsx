    ...
    <section className="pt-6 md:pt-10">
      ...
      <div className="hidden justify-center md:flex">
        <div className="w-full max-w-[1520px] px-4">
          <div
            className="flex h-[55px] items-center rounded-[3px] border bg-[#121212]"
            style={{ borderColor: '#FEA8034D' }}
          >
            {/* Left */}
            <div className="flex items-center gap-2 px-4">
              <span
                className="font-cravend gap-4 text-[16px] font-bold text-[#DFA336]"
            ...
            <div
              ...
              style={{ backgroundColor: '#FEA8034D' }}
            />

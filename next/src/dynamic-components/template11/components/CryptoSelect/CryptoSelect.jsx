...
export default function CryptoSelect({
  ...
  return (
    <div className={`space-y-6 ${className}`}>
            ...
            <div className="flex flex-wrap gap-1 md:gap-3">
              {categories.map((cat) => (
                <button
                  ...
                  className={`flex-1 rounded-[4px] border px-3 py-2 text-[12px] font-bold whitespace-nowrap transition-all duration-300 md:flex-none md:px-6 md:py-2.5 md:text-[14px] ${
                    category === cat.key
                      ? 'border-[#FEA8034D] bg-[#FEA803] text-white'
                      : 'border-[#FEA8034D] bg-[#1A160D] text-[#DFA336]'
                  }`}
                >
                  {cat.label}
                </button>
      ...
      <div className="rounded-[5px] border border-[#FEA8034D] bg-transparent p-4 md:p-5">
                ...
                <button
                  ...
                  className={`group flex min-h-[80px] w-full items-center justify-between gap-3 rounded-[5px] border-2 px-4 py-4 text-[#cfd8df] transition-all duration-300 sm:px-4 ${
                    selectedCurrency === c.code
                      ? 'border-[#FEA8034D] bg-[#0C0C0C]'
                      : 'border-[#FEA8034D] bg-transparent'
                  } hover:border-[#FEA803] focus:border-[#FEA803] focus:shadow-[inset_0_4.723px_28.336px_0_rgba(254,168,3,0.41)]`}
                >

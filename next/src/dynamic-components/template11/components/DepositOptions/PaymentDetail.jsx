...
const DropdownOption = memo(({ option, onSelect, field }) => (
  <div
    key={option}
    className="cursor-pointer px-3 py-2 text-xs text-white transition-colors duration-150 hover:bg-[#FEA803] md:text-sm"
    onClick={() => {
  ...
  return (
    <div className="space-y-6 text-white">
      ...
      <div className="mb-4 flex flex-wrap items-center gap-2 sm:gap-4">
        ...
        <div className="flex items-center gap-2 rounded bg-[#FEA80326] px-3.5 py-2 text-xs sm:text-sm">
          <Image
                ...
                render={({ field }) => (
                  <div className="flex w-full flex-col gap-1">
                    <div className="relative w-full" ref={sendingDropdownRef}>
                      <div
                        className={`relative flex h-[46px] w-full cursor-pointer appearance-none items-center justify-between rounded-[5px] border px-3 py-3 text-white shadow-none focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm lg:h-[55px] ${
                          errors.sendingOption
                            ...
                            : 'border-[#FEA8034D] bg-transparent focus:border-[#FEA8034D]'
                        }`}
                      ...
                      {isSendingOpen && (
                        <div className="absolute z-20 mt-1 max-h-56 w-full overflow-auto rounded-[5px] border border-[#FEA8034D] bg-[#1a1a1a] shadow-xl">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Input
                    ...
                    className="relative block h-[46px] w-full appearance-none rounded-[5px] border border-[#FEA8034D] bg-transparent px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFF66] placeholder:capitalize focus:border-[#FEA803] focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:h-[55px]"
              ...
              <Controller
                ...
                render={({ field: { onChange } }) => (
                  <div className="flex w-full flex-col gap-1">
                    <div
                      className={`flex w-full flex-wrap items-center gap-3 rounded-[5px] border px-3 py-2 shadow-none transition-colors focus-within:ring-0 focus-within:ring-transparent focus-within:outline-none ${
                        errors.receiptFile
                          ...
                          : 'border-[#FEA8034D] bg-transparent focus-within:border-[#FEA803] hover:border-[#FEA803]'
                      }`}
                      onDragOver={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                    ...
                    >
                      <div
                        className={`filled-hover-effect btn-style901 rounded-md bg-[#FEA803] px-6 py-2 text-xs font-semibold text-black transition-opacity focus-within:ring-2 focus-within:ring-[#4A9B4A] focus-within:outline-none active:scale-95 ${
                          isFileDialogOpening
            ...
            <div className="mt-6 space-y-3">
                    ...
                    >
                      ...
                      <span
                        ...
                        className={`grid h-5 w-5 flex-shrink-0 place-items-center rounded-[3px] border-2 transition-all duration-200 ${
                          field.value
                            ? 'border-[#FEA803] bg-[#FEA803]'
                            : 'border-[#FEA8034D] bg-transparent hover:border-[#FEA803]'
                        }`}
                      >
                        <svg
                          viewBox="0 0 24 24"
              ...
              <div className="mt-8 flex w-full flex-row justify-center">
                <button
                  ...
                  className="template9-filled-button-hover flex h-[52px] w-[704px] items-center justify-center rounded-[6px] bg-[#FEA803] text-[16px] font-semibold text-black transition-all duration-200 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
                >

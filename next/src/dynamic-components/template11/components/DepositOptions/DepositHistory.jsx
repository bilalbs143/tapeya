...
import TransactionDetail from '@/dynamic-components/template11/components/TransactionDetail/TransactionDetail';
                    ...
                    requestInfoData.data.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-1 py-2 whitespace-nowrap md:px-2 md:py-3">
                          <span className="text-[#E8D25E] transition-all duration-200">

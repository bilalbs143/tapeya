...
const ContentDetail = ({ title, data, onClose, fields = [] }) => {
  ...
  return (
    <>
      ...
      <div className="space-y-6 rounded-[7px] border border-[#FEA8034D] p-4">
        ...
        <div className="rounded-[5px] p-3">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="flex flex-col gap-4">
              <div>
                ...
                <input
                  ...
                  readOnly
                  className="h-[46px] w-full cursor-not-allowed rounded-[3px] border border-[#272727] bg-transparent px-3 text-[12px] text-[#FFFFFF80]"
                />
              </div>
            ...
            <div>
              ...
              <div className="min-h-[136px] w-full cursor-not-allowed rounded-[3px] border border-[#272727] bg-transparent px-3 py-3 text-sm text-[#FFFFFF80]">
                <div
        ...
        <div className="mx-auto mb-6 h-[1px] bg-[#FEA8034D] md:w-[98%]" />
        ...
        <div className="rounded-[5px] bg-transparent p-4">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-[2fr_1fr]">
            ...
            <div>
              ...
              <div className="min-h-[260px] w-full cursor-not-allowed rounded-[3px] border border-[#272727] bg-transparent px-3 py-3 text-sm text-[#FFFFFF80]">
                <div
                  className="text-xs break-words md:text-sm"
                  dangerouslySetInnerHTML={{

        ...
        <div className="mt-6 flex flex-col items-center justify-center gap-4">
          {hasMore && (
            <button
              ...
              className="inline-flex transform cursor-pointer items-center justify-center rounded-[5px] border-2 border-[#E8D25E] bg-[#D3AF37]/10 px-8 py-3 font-semibold text-[#D3AF37] transition-all hover:scale-105 hover:bg-[#D3AF37]/20 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
            >

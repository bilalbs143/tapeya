  ...
  return (
    <div className="rounded-[16px] border border-[#FFFFFF66] bg-transparent p-5">
        ...
        <div className="rounded-[12px] border border-[#FFFFFF66] bg-transparent px-6 py-8 text-white">
          <div className="flex flex-col gap-3 md:flex-row md:items-center">
            <div className="flex-1">
              <div className="rounded-[10px] border border-[#55BC55] bg-[#0A1818] px-4 py-4">
                <div className="text-center text-base font-bold md:text-lg">
                  <span className="text-[#55BC55]">
      ...
      <div className="mb-6">
        ...
        <div className="rounded-[12px] bg-[#0A1818] px-5 py-4 text-white">
      ...
      <div className="">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-stretch">
          <div className="flex-1 rounded-[12px] border border-[#054516] bg-black px-3 py-3 text-white">
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                aria-label="copy"
                className="filled-hover-effect shrink-0 transition-opacity hover:opacity-80"
          ...
          <button
            className="filled-hover-effect w-full rounded-[10px] bg-[#55BC55] px-5 py-3 text-sm font-bold text-black transition-all duration-200 active:scale-95 disabled:opacity-50 sm:w-[270px]"
            onClick={() =>
              copyToClipboard(withdrawalData?.withdraw_address || '')
            }
            disabled={!withdrawalData?.withdraw_address}
      ...
      <div className="mt-6">
        ...
        <div className="text-grey-400 rounded-[12px] bg-[#0A1818] px-5 py-4">

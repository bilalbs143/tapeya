...
function AuthNavbar() {
  ...
  const navigationItems = [
    ...
    {
      label: getCapitalizedLabel('customer_inquiry', 'RAKENING'),
  ...
  return (
    <>
      {/* Main Navbar */}
      <nav
        className={`relative z-[100] bg-[#161616] overflow-visible ${
          isMobilePlatform ? 'pt-safe-top' : ''
        }`}
      >
        <div className="container mx-auto px-4 overflow-visible">
          <div className="relative flex items-center justify-between overflow-visible" style={{ minHeight: '56px' }}>
            ...
            <div className="hidden flex-1 items-center gap-0 md:flex relative" style={{ height: '56px' }}>
              {(() => {
                ...
                return desktopItems.map((item, index) => {
                  if (item.isText) {
                    return (
                      <div key={index} className="relative flex items-center h-full">
                        <span className="flex items-center px-4 text-sm font-bold text-[#E8D25E]">
                          {item.label}
                        </span>
                  ...
                  if (isUserArea) {
                    ...
                    return (
                      <div key={index} className="relative flex items-center h-full">
                        <Link
                          href={item.href}
                          className={`flex items-center px-4 text-sm font-bold text-[#E8D25E] transition-colors hover:opacity-80 ${
                  ...
                  return (
                    <div key={index} className="relative flex items-center h-full">
                      <Link
                        href={item.href}
                        className={`flex items-center gap-2 px-4 text-sm font-medium text-[#787878] transition-colors hover:text-[#E8D25E] ${
                          isActive ? 'text-[#E8D25E]' : ''
                        }`}
                      >
            ...
            <div
              className="hidden items-center gap-0 md:flex md:flex-shrink-0 relative overflow-visible"
              style={{ height: '56px' }}
            >
              <span
                className="absolute top-0 bottom-0 left-0 w-px bg-[#2F2F2F]"
                style={{ height: '56px' }}
              />

              {/* How to play icon (separate cell from profile) */}
              <div className="relative flex items-center h-full group px-3">
                <button
                  type="button"
                ...
                <span
                  ...
                  role="tooltip"
                >
                  {getCapitalizedLabel('how_to_play_title', 'How To Play')}
                </span>
              </div>

              {/* Separator between How to play and Profile */}
              <span
                className="h-6 w-px flex-shrink-0 bg-[#2F2F2F]"
              />
              ...
              <div className="relative flex items-center h-full overflow-visible">
                <button
                  ...
                  className="group flex cursor-pointer items-center gap-2 px-4 text-sm font-medium text-[#787878] transition-colors hover:text-[#E8D25E] h-full"
                >
                  {/* User Icon */}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="relative flex items-center h-full">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 text-sm font-medium text-[#787878] transition-colors hover:text-[#E8D25E] h-full"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                  ...
                  >
                    <path
                      d="M5 18L5 6C5 4.93913 5.42143 3.92172 6.17157 3.17157C6.92172 2.42143 7.93913 2 9 2H15C16.0609 2 17.0783 2.42143 17.8284 3.17157C18.5786 3.92172 19 4.93913 19 6V18C19 19.0609 18.5786 20.0783 17.8284 20.8284C17.0783 21.5786 16.0609 22 15 22H9C7.93913 22 6.92172 21.5786 6.17157 20.8284C5.42143 20.0783 5 19.0609 5 18Z"
                      stroke="#797979"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M10.75 9.5L13.25 12L10.75 14.5"
                      stroke="#797979"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                  ...
                  <span>{getCapitalizedLabel('logout', 'SIGN-OUT')}</span>
                </button>
                {/* Separator after Logout */}
                <span
                  className="absolute top-0 bottom-0 right-0 w-px bg-[#2F2F2F]"
                  style={{ height: '56px' }}
                />
            ...
            {/* Mobile How to play + Menu Button */}
            <div className="relative z-[1000] flex items-center gap-3 md:hidden">
              {/* How to play icon (mobile) */}
              <button
                type="button"
                onClick={() => router.push('/how-to-play')}
                className="flex h-[44px] w-[44px] items-center justify-center rounded-[10px] text-[#E8D25E] bg-transparent border border-transparent hover:border-[#E8D25E]/40 hover:bg-[#E8D25E]/10 transition-colors"
                aria-label={t('how_to_play_title')}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                >
                  ...
                  <path d="M9 10c0-1.66 1.34-3 3-3s3 1.34 3 3c0 .98-.47 1.85-1.2 2.4-.73.55-1.3.6-1.8 1.6" />
                  <path d="M12 17v0.01" />
                </svg>
              </button>
        ...
        >
          ...
          >
            ...
            <div className="px-4 py-4">
              <div className="flex w-full items-center gap-3 rounded-[5px] border border-[#FFFFFF66] bg-[#000304] px-3 py-3">
                      ...
                      <Link
                        ...
                        className={`flex items-center rounded-[5px] px-3 py-2 text-sm font-bold transition-colors ${
                          isActive
                            ...
                            : 'text-[#E8D25E] hover:bg-[#E8D25E]/20'
                        }`}
                      >
                        {item.label}
                      </Link>
                  ...
                  return (
                    <Link
                      ...
                      className={`flex items-center gap-2 rounded-[5px] px-3 py-2 text-sm font-medium transition-colors ${
                        isActive
                          ? 'bg-[#E8D25E] text-black'
                          : 'text-[#787878] hover:bg-[#E8D25E]/20'
                      }`}
                    >
                      <span className="flex-shrink-0">{renderIcon(item.icon)}</span>
                      <span>{item.label}</span>

          ...
          <div className="game-card-image-section">
            <div className="game-card-image-wrap">
              <div className="game-card-media">
                ...
                {/* Overlay background */}
                <div className="absolute inset-0 transition-all duration-300 sm:group-hover:bg-[#6d6936c9]" />
                  ...
                  <div className="absolute inset-0 z-10 hidden items-center justify-center transition-all duration-300 sm:flex">
                    <div className="flex flex-col items-center gap-2 opacity-0 transition-opacity duration-300 sm:gap-3 sm:group-hover:opacity-100">
                      <button
                        ...
                        className={`flex h-12 w-12 cursor-pointer items-center justify-center rounded-full border-2 border-[#E8D25E] bg-black transition-colors hover:border-[#FFF788] disabled:opacity-50 sm:h-16 sm:w-16 ${playButtonClassName}`}
                        style={{

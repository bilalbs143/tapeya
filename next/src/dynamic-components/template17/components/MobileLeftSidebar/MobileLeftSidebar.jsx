...
export default function MobileLeftSidebar() {
  ...
  const linkClass = (href) =>
    `mobile-left-sidebar-btn ${isActive(href) ? 'mobile-left-sidebar-btn-active' : ''}`;
  ...
  return (
    ...
    >
      ...
      <Link
        href={isAuth ? '/dashboard/customer-inquiry' : '/contact-us'}
        className={linkClass(isAuth ? '/dashboard/customer-inquiry' : '/contact-us')}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="14"

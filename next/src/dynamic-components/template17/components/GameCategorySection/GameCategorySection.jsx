...
import GameCard from '@/dynamic-components/template17/components/GameCard/GameCard';
...
function GameCategorySection() {
  ...
  // Slot providers - matches template14 (same keys and getProviderId lookup by name)
  ...
  // Casino providers - matches template14 live casino (same ids and provider keys)
      ...
      <div className="max-w-full">
        ...
        <div className="grid grid-cols-1 gap-4 sm:gap-6 lg:grid-cols-[180px_1fr] xl:grid-cols-[220px_1fr]">
          ...
          <div className="w-full">
            <div className="flex flex-row flex-wrap gap-2 rounded-[10px] border border-[#E8D25E]/30 bg-[#111111] p-2 sm:gap-3 sm:p-3 lg:flex-col lg:flex-nowrap lg:gap-3 lg:p-4">
              {categories.map((category) => {
                ...
                return (
                  <button
                    ...
                    disabled={!isEnabled}
                    className={`flex flex-1 items-center gap-2 rounded-[7px] bg-[#E8D25E]/[0.09] px-2 py-2 transition-all duration-200 sm:gap-2 sm:px-3 sm:py-2 lg:w-full lg:flex-initial lg:gap-3 lg:px-4 lg:py-3 ${

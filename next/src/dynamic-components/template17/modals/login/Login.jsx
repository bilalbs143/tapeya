      ...
      <div className="rounded-[12px] bg-black p-6 sm:p-8">
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-bold text-[#E8D25E] uppercase sm:text-3xl">
              {t('login') || 'LOGIN'}
            </h2>
            <button
          ...
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="pt-2">
              <button
                ...
                className="flex w-full cursor-pointer items-center justify-center rounded-[5px] bg-[#E8D25E] px-4 py-4 text-base font-bold text-black [box-shadow:inset_0_-6px_0_#876800] transition-all duration-200 hover:[box-shadow:inset_0_-4px_0_#876800] active:scale-95 active:[box-shadow:inset_0_-2px_0_#876800] disabled:cursor-not-allowed disabled:opacity-50"
              >
                {loginLoader

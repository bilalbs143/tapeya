...
import DepositBankTab from '@/dynamic-components/template17/components/DepositOptions/DepositBankTab';
import DepositCryptoTab from '@/dynamic-components/template17/components/DepositOptions/DepositCryptoTab';
import DepositDebitTab from '@/dynamic-components/template17/components/DepositOptions/DepositDebitTab';
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-4">
        ...
        {/* Tab content */}
        <div className="rounded-[6px] border border-[#E8D25E4D] p-3 md:p-4 lg:p-6">

        ...
        <div className="">
          ...
          >
            <div className="p-8 md:p-12">
              {/* Header */}
              <div className="mb-8">
                <h1 className="mobile-title mb-4 bg-[#E8D25E] bg-clip-text text-[25px] font-semibold text-transparent lg:text-[60px]">
              ...
              <div className="space-y-6">
                <section>
                  <h2 className="mobile-section-heading mb-4 bg-gradient-to-r from-[#D3AF37] via-[#FFF788] to-[#D3AF37] bg-clip-text font-bold text-transparent">

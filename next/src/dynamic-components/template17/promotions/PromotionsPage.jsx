...
import UserPromotions from '@/dynamic-components/template17/components/UserPromotions/UserPromotions';
...
export default function PromotionsPage({ embedded = false }) {
  ...
  const content = (
    <>
      {/* Header with Back Button and Heading (standalone only) */}
      {!embedded && (
        <div className="container mx-auto px-4 pt-6 text-white md:px-0">
          <div className="mb-4 flex items-center justify-between gap-4">
            {showBackButton ? (
              ...
              <div className="w-[30px] sm:w-[33px]" /> // Spacer to maintain layout
            )}
        ...
        <div className="container mx-auto space-y-6 px-4 md:px-6">
          {promotions && promotions.length === 0 ? (
            ...
            (promotions || []).map((promo) => (
              <div
                key={promo.id}
                className={`overflow-hidden rounded-[10px] border border-[#E8D25E] ${

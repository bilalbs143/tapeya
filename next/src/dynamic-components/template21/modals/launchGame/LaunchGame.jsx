        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              className="flex h-12 w-full cursor-pointer items-center justify-center rounded-lg text-sm font-semibold text-white transition-all duration-150 active:scale-95 disabled:opacity-50 sm:h-14 sm:text-base"
              style={{
                backgroundImage: 'linear-gradient(#74cae3, #5bc0de 60%, #4ab9db)',
              }}
            >

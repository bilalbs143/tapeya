...
export default function Transaction({ defaultTab }) {
  ...
  return (
    <div className="transaction-modal relative mx-auto flex h-[80vh] w-full flex-col overflow-hidden rounded-[12px] p-[1px] text-white shadow-xl" style={{ backgroundImage: 'linear-gradient(#74cae3, #5bc0de 60%, #4ab9db)' }}>
            ...
            <div className="flex flex-wrap gap-1 md:gap-2">
              {[
                ...
                <button
                  ...
                  className={`flex-1 rounded-[5px] border border-[#FFFFFF66] px-3 py-2 text-[12px] font-bold whitespace-nowrap transition-all duration-300 md:border-0 md:px-6 md:py-3 md:text-[14px] lg:px-8 lg:text-[16px] ${activeTab === t.key ? 'text-white' : 'text-white'}`}

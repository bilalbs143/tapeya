...
import DepositBankTab from '@/dynamic-components/template21/components/DepositOptions/DepositBankTab';
import DepositCryptoTab from '@/dynamic-components/template21/components/DepositOptions/DepositCryptoTab';
import DepositDebitTab from '@/dynamic-components/template21/components/DepositOptions/DepositDebitTab';
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-4">
        {/* Tabs header */}
        {/* Commented out tab switcher for Deposit Bank, Deposit Crypto, and Deposit Bank/Credit */}
        ...
        {/* Tab content */}
        <div className="rounded-[6px] border border-[rgba(0,0,0,0.6)] p-3 md:p-4 lg:p-6">

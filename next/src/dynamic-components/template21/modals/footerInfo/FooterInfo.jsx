    ...
    >
      ...
      <div className="absolute top-4 right-4 z-10 md:top-4 md:right-4">
        <button
          ...
          className="flex h-8 w-8 cursor-pointer items-center justify-center rounded-md text-white transition-all duration-300 hover:opacity-90 sm:h-10 sm:w-10"
          style={{
      ...
      <div className="relative block border-b border-white bg-[#1E1E1E] px-4 py-3 pr-14 md:hidden">
        <select
          value={activeSection}

            ...
            <tbody>
              {requestInfoLoader ? (
                ...
                requestInfoData.data.map((item, index) => (
                  ...
                  >
                    <td className="w-12 border-t border-[#1c1e22] px-[8px] py-[5px] text-center whitespace-nowrap text-white md:w-14">
                      {calculateIndex(
                        index,
                        currentPage,
                        rowsPerPage,
                    ...
                    <td className="whitespace-nowrap border-t border-[#1c1e22] px-[8px] py-[5px]">

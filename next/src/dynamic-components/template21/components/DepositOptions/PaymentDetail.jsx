...
const DropdownOption = memo(({ option, onSelect, field }) => (
  <div
    key={option}
    className="cursor-pointer px-3 py-2 text-xs text-white transition-colors duration-150 hover:opacity-90 md:text-sm"
    onMouseEnter={(e) => { e.currentTarget.style.backgroundImage = 'linear-gradient(#74cae3, #5bc0de 60%, #4ab9db)'; }}
    onMouseLeave={(e) => { e.currentTarget.style.backgroundImage = 'transparent'; }}
    onClick={() => {
...
export default function ConfirmPaymentDetail({
  ...
  return (
    <div className="space-y-6 text-white">
      ...
      {/* Single-column layout: account details and form */}
      <div className="mt-10 grid grid-cols-1 gap-6">
        {/* Account details section */}
        <div className="h-max rounded-[16px] bg-black p-5">
              ...
              <Controller
                ...
                render={({ field: { onChange } }) => (
                  <div className="flex w-full flex-col gap-1">
                    ...
                    >
                      <div
                        className={`btn-style901 rounded-md px-4 py-2 text-xs font-semibold text-white transition-opacity focus-within:ring-2 focus-within:outline-none active:scale-95 ${
                          isFileDialogOpening
            ...
            <div className="mt-6 space-y-3">
              ...
              <div className="mt-6 flex flex-row justify-center gap-3 sm:gap-4">
                <button
                  type="button"
                  onClick={handleBack}
                  className="btn-style503 btn-style901 inline-flex items-center justify-center rounded-[10px] border-2 border-[#FFFFFF66] bg-transparent px-6 py-3 text-[14px] font-semibold text-white transition-all duration-200 hover:opacity-10 active:scale-95"
                >
                  {t('back')}
                </button>
                <button
        ...
        >
          ...
          >
            ...
            <button
              type="button"
              onClick={() => setIsQRPreviewOpen(false)}
              className="absolute top-2 right-2 flex h-8 w-8 items-center justify-center rounded-full text-white transition-opacity hover:opacity-80"
              style={{
                backgroundImage: 'linear-gradient(#74cae3, #5bc0de 60%, #4ab9db)',
              }}

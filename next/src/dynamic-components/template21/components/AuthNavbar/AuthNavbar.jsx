...
function AuthNavbar() {
  ...
  return (
    <>
      ...
      >
        <div className="mx-auto w-full min-w-0 overflow-hidden px-4 md:px-0 min-[768px]:max-w-[750px] min-[992px]:max-w-[970px] min-[1200px]:max-w-[1170px]">
          <div className="relative flex min-w-0 items-center justify-between gap-1 overflow-hidden" style={{ minHeight: '56px' }}>
            {/* User Area text - Mobile Only */}
            <div className="flex items-center py-3 md:hidden">
              <span className="text-sm font-semibold text-[#FFDD00]">
                {t('user_area') || 'User Area'}
              </span>
            </div>
                ...
                return desktopItems.map((item, index) => {
                  if (item.isText) {
                    return (
                      <div key={index} className="relative flex items-center h-full">
                        <span className="flex items-center px-4 text-[12px] font-bold text-[#E8D25E] [text-shadow:1px_1px_1px_rgba(0,0,0,0.3)]">
                          {item.label}
                        </span>
                  ...
                  if (isUserArea) {
                    ...
                    return (
                      <div key={index} className="relative flex items-center h-full">
                        <Link
                          href={item.href}
                          className={`flex items-center px-4 text-[12px] font-bold text-[#FFDD00] transition-colors hover:opacity-80 [text-shadow:1px_1px_1px_rgba(0,0,0,0.3)] ${
                  ...
                  return (
                    <div key={index} className="relative flex items-center h-full group">
                      <Link
                        href={href}
                        className={`flex items-center gap-1.5 px-4 text-[12px] font-medium transition-all [text-shadow:1px_1px_1px_rgba(0,0,0,0.3)] h-full ${
                          isActive 
                            ? 'text-[#E8D25E]' 
                            : 'text-white'
                        }`}
            ...
            <div className="hidden min-w-0 items-center gap-0 md:flex md:flex-shrink-0 relative overflow-visible" style={{ height: '56px' }}>
              ...
              <div className="relative flex items-center h-full group px-4">
                <button
                  type="button"
                  onClick={() => router.push('/how-to-play')}
                  onMouseEnter={() => setHowToPlayReplayKey((k) => k + 1)}
                  className="flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-lg text-[#FFDD00] transition-colors hover:bg-[#FFDD00]/10 focus:outline-none focus:ring-0"
              ...
              <div className="relative flex min-w-0 items-center h-full group">
                <button
                  ...
                  className="flex cursor-pointer items-center gap-1.5 px-4 text-[12px] font-medium text-white transition-all h-full min-w-0 [text-shadow:1px_1px_1px_rgba(0,0,0,0.3)]"
                  style={{
                    backgroundImage: 'linear-gradient(#020202, #101112 40%, #191b1d)',
                    backgroundSize: '100% 0%',
                    backgroundRepeat: 'no-repeat',
              ...
              <div className="relative flex items-center h-full group">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-4 text-[12px] font-medium text-white transition-all h-full [text-shadow:1px_1px_1px_rgba(0,0,0,0.3)]"
                  style={{
                    backgroundImage: 'linear-gradient(#020202, #101112 40%, #191b1d)',
                    backgroundSize: '100% 0%',
                    backgroundRepeat: 'no-repeat',
              ...
              <div className="relative flex min-w-0 items-center h-full">
                <span className="absolute top-0 bottom-0 left-0 w-px bg-[#2F2F2F]" style={{ height: '56px' }} />
                <div className="flex min-w-0 items-center gap-1.5 px-4 text-[12px] font-medium text-white h-full [text-shadow:1px_1px_1px_rgba(0,0,0,0.3)]">
            ...
            <div className="relative z-[1000] flex items-center gap-1 md:hidden">
              <div className="relative group overflow-visible">
                <button
                  type="button"
                  onClick={() => router.push('/how-to-play')}
                  onMouseEnter={() => setHowToPlayReplayKey((k) => k + 1)}
                  className="flex h-[35px] w-[35px] flex-shrink-0 items-center justify-center rounded-[6px] text-[#FFDD00] transition-colors hover:bg-[#FFDD00]/10 focus:outline-none focus:ring-0"
                  aria-label={t('how_to_play_title')}
                >
                  <svg
                    key={howToPlayReplayKey}
              ...
              <button
                ...
                className="relative flex h-[35px] w-[35px] flex-shrink-0 cursor-pointer items-center justify-center rounded-[6px] text-white transition-colors duration-200 hover:text-orange-400"
                ...
                {navigationItems.map((item, index) => {
                  if (item.isText) {
                    return (
                      <div
                        key={index}
                        className="px-4 py-2 text-sm font-bold text-[#E8D25E]"
                      >
                        {item.label}
                      </div>
                    );
                  ...
                  if (isUserArea) {
                    return (
                      <Link
                        ...
                        className={`flex items-center rounded-[5px] px-4 py-2 text-sm font-bold transition-colors ${
                          isActive
                            ? 'text-white'
                            : 'text-[#FFDD00] hover:opacity-80'
                        }`}
                        style={
                          isActive
                            ? {
                  ...
                  return (
                    <Link
                      ...
                      href={href}
                      onClick={closeMobileMenu}
                      className={`flex items-center gap-2 rounded-[5px] px-4 py-2 text-sm font-medium transition-colors ${
                        isActive

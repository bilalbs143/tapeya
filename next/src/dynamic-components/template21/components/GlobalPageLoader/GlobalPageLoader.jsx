...
const GlobalPageLoader = () => {
  ...
  // Memoize accent dots positions (template21 red & cyan scheme)
  ...
  // Animated loading dots component with template21 accent theme
  const LoadingDots = () => (
  ...
  // Diamond particle component (still used for subtle accent, recolored to template21 scheme)

...
const FloatingButtons = () => {
  ...
  const handleWithdrawalClick = useCallback(() => {
    router.push('/dashboard/home?tab=withdrawal');
    setIsExpanded(false);
  }, [router]);

  const handleDepositClick = useCallback(() => {
    router.push('/dashboard/home?tab=deposit');
    setIsExpanded(false);
  }, [router]);

  const handleSupportClick = useCallback(() => {
    router.push('/dashboard/home?tab=cm_inquiry');
    setIsExpanded(false);
  }, [router]);

  const handleNotesClick = useCallback(() => {
    router.push('/dashboard/home?tab=notes');
    setIsExpanded(false);
  }, [router]);
    ...
    <div ref={containerRef} className="floating-buttons-container">
      ...
      >
        ...
        >
          <div className="floating-button-inner">
            <div className="floating-button-content">
              {/* Deposit icon - wallet with arrow pointing up */}
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" className="floating-button-icon">
                ...
                <path d="M10 6v6M7 9l3 3 3-3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
      ...
      >
        ...
        >
          <div className="floating-button-inner">
            <div className="floating-button-content">
              {/* Withdrawal icon - wallet with arrow pointing down */}
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" className="floating-button-icon">
                <rect x="1" y="4" width="18" height="12" rx="2" stroke="currentColor" strokeWidth="1.5"/>
                <path d="M1 8h18" stroke="currentColor" strokeWidth="1.5"/>
      ...
      {/* Inquiry Button - appears downward (label matches Auth navbar) */}
      <div
          ...
          <div className="floating-button-inner">
            <div className="floating-button-content">
              <img
                ...
                className="floating-button-icon"
              />
              <span className="floating-button-text">{t('inquiry')}</span>
            </div>
          </div>
        </button>
      </div>

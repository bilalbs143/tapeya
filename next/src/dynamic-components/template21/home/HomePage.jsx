...
import HeroSection from '@/dynamic-components/template21/components/HeroSection/HeroSection';
import SubNavbar from '@/dynamic-components/template21/components/Navbar/SubNavbar';
import RegisterForm from '@/dynamic-components/template21/register/RegisterForm';
...
function HomePage() {
  ...
  return (
    <div className="relative text-white">
      ...
      {/* SubNavbar - Mobile only, directly under Navbar */}
      ...
      {!isAuth && (
        <div className="block md:hidden bg-[#402f04]" style={{ overflowAnchor: 'none' }}>
          <div className="container mx-auto px-4 pb-6" style={{ overflowAnchor: 'none' }}>
            {/* Login and Register Section */}
            <section className="p-4 space-y-4" style={{ overflowAnchor: 'none' }}>
              <form
              ...
              >
                ...
                <SimpleImageCaptcha
                  ...
                  width={60}
                  height={30}
                  imageClassName="rounded-[8px] border-0"
                />
              ...
              >
                <div className="min-h-0 overflow-hidden" style={{ overflowAnchor: 'none' }}>
                  <div className="pt-2">
                    <h2 className="mb-4 flex h-[36px] w-full items-center justify-center rounded-[3px] bg-[linear-gradient(#484e55,#3a3f44_60%,#313539)] text-[14px] font-bold text-white">
                      {t('register') || 'Register'}
                    </h2>
                    <RegisterForm

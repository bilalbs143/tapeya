...
const T21_ACCENT = '#ec4d49';
const T21_ACCENT_RGBA_30 = 'rgba(236, 77, 73, 0.3)';
const T21_ACCENT_RGBA_20 = 'rgba(236, 77, 73, 0.2)';
const T21_ACCENT_RGBA_15 = 'rgba(236, 77, 73, 0.15)';
...
function HowToPlayPage() {
      ...
      return (
        <div className="space-y-6 text-[#B0B0B0] md:space-y-8 md:text-base">
          ...
          <div
            ...
            style={{ borderColor: T21_ACCENT_RGBA_30 }}
          >
            <Image
              ...
              >
                ...
                {isOpen && (
                  <div
                    ...
                    style={{ borderColor: T21_ACCENT_RGBA_20, backgroundColor: '#111111' }}
                  >
  ...
  return (
    <div className="min-h-screen bg-[#402f04] text-white">

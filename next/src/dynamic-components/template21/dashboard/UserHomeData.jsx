...
function UserHomeData() {
  ...
  const { getCurrency, headerLogo } = useTemplate();
  ...
  return (
    <section className="w-full">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-[auto_1fr_1fr_1fr]">
        {/* Site Logo */}
        ...
        {/* User Data */}
        <div
          className="flex flex-col overflow-hidden rounded-[5px] border border-[#2A2A2A] bg-[#2e3338]"
          style={{ boxShadow: '0px 3px 5px 0px rgba(0, 0, 0, 0.4)' }}
        >
          <div className="px-4 py-1" style={{ backgroundColor: '#ee5f5b' }}>
            <h3 className="text-[12px] font-bold text-white">
              {t('user_data') !== 'user_data' ? t('user_data') : 'User Data'}
            </h3>
          </div>
          <div className="px-4 py-3 text-[11px] leading-relaxed text-[#E0E0E0]">
        ...
        >
          ...
          <div className="px-4 py-3 text-[11px] leading-relaxed text-[#E0E0E0] space-y-1.5">
            {depositLoading ? (
                ...
                <p className="opacity-70">{t('no_data_found')}</p>
              )}
          </div>
        </div>
        ...
        >
          <div className="px-4 py-1" style={{ backgroundColor: '#ee5f5b' }}>
            <h3 className="text-[12px] font-bold text-white">
              {`${t('withdrawal') || 'Withdrawal'} ${t('status')}`}
            </h3>
          </div>
          <div className="px-4 py-3 text-[11px] leading-relaxed text-[#E0E0E0] space-y-1.5">
            {withdrawalLoading ? (

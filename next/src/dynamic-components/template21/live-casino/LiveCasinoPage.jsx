...
function LiveCasinoPage({ categoryOverride }) {
  ...
  return (
    <div className={`text-white min-h-screen ${isDashboardHome ? 'bg-transparent' : 'bg-[#402f04]'}`}>
      <div className="container mx-auto py-6">
        ...
        <div className={`p-4 md:p-6 ${isDashboardHome ? 'bg-transparent' : 'bg-[#14141480] rounded-[10px]'}`}>

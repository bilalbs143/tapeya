...
import Timer from '@/dynamic-components/template21/components/Timer/Timer';
import UserPromotions from '@/dynamic-components/template21/components/UserPromotions/UserPromotions';
...
export default function PromotionsPage({ embedded = false }) {
        ...
        <div className="container mx-auto space-y-6 px-4 md:px-6">
          {promotions && promotions.length === 0 ? (
            ...
            (promotions || []).map((promo) => (
              <div
                key={promo.id}
                className="overflow-hidden rounded-[10px] bg-[#14141480]"
              >
                {/* Desktop Layout */}
  ...
  return (
    <div className="min-h-screen bg-[#402f04]">

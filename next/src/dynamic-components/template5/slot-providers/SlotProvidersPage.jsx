...
export default function SlotProvidersPage() {
  ...
  const staticProviders = [
    ...
    {
      key: 'vibra_gaming',
      id: getProviderId('vibra_gaming'),
      icon: 'sp-2-5-New.webp',
      logo: 'vibra.png',
      name: 'VIBRA GAMING',
      isLive: false,
    },
    ...
    {
      key: 'egp',
      id: getProviderId('egp'),
      icon: 'sp-9-5-New.webp',
      logo: 'egp.png',
      name: 'EGP',
      isLive: false,
    },
    {
      key: 'gamefish',
      id: getProviderId('gamefish'),
      icon: 'sp-10-5-New.webp',

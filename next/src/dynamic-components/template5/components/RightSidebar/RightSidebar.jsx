...
const RightSidebar = memo(function RightSidebar() {
  ...
  return (
    <motion.aside
      className="template5-right-sidebar hidden w-64 flex-shrink-0 overflow-hidden border-l border-[#00374A] bg-[#00111A] lg:block lg:w-64 xl:w-64"
      ...
      <div className="flex flex-col p-3">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            >
              <LazyImage
                src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/sp-1-5.webp"
                alt="Slot Game"
                width={240}
                height={120}
            ...
            >
              <LazyImage
                src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/sp-2-5.webp"
                alt="Slot Game"
                width={240}
                height={120}
                className="h-full w-full object-cover transition-transform duration-300 group-hover:scale-110"
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            >
              <LazyImage
                src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/allbet-5.webp"
                alt="Casino Provider"
                width={240}
                height={120}
                className="h-full w-full object-cover transition-transform duration-300 group-hover:scale-110"
            ...
            >
              <LazyImage
                src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/dream-gaming-5.webp"
                alt="Casino Provider"
                width={240}
                height={120}
                className="h-full w-full object-cover transition-transform duration-300 group-hover:scale-110"

...
import GameCard from '@/dynamic-components/template5/components/GameCard/GameCard';
      ...
      <div>
        ...
        >
          ...
          <div className="block w-full lg:hidden">
            ...
            >
              <Image
                src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/trending-games-banner-mob-5.webp"
                alt="Top Games Banner"
                width={800}
                height={400}
                className="h-auto w-full object-cover transition-opacity hover:opacity-90"
              />
              {/* View All Button - Bottom Left */}
              <div className="absolute bottom-4 left-4 rounded-[22px] bg-[#20C5FE] px-6 py-2 text-sm font-semibold text-white transition-opacity hover:opacity-90">
                {t('view_all')}
              </div>
            </Link>
          </div>
          ...
          <div className="hidden flex-shrink-0 lg:flex lg:w-[280px] xl:w-[320px]">
            ...
            >
              <div className="relative h-full w-full overflow-hidden rounded-[5px]">
                <Image
                  src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/trending-games-banner-5.webp"
                  alt="Top Games Banner"
                  width={320}
                  height={650}

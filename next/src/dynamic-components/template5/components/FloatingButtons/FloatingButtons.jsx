    ...
    return (
      <>
        ...
        <div ref={containerRef} className="floating-buttons-container">
          ...
          {/* Register Button - appears leftward */}
          <div
            className={`floating-button-wrapper leftward floating-button-register-left ${
              isExpanded ? 'expanded' : 'collapsed'
            }`}
          >
            <button
          ...
          >
            ...
            {isExpanded ? (
              ...
              <div className="floating-main-button-inner with-gif">
                <img
                  src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/floating-logo-5.svg"
                  alt="Floating Logo"
  ...
  return (
    <>
      ...
      <div ref={containerRef} className="floating-buttons-container">
        ...
        {/* Home Button - appears leftward */}
        <div
          className={`floating-button-wrapper leftward floating-button-home-left ${
            isExpanded ? 'expanded' : 'collapsed'
          }`}
        >
          <button
        ...
        {/* Slot Button - appears leftward */}
        <div
          className={`floating-button-wrapper leftward floating-button-slot-left ${
            isExpanded ? 'expanded' : 'collapsed'
          }`}
        >
          <button
            ...
            <div className="floating-button-inner">
              <div className="floating-button-content">
                <img
                  ...
                  className="floating-button-icon"
                />
                <span className="floating-button-text capitalize">
                  {t('slot') || 'Slot'}
                </span>
              </div>
            </div>
        ...
        {/* Casino Button - appears leftward */}
        <div
          className={`floating-button-wrapper leftward floating-button-casino-left ${
            isExpanded ? 'expanded' : 'collapsed'
          }`}
        >
          <button
            type="button"
            aria-label={t('casino') || 'Casino'}

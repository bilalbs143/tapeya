...
function Announcement() {
  ...
  return (
    ...
    >
      <motion.div
        className="z-[1] rounded-[10px] border border-[#00374A] bg-[#00111A] px-2 py-2 md:px-3"
        initial={{ opacity: 0, scale: 0.98 }}
        animate={
          isMounted ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.98 }
        }
        transition={{
          duration: 0.6,
          ease: [0.25, 0.1, 0.25, 1],
      ...
      >
        ...
        <div className="hidden items-center md:flex md:gap-2">
          ...
          <div className="flex w-full items-center gap-3 overflow-hidden py-2 pr-4 text-[#20C5FE] transition-colors">
            <Image
              src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/announcement-5.svg"
              alt={t('announcement')}
              width={20}
              height={20}
            />
            <span className="h-6 w-px flex-shrink-0 bg-[#0D1E41]" />

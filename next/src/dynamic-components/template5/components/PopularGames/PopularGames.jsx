      ...
      <div>
        ...
        >
          ...
          <div className="order-first block w-full lg:hidden">
            ...
            >
              <Image
                src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/popular-games-banner-mob-5.webp"
          ...
          <div className="hidden flex-shrink-0 lg:flex lg:w-[280px] xl:w-[320px]">
            ...
            >
              <div className="relative h-full w-full overflow-hidden rounded-[5px]">
                <Image
                  src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/popular-games-banner-5.webp"
                  alt="Popular Games Banner"
                  width={320}
                  height={650}

      ...
      <div className="space-y-2">
        {pendingDepositCount > 0 && (
          <button
            ...
            className="w-full cursor-pointer rounded-[10px] bg-[#5AB25A] px-4 py-3 text-sm font-semibold text-black [box-shadow:inset_0_-3px_0_#876800] transition-all duration-150 active:scale-95"

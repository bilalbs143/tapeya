...
우리가 계속 성장하고 발전함에 따라, 우리의 미션은 명확합니다: 아시아-태평양 지역에서 가장 매력적이고, 안전하며, 보람 있는 온라인 게임 경험을 제공하는 것입니다. 우리는 여러분을 Artchip 가족에 초대하며, 왜 우리가 아시아 전역의 수백만 명의 플레이어들이 선호하는 선택인지 발견하시기 바랍니다.`,
  ...
  return (
    <div className="text-white">
      <div className="container mx-auto px-4 py-7 md:px-2">
        <div className="mb-6 flex sm:hidden">
          <button
            onClick={() => handleTabChange('Home')}
            className="flex h-[37px] w-[138px] items-center justify-center gap-2 rounded-[3px] border border-[#00374A] bg-transparent text-[10px] font-bold text-white transition-all duration-300 hover:border-[#20C5FE] hover:bg-[#20C5FE]"
            style={{
              padding: '0 10px',
              letterSpacing: '0.3px',
            }}

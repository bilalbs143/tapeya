...
const GameCard = React.memo(
  ({
    ...
    return (
      <div
        className={`group ${className} relative cursor-pointer overflow-hidden rounded-[10px] border border-[#CBBC9180] transition-all duration-300 hover:border-[#CBBC91]`}
      ...
      >
        <div className={`relative w-full ${imageClassName} bg-[#121212]`}>
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(185deg, rgba(35, 34, 39, 0.00) 2.05%, rgba(35, 34, 39, 0.97) 76.88%)',
            }}
          >
            <span className="min-w-[100px] translate-y-4 transform rounded-full bg-[#CBBC91] px-6 py-2 text-center text-sm font-bold text-[#1a1a1a] opacity-0 shadow-lg transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
              Play
            </span>
          </div>
        </div>

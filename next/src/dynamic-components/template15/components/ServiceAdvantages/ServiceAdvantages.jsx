              ...
              {tabs.map((tab) => (
                <button
                  ...
                  style={{
                    ...
                    padding: '6px 45px',
                    background:
                      activeTab === tab.id ? '#CBBC91' : 'transparent',
                    border: '1px solid #0F5045 ',
                    boxShadow:
                      activeTab === tab.id
            ...
            >
              ...
              >
                <thead className="sticky top-0 z-20">
                  <tr>
                    <th
                      className="relative px-3 py-3 pl-10 text-left text-[13px] font-medium uppercase sm:px-4 sm:py-4 sm:pl-12 sm:text-[14px]"
                      style={{ color: '#8B8B8B' }}
                    >
                    ...
                    <th
                      className="px-3 py-3 text-left text-[13px] font-medium uppercase sm:px-4 sm:py-4 sm:text-[14px]"
                      style={{ color: '#8B8B8B' }}
                    >
                      {t('user') || 'User'}
                    </th>
                  ...
                  {currentTabData.loading ? (
                    ...
                    currentTabData.data.map((row, index) => (
                      <tr
                        ...
                        style={{
                          backgroundColor: '#232227CC',
                        }}
                      >
                        <td className="px-3 py-3 pl-10 text-xs text-white first:rounded-l-[14px] sm:px-4 sm:py-4 sm:pl-12 sm:text-sm">
                        ...
                        <td className="px-3 py-3 text-xs text-white sm:px-4 sm:py-4 sm:text-sm">
                        ...
                        <td className="px-3 py-3 text-xs font-bold text-white sm:px-4 sm:py-4 sm:text-sm">
                          {row.bet && row.bet.includes('IDR') ? (
                            <>
                              {row.bet.split(' IDR')[0]}{' '}
                              <span style={{ color: '#CBBC91' }}>IDR</span>
                            </>
                          ) : (
                            row.bet
                          )}
                        ...
                        <td className="px-3 py-3 text-xs font-bold text-white last:rounded-r-[14px] sm:px-4 sm:py-4 sm:text-sm">
                          {row.profit &&
            ...
            {tabs.map((tab) => (
              <button
                ...
                style={{
                  ...
                  background: activeTab === tab.id ? '#CBBC91' : 'transparent',
                  border: '1px solid #0F5045 ',
                  boxShadow:
                    activeTab === tab.id
                      ? '0 3.151px 11.029px 0 rgba(0, 0, 0, 0.25)'

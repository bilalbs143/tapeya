...
import CryptoSelect from '@/dynamic-components/template15/components/CryptoSelect/CryptoSelect';
import CryptoWithdrawalDetails from '@/dynamic-components/template15/components/CryptoWithdrawalDetails/CryptoWithdrawalDetails';
          ...
          <Controller
            ...
            render={({ field }) => (
              <Input
                ...
                className="relative block h-[46px] w-full appearance-none rounded-[5px] border border-[#CBBC9133] bg-[#0F50451A] px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFF66] focus:border-[#CBBC91] focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:h-[55px]"
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-col gap-3">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Input
                    ...
                    className="relative block h-[46px] w-full appearance-none rounded-[5px] border border-[#CBBC9133] bg-[#0F50451A] px-3 py-3 text-white placeholder:text-xs placeholder:text-[#FFFFFF66] focus:border-[#CBBC91] focus:ring-0 sm:text-sm md:placeholder:text-sm lg:h-[55px]"
            ...
            <button
              ...
              className="filled-button-hover-effect-5 flex w-full cursor-pointer items-center justify-center rounded-[6px] bg-[#CBBC91] px-12 pt-3 pb-3 text-[14px] font-semibold text-black transition-all duration-200 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 md:w-auto md:self-end"
            >

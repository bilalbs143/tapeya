...
import TransactionDetail from '@/dynamic-components/template15/components/TransactionDetail/TransactionDetail.jsx';
                    ...
                    requestInfoData.data.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-1 py-2 md:px-2 md:py-3">
                          <span className="text-[#CBBC91] transition-all duration-200">

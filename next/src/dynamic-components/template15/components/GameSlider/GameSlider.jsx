              ...
              {showNavigation && validGames.length > currentPerPage && (
                <div className="flex items-center gap-6 md:pr-2">
                  ...
                  <button
                    ...
                    className={`flex items-center justify-center transition-opacity duration-200 ${canScrollPrev ? 'opacity-60 hover:opacity-100' : 'cursor-not-allowed opacity-20'} `}
                  >
                    <Image
                      ...
                      style={{
                        filter: canScrollPrev
                          ? 'brightness(0) saturate(100%) invert(82%) sepia(18%) saturate(700%) hue-rotate(2deg)'
                  ...
                  <button
                    ...
                    className={`flex items-center justify-center transition-opacity duration-200 ${canScrollNext ? 'opacity-80 hover:opacity-100' : 'cursor-not-allowed opacity-30'} `}
                  >
                    <Image

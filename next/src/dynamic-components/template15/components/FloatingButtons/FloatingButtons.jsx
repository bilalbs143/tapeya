...
const FloatingButtons = () => {
  ...
  if (!isAuth) {
    return (
      <div ref={containerRef} className="floating-buttons-container">
        ...
        <div
          className={`floating-button-wrapper upward floating-button-login ${isExpanded ? 'expanded' : 'collapsed'
          }`}
        >
          <button
            type="button"
            ...
            className={`floating-button ${clickedButton === 'login' ? 'clicked' : ''
            }`}
          >
        ...
        <div
          className={`floating-button-wrapper downward floating-button-register ${isExpanded ? 'expanded' : 'collapsed'
          }`}
        >
          <button
            type="button"
            ...
            className={`floating-button ${clickedButton === 'register' ? 'clicked' : ''
            }`}
          >
            <div className="floating-button-inner">
              <div className="floating-button-content">
        ...
        >
          ...
          {isExpanded ? (
            ...
            <div className="floating-main-button-inner with-gif">
              <img
                src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/plus.png"
                alt="Floating Logo"
  ...
  return (
    <div ref={containerRef} className="floating-buttons-container">
      ...
      <div
        className={`floating-button-wrapper upward floating-button-deposit ${isExpanded ? 'expanded' : 'collapsed'
        }`}
      >
        <button
          type="button"
          ...
          className={`floating-button ${clickedButton === 'deposit' ? 'clicked' : ''
          }`}
        >
          <div className="floating-button-inner">
            <div className="floating-button-content">
              <img
                src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/Deposit.png"
                alt={t('deposit')}
                width="30"
                height="30"
                className="floating-button-icon"
      ...
      <div
        className={`floating-button-wrapper upward floating-button-withdrawal ${isExpanded ? 'expanded' : 'collapsed'
        }`}
      >
        <button
          type="button"
          ...
          className={`floating-button ${clickedButton === 'withdrawal' ? 'clicked' : ''
          }`}
        >
          <div className="floating-button-inner">
            <div className="floating-button-content">
              <img
                src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/Component+9.svg"
                alt={t('withdrawal')}
                width="20"
                height="20"
                className="floating-button-icon"
      ...
      <div
        className={`floating-button-wrapper downward floating-button-support ${isExpanded ? 'expanded' : 'collapsed'
        }`}
      >
        <button
          type="button"
          ...
          className={`floating-button ${clickedButton === 'support' ? 'clicked' : ''
          }`}
        >
          <div className="floating-button-inner">
            <div className="floating-button-content">
              <img
                src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/Customer+Inquiry.png"
                alt={t('support')}
                width="20"
                height="20"
                className="floating-button-icon"
      ...
      <div
        className={`floating-button-wrapper downward floating-button-notes ${isExpanded ? 'expanded' : 'collapsed'
        }`}
      >
        <button
          type="button"
          ...
          className={`floating-button ${clickedButton === 'notes' ? 'clicked' : ''
          }`}
        >
          <div className="floating-button-inner">
            <div className="floating-button-content">
              <div className="relative">
                <img
                  src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/Notes.png"
                  alt={t('notes')}
                  width="20"
                  height="20"
                  className="floating-button-icon"

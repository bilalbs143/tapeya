...
function Navbar() {
  ...
  const sidebarApkSrc = useMemo(() => {
    if (currentLocale === 'id') {
      return 'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/Download-Mob-sidnav.png';
    }
    if (currentLocale === 'ko') {
      return 'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/Download-Mob-sidnav.png';
    }
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="relative hidden items-center gap-6 md:flex">
              ...
              <button
                ...
                className="flex h-12 w-12 items-center justify-center rounded-full bg-[#1A1A1A] transition-colors hover:bg-[#252525]"
              >
              ...
              {isDesktopMenuOpen && (
                <>
                  ...
                  <div className="fixed top-[110px] left-1/2 z-[90] -translate-x-1/2">
                    <div
                      className="rounded-[20px] bg-gradient-to-b from-[#1a1a1a] to-[#0e0e0e] shadow-[0_40px_120px_rgba(0,0,0,0.85)]"
                      style={{
                        width: '1920px',
                        height: '403px',
                      }}
                          ...
                          <div className="flex h-full gap-[60px]">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="grid grid-cols-3 gap-[16px]">
                                {/* Home */}
                                <Link href="/">
                                  <button className="flex h-[54px] w-full items-center justify-between rounded-[10px] bg-[#CBBC91] px-5">
                                ...
                                <button
                                  ...
                                  className="group flex w-full cursor-pointer items-center justify-between rounded-[8px] border border-[#2A2A2A] bg-transparent px-5 py-4 transition-colors hover:border-[#CBBC91] hover:bg-[#ffffff05]"
                                >
                                  <div className="flex items-center gap-3">
                                    <div className="flex h-6 w-6 items-center justify-center">
                                      <Image
                                ...
                                >
                                  <div className="flex items-center gap-3">
                                    ...
                                    {helpUnreadCount > 0 && (
                                      <span className="grid h-5 min-w-[20px] place-items-center rounded-full bg-[#CBBC91] px-1.5 text-[10px] font-bold text-black">
                                        {helpUnreadCount > 99
                                          ? '99+'
                                          : helpUnreadCount}
                                      </span>
                            ...
                            <div className="w-[320px]">
                              <h3 className="mb-[17px] text-[15px] font-semibold text-white">
                                Download APK
                              </h3>
                              ...
                              <div
                                ...
                                style={{
                                  backgroundImage:
                                    "url('https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/Download-Mega-Menu-15.png')",
                              ...
                              >
                                ...
                                <img
                                  ...
                                  alt="Download APK QR"
                                  className="absolute bottom-[16px] left-[16px] z-20 h-[120px] w-[120px]"
                                />
                              </div>
                            </div>
                          </div>
            ...
            <div className="relative hidden items-center gap-4 md:flex">
              ...
              <div className="relative z-10">
                <button className="flex h-10 w-10 items-center justify-center rounded-full bg-[#1A1A1A] transition-colors hover:bg-[#252525]">
                  {/* Placeholder for US Flag or LanguageSwitcher */}
              ...
              {isAuth && (
                <div className="flex items-center justify-between gap-4 rounded-full border border-[#333] bg-[#1A1A1A] p-1.5 pr-1.5 pl-5">
                  <div className="flex items-center gap-3">
                    <Image
                  ...
                  <button
                    onClick={handleOpenTransactionTab}
                    className="rounded-full bg-[#0F5146] px-6 py-2 text-sm font-bold text-white transition-transform hover:bg-[#146154] active:scale-95"
                  >
                    {t('deposit') || 'Deposit'}
                  </button>
                </div>
              ...
              {isAuth && (
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-3 rounded-full border border-[#333] bg-[#1A1A1A] p-1.5 pr-4 transition-colors hover:bg-[#252525]"
                  >
                    <div className="flex h-10 w-10 items-center justify-center rounded-full border border-[#CBBC91] bg-[#121212] font-bold text-[#CBBC91]">
                      {userInitial || 'A'}
                    </div>
                    <span className="text-base font-bold text-white">
                  ...
                  {isUserDropdownOpen && (
                    <>
                      <div
                        ...
                        onClick={toggleUserDropdown}
                      />
                      <div className="absolute top-[calc(100%+8px)] right-0 z-[100] w-[280px] rounded-[16px] border border-[#333] bg-[#121212] p-2 shadow-2xl">
                        {/* 1. Profile */}
                        <button
                          onClick={handleOpenProfileTab}
                          className="group flex w-full items-center justify-between rounded-[8px] px-4 py-3 transition-colors hover:bg-[#ffffff08]"
                        >
                          <div className="flex items-center gap-3">
                            <svg
                              width="20"
                          ...
                          <svg
                            ...
                            viewBox="0 0 24 24"
                            fill="none"
                            className="stroke-[#666] transition-colors group-hover:stroke-white"
                          >
                            <path
                              d="M9 18L15 12L9 6"
                              strokeWidth="2"
                        ...
                        <div className="mx-2 my-1 h-[1px] bg-[#222]" />
              ...
              {isAuth && (
                <button
                  onClick={handleOpenAnnouncementModal}
                  className="flex h-12 w-12 items-center justify-center rounded-full border border-[#333] bg-[#1A1A1A] transition-colors hover:bg-[#252525]"
                >
              ...
              {!isAuth && (
                <div className="flex items-center gap-4">
                  <button
                    ...
                    className="h-[42px] rounded-full bg-[#0F5146] px-8 text-[14px] font-bold text-white shadow-lg shadow-[#0F5146]/20 transition-all hover:bg-[#146154] active:scale-95"
                  >
                    Login
                  </button>
                  <button
                    onClick={handleOpenRegisterModal}
                    className="h-[42px] rounded-full border border-[#CBBC91] bg-transparent px-8 text-[14px] font-bold text-white transition-all hover:bg-[#CBBC91]/10 active:scale-95"
                  >
                    Register
                  </button>
                </div>
            ...
            <div className="relative z-[1000] flex w-full items-center justify-between md:hidden">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="flex h-11 w-11 items-center justify-center rounded-full bg-[#1A1A1A] transition-colors hover:bg-[#252525]"
                >
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path
                      d="M4 7H20M4 12H20M4 17H20"
              ...
              {isAuth ? (
                <div className="flex items-center gap-2" ref={userMenuRef}>
                  <button
                    ...
                    className="flex h-11 w-11 items-center justify-center rounded-full border border-[#CBBC91] bg-[#121212] text-base font-bold text-[#CBBC91] transition-all"
                  >
                    {userInitial}
                  </button>
                  ...
                  {isUserMenuOpen && (
                    <div className="absolute top-[calc(100%+8px)] right-0 z-[1000] w-[240px]">
                      <div className="rounded-[16px] border border-[#333] bg-[#1A1A1A] p-2 shadow-2xl">
                        {/* Profile */}
                        <button
                          onClick={() => {
                        ...
                        <div className="mx-2 my-1 h-[1px] bg-[#333]" />
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-6">
              ...
              <button
                onClick={toggleMobileMenu}
                className="group flex h-9 w-9 cursor-pointer items-center justify-center rounded-[6px] border border-[#CBBC91] bg-transparent text-white transition-colors hover:bg-[#CBBC91] hover:text-black"
              >
                <svg
                  className="h-5 w-5"
                  fill="none"
              ...
              <div className="mb-4 border-b border-[#FFFFFF1A] px-0 py-0">
                <div className="flex items-center gap-3">
                  <div className="flex w-full items-center gap-3 rounded-[0px] bg-black px-3 py-3">
                    <button
                      onClick={handleOpenLoginModal}
                      className="outline-hover-effect group flex flex-1 cursor-pointer items-center justify-center gap-3 rounded-[30px] bg-[#0F5045] px-3 py-3 text-base font-semibold text-white transition-colors"
                    >
                      <span>Login</span>
                    </button>
                    ...
                    <button
                      onClick={handleOpenRegisterModal}
                      className="filled-hover-effect group flex flex-1 cursor-pointer items-center justify-center gap-3 rounded-[40px] border-1 border-[#CBBC91] bg-[#18181A] px-3 py-3 text-base font-semibold text-white transition-colors"
                      data-hover="Register"
                    >
                      <span>Register</span>
                    </button>
            ...
            {isAuth && (
              <div className="mx-4 mb-6 flex items-center justify-between rounded-full bg-[#1A1A1A] p-2 pl-6">
                <div className="flex items-center gap-3">
                  <Image
                    src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/ph_coins-light.png"
                    alt="Balance"
                ...
                <button
                  onClick={handleOpenTransactionTab}
                  className="rounded-full bg-[#0F5146] px-8 py-3 text-base font-bold text-white transition-transform hover:bg-[#146154] active:scale-95"
                >
                  {t('deposit') || 'Deposit'}
                </button>
              </div>
            ...
            <div className="mt-auto space-y-3 p-4">
              ...
              <div className="relative left-1 mb-8">
                {/* Text overlay */}
                <div className="absolute top-[15%] left-[5%] z-10 text-center">
                ...
                <img
                  src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/user13.png"
                  alt="Download APK QR"
                  className="absolute top-[45%] left-[6%] z-10 h-[96px] w-[96px]"
                />

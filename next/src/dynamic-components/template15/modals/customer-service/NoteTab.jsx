    ...
    <div className="flex h-full flex-col">
      ...
      {showNoteDetails ? (
        ...
        <>
          ...
          <div className="overflow-hidden rounded-[9px] border border-[#CBBC9133]">
                ...
                <tbody>
                  {notesData.length === 0 ? (
                    ...
                    notesData.map((item, index) => (
                      <tr
                        key={item.id || index}
                        className="cursor-pointer border-t border-b border-[#CBBC9133] transition-all duration-300 hover:border-[#CBBC91] hover:bg-[#0C0C0C] hover:shadow-[inset_0_4.88px_29.278px_0_#0F5045,0_0_20px_rgba(15,80,69,0.6)]"

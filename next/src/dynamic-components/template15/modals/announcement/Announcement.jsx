...
export default function Announcement() {
  ...
  return (
    <div className="announcement-modal relative mx-auto flex h-[80vh] w-full max-w-[1479px] flex-col overflow-hidden rounded-[5px] border-2 border-[#0F5045] bg-[#0E0E0E] text-white shadow-xl">
      <div className="flex min-h-0 flex-1 flex-col space-y-4 p-4 md:p-6 lg:p-8">
        ...
        <div className="flex min-h-0 flex-1 flex-col space-y-6">
          <div className="min-h-0 flex-1 overflow-hidden rounded-[5px] border border-[#CBBC91]">
                        ...
                        >
                          <button
                            ...
                            className={`w-full cursor-pointer rounded-[5px] px-3 py-2 text-left transition-all duration-300 md:px-4 md:py-3 ${selectedAnnouncement === item.id
                              ? 'border border-[#CBBC91] bg-[#0F50451A]'
                              : 'border border-[#CBBC91] bg-transparent text-white'
                            }`}
                          >
                            <div className="flex items-center justify-between">
                              <span

        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              className="flex h-12 w-full cursor-pointer items-center justify-center rounded-lg bg-[#CBBC91] text-sm font-semibold text-black transition-all duration-150 active:scale-95 disabled:opacity-50 sm:h-14 sm:text-base"
            >
              {isGameLaunching ? (

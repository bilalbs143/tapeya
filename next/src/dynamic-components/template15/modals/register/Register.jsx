...
export default function Register(props) {
  ...
  return (
    <div
      className={`mx-auto max-h-[90vh] w-full max-w-[1026px] transform overflow-y-auto rounded-[7px] border border-[#0F5045] bg-[#18181A] bg-[linear-gradient(90deg,rgba(24,24,26,0)_-16.56%,#18181A_48.8%,rgba(24,24,26,0)_113.29%)] text-white shadow-xl transition-all duration-300 ease-out md:h-[480px] md:max-h-[480px] md:overflow-visible ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'
      }`}
    >
          ...
          <div className="w-full max-w-[935px]">
            ...
            <form className="space-y-4 pt-2" onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        ...
                        className="w-full rounded-[4px] border border-[#CBBC9133] bg-[#0F50451A] focus:border-[#CBBC91] focus:ring-0 focus:outline-none"
                      />
                    )}
                  />
                </div>
                ...
                <div className="overflow-visible">
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      ...
                      >
                        <SelectTrigger className="w-full rounded-[4px] border border-[#CBBC9133] bg-[#0F50451A]">
                          <SelectValue placeholder={t('select_bank')} />
                        </SelectTrigger>

                        {/* select bank*/}
                        <SelectContent className="z-[9999] border-[#CBBC9133] bg-[#0E0E0E] text-white">
              ...
              <button
                ...
                className="template10-filled-button-hover mt-5 w-full rounded-[50px] bg-[#CBBC91] py-3 font-semibold text-white transition active:scale-95 disabled:opacity-50"
              >

...
import WithdrawalBankTab from '@/dynamic-components/template15/components/WithdrawalOptions/WithdrawalBankTab';
import WithdrawalCryptoTab from '@/dynamic-components/template15/components/WithdrawalOptions/WithdrawalCryptoTab';
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-4">
        {/* Tabs header */}
        <div className="mt-4 mb-[10px] rounded-[5px] border border-[#CBBC9180] p-[2px] md:mt-4">

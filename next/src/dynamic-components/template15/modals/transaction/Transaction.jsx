...
export default function Transaction({ defaultTab }) {
  ...
  return (
    <div className="transaction-modal relative mx-auto flex h-[80vh] w-full max-w-[1479px] flex-col overflow-hidden rounded-[12px] border-1 border-[#0F5045] bg-[#18181A] bg-[linear-gradient(90deg,rgba(24,24,26,0)_-16.56%,#18181A_48.8%,rgba(24,24,26,0)_113.29%)] text-white shadow-xl">
                ...
                {tabs.map((tab) => {
                  ...
                  return (
                    <button
                      ...
                      className={` ${isConvert ? 'min-w-[454px]' : 'min-w-[200px]'} rounded-[4px] px-6 py-3.5 text-[14px] font-semibold transition-all duration-200 ${activeTab === tab.key

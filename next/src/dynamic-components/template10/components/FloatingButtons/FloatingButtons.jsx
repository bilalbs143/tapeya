...
const FloatingButtons = () => {
  ...
  const lottieIconUrl =
    'https://lottie.host/b8ec8dfe-1314-42ba-8c83-d757b65ba663/vw6pJ39VIx.lottie';
  ...
  if (!isAuth) {
    return (
      <>
        ...
        >
          {/* Closed State - Clickable animated Lottie icon */}
          {!isExpanded && (
            <button
              type="button"
              aria-label="Open Menu"
              onClick={handleMainButtonClick}
              className="floating-lottie-button"
            >
              <DotLottieReact
                src={lottieIconUrl}
                loop
                autoplay
                className="floating-lottie-icon"
              />
            </button>
          )}
          ...
          {isExpanded && (
            ...
            >
              ...
              {/* Animated Lottie icon peeking from top-right */}

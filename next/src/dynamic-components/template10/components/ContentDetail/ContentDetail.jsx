    ...
    <>
      <div className="mb-4 flex items-center justify-start">
        <button
          onClick={onClose}
          aria-label={t('back')}
          className="template10-filled-button-hover flex items-center justify-center rounded-[4px] bg-[#E33A24] px-10 py-3 font-semibold text-white transition-all duration-300 hover:bg-[#9D4EDD]"
        >
          {t('back')}
        </button>
      </div>
      ...
      <div className="space-y-6">
        {/* Inquiry Details */}
        <div className="rounded-[5px] border border-[#E33A2480] bg-[#1D4647] p-4">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="flex flex-col gap-4">
              <div>
                ...
                <input
                  ...
                  readOnly
                  className="h-[46px] w-full cursor-not-allowed rounded-[3px] border border-[#182F31] bg-transparent px-3 text-[12px] text-[#FFFFFF80]"
                />
              </div>
            ...
            <div>
              ...
              <div className="min-h-[136px] w-full cursor-not-allowed rounded-[3px] border border-[#182F31] bg-transparent px-3 py-3 text-sm text-[#FFFFFF80]">
                <div
                  className="text-xs break-words md:text-sm"
                  dangerouslySetInnerHTML={{
                    __html:
        ...
        {/* Response Details */}
        <div className="rounded-[5px] border border-[#E33A2480] bg-transparent p-4">
          <div className="mb-4 text-[14px] font-extrabold text-white uppercase">
            Response Details
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="flex flex-col gap-4">
              <div>
                ...
                <input
                  ...
                  readOnly
                  className="h-[46px] w-full cursor-not-allowed rounded-[3px] border border-[#8B8B8B33] bg-transparent px-3 text-[12px] text-[#FFFFFF80]"
                />
              </div>
            ...
            <div>
              ...
              <div className="min-h-[225px] w-full cursor-not-allowed rounded-[3px] border border-[#8B8B8B33] bg-transparent px-3 py-3 text-sm text-[#FFFFFF80]">
                <div
                  className="text-xs break-words md:text-sm"
                  dangerouslySetInnerHTML={{

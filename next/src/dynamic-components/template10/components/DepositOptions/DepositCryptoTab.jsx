...
import CryptoPaymentDetails from '@/dynamic-components/template10/components/CryptoPaymentDetails/CryptoPaymentDetails';
...
export default function DepositCryptoTab({ isActive }) {
  ...
  const renderAmountInfo = () => {
    ...
    return (
      <div className="mt-2 rounded-[5px] border border-[#E33A2480] bg-[#182F31] p-3 shadow-[inset_4px_5px_16px_rgba(0,0,0,0.25)]">
        {minimumAmountLoader ? (
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-center">
            <Controller
              ...
              render={({ field }) => (
                <Input
                  ...
                  className="focus:bg-[] relative block h-[46px] w-[99%] appearance-none rounded-[5px] border border-[#E33A2480] bg-transparent px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFF66] focus:border-[#E33A2480] focus:bg-[#172F31CC] focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:h-[55px]"
            ...
            <button
              ...
              className="template10-filled-button-hover flex h-[54px] min-w-[160px] cursor-pointer items-center justify-center rounded-[4px] bg-[#E33A24] px-5 text-[14px] font-semibold text-white transition-all duration-200 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 md:mb-1 md:w-auto"
            >

...
export default function DepositBankTab() {
  ...
  const PaymentMethodCard = ({ method, methodType }) => (
    <button
      ...
      className="flex h-[64px] w-full cursor-pointer items-center justify-center rounded-[5px] border border-[#E33A2480] bg-[#182F31] transition-all duration-300 hover:border hover:border-[#E33A24] hover:bg-[#182F31] hover:shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)]"
    >
    ...
    return (
      <div className="space-y-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-[#E33A24] md:text-sm">
            ({approvalType})
          </span>
        </div>
  ...
  return (
    <div className="space-y-6 overflow-hidden">
      <div className="mt-4 rounded-[5px] border border-[#E33A2480] bg-[#1D4647] p-3 shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)] md:p-4 lg:p-6">
      ...
      <div className="mt-8">
        <h3 className="font-spy-agency mb-4 text-[20px] text-white md:text-[22px]">
          {t('deposit_history')}
        </h3>
        <DepositHistory />
      </div>

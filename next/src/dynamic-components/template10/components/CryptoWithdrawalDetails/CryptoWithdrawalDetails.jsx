    ...
    <div className="rounded-[16px] border border-[#FFFFFF66] bg-transparent p-5">
      ...
      <div className="mb-4 flex items-center justify-start gap-4">
        <button
          onClick={onClose}
          aria-label={t('back')}
          className="template10-filled-button-hover flex items-center justify-center rounded-[4px] bg-[#9E91E6] px-8 py-2 font-extrabold text-white transition-all duration-300"
        >
          <span>{t('black')}</span>
        </button>
      ...
      <div className="mb-8">
        ...
        <div className="rounded-[12px] border border-[#DBB42C4D] bg-transparent px-6 py-8 text-white">
          <div className="flex flex-col gap-3 md:flex-row md:items-center">
            <div className="flex-1">
              <div className="rounded-[10px] border border-[#DBB42C4D] bg-[#1D0032] px-4 py-4">
                <div className="text-center text-base font-bold md:text-lg">
                  <span className="text-[#DBB42C]">
            ...
            <div className="text-center text-2xl font-bold text-[#DBB42C] select-none md:hidden">
              =
            </div>
            <div className="hidden px-2 text-center text-2xl font-bold text-[#DBB42C] select-none md:block">
              =
            </div>
            <div className="flex-1">
              <div className="rounded-[10px] border border-[#DBB42C4D] bg-[#B6AAFF] px-4 py-4">
                <div className="text-center text-base font-bold md:text-lg">
                  <span className="text-[#DBB42C]">
      ...
      <div className="">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-stretch">
          <div className="flex-1 rounded-[12px] border border-[#DBB42C4D] bg-black px-3 py-3 text-white">
          ...
          <button
            className="template10-filled-button-hover w-full rounded-[4px] bg-[#9E91E6] px-5 py-3 text-sm font-bold text-white transition-all duration-200 active:scale-95 disabled:opacity-50 sm:w-[270px]"
            onClick={() =>
              copyToClipboard(withdrawalData?.withdraw_address || '')
            }
            disabled={!withdrawalData?.withdraw_address}

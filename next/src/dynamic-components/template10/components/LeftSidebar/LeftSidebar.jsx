...
const LeftSidebar = memo(function LeftSidebar() {
  ...
  // Removed activeFill and activeStroke - colors are now handled by CSS
  ...
  return (
    <aside
      className={`template10-left-sidebar m-4 hidden h-auto flex-shrink-0 flex-col self-start rounded-[5px] border transition-all duration-300 lg:flex ${
        isCollapsed ? '' : 'w-64'
      }`}
      style={{
    ...
    >
      <div className="relative flex flex-col p-4 pb-6">
        {/* Expand/Collapse Button */}
        <button
          onClick={() => setIsCollapsed(!isCollapsed)}
          className="absolute top-4 -right-[15px] z-10 flex items-center justify-center transition-opacity duration-200 hover:opacity-80"
        >
          <svg
          ...
          >
            <path
              d="M0 0H5C10.5228 0 15 4.47715 15 10V29C15 34.5228 10.5228 39 5 39H0V0Z"
              fill="#0C3034"
            />
            <path
              d="M4 9.5L9.4848 19L4 28.5"
              stroke="white"
              strokeWidth="1.5"
              strokeLinecap="round"
          ...
          <nav className="mt-2 space-y-2">
            ...
            <Link
              ...
              className={`group flex items-center justify-center ${
                isCollapsed
                  ? 'p-2'
                  : `template10-menu-item-angled ${isActive('/') ? 'template10-menu-item-angled-active' : ''}`
              }`}
            >
              {isCollapsed ? (
                <div
                  className={`flex items-center justify-center rounded-[3px] ${isActive('/') ? 'bg-[#E33A24] p-2' : ''}`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 35 36"
                ...
                <div className="template10-menu-item-angled-inner w-full">
                  <div className="template10-menu-item-content">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 35 36"
                      fill="none"
            ...
            <Link
              ...
              className={`group flex items-center justify-center ${
                isCollapsed ? 'p-2' : 'template10-menu-item-angled'
              } ${isActive('/dashboard/deposit') ? 'template10-menu-item-angled-active' : ''}`}
            >
              {isCollapsed ? (
                <div
                  className={`flex items-center justify-center rounded-[3px] ${isActive('/dashboard/deposit') ? 'bg-[#E33A24] p-2' : ''}`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 37 37"
                  ...
                  >
                    <path
                      fill={
                        isActive('/dashboard/deposit') ? 'white' : '#636363'
                      }
                ...
                <div className="template10-menu-item-angled-inner">
                  <div className="template10-menu-item-content">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 37 37"
            ...
            <Link
              ...
              className={`group flex items-center justify-center ${
                isCollapsed ? 'p-2' : 'template10-menu-item-angled'
              } ${isActive('/dashboard/withdrawal') ? 'template10-menu-item-angled-active' : ''}`}
            >
              {isCollapsed ? (
                <div
                  className={`flex items-center justify-center rounded-[3px] ${isActive('/dashboard/withdrawal') ? 'bg-[#E33A24] p-2' : ''}`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 37 37"
                  ...
                  >
                    <g
                      fill={
                        isActive('/dashboard/withdrawal') ? 'white' : '#636363'
                      }
                      clipPath="url(#a)"
                      className="transition-all duration-300"
                    >
            ...
            <Link
              ...
              className={`group flex items-center justify-center ${
                isCollapsed ? 'p-2' : 'template10-menu-item-angled'
              } ${isActive('/dashboard/coupons') ? 'template10-menu-item-angled-active' : ''}`}
            >
              {isCollapsed ? (
                <div
                  className={`flex items-center justify-center rounded-[3px] ${isActive('/dashboard/coupons') ? 'bg-[#E33A24] p-2' : ''}`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 37 37"
                  ...
                  >
                    <path
                      fill={
                        isActive('/dashboard/coupons') ? 'white' : '#636363'
                      }
                      className="transition-all duration-300"
            ...
            <Link
              ...
              className={`group flex items-center justify-center ${
                isCollapsed ? 'p-2' : 'template10-menu-item-angled'
              } ${isActive('/dashboard/customer-inquiry') ? 'template10-menu-item-angled-active' : ''}`}
            >
              {isCollapsed ? (
                <div
                  className={`flex items-center justify-center rounded-[3px] ${isActive('/dashboard/customer-inquiry') ? 'bg-[#E33A24] p-2' : ''}`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 33 37"
            ...
            <Link
              ...
              className={`group flex items-center justify-center ${
                isCollapsed ? 'p-2' : 'template10-menu-item-angled'
              } ${isActive('/dashboard/note') ? 'template10-menu-item-angled-active' : ''}`}
            >
              {isCollapsed ? (
                <div
                  className={`flex items-center justify-center rounded-[3px] ${isActive('/dashboard/note') ? 'bg-[#E33A24] p-2' : ''}`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 37 37"
                  ...
                  >
                    <path
                      fill={isActive('/dashboard/note') ? 'white' : '#636363'}
                      className="transition-all duration-300"
            ...
            <Link
              ...
              className={`group flex items-center justify-center ${
                isCollapsed ? 'p-2' : 'template10-menu-item-angled'
              } ${isActive('/announcements') ? 'template10-menu-item-angled-active' : ''}`}
            >
              {isCollapsed ? (
                <div
                  className={`flex items-center justify-center rounded-[3px] ${isActive('/announcements') ? 'bg-[#E33A24] p-2' : ''}`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 37 37"
                  ...
                  >
                    <g
                      fill={isActive('/announcements') ? 'white' : '#636363'}
                      clipPath="url(#a)"
                      className="transition-all duration-300"
                    >
            ...
            <Link
              ...
              className={`group flex items-center justify-center ${
                isCollapsed ? 'p-2' : 'template10-menu-item-angled'
              } ${isActive('/dashboard/faqs') ? 'template10-menu-item-angled-active' : ''}`}
            >
              {isCollapsed ? (
                <div
                  className={`flex items-center justify-center rounded-[3px] ${isActive('/dashboard/faqs') ? 'bg-[#E33A24] p-2' : ''}`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 37 37"
                  ...
                  >
                    <path
                      fill={isActive('/dashboard/faqs') ? 'white' : '#636363'}
                      className="transition-all duration-300"
        ...
        <div
          className={`${isCollapsed ? 'mt-16 flex flex-col items-center' : 'mt-16'}`}
        >
          {/* Telegram Button */}
          <a
            ...
            className={`group ${isCollapsed ? 'mb-2 flex h-10 w-10 items-center justify-center rounded-[3px] border' : 'mb-3 block'}`}
            style={
              isCollapsed ? { borderColor: 'rgba(219, 180, 44, 0.30)' } : {}
            }
          >
            {isCollapsed ? (
              <svg
              ...
              <div
                className="template10-menu-item-angled-inner rounded-[3px] border bg-transparent transition-colors duration-200"
                style={{ borderColor: 'rgba(247, 146, 86, 0.20)' }}
              >
                <div className="template10-menu-item-content">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className={`group ${isCollapsed ? 'mt-2 flex h-10 w-10 items-center justify-center rounded-[3px] border' : ''}`}
            style={
              isCollapsed ? { borderColor: 'rgba(219, 180, 44, 0.30)' } : {}
            }
          >

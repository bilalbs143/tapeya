          ...
          <div className="mb-6 w-full">
            <div className="flex items-center justify-between gap-3 px-0 py-0 md:px-2 md:py-1">
              ...
              <div className="flex items-center gap-3">
                <LazyImage
                  src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/game-icon-9.svg"
                  alt="Game icon"
                  width={34}
                  height={42}
                ...
                <h3 className="text-[20px] tracking-wide uppercase md:text-[25px]">
                  <span className="font-spy-agency text-white">{t('new')}</span>{' '}
                  <span className="font-spy-agency text-white">
                    {t('games')}
                  </span>
                </h3>
              </div>
      ...
      <div className="">
        ...
        <div className="mb-6 w-full">
          <div className="flex items-center justify-between gap-3 px-0 py-0 md:px-2 md:py-1">
            ...
            <div className="flex items-center gap-3">
              <LazyImage
                src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/game-icon-10.svg"
                alt="Game icon"
                width={34}
                height={42}
                className="object-contain"
              ...
              <h3 className="text-[20px] tracking-wide uppercase md:text-[25px]">
                <span className="font-spy-agency text-white">{t('new')}</span>{' '}
                <span className="font-spy-agency text-white">{t('games')}</span>
              </h3>
            </div>
            ...
            {validGames.length > 5 && (
              <div className="flex shrink-0 gap-2">
                <button
                  className="flex h-7 w-7 cursor-pointer items-center justify-center rounded-[5px] border transition-all duration-200 hover:scale-110 sm:h-9 sm:w-9"
                  style={{
                    background: 'rgba(36, 106, 115, 0.30)',
        ...
        <div>
          ...
          >
            <div
              className="template10-game-slider template10-new-games-slider overflow-hidden"
              ref={emblaRef}
            >
              <div className="flex">
                {/* Single row layout */}
                    ...
                    >
                      <div className="flex-shrink-0 md:h-[270px]">
                        <GameCard
                          ...
                          hoverOverlayColor="rgba(36, 106, 115, 0.3)"
                        />
                      </div>
                    </div>
                  );

...
import TransactionDetail from '@/dynamic-components/template10/components/TransactionDetail/TransactionDetail.jsx';
    ...
    <div className="space-y-6">
      {showDetails ? (
        ...
        <>
          ...
          <div className="overflow-hidden rounded-[9px] border border-[#E33A2480]">
                    ...
                    requestInfoData.data.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-1 py-2 md:px-2 md:py-3">
                          <span className="text-[#E33A24]/50 transition-all duration-200">

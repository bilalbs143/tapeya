...
import { LanguageSwitcher } from '@/dynamic-components/template10/components/LanguageSwitcher/LanguageSwitcher';
import LazyImage from '@/dynamic-components/template10/components/LazyImage/LazyImage';
import WalletDropdown from '@/dynamic-components/template10/components/WalletDropdown/WalletDropdown';
...
function Navbar() {
  ...
  const sidebarApkSrc = useMemo(() => {
    if (currentLocale === 'id') {
      return 'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/apk-new-banner-mob-10.webp';
    }
    if (currentLocale === 'ko') {
      return 'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/apk-new-banner-mob-10.webp';
    }
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            borderBottom: '1px solid rgba(36, 106, 115, 0.30)',
            background: '#131515',
          }}
        >
                ...
                {!isAuth ? (
                  <>
                    <button
                      ...
                      className="template10-filled-button-hover h-[64px] w-[130px] rounded-[4px] border border-[#E33A24] bg-[#E33A24] px-4 font-bold text-white"
                    >
                      Login
                    </button>
                    ...
                    <button
                      ...
                      className="template10-bordered-button-hover h-[64px] w-[130px] rounded-[4px] border bg-transparent px-4 font-bold text-white"
                      style={{
                        borderColor: '#E33A24',
                      }}
                    >
                  ...
                  <div className="flex items-center gap-4">
                    <div
                      className="relative rounded-[5px] bg-[#131515] p-2"
                      ref={userMenuRef}
                      style={{
                        pointerEvents: 'auto',
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="flex h-12 w-12 items-center justify-center rounded-[3px] bg-[#E33A24]">
                          {user?.avatar ? (
                            <Image
                              src={user.avatar}
                              alt="Profile"
                        ...
                        <div className="flex flex-col items-start">
                          ...
                          <span className="text-xs font-medium text-[#3DCCC7] underline">
                            {t('View Profile') ||
                              t('view_profile') ||
                              'View Profile'}
                          </span>
                          ...
                          >
                            <div className="overflow-hidden rounded-[5px] p-3">
                              <Link
                                ...
                                style={{
                                  borderColor: 'rgba(36, 106, 115, 0.3)',
                                }}
                              >
                                <span className="flex items-center gap-3">
                                  <svg
                                    ...
                                    viewBox="0 0 16 16"
                                    fill="currentColor"
                                    className="h-4 w-4 text-[#3DCCC7] transition-colors group-hover:!text-white"
                                  >
                              ...
                              >
                                <span className="flex items-center gap-3">
                                  ...
                                  <span className="text-[12px] text-[#3DCCC7] capitalize transition-colors group-hover:text-white">
        ...
        {/* Mobile Navbar */}
        <div
          className="m-0 px-3 py-2 lg:hidden"
          style={{
            borderBottom: '1px solid rgba(36, 106, 115, 0.30)',
            background: '#131515',
          }}
        >
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex h-[30px] w-[30px] items-center justify-center rounded-[3px] bg-transparent"
              style={{
                border: '1px solid rgba(36, 106, 115, 0.30)',
              }}
            >
            ...
            <Link href="/" className="flex items-center">
              <div className="flex items-center justify-center px-4 py-1">
                <Image
                  src="https://d3emlo5tm9es2f.cloudfront.net/next/logos/artchip-main-10.svg"
                  alt="Artchip Logo"
                  width={100}
                  height={40}
                  priority
            ...
            <div className="template10-mobile-lang-button">
              <div style={{ pointerEvents: 'auto' }}>
                <LanguageSwitcher
                  variant="dropdown"
                  appearance="filled"
      ...
      >
        {/* Drawer Content */}
        <div
          className={`absolute top-0 left-0 h-full w-80 shadow-xl ${
            isMobilePlatform ? 'pt-safe-top' : ''
          }`}
          style={{
            background: 'linear-gradient(180deg, #00181B 0%, #131515 100%)',
          }}
        >
          <div
          ...
          >
            ...
            <div className="m-4">
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={toggleMobileMenu}
                  className="group flex h-8 w-8 cursor-pointer items-center justify-center rounded-sm transition-colors"
                  style={{
            ...
            {/* WalletDropdown and Profile at Top */}
            <div className="m-4 space-y-3">
              ...
              {isAuth && (
                <div className="relative" ref={userMenuRef}>
                  <div
                    className="flex h-[50px] w-full items-center rounded-[3px] px-3"
                    style={{
                  ...
                  >
                    ...
                    >
                      {/* Avatar Container */}
                      <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#246A73]">
                        {user?.avatar ? (
                          <Image
                            src={user.avatar}
                            alt="Profile"
              ...
              {!isAuth && (
                <div className="px-0 py-0">
                  <div className="flex items-center gap-3">
                    <div className="flex w-full items-center gap-3 rounded-[0px]">
                      <button
                        onClick={handleOpenLoginModal}
                        className="template10-filled-button-hover h-[50px] flex-1 rounded-[4px] border border-[#E33A24] bg-[#E33A24] px-4 font-bold text-white"
                      >
                        Login
                      </button>
                      ...
                      <button
                        onClick={handleOpenRegisterModal}
                        className="template10-bordered-button-hover h-[50px] flex-1 rounded-[4px] border bg-transparent px-4 font-bold text-white"
                        style={{
                          borderColor: '#E33A24',
                        }}
                      >
            ...
            <div className="px-0">
              <nav className="mt-2">
                <Link
                  ...
                  style={{
                    borderBottom: '0.3px solid #00374A',
                  }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <Link
                  ...
                  onClick={(e) =>
                    handleMobileNavigation(e, '/dashboard/deposit')
                  }
                  className="group flex items-center gap-3 px-4 py-4"
                  style={{
                    borderBottom: '0.3px solid #00374A',
                ...
                <Link
                  ...
                  onClick={(e) =>
                    handleMobileNavigation(e, '/dashboard/coupons')
                  }
                  className="group flex items-center gap-3 px-4 py-4"
                  style={{
                    borderBottom: '0.3px solid #00374A',
              ...
              <div className="relative mb-8 block w-full">
                ...
                <div className="relative block w-full">
                  ...
                  <a
                    ...
                    download
                    className="absolute bottom-3 left-4 z-10 bg-[#246A73] px-4 py-2 text-center transition-colors duration-300 hover:bg-[#1e5560]"
                    style={{ borderRadius: '15.332px' }}
                  >
              ...
              {isAuth && (
                <div className="mt-4">
                  <button
                    ...
                    className="group flex w-full cursor-pointer items-center justify-between rounded-[2.314px] bg-transparent px-4 py-3 text-base font-semibold text-white transition-colors duration-300"
                    style={{
                      border: '1px solid rgba(36, 106, 115, 0.3)',
                    }}
                  >

...
function FaqPage() {
  ...
  const Section = ({ items }) => (
    <div className="space-y-4">
      {items.map((item, idx) => (
        <div
          key={idx}
          className="rounded-[3px] border border-[#E33A2480] transition-colors duration-200 hover:border-[#E33A2480]"
        >
  ...
  return (
    <div className="min-h-screen text-white">
      <div className="container px-2 py-8 md:mx-auto md:ml-2">
          ...
          <div className="flex flex-wrap gap-2">
            {tabs.map((tab) => (
              <button
                ...
                className={`mobile-tab-button rounded-[4px] border border-[#E33A2480] px-3 py-2 text-sm transition-colors duration-200 focus:ring-0 focus:outline-none focus-visible:outline-none sm:px-4 sm:py-3 sm:text-base ${
                  activeTab === tab.key

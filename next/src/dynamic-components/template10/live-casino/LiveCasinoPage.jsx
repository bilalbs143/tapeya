  ...
  const liveCasinoProviders = [
    {
      ...
      name: 'Evolution',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/evolution-10.webp',
      isLive: true,
    },
    {
      ...
      name: 'Pragmatic',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/pragmatic-10.webp',
      isLive: true,
    },
    {
      key: 'AGIN',
      ...
      name: 'Asia Gaming',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/asia-gaming-10.webp',
      isLive: true,
    },
    {
      key: 'cq9_casino',
      ...
      name: 'CQ9',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/cq9-10.webp',
      isLive: true,
    },
    {
      key: 'MICRO_Casino',
      ...
      name: 'Microgaming',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/micro-gaming-10.webp',
      isLive: false,
    },
    {
      key: 'VOTA',
      ...
      name: 'VOTA',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/vota-10.webp',
      isLive: true,
    },
    {
      key: 'TOMHORN_7Mojos',
      ...
      name: '7 Mojos',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/seven-mojos-10.webp',
      isLive: true,
    },
    {
      ...
      name: 'Absolute Live',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/absolute-live-10.webp',
      isLive: true,
    },
    {
      key: 'TOMHORN_VIVO',
      ...
      name: 'Vivo',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/vivo-10.webp',
      isLive: true,
    },
    {
      key: 'crypto_poker',
      ...
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/crypto-in-poker-10.webp',
      isLive: false,
    },
    {
      key: 'allbet',
      ...
      name: 'Allbet',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/all-bet-10.webp',
      isLive: false,
    },
    {
      key: 'cream_gaming',
      ...
      name: 'Cream Gaming',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/dream-gaming-10.webp',
      isLive: false,
    },
    {
      key: 'mt',
      ...
      name: 'Mt',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/mt-game-10.webp',
      isLive: false,
    },
    {
      key: 'oriental_game',
      ...
      name: 'Oriental Game',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/oriental-gaming-10.webp',
      isLive: false,
    },
    {
      key: 'sa_game',
      ...
      name: 'Sa Game',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/sa-game-10.webp',
      isLive: false,
    },
    {
      key: 'sexy',
      ...
      name: 'Sexy',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/sexy-gaming-10.webp',
      isLive: false,
    },
    {
      key: 'bet_game',
      ...
      name: 'Bet Game',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/bet-games-10.webp',
      isLive: false,
    },
    {
      ...
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/gameplay-interactive-10.webp',
      isLive: false,
    },
    {
      key: 'playtech',
      ...
      name: 'Playtech',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/playtech-10.webp',
      isLive: false,
    },
    {
      key: 'skywind',
      ...
      name: 'Skywind',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/skywind-group-10.webp',
      isLive: false,
    },
  ];
      ...
      >
        <div className="relative min-h-[200px] w-full overflow-hidden">
          ...
          <div className="relative hidden w-full md:block">
            <Image
              src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/casino-top-banner-10.webp"
          ...
          <div className="relative block w-full md:hidden">
            <Image
              src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/casino-top-banner-mob-10.webp"
          ...
          {/* Content Overlay */}
          <div className="absolute inset-0 z-10 flex items-start justify-center pt-8 sm:pt-6 md:mt-6 md:items-center md:justify-end md:pt-0 md:pr-24">
        ...
        <div className="mb-6 w-full">
          ...
          >
            ...
            <div className="flex items-center pr-3 md:pr-6">
              ...
              >
                <span className="font-spy-agency md:hidden">
                  {t('providers')}
                </span>
                <span className="font-spy-agency hidden md:inline">
                  {t('casino_providers')}
                </span>
              </h3>
            </div>
            ...
            >
              ...
              >
                ...
                <div className="relative bg-transparent">
                  <div className="relative flex items-center justify-center overflow-hidden rounded-[5px]">
                    ...
                    <div
                      ...
                      style={{ backgroundColor: 'rgba(36, 106, 115, 0.3)' }}
                    />
                    ...
                    <div className="absolute inset-0 z-30 flex items-center justify-center opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                      <div className="z-40 flex flex-col items-center gap-2 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                        <button
                          type="button"
                          className="flex h-12 w-12 cursor-pointer items-center justify-center rounded-full border-2 transition-colors disabled:opacity-50 sm:h-16 sm:w-16"
                          style={{
                            backgroundColor: '#E33A24',
                            borderColor: '#E33A24',
                          }}
                ...
                <div className="relative z-10 mt-2 text-center">
                  <span className="font-spy-agency text-sm text-white uppercase sm:text-base">
                    {provider.name}
                  </span>
                </div>
              </div>
        ...
        <div className="mt-0">
          <div className="px-0 pt-8 sm:px-0">
            <div className="relative overflow-hidden">
              {/* Desktop Banner - Hidden on mobile (<=768px) */}
              <img
                src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/casino-bottom-banner-10.webp"
              ...
              {/* Mobile Banner - Only visible on mobile (<=768px) */}
              <img
                src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/casino-bottom-banner-mob-10.webp"
                alt={t('home_page_banner')}

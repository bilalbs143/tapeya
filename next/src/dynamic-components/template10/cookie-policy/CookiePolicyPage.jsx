    ...
    <div className="text-white">
      <div className="container mx-auto px-3 py-7">
        ...
        <div className="">
          {/* Border Container */}
          <div
            className="overflow-hidden rounded-[3px] border-1 bg-transparent md:ml-3"
            ...
            <div className="bg-transparent p-6 md:p-12">
              ...
              <div className="space-y-6">
                ...
                <section>
                  ...
                  <div className="text-white">
                    <p className="mobile-content mb-3 text-[10px] text-[#CCCCCC] md:text-[16px]">
                      {currentContent.typesIntro}
                    </p>
                    <ul className="ml-6 space-y-2">
                      <li className="flex items-start">
                        <span className="mr-2 text-[10px] text-[#CCCCCC] md:text-[16px]">
                          •
                        </span>
                        <span className="mobile-content text-[10px] text-[#CCCCCC] md:text-[16px]">

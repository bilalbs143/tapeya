...
import PendingExchangeAlert from '@/dynamic-components/template10/components/AlertSections/PendingExchangeAlert';
import UnreadNotesAlert from '@/dynamic-components/template10/components/AlertSections/UnreadNotesAlert';
...
export default function Alert() {
  ...
  return (
    <div
      className={`mx-auto w-full max-w-[400px] transform rounded-[5px] bg-[#246A734D] text-white shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)] transition-all duration-300 ease-out sm:max-w-[500px] lg:max-w-[590px] ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'}`}
    >
        ...
        <div className="space-y-4 sm:space-y-6">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={handleCloseModal}
              aria-label={t('close')}
              className="group flex h-[30px] w-[30px] flex-shrink-0 cursor-pointer items-center justify-center rounded-[5px] border border-[#E33A2480] text-black transition-all duration-300 sm:h-[38px] sm:w-[38px]"
            >
              <svg
                width="16"
                height="16"
          ...
          <div className="space-y-6">
            ...
            {isExchangeRequestAlert && (
              <div className="space-y-4">
                <div className="rounded-[6px] border border-[#E33A2480] bg-[#1D4647] px-6 py-6 shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)]">
                    ...
                    {modalProps.data?.exchangeRequest && (
                      <div className="mt-4 space-y-3">
                        ...
                        <div className="mt-2 space-y-3">
                          {/* Requested Amount */}
                          <div className="flex items-center justify-between rounded-[5px] border border-[#E33A2480] bg-[#172F31CC] px-5 py-3 text-white shadow-inner">
                            <span className="text-sm font-medium">
                              {t('requested_amount')}
                            </span>
                            <span className="bg-[#E33A24] bg-clip-text text-lg font-semibold text-transparent">
                              {formatCurrency(
            ...
            {isCustomerInquiryReplyAlert && (
              <div className="space-y-4">
                <div className="rounded-[5px] border border-[#E33A2480] bg-[#1D4647] px-3 py-4">
                  <h3 className="border-b border-[#E33A2480] bg-[#1D4647] pb-1 text-sm font-medium text-white">
                  ...
                  {modalProps?.data?.customerInquiry && (
                    <div className="mt-4 space-y-3">
                      <div className="rounded-[5px] border border-[#E33A2480] bg-[#172F31CC] px-6 py-4 shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)]">
                  ...
                  <div className="mt-4">
                    <button
                      ...
                      className="flex w-full cursor-pointer items-center justify-center rounded-[5px] bg-[#E33A24] px-4 pt-3 pb-3 text-sm font-semibold text-white active:scale-95"
            ...
            {hasUnreadNotes &&
              ...
              !isCustomerInquiryReplyAlert && (
              <div className="space-y-4">
                <div className="rounded-[3px] border border-[#E33A2480] bg-[#1D4647] px-3 py-4">
                  <h3 className="border-b border-[#E33A2480] pb-1 text-sm font-medium text-white">
                    {t('unread_messages')}
                  </h3>
                  <UnreadNotesAlert

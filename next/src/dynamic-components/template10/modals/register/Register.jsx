...
export default function Register(props) {
  ...
  return (
    <div
      className={`mx-auto max-h-[90vh] w-full max-w-[900px] transform overflow-x-hidden overflow-y-auto rounded-[5px] bg-[#246A734D] text-white shadow-xl transition-all duration-300 ease-out md:max-h-none ${
        isVisible ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'
      }`}
    >
      <div className="flex w-full flex-col items-stretch rounded-[5px]">
          ...
          <div className="w-full max-w-[820px]">
            ...
            <div className="mt-2 mb-8 flex items-center justify-between">
              ...
              <button
                ...
                aria-label={t('close')}
                className="group flex h-[30px] w-[30px] flex-shrink-0 cursor-pointer items-center justify-center rounded-[4px] border border-[#E33A2480] text-black transition-all duration-300 sm:h-[35px] sm:w-[35px]"
              >
                <svg
                  width="16"
                  height="16"
            ...
            <form className="space-y-2" onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        ...
                        className="w-full rounded-[5px] border border-[#E33A2480] bg-[#1D4647] focus:border-[#E33A2480] focus:bg-[#172F31CC] focus:ring-0 focus:outline-none"
                      />
                    )}
                  />
                </div>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        ...
                        className="w-full rounded-[6px] border border-[#E33A2480] bg-[#1D4647] focus:border-[#E33A2480] focus:bg-[#172F31CC] focus:ring-0 focus:outline-none"
                      />
                    )}
                  />
                </div>
                ...
                <div className="overflow-visible">
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      ...
                      >
                        <SelectTrigger className="w-full rounded-[5px] border border-[#E33A2480] bg-[#1D4647] focus:border-[#E33A2480] focus:bg-[#172F31CC] focus:ring-0 focus:outline-none">
                          <SelectValue placeholder={t('select_bank')} />
                        </SelectTrigger>
                        <SelectContent className="border-[#E33A2480] bg-[#172F31CC] text-white">
              ...
              <button
                ...
                className="template10-filled-button-hover mt-5 w-full rounded-[5px] bg-[#E33A24] py-2 font-semibold text-white transition active:scale-95 disabled:opacity-50"
              >

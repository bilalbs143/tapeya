...
export default function LaunchGame() {
  ...
  return (
    <div className="mx-auto w-full max-w-[400px] transform rounded-[5px] bg-[#246A734D] text-white shadow-xl transition-all duration-300 ease-out sm:max-w-[520px] lg:max-w-[600px]">
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="space-y-5 sm:space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="font-cravend text-lg text-white sm:text-xl">
            ...
            <button
              onClick={handleCloseModal}
              aria-label={t('close')}
              className="group flex h-[30px] w-[30px] flex-shrink-0 cursor-pointer items-center justify-center rounded-[5px] border border-[#E33A2480] text-black transition-all duration-300 sm:h-[35px] sm:w-[35px]"
            >
              <svg
                width="16"
                height="16"
          ...
          <div className="space-y-4 rounded-[6px] border border-[#E33A2480] bg-[#1D4647] p-4 sm:p-6">
            {/* Game Image */}
            <div className="relative w-full overflow-hidden rounded-[10px] border border-[#E33A2480] bg-[#0F0F0F]">
              <img
                src={
                  game.image_url ||
                  game.image ||
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <button
                ...
                className="fancy-hover-effect-orange flex w-full cursor-pointer items-center justify-center rounded-[4px] bg-[#E33A24] px-4 py-4 text-base font-extrabold tracking-wide text-white uppercase transition-all duration-200 active:scale-95 disabled:opacity-50"

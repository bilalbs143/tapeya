...
export default function NoteTab({ openMessageId }) {
  ...
  return (
    <div className="flex h-full flex-col">
      <h3 className="font-spy-agency text-center text-[20px] sm:text-left sm:text-[35px] md:text-[35px]">
        {t('notes')}
      </h3>
                ...
                <tbody>
                  {notesData.length === 0 ? (
                    ...
                    notesData.map((item, index) => (
                      <tr
                        key={item.id || index}
                        className="cursor-pointer border-t border-b border-[#E33A2480] transition-all duration-300 hover:border-[#E33A2480] hover:bg-[#172F31CC] hover:shadow-[inset_0_4px_14px_0_rgba(227,58,36,0.50)]"

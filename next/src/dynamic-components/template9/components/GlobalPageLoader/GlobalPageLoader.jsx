...
const GlobalPageLoader = () => {
      ...
      <div className="relative flex items-center justify-center">
        ...
        <div className="absolute">
          ...
          <div
            style={{
              ...
              borderTopColor: '#DBB42C',
              borderRightColor: '#DBB42C',
              animation: 'spinForward 3s linear infinite',
              filter: 'drop-shadow(0 0 15px rgba(219, 180, 44, 0.6))',
            }}
          />
        </div>
        ...
        <div className="absolute">
          <div
            style={{
              ...
              borderRadius: '50%',
              border: '3px solid transparent',
              borderBottomColor: '#DBB42C',
              borderLeftColor: '#DBB42C',
              animation: 'spinBackward 2.5s linear infinite',
              filter: 'drop-shadow(0 0 12px rgba(219, 180, 44, 0.6))',
            }}
          />
        </div>
        ...
        <div className="absolute">
          <div
            style={{
              ...
              filter: 'drop-shadow(0 0 10px rgba(219, 180, 44, 0.6))',
            }}
          />
        </div>
        ...
        <div
          ...
          style={{
            ...
            height: '50px',
            borderRadius: '50%',
            background: 'linear-gradient(135deg, #DBB42C 0%, #12001F 100%)',
            boxShadow: `
              0 0 30px rgba(219, 180, 44, 0.8),
              0 0 60px rgba(219, 180, 44, 0.4),
              inset 0 0 20px rgba(219, 180, 44, 0.3)
            `,
        ...
        >
          ...
          <div
            style={{
              ...
              height: '15px',
              borderRadius: '50%',
              background: 'rgba(219, 180, 44, 0.6)',
              filter: 'blur(2px)',
            }}
          />
        </div>
  ...
  return (
    <div
      className="fixed inset-0 z-[9999] flex items-center justify-center overflow-hidden bg-[#12001F]"
      style={{
        display: 'flex',
        position: 'fixed',
        top: 0,
    ...
    >
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(circle at 50% 50%, rgba(219, 180, 44, 0.12) 0%, transparent 50%),
            radial-gradient(circle at 20% 80%, rgba(219, 180, 44, 0.08) 0%, transparent 40%),
            radial-gradient(circle at 80% 20%, rgba(219, 180, 44, 0.08) 0%, transparent 40%)
          `,
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle at 50% 50%, rgba(219, 180, 44, 0.05) 0%, transparent 70%)',
        ...
        <div className="mt-8 flex min-h-[24px] flex-col items-center justify-center text-center sm:mt-10">
          {isTranslationReady ? (
            <p
              ...
              style={{
                color: '#DBB42C',
                textShadow: '0 0 10px rgba(219, 180, 44, 0.5)',
              }}
            >
            ...
            <div className="flex items-center space-x-3">
              {[...Array(3)].map((_, i) => (
                <div
                  ...
                  style={{
                    background: 'radial-gradient(circle, #DBB42C, #12001F)',
                    boxShadow: `
                      0 0 15px rgba(219, 180, 44, 0.8),
                      0 0 30px rgba(219, 180, 44, 0.4)
                    `,

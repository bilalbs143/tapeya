    ...
    return (
      <div ref={dropdownRef} className="relative z-[1001] inline-block">
        <button
          ...
          className={`group inline-flex w-full items-center justify-center rounded-[3px] bg-[#12001F] p-2 transition-all duration-300 ${
            size === 'mobile' ? 'min-h-[48px]' : 'min-h-[64px]'
          } ${
        ...
        >
          <div
            className={`relative flex flex-col items-center justify-center rounded-[5px] bg-[#1D0032] ${
              size === 'mobile' ? 'h-10 w-10' : 'h-12 w-12'
            }`}
          >
            <Image
            ...
            {!isSavingToBackend && (
              ...
              >
                <path
                  d="M0.129395 0.482964L12.1294 3.69835L24.1294 0.482964"
                  stroke="#DBB42C"
                />
              </svg>
            )}
          ...
          <div className="absolute right-0 z-[1002] mt-2 w-34">
            ...
            >
              <div className="rounded-[3px]">
                <div className="overflow-hidden rounded-[3px] p-1">
                  <div role="listbox" aria-label="Language options">
                    {locales.map((locale, idx) => (
                      <button
                        ...
                        className={`group mb-2 flex w-full items-center justify-between rounded-[3px] border border-transparent bg-[#12001F] px-3 py-2 text-left transition-all duration-200 last:mb-0 ${
                      ...
                      >
                        <span className="flex items-center gap-2 text-[#636363] transition-colors group-hover:text-white">
                          <Image

          ...
          <div className="mb-6 w-full">
            <div className="flex items-center justify-between gap-3 px-0 py-0 md:px-2 md:py-1">
              ...
              <div className="flex items-center gap-3">
                <LazyImage
                  src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/top-games-9.svg"
                  alt={t('top_games')}
                  width={34}
                  height={42}
                ...
                <h3 className="text-[20px] tracking-wide uppercase md:text-[25px]">
                  <span className="font-cravend text-white">{t('top')}</span>{' '}
    ...
    <section className="relative mt-6 py-4 pb-4 md:mt-10">
      <div className="">
        ...
        <div>
          ...
          >
            <div
              className="template9-game-slider template9-top-games-slider overflow-hidden"
              ref={emblaRef}
            >
              <div className="flex">
                {/* Single row layout */}

...
const LeftSidebar = memo(function LeftSidebar() {
  ...
  return (
    <aside className="template9-left-sidebar m-4 hidden h-auto w-64 flex-shrink-0 flex-col self-start rounded-[5px] bg-[#1D0032] lg:flex lg:w-64 xl:w-64">
      <div className="flex flex-col p-4 pb-6">
        {/* Our Menu Heading */}
        <div className="mb-6">
          <h2 className="text-lg font-bold" style={{ color: '#DBB42C' }}>
            Our Menu
          </h2>
        </div>
        ...
        <div>
          <nav className="mt-2 space-y-2">
            ...
            <Link
              ...
              className={`group template9-menu-item-angled ${isActive('/dashboard/faqs') ? 'template9-menu-item-angled-active' : ''}`}
            >
              <div className="template9-menu-item-angled-inner">
                <div className="template9-menu-item-content">
                  <svg
        ...
        <div className="mt-16 mb-4">
          ...
          >
            <Image
              src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/download-apk-9.webp"
              alt="Download APK"
              width={240}
              height={80}
        ...
        <div className="space-y-2">
          ...
          >
            <div
              className="template9-menu-item-angled-inner rounded-[3px] border bg-[rgba(51,19,105,0.41)] shadow-[4px_5px_16px_0_rgba(0,0,0,0.25)_inset] transition-colors duration-200 hover:bg-[rgba(51,19,105,0.60)]"
          ...
          >
            <div
              className="template9-menu-item-angled-inner mt-3 rounded-[3px] border bg-[rgba(51,19,105,0.41)] shadow-[4px_5px_16px_0_rgba(0,0,0,0.25)_inset] transition-colors duration-200 hover:bg-[rgba(51,19,105,0.60)]"
              style={{ borderColor: 'rgba(219, 180, 44, 0.30)' }}
            >
              <div className="template9-menu-item-content">
                <svg

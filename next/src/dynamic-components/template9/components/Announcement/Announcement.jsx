...
function Announcement() {
  ...
  return (
    <section className="pt-6 md:pt-10">
      <div
        className="z-[1] rounded-[3px] border bg-[#1D0032]"
        style={{ borderColor: 'rgba(157, 78, 221, 0.50)' }}
      >
        {/* Desktop Layout */}
        <div className="hidden items-center md:flex">
          ...
          <div className="flex items-center gap-2 px-4 py-6">
            <Image
              src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/announce-icon-9.svg"
              alt="Announcement"
              width={29}
              height={31}
              className="h-6 w-6 flex-shrink-0"
            />
            <span className="font-cravend text-sm font-medium text-[#DBB42C]">
              {t('announcement')}
            </span>
          </div>
          {/* Vertical Separator */}
          <div
            className="h-8 w-px"
            style={{ backgroundColor: 'rgba(157, 78, 221, 0.50)' }}
          />
          <div
            className="relative flex-1 overflow-hidden px-4 py-2 text-[#20C5FE] transition-colors"
        ...
        <div className="flex items-center justify-center md:hidden">
          ...
          <div className="relative z-10 inline-flex items-center justify-center gap-2 overflow-hidden px-2 py-4">
            <Image
              src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/announce-icon-9.svg"
              alt="Announcement"
              width={29}
            ...
            />
            <span className="font-cravend text-xs font-medium text-white">
              {t('announcement')}
            </span>
          </div>
          {/* Vertical Separator */}
          <div
            className="relative z-10 h-6 w-px"
            style={{ backgroundColor: 'rgba(157, 78, 221, 0.50)' }}
          />
          <Link
            href="#"

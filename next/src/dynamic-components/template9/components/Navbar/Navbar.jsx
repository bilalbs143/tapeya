...
import { LanguageSwitcher } from '@/dynamic-components/template9/components/LanguageSwitcher/LanguageSwitcher';
import LazyImage from '@/dynamic-components/template9/components/LazyImage/LazyImage';
import WalletButton from '@/dynamic-components/template9/components/WalletButton/WalletButton';
import WalletDropdown from '@/dynamic-components/template9/components/WalletDropdown/WalletDropdown';
...
function Navbar() {
  ...
  const sidebarApkSrc = useMemo(() => {
    if (currentLocale === 'id') {
      return 'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/apk-new-banner-mob-9.webp';
    }
    if (currentLocale === 'ko') {
      return 'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/apk-new-banner-mob-9.webp';
    }
  ...
  // Keep profile dropdown width equal to the trigger button container
  useEffect(() => {
  ...
  return (
    <>
      ...
      >
            ...
            <div className="relative flex items-center">
              ...
              <div className="flex-1">
                <Link href="/" className="flex items-center">
                  <div className="flex min-h-[64px] items-center justify-center rounded-[3px] border-[0.5px] border-[rgba(219,180,44,0.30)] bg-[#12001F] px-8 py-2">
                    <Image
                      src={headerLogo}
                      alt="Artchip Logo"
                      width={120}
              ...
              {/* Wallet Button - Center - Only show if authenticated */}
              <div
                ...
                {!isAuth ? (
                  <>
                    <button
                      ...
                      className="template9-filled-button-hover h-[64px] w-[130px] rounded-[4px] border border-[#9D4EDD] bg-[#9D4EDD] px-4 font-bold text-white"
                    >
                      Login
                    </button>
                    ...
                    <button
                      ...
                      className="template9-bordered-button-hover h-[64px] w-[130px] rounded-[4px] border bg-[#12001F] px-4 font-bold text-white"
                      style={{
                  ...
                  <div className="flex items-center gap-4">
                    <div
                      className="relative rounded-[3px] bg-[#12001F] p-2"
                      ref={userMenuRef}
                      style={{
                        pointerEvents: 'auto',
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="flex h-12 w-12 items-center justify-center rounded-[3px] bg-[#1D0032]">
                          {user?.avatar ? (
                            <Image
                              src={user.avatar}
                              alt="Profile"
                        ...
                        <div className="flex flex-col items-start">
                          ...
                          <span className="text-xs font-medium text-[#DBB42C] underline">
                            {t('viewProfile') ||
                              t('view_profile') ||
                              'View Profile'}
                          </span>
                      ...
                      {isUserMenuOpen && (
                        ...
                        >
                          ...
                          >
                            <div className="overflow-hidden rounded-[3px] p-3">
                              <Link
                              ...
                              >
                                <span className="flex items-center gap-3">
                                  <svg
                                    ...
                                    viewBox="0 0 16 16"
                                    fill="currentColor"
                                    className="h-4 w-4 text-[#636363] transition-colors group-hover:!text-[#DBB42C]"
                                  >
                              ...
                              >
                                <span className="flex items-center gap-3">
                                  ...
                                  <span className="text-[12px] text-[#636363] capitalize transition-colors group-hover:text-white">
        ...
        {/* Mobile Navbar */}
        <div
          className="m-0 px-3 py-3 lg:hidden"
          style={{
            borderRadius: '5px',
            border: '0.5px solid rgba(219, 180, 44, 0.30)',
            background: '#1D0032',
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex min-h-[58px] w-[58px] items-center justify-center rounded-[3px] bg-[#12001F]"
              style={{
                border: '0.5px solid rgba(219, 180, 44, 0.30)',
              }}
            >
            ...
            {/* Logo - Center */}
            <Link href="/" className="flex items-center">
              <div className="flex items-center justify-center rounded-[3px] border-[0.5px] border-[rgba(219,180,44,0.30)] bg-[#12001F] px-4 py-2">
                <Image
                  src="https://d3emlo5tm9es2f.cloudfront.net/next/logos/artchip-main-9.svg"
                  alt="Artchip Logo"
                  width={100}
                  height={40}
                  priority
            ...
            <div className="template9-mobile-lang-button">
              <div style={{ pointerEvents: 'auto' }}>
                <LanguageSwitcher
                  variant="dropdown"
                  appearance="filled"
      ...
      >
        {/* Drawer Content */}
        <div
          className={`absolute top-0 left-0 h-full w-80 bg-[#1D0032] shadow-xl ${
        ...
        >
          ...
          >
            ...
            <div
              className="m-4 rounded-[3px] border-[0.5px] bg-[#12001F] p-4"
              style={{ borderColor: 'rgba(219, 180, 44, 0.30)' }}
            >
              <div className="flex items-center justify-between">
                <Link href="/" className="flex items-center">
                ...
                <button
                  onClick={toggleMobileMenu}
                  className="group flex h-8 w-8 cursor-pointer items-center justify-center rounded-sm bg-[#1D0032] transition-colors"
                  style={{
              ...
              <div className="px-0 py-0">
                <div className="flex items-center gap-3">
                  <div className="flex w-full items-center gap-3 rounded-[0px] px-3 py-3">
                    <button
                      onClick={handleOpenLoginModal}
                      className="template9-filled-button-hover h-[50px] flex-1 rounded-[4px] border border-[#9D4EDD] bg-[#9D4EDD] px-4 font-bold text-white"
                    >
                      Login
                    </button>
                    ...
                    <button
                      onClick={handleOpenRegisterModal}
                      className="template9-bordered-button-hover h-[50px] flex-1 rounded-[4px] border bg-[#12001F] px-4 font-bold text-white"
                      style={{
                        borderColor: 'rgba(219, 180, 44, 0.30)',
                      }}
                    >
            ...
            <div className="mt-2 space-y-2 p-4">
              <Link
                ...
                className={`group template9-menu-item-angled ${isActive('/') ? 'template9-menu-item-angled-active' : ''}`}
              >
                <div className="template9-menu-item-angled-inner">
                  <div className="template9-menu-item-content">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 35 36"
                      fill="none"
                    ...
                    <span className="font-bold text-[#636363] transition-colors duration-300">
                      {t('home') || 'Home'}
                    </span>
                  </div>
                  <svg
              ...
              <Link
                ...
                className={`group template9-menu-item-angled ${isActive('/dashboard/withdrawal') ? 'template9-menu-item-angled-active' : ''}`}
              >
                <div className="template9-menu-item-angled-inner">
                  <div className="template9-menu-item-content">
                    <svg
              ...
              <Link
                ...
                className={`group template9-menu-item-angled ${isActive('/dashboard/deposit') ? 'template9-menu-item-angled-active' : ''}`}
              >
                <div className="template9-menu-item-angled-inner">
                  <div className="template9-menu-item-content">
                    <svg
              ...
              <Link
                ...
                className={`group template9-menu-item-angled ${isActive('/dashboard/coupons') ? 'template9-menu-item-angled-active' : ''}`}
              >
                <div className="template9-menu-item-angled-inner">
                  <div className="template9-menu-item-content">
                    <svg
              ...
              <Link
                ...
                className={`group template9-menu-item-angled ${isActive('/dashboard/customer-inquiry') ? 'template9-menu-item-angled-active' : ''}`}
              >
                <div className="template9-menu-item-angled-inner">
                  <div className="template9-menu-item-content">
                    <svg
              ...
              <Link
                ...
                className={`group template9-menu-item-angled ${isActive('/dashboard/note') ? 'template9-menu-item-angled-active' : ''}`}
              >
                <div className="template9-menu-item-angled-inner">
                  <div className="template9-menu-item-content">
                    <svg
              ...
              <Link
                ...
                className={`group template9-menu-item-angled ${isActive('/announcements') ? 'template9-menu-item-angled-active' : ''}`}
              >
                <div className="template9-menu-item-angled-inner">
                  <div className="template9-menu-item-content">
                    <svg
              ...
              <Link
                ...
                className={`group template9-menu-item-angled ${isActive('/faq') ? 'template9-menu-item-angled-active' : ''}`}
              >
                <div className="template9-menu-item-angled-inner">
                  <div className="template9-menu-item-content">
                    <svg
            ...
            {isAuth && (
              <div className="px-4">
                <div className="relative" ref={userMenuRef}>
                  <div
                    className="flex h-[50px] w-full items-center rounded-[3px] border bg-[#12001F] px-3 pl-1"
                    style={{ borderColor: 'rgba(219, 180, 44, 0.30)' }}
                  >
                    <button
                      onClick={toggleUserMenu}
                      className="group flex h-full w-full cursor-pointer items-center gap-3 border-none bg-transparent px-0 py-0 text-base font-bold text-white transition-all"
                    >
                      {/* Avatar Container */}
                      <div className="flex h-10 w-10 items-center justify-center rounded-[3px] bg-[#1D0032]">
                        {user?.avatar ? (
                          <Image
                            src={user.avatar}
                            alt="Profile"
            ...
            <div className="mt-auto space-y-3 p-4">
              ...
              <a
                href="https://thestaticfile.com/uploads/user09.apk"
                download
                className="relative mb-8 block w-full"
              >
                {/* Text overlay */}
                <div className="absolute top-4 left-4 z-10">
                  <h3 className="text-left text-base leading-tight font-bold text-white uppercase">
                    {t('download_apk')}
                  </h3>
                </div>
              ...
              {isAuth && (
                <div className="mt-4">
                  <button
                    ...
                    className="group flex w-full cursor-pointer items-center justify-between rounded-[2.314px] bg-[rgba(51,19,105,0.41)] px-4 py-3 text-base font-semibold text-white transition-colors duration-300"
                    style={{
                      border: '0.771px solid rgba(219, 180, 44, 0.30)',
                      boxShadow:
                        '3.085px 3.857px 12.342px 0 rgba(0, 0, 0, 0.25) inset',
                    }}
                  >

    ...
    <div className="rounded-[16px] border border-[#FFFFFF66] bg-transparent p-5">
      ...
      <div className="mb-4 flex items-center justify-start gap-4">
        <button
          onClick={onClose}
          aria-label={t('back')}
          className="template9-filled-button-hover flex items-center justify-center rounded-[4px] bg-[#9E91E6] px-8 py-2 font-extrabold text-white transition-all duration-300"
        >
          <span>{t('black')}</span>
        </button>
      ...
      <div className="">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-stretch">
          ...
          <button
            className="template9-filled-button-hover w-full rounded-[4px] bg-[#9E91E6] px-5 py-3 text-sm font-bold text-white transition-all duration-200 active:scale-95 disabled:opacity-50 sm:w-[270px]"
            onClick={() =>
              copyToClipboard(withdrawalData?.withdraw_address || '')
            }
            disabled={!withdrawalData?.withdraw_address}

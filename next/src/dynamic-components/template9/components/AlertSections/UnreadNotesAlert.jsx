  ...
  return (
    <div className="space-y-4">
      <div className="mt-3 flex items-center space-x-3">
        <div className="flex h-10 w-10 items-center justify-center rounded-[5px] bg-[#9D4EDD] shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)]">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
      ...
      <div className="rounded-[5px] border border-[#DBB42C4D] bg-[#1D0032] p-4">
      ...
      <button
        ...
        className="w-full cursor-pointer rounded-[5px] bg-[#9D4EDD] px-4 py-3 text-sm font-semibold text-white transition-all duration-150 active:scale-95"

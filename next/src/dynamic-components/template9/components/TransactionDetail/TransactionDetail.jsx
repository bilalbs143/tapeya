  ...
  return (
    <div className="">
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-1">
        {/* Transaction Details */}
        <div className="rounded-[9px] border-[0.8px] border-[#DBB42C4D] p-4">
          <div className="mb-4 flex items-center justify-between">
            <div className="font-cravend text-[17px] font-semibold text-white">
              {title}
            </div>
            ...
            <button
              onClick={onClose}
              aria-label={t('close')}
              className="group flex h-[30px] w-[30px] flex-shrink-0 cursor-pointer items-center justify-center rounded-[5px] border border-[#DBB42C4D] bg-[#1D0032] text-black transition-all duration-300 sm:h-[33px] sm:w-[33px]"
            >
              <svg
                width="16"
                height="16"

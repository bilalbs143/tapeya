      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2 md:gap-4">
        <div>
          ...
          <div className="relative" ref={convertDropdownRef}>
            <div
              id="convert-select"
              className="relative flex h-[46px] w-full cursor-pointer appearance-none items-center justify-between rounded-[5px] border border-[#DBB42C4D] bg-[#060D0D] px-3 py-3 text-[12px] text-white shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)] focus:border-[#DBB42C] focus:bg-[#1D0032] focus:ring-1 focus:ring-[#2DFA1A4D] focus:outline-none md:text-[14px] lg:h-[55px]"
            ...
            {isConvertDropdownOpen && (
              <div className="scrollbar-hide absolute z-[99999] mt-1 max-h-[150px] w-full overflow-y-auto rounded-[3px] border border-[#DBB42C4D] bg-black shadow-lg">
                <div
                  className="cursor-pointer px-3 py-2 text-[12px] text-white transition-colors duration-150 hover:bg-[#9D4EDD] md:text-[14px]"
                  onClick={() => {
                    setConvertType('points_exchange');
                    setIsConvertDropdownOpen(false);
                  }}
        ...
        <div>
          ...
          <div
            id="available-amount"
            className="flex h-[46px] w-full items-center rounded-[3px] border border-[#DBB42C4D] bg-[#060D0D] px-3 py-3 text-[12px] text-[#FFFFFF80] shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)] sm:text-sm md:placeholder:text-sm lg:h-[55px]"
          >
            {convertType === 'points_exchange' ? (
        ...
        <form onSubmit={handleSubmitConvert} className="space-y-4">
          <div className="">
            ...
            <input
              ...
              className="relative block h-[46px] w-full appearance-none rounded-[3px] border border-[#DBB42C4D] bg-[#060D0D] px-3 py-3 text-white shadow-[inset_4px_5px_16px_0_rgba(0,0,0,0.25)] placeholder:text-xs placeholder:text-[#FFFFFF66] focus:border-[#DBB42C] focus:bg-[#1D0032] focus:ring-0 focus:ring-transparent focus:outline-none sm:flex-1 sm:text-sm md:placeholder:text-sm lg:h-[55px]"
              min="1"
              step="1"
            />
          </div>
          <div className="flex justify-end">
            <button
              ...
              className="template9-filled-button-hover flex cursor-pointer items-center justify-center rounded-[4px] bg-[#9D4EDD] px-6 pt-4 pb-4 text-[16px] font-normal text-white transition-all duration-200 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
            >

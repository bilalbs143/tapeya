          ...
          >
            ...
            >
              <button
                ...
                className="flex w-full cursor-pointer items-center justify-center rounded-b-lg bg-[#9D4EDD] px-4 pt-3 pb-4 text-sm font-semibold text-white active:scale-95"
              >

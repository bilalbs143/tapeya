...
import ContentDetail from '@/dynamic-components/template9/components/ContentDetail/ContentDetail';
      ...
      {showInquiryDetails ? (
        ...
        <div className="space-y-6">
          <div className="rounded-[5px] border border-[#DBB42C4D] bg-[#12001F] p-3 md:p-4 lg:p-6">
            ...
            >
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input
                      ...
                      type="text"
                      placeholder={t('title')}
                      className="relative block h-[46px] w-full appearance-none rounded-[3px] border border-[#DBB42C4D] bg-transparent px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFF66] focus:border-[#DBB42C4D] focus:bg-[#1D0032] focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:h-[55px]"
                      error={
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <textarea
                      ...
                      rows="4"
                      className="relative block min-h-[46px] w-full resize-none appearance-none rounded-[3px] border border-[#DBB42C4D] bg-transparent px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFF66] focus:border-[#DBB42C4D] focus:bg-[#1D0032] focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:min-h-[55px]"
                    />
                  )}
                />
              ...
              <div className="mt-6 hidden justify-end md:flex">
                <button
                  type="submit"
                  className="template9-filled-button-hover flex cursor-pointer items-center justify-center rounded-[4px] bg-[#9D4EDD] px-9 pt-3.5 pb-3.5 text-[16px] font-semibold text-white transition-all duration-200 active:scale-95"
                  data-hover={t('submit')}
                >
              ...
              <div className="mt-6 flex justify-center md:hidden">
                <button
                  type="submit"
                  className="template9-filled-button-hover flex w-full cursor-pointer items-center justify-center rounded-[3px] bg-[#9D4EDD] px-8 py-2 text-[16px] font-semibold text-white transition-all duration-200 active:scale-95 md:w-auto"
                  data-hover={t('submit')}
                >
                  <span className="text-container">
                    <span className="text">{t('submit')}</span>
          ...
          <div className="space-y-4">
            ...
            <div className="overflow-hidden rounded-[5px] border border-[#DBB42C4D]">

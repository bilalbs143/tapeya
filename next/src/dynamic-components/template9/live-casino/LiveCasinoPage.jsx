  ...
  const liveCasinoProviders = [
    {
      ...
      name: 'Evolution',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/evolution-9.webp',
      isLive: true,
    },
    {
      ...
      name: 'Pragmatic',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/pragmatic-9.webp',
      isLive: true,
    },
    {
      key: 'AGIN',
      ...
      name: 'Asia Gaming',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/asia-gaming-9.webp',
      isLive: true,
    },
    {
      key: 'cq9_casino',
      ...
      name: 'CQ9',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/cq9-9.webp',
      isLive: true,
    },
    {
      key: 'MICRO_Casino',
      ...
      name: 'Microgaming',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/micro-gaming-9.webp',
      isLive: false,
    },
    {
      key: 'VOTA',
      ...
      name: 'VOTA',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/vota-9.webp',
      isLive: true,
    },
    {
      key: 'TOMHORN_7Mojos',
      ...
      name: '7 Mojos',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/seven-mojos-9.webp',
      isLive: true,
    },
    {
      ...
      name: 'Absolute Live',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/absolute-live-9.webp',
      isLive: true,
    },
    {
      key: 'TOMHORN_VIVO',
      ...
      name: 'Vivo',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/vivo-9.webp',
      isLive: true,
    },
    {
      key: 'crypto_poker',
      ...
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/crypto-in-poker-9.webp',
      isLive: false,
    },
    {
      key: 'allbet',
      ...
      name: 'Allbet',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/all-bet-9.webp',
      isLive: false,
    },
    {
      key: 'cream_gaming',
      ...
      name: 'Cream Gaming',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/dream-gaming-9.webp',
      isLive: false,
    },
    {
      key: 'mt',
      ...
      name: 'Mt',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/mt-game-9.webp',
      isLive: false,
    },
    {
      key: 'oriental_game',
      ...
      name: 'Oriental Game',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/oriental-gaming-9.webp',
      isLive: false,
    },
    {
      key: 'sa_game',
      ...
      name: 'Sa Game',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/sa-game-9.webp',
      isLive: false,
    },
    {
      key: 'sexy',
      ...
      name: 'Sexy',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/sexy-gaming-9.webp',
      isLive: false,
    },
    {
      key: 'bet_game',
      ...
      name: 'Bet Game',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/bet-games-9.webp',
      isLive: false,
    },
    {
      ...
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/gameplay-interactive-9.webp',
      isLive: false,
    },
    {
      key: 'playtech',
      ...
      name: 'Playtech',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/playtech-9.webp',
      isLive: false,
    },
    {
      key: 'skywind',
      ...
      name: 'Skywind',
      background:
        'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/skywind-group-9.webp',
      isLive: false,
    },
  ];
      ...
      >
        <div className="relative min-h-[200px] w-full overflow-hidden">
          ...
          <div className="relative hidden w-full md:block">
            <Image
              src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/casino-top-banner-up-9.webp"
          ...
          <div className="relative block w-full md:hidden">
            <Image
              src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/casino-top-banner-mob-9.webp"
          ...
          <div className="absolute inset-0 z-10 mt-0 flex items-start justify-center pt-8 sm:pt-6 md:mt-6 md:items-center md:justify-start md:pt-0 md:pl-16">
            <div className="w-auto max-w-[calc(100%-2rem)] sm:max-w-[calc(100%-3rem)] md:max-w-none">
              <div className="flex flex-col items-start">
                ...
                {/* SPIN THE MYTH. */}
                <h2 className="font-cravend text-left text-[20px] leading-tight tracking-[1px] break-words text-white sm:text-[18px] md:text-lg lg:text-[25px] xl:text-[30px] 2xl:text-[40px]">
                  {t('spin_the_myth')}
                </h2>
            ...
            >
              ...
              >
                  ...
                  <div className="relative flex items-center justify-center overflow-hidden rounded-[5px]">
                    ...
                    <div className="absolute inset-0 z-30 flex items-center justify-center opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                      <div className="z-40 flex flex-col items-center gap-2 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                        <button
                          type="button"
                          className="flex h-12 w-12 cursor-pointer items-center justify-center rounded-full border-2 border-[#DBB42C] bg-black transition-colors disabled:opacity-50 sm:h-16 sm:w-16"
                ...
                <div className="relative z-10 mt-2 text-center">
                  <span className="font-cravend text-sm text-white uppercase sm:text-base">
                    {provider.name}
                  </span>
                </div>
              </div>
        ...
        <div className="mt-0">
          <div className="px-0 pt-8 sm:px-0">
            <div className="relative overflow-hidden">
              {/* Desktop Banner - Hidden on mobile (<=768px) */}
              <img
                src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/casino-bottom-banner-up-9.webp"
              ...
              {/* Mobile Banner - Only visible on mobile (<=768px) */}
              <img
                src="https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/casino-bottom-banner-mob-up-9.webp"
                alt={t('home_page_banner')}
              ...
              <div className="absolute inset-0 z-10 mt-0 flex items-start justify-center pt-8 sm:pt-6 md:mt-6 md:items-center md:justify-start md:pt-0 md:pl-16">
                <div className="w-auto max-w-[calc(100%-2rem)] text-left sm:max-w-[calc(100%-3rem)] md:max-w-none">
                  <div className="flex flex-col items-start gap-2 md:gap-3">
                    ...
                    {/* LUCK IS A GLITCH IN THE MATRIX. */}

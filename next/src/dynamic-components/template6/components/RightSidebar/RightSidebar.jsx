...
const RightSidebar = memo(function RightSidebar() {
  ...
  const { user, userLoader, isAuth } = useSelector((state) => state.auth);
  ...
  return (
    <aside
      className="template6-right-sidebar hidden w-64 flex-shrink-0 border-l bg-[#101010] lg:block lg:w-64 xl:w-64"

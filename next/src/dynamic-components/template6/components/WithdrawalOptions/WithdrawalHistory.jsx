...
import TransactionDetail from '@/dynamic-components/template6/components/TransactionDetail/TransactionDetail.jsx';
    ...
    <div className="space-y-6">
      {showDetails ? (
        ...
        <>
          ...
          <div className="overflow-hidden rounded-[9px] border border-[#FB63214D]">
                ...
                <tbody>
                  {requestInfoLoader ? (
                    ...
                    requestInfoData.data.map((item, index) => (
                      <tr
                        key={item.id || index}
                        className="cursor-pointer border border-[#FB63214D] transition-all duration-300 hover:shadow-[inset_0_4.402px_26.412px_0_#E70011] focus:border-[#D61324]"
                        onClick={() => {
                      ...
                      >
                        ...
                        <td className="px-1 py-2 md:px-2 md:py-3">
                          <span className="text-[#F45E2A] transition-all duration-200">

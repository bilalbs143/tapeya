  ...
  return (
    <div className="space-y-4">
      <div className="mt-3 flex items-center space-x-3">
        <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#20C5FE]">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
      ...
      <div className="rounded-lg bg-[#18202D] p-4">
      ...
      <button
        ...
        className="w-full cursor-pointer rounded-[10px] bg-[#20C5FE] px-4 py-3 text-sm font-semibold text-black transition-all duration-150 active:scale-95"

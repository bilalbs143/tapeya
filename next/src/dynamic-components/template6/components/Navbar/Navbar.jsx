...
import { LanguageSwitcher } from '@/dynamic-components/template6/components/LanguageSwitcher/LanguageSwitcher';
import LazyImage from '@/dynamic-components/template6/components/LazyImage/LazyImage';
import WalletDropdown from '@/dynamic-components/template6/components/WalletDropdown/WalletDropdown';
...
function Navbar() {
  ...
  const sidebarApkSrc = useMemo(() => {
    if (currentLocale === 'id') {
      return 'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/apk-new-banner-mob-6.webp';
    }
    if (currentLocale === 'ko') {
      return 'https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/apk-new-banner-mob-6.webp';
    }
  ...
  return (
    <>
      {/* Main Navbar */}
      <nav
        className={`relative z-[100] border-b bg-[#101010] ${
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex w-full items-center justify-between lg:hidden">
              ...
              <button
                ...
                className="relative flex h-[40px] w-[45px] cursor-pointer items-center justify-center rounded-[5px] border text-[#D61324] transition-colors duration-200 hover:text-[#D61324]"
              ...
              <div className="flex items-center gap-2">
                {/* Language Switcher */}
                <div
                  className="flex h-[50px] items-center rounded-[5px] border bg-black px-0 transition-all duration-300 hover:bg-[#F45E2A]"
                  style={{ borderColor: 'rgba(251, 99, 33, 0.30)' }}
                >
            ...
            <div className="hidden items-center gap-4 lg:flex">
              {/* Language Switcher */}
              <div
                className="flex h-[50px] items-center rounded-[5px] border bg-black transition-all duration-300 hover:bg-[#F45E2A]"
                style={{ borderColor: 'rgba(251, 99, 33, 0.30)' }}
              >
                <LanguageSwitcher variant="dropdown" appearance="filled" />
              </div>
              ...
              {!isAuth ? (
                <>
                  <button
                    ...
                    className="fancy-hover-effect-red group flex h-[50px] w-[130px] cursor-pointer items-center justify-center gap-3 rounded-[5px] border-2 border-[#F45E2A] bg-[#F45E2A] px-3 text-base font-semibold text-white transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="fancy-hover-effect-orange group flex h-[50px] w-[130px] cursor-pointer items-center justify-center gap-3 rounded-[5px] border-2 border-[#D61324] bg-[#D61324] px-3 text-base font-semibold text-white transition-colors"
                    data-hover="Register"
                  >
                    <span className="text-container">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="relative" ref={userMenuRef}>
                    <div
                      className="inline-flex items-stretch rounded-[5px] border"
                      style={{ borderColor: 'rgba(251, 99, 33, 0.30)' }}
                    >
                      <button
                        onClick={toggleUserMenu}
                        ref={userButtonRef}
                        className="group flex h-[50px] cursor-pointer items-center gap-2 rounded-[5px] bg-black px-1 pr-2 pl-1 text-base font-medium text-white transition-all hover:bg-[rgb(214,19,36)]"
                      >
                        <span className="inline-flex h-[41px] w-[41px] items-center justify-center rounded-[3px] bg-[#F45E2A] text-[12px] text-white">
                          {userInitial}
                        </span>
                        ...
                        <Image
                          src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/drop-6-orange.svg"
                    ...
                    {isUserMenuOpen && (
                      <div
                        ...
                        style={{ width: userButtonWidth }}
                      >
                        <div className="rounded-[10px] bg-black shadow-xl">
                          <div className="overflow-hidden rounded-[5px] p-3">
                            ...
                            >
                              <span className="flex items-center gap-3">
                                <svg
                                  ...
                                  viewBox="0 0 16 16"
                                  fill="currentColor"
                                  className="h-4 w-4 text-white/50 transition-colors group-hover:!text-[#D61324]"
                                >
                                ...
                                <span className="text-[12px] text-[#7D7D7D] transition-colors group-hover:text-white">
                                  {t('profile')}
                                </span>
                              </span>
                              <svg
                                ...
                                viewBox="0 0 6 13"
                                fill="none"
                                className="text-white/50 transition-colors group-hover:!text-[#D61324]"
                              >
                                <path
                            ...
                            >
                              <span className="flex items-center gap-3">
                                ...
                                <span className="text-[12px] text-[#7D7D7D] capitalize transition-colors group-hover:text-white">
      ...
      >
        {/* Drawer Content */}
        <div
          className={`absolute top-0 left-0 h-full w-80 bg-[#101010] shadow-xl ${
            isMobilePlatform ? 'pt-safe-top' : ''
          }`}
        >
          <div
          ...
          >
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={toggleMobileMenu}
                  className="group flex h-8 w-8 cursor-pointer items-center justify-center rounded-sm bg-[#D61324] text-black transition-colors"
                >
                  <svg
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="flex w-full items-center gap-3 rounded-[0px] px-3 py-3">
                    <button
                      onClick={handleOpenLoginModal}
                      className="fancy-hover-effect-red group flex flex-1 cursor-pointer items-center justify-center gap-3 rounded-[5px] border-2 border-[#F45E2A] bg-[#F45E2A] px-3 py-3 text-base font-semibold text-white transition-colors"
                    >
                      <span className="text-container">
                        <span className="text">Login</span>
                      </span>
                    ...
                    <button
                      onClick={handleOpenRegisterModal}
                      className="fancy-hover-effect-orange group flex flex-1 cursor-pointer items-center justify-center gap-3 rounded-[5px] border-2 border-[#D61324] bg-[#D61324] px-3 py-3 text-base font-semibold text-white transition-colors"
                      data-hover="Register"
                    >
                      <span className="text-container">
                        <span className="text">Register</span>
            ...
            <div className="grid grid-cols-2 gap-3 p-4">
              <Link
                ...
                className={`group flex min-w-0 items-center justify-center gap-2 rounded-[5px] border bg-transparent px-4 py-4 transition-all duration-300 hover:bg-white/5 ${pathname === '/' ? 'text-white' : 'text-[#7D7D7D]'}`}
                style={{
                  borderColor: 'rgba(251, 99, 33, 0.30)',
                }}
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="none"
                  className={`h-5 w-5 transition-colors duration-300 ${pathname === '/' ? 'text-[#D61324]' : 'text-white/50 group-hover:text-[#D61324]'}`}
                >
                  <path
                ...
                <span
                  className={`min-w-0 flex-1 truncate text-[12px] transition-colors duration-300 ${pathname === '/' ? 'text-white' : 'text-[#7D7D7D] group-hover:text-white'}`}
                >
                  {t('home') || 'Home'}
                </span>
              </Link>
              ...
              <Link
                ...
                className={`group flex min-w-0 items-center justify-center gap-2 rounded-[5px] border bg-transparent px-4 py-4 transition-all duration-300 hover:bg-white/5 ${pathname === '/dashboard/withdrawal' ? 'text-white' : 'text-[#7D7D7D]'}`}
                style={{
                  borderColor: 'rgba(251, 99, 33, 0.30)',
                }}
              >
                <svg
                  ...
                  viewBox="0 0 22 21"
                  fill="none"
                  className={`h-5 w-5 transition-colors duration-300 ${pathname === '/dashboard/withdrawal' ? 'text-[#D61324]' : 'text-white/50 group-hover:text-[#D61324]'}`}
                >
                  <path
                ...
                <span
                  className={`min-w-0 flex-1 truncate text-[12px] transition-colors duration-300 ${pathname === '/dashboard/withdrawal' ? 'text-white' : 'text-[#7D7D7D] group-hover:text-white'}`}
                >
                  {t('withdrawal')}
                </span>
              </Link>
              ...
              <Link
                ...
                className={`group flex min-w-0 items-center justify-center gap-2 rounded-[5px] border bg-transparent px-4 py-4 transition-all duration-300 hover:bg-white/5 ${pathname === '/dashboard/deposit' ? 'text-white' : 'text-[#7D7D7D]'}`}
                style={{
                  borderColor: 'rgba(251, 99, 33, 0.30)',
                }}
              >
                <svg
                  ...
                  viewBox="0 0 22 21"
                  fill="none"
                  className={`h-5 w-5 transition-colors duration-300 ${pathname === '/dashboard/deposit' ? 'text-[#D61324]' : 'text-white/50 group-hover:text-[#D61324]'}`}
                >
                  <path
                ...
                <span
                  className={`min-w-0 flex-1 truncate text-[12px] transition-colors duration-300 ${pathname === '/dashboard/deposit' ? 'text-white' : 'text-[#7D7D7D] group-hover:text-white'}`}
                >
                  {t('deposit') || 'Deposit'}
                </span>
              </Link>
              ...
              <Link
                ...
                className={`group flex min-w-0 items-center justify-center gap-2 rounded-[5px] border bg-transparent px-4 py-4 transition-all duration-300 hover:bg-white/5 ${pathname === '/dashboard/coupons' ? 'text-white' : 'text-[#7D7D7D]'}`}
                style={{
                  borderColor: 'rgba(251, 99, 33, 0.30)',
                }}
              >
                <svg
                  ...
                  viewBox="0 0 23 21"
                  fill="none"
                  className={`h-5 w-5 transition-colors duration-300 ${pathname === '/dashboard/coupons' ? 'text-[#D61324]' : 'text-white/50 group-hover:text-[#D61324]'}`}
                >
                  <path
                    ...
                    fill="currentColor"
                    className="transition-all duration-300 group-hover:fill-[#D61324]"
                  />
                </svg>
                <span
                  className={`min-w-0 flex-1 truncate text-[12px] transition-colors duration-300 ${pathname === '/dashboard/coupons' ? 'text-white' : 'text-[#7D7D7D] group-hover:text-white'}`}
                >
                  {t('coupons') || 'Coupons'}
                </span>
              </Link>
              ...
              <Link
                ...
                className={`group flex min-w-0 items-center justify-center gap-2 rounded-[5px] border bg-transparent px-4 py-4 transition-all duration-300 hover:bg-white/5 ${pathname === '/dashboard/customer-inquiry' ? 'text-white' : 'text-[#7D7D7D]'}`}
                style={{
                  borderColor: 'rgba(251, 99, 33, 0.30)',
                }}
              >
                <svg
                  ...
                  viewBox="0 0 22 22"
                  fill="none"
                  className={`h-5 w-5 transition-colors duration-300 ${pathname === '/dashboard/customer-inquiry' ? 'text-[#D61324]' : 'text-white/50 group-hover:text-[#D61324]'}`}
                >
                  <path
                ...
                <span
                  className={`min-w-0 flex-1 truncate text-[12px] transition-colors duration-300 ${pathname === '/dashboard/customer-inquiry' ? 'text-white' : 'text-[#7D7D7D] group-hover:text-white'}`}
                >
              ...
              <Link
                ...
                className={`group flex min-w-0 items-center justify-center gap-2 rounded-[5px] border bg-transparent px-4 py-4 transition-all duration-300 hover:bg-white/5 ${pathname === '/dashboard/note' ? 'text-white' : 'text-[#7D7D7D]'}`}
                style={{
                  borderColor: 'rgba(251, 99, 33, 0.30)',
                }}
              >
                <svg
                  ...
                  viewBox="0 0 20 20"
                  fill="none"
                  className={`h-5 w-5 transition-colors duration-300 ${pathname === '/dashboard/note' ? 'text-[#D61324]' : 'text-white/50 group-hover:text-[#D61324]'}`}
                >
                  <path
                ...
                <span
                  className={`min-w-0 flex-1 truncate text-[12px] transition-colors duration-300 ${pathname === '/dashboard/note' ? 'text-white' : 'text-[#7D7D7D] group-hover:text-white'}`}
                >
                  {t('notes') || 'Notes'}
                </span>
              </Link>
              ...
              <Link
                ...
                className={`group flex min-w-0 items-center justify-center gap-2 rounded-[5px] border bg-transparent px-4 py-4 transition-all duration-300 hover:bg-white/5 ${pathname === '/announcements' ? 'text-white' : 'text-[#7D7D7D]'}`}
                style={{
                  borderColor: 'rgba(251, 99, 33, 0.30)',
                }}
              >
                <svg
                  ...
                  viewBox="0 0 18 23"
                  fill="none"
                  className={`h-5 w-5 transition-colors duration-300 ${pathname === '/announcements' ? 'text-[#D61324]' : 'text-white/50 group-hover:text-[#D61324]'}`}
                >
                  <path
                ...
                <span
                  className={`min-w-0 flex-1 truncate text-[12px] transition-colors duration-300 ${pathname === '/announcements' ? 'text-white' : 'text-[#7D7D7D] group-hover:text-white'}`}
                >
              ...
              <Link
                ...
                className={`group flex min-w-0 items-center justify-center gap-2 rounded-[5px] border bg-transparent px-4 py-4 transition-all duration-300 hover:bg-white/5 ${pathname === '/faq' ? 'text-white' : 'text-[#7D7D7D]'}`}
                style={{
                  borderColor: 'rgba(251, 99, 33, 0.30)',
                }}
              >
                <svg
                  ...
                  viewBox="0 0 20 20"
                  fill="none"
                  className={`h-5 w-5 transition-colors duration-300 ${pathname === '/faq' ? 'text-[#D61324]' : 'text-white/50 group-hover:text-[#D61324]'}`}
                >
                  <path
                ...
                <span
                  className={`min-w-0 flex-1 truncate text-[12px] transition-colors duration-300 ${pathname === '/faq' ? 'text-white' : 'text-[#7D7D7D] group-hover:text-white'}`}
                >
                  {t('faq') || "FAQ's"}
                </span>
              </Link>
              ...
              <div className="px-4">
                <div className="relative" ref={userMenuRef}>
                  ...
                  >
                    <button
                      onClick={toggleUserMenu}
                      className="group flex h-[50px] w-full cursor-pointer items-center gap-2 rounded-[5px] bg-black py-2 pr-4 pl-1 text-base font-medium text-white transition-all hover:bg-[rgb(214,19,36)] hover:shadow-[inset_0_0_6px_1px_#D61324]"
                    >
                      <span className="inline-flex h-[40px] w-[40px] items-center justify-center rounded-[3px] bg-[#D61324] text-[12px] text-white">
                        {userInitial}
                      </span>
                      ...
                      <div className="rounded-[10px] bg-black shadow-xl">
                        <div className="overflow-hidden rounded-[5px] p-3">
                          ...
                          <button
                            ...
                            className="group flex w-full items-center justify-between rounded-[3px] border bg-black px-3 py-3 transition-all duration-200"
                            style={{
                              borderColor: 'rgba(251, 99, 33, 0.30)',
                            }}
                          >
            ...
            <div className="mt-auto space-y-3 p-4">
              ...
              <div className="relative mb-8">
                ...
                <div className="absolute top-[15%] left-[5%] z-10">
                  ...
                  {/* Download APK Button */}
                  <a
                    href="https://thestaticfile.com/uploads/user06.apk"
                    download
                    className="inline-block rounded-[50px] bg-[#F45E2A] px-3 py-2 text-[11px] font-semibold text-white transition-all hover:bg-[#1BB0E8]"
                  >
                    {t('download_apk')}
                  </a>
                </div>
              ...
              {isAuth && (
                <div className="border-t border-[#00374A] pt-4">
                  <button
                    ...
                    className="group flex w-full cursor-pointer items-center justify-between rounded-[3px] border bg-black px-4 py-3 text-base font-semibold text-white transition-colors duration-200"
                    style={{
                      borderColor: 'rgba(251, 99, 33, 0.30)',
                    }}
                  >

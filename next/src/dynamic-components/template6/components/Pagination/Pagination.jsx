...
const Pagination = ({
  ...
  return (
    <div
      className={`flex items-center justify-center gap-2 md:justify-end md:gap-4 ${className}`}
    >
      {/* Rows per page selector */}
      <div className="text-xs text-white/60 md:text-sm">
        {t('rows_per_page')}:
        <select
          className="text-grey-400 ml-2 rounded border border-[#FB63214D] bg-[#101010] px-2 py-1 text-xs md:text-sm"
          value={rowsPerPage}
      ...
      {/* Page information */}
      <div className="flex items-center text-xs text-white/60 md:gap-2 md:text-sm">
        <span>

  ...
  return (
    <div className="rounded-[16px] border border-[#FFFFFF66] bg-transparent p-5">
      ...
      <div className="mb-8">
        ...
        <div className="rounded-[12px] border border-[#FB63214D] bg-transparent px-6 py-8 text-white">
          <div className="flex flex-col gap-3 md:flex-row md:items-center">
            <div className="flex-1">
              <div className="rounded-[10px] border border-[#FB63214D] bg-[#101010] px-4 py-4">
                <div className="text-center text-base font-bold md:text-lg">
                  <span className="text-[#D61324]">
            ...
            <div className="hidden px-2 text-center text-2xl font-bold text-[#D61324] select-none md:block">
              =
            </div>
            <div className="flex-1">
              <div className="rounded-[10px] border border-[#FB63214D] bg-[#D61324] px-4 py-4">
                <div className="text-center text-base font-bold md:text-lg">
                  <span className="text-[#D61324]">
      ...
      <div className="">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-stretch">
          <div className="flex-1 rounded-[12px] border border-[#FB63214D] bg-black px-3 py-3 text-white">
          ...
          <button
            className="fancy-hover-effect-orange w-full rounded-[10px] bg-[#D61324] px-5 py-3 text-sm font-bold text-white transition-all duration-200 active:scale-95 disabled:opacity-50 sm:w-[270px]"
            onClick={() =>
              copyToClipboard(withdrawalData?.withdraw_address || '')
            }
            disabled={!withdrawalData?.withdraw_address}

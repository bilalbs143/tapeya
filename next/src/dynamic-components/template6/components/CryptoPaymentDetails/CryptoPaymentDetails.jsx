...
const CryptoPaymentDetails = ({ paymentData, onClose }) => {
  ...
  const renderAmountDisplay = () => (
    <div className="rounded-[3px] border border-[#272727] bg-[#101010] px-4 py-4">
      <div className="text-center text-base font-bold md:text-lg">
        <span className="text-[#D61324]">{displayAmount.amount}</span>{' '}
        <span className="text-[#D61324]">{displayAmount.currency}</span>
      </div>
    </div>
  );
  ...
  const renderCryptoAmountDisplay = () => (
    <div className="rounded-[3px] border border-[#272727] bg-[#101010] px-4 py-4">
      <div className="text-center text-base font-bold md:text-lg">
        <span className="text-[#D61324]">{cryptoAmount.amount}</span>{' '}
        <span className="text-[#D61324]">{cryptoAmount.currency}</span>
      </div>
    </div>
  );
  ...
  const renderQRCode = () => {
    ...
    return (
      <div className="flex flex-col items-center">
        ...
        <div className="mt-3 text-xs tracking-wide text-[#D61324] uppercase">
          {t('scan_to_pay')}
        </div>
      </div>
    );
  ...
  const renderAddressSection = () => (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-stretch">
      <div className="flex h-[46px] w-full items-center rounded-[6px] border border-[#FB63214D] bg-transparent px-3 text-[12px] text-white md:text-[14px]">
      ...
      <button
        className="fancy-hover-effect-orange w-full rounded-[10px] bg-[#D61324] px-5 py-3 text-sm font-bold text-white transition-all duration-200 active:scale-95 sm:w-[270px]"
        onClick={() => copyToClipboard(paymentData.pay_address)}
      >
  ...
  return (
    <div className="rounded-[5px] border border-[#FB63214D] bg-transparent p-5">
      {/* Header */}
      <div className="mb-6 flex items-center justify-start gap-4">
        <button
          onClick={onClose}
          aria-label={t('back')}
          className="fancy-hover-effect-orange flex items-center justify-center rounded-[4px] bg-[#D61324] px-8 py-2 font-extrabold text-white transition-all duration-300"
        >
          <span className="text-container">
      ...
      <div className="grid grid-cols-1 items-start gap-4 md:grid-cols-3">
        <div className="md:col-span-2">
          ...
          <div className="rounded-[8px] border border-[#FB63214D] bg-transparent px-6 py-8 text-white">
      ...
      <div className="mt-6">
        ...
        <div className="rounded-[8px] border border-[#272727] bg-[#101010] px-5 py-4 text-[#ffffffcc]">
          {renderInstructions()}
        </div>
      </div>
    </div>

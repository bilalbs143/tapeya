        ...
        <div className="mt-6 flex flex-col items-center justify-center gap-4">
          {hasMore && (
            <button
              ...
              className="inline-flex transform cursor-pointer items-center justify-center rounded-[5px] bg-[#D61324] px-8 py-3 font-semibold text-white transition-all hover:scale-105 hover:bg-[#D61324]/90 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
            >
          ...
          {accumulatedGames.length > 60 && (
            <button
              onClick={scrollToTop}
              className="inline-flex transform cursor-pointer items-center justify-center rounded-[5px] bg-[#D61324] px-6 py-3 font-semibold text-white transition-all hover:scale-105 hover:bg-[#D61324]/90 active:scale-95"
            >
              <svg
        ...
        {currentPage === 1 &&
          ...
          <div className="py-16">
            <div className="flex flex-col items-center space-y-4">
              <CommonLoader size="xl" border="border-[#F45E2A]" />

...
export default function CryptoSelect({
  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      {showCategories && (
        <div className="mt-10 mb-[10px] rounded-[5px] border border-[#FB63214D] p-[1px] md:mt-5">
      ...
      <div className="rounded-[5px] border border-[#FB63214D] bg-transparent p-4 md:p-5">
            ...
            {loadingCurrencies ? (
              ...
              visibleCoins.map((c) => (
                <button
                  ...
                  className={`group flex min-h-[80px] w-full items-center justify-between gap-3 rounded-[5px] border border-[#FB63214D] bg-transparent px-4 py-4 text-[#cfd8df] transition-all duration-300 hover:shadow-[inset_0_4.402px_26.412px_0_#E70011] focus:border-[#D61324] sm:px-4 ${
                    selectedCurrency === c.code
                      ? 'border-[#D61324] shadow-[inset_0_4.402px_26.412px_0_#E70011]'
                      : ''
                  }`}
                >

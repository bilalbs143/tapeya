...
export default function DepositBankTab() {
  ...
  const PaymentMethodCard = ({ method, methodType }) => (
    <button
      ...
      className="flex h-[64px] w-full cursor-pointer items-center justify-center rounded-[5px] bg-[#1C1C1C] transition-all duration-300 hover:border hover:border-[#D61324] hover:bg-[#000000] hover:shadow-[inset_0_4.402px_26.412px_0_#E70011]"
    >
    ...
    return (
      <div className="mb-3 space-y-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-[#D61324] md:text-sm">
            ({approvalType})
          </span>
        </div>

...
const DropdownOption = memo(({ option, onSelect, field }) => (
  <div
    key={option}
    className="cursor-pointer px-3 py-2 text-xs text-white transition-colors duration-150 hover:bg-[#D61324] md:text-sm"
    onClick={() => {
  ...
  return (
    <div className="space-y-6 text-white">
      ...
      <div className="mb-4 flex flex-wrap items-center gap-2 sm:gap-4">
        <button
          onClick={handleBack}
          className="fancy-hover-effect-orange flex items-center justify-center rounded-[4px] bg-[#D61324] px-6 py-1.5 font-extrabold text-white transition-all duration-300"
        >
      ...
      <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                render={({ field }) => (
                  <div className="flex w-full flex-col gap-1">
                    <div className="relative w-full" ref={sendingDropdownRef}>
                      <div
                        className={`relative flex h-[46px] w-full cursor-pointer appearance-none items-center justify-between rounded-[5px] border px-3 py-3 text-white shadow-none focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm lg:h-[55px] ${
                          errors.sendingOption
                            ...
                            : 'border-[#FB63214D] bg-transparent focus:border-[#D61324]'
                        }`}
                      ...
                      {isSendingOpen && (
                        <div className="absolute z-20 mt-1 max-h-56 w-full overflow-auto rounded-[5px] border border-[#FB63214D] bg-[#D61324] shadow-xl">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Input
                    ...
                    className="relative block h-[46px] w-full appearance-none rounded-[5px] border border-[#FB63214D] bg-transparent px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFF66] placeholder:capitalize focus:border-[#D61324] focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:h-[55px]"
              ...
              <Controller
                ...
                render={({ field: { onChange } }) => (
                  <div className="flex w-full flex-col gap-1">
                    <div
                      className={`flex w-full flex-wrap items-center gap-3 rounded-[5px] border px-3 py-2 shadow-none transition-colors focus-within:ring-0 focus-within:ring-transparent focus-within:outline-none ${
                        errors.receiptFile
                          ...
                          : 'border-[#FB63214D] bg-transparent focus-within:border-[#D61324] hover:border-[#D61324]'
                      }`}
                      onDragOver={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                    ...
                    >
                      <div
                        className={`fancy-hover-effect-orange rounded-md bg-[#D61324] px-4 py-2 text-xs font-semibold text-white transition-opacity focus-within:ring-2 focus-within:ring-[#D61324] focus-within:outline-none active:scale-95 ${
                          isFileDialogOpening
            ...
            <div className="mt-6 space-y-3">
                    ...
                    >
                      ...
                      <span
                        ...
                        className={`grid h-5 w-5 flex-shrink-0 place-items-center rounded-[3px] border-2 transition-all duration-200 ${
                          field.value
                            ? 'border-[#FB63214D] bg-[#D61324]'
                            : 'border-[#FB63214D] bg-transparent hover:border-[#D61324]'
                        }`}
                      >
                        <svg
                          viewBox="0 0 24 24"
              ...
              <div className="mt-8 flex w-full flex-row justify-center">
                <button
                  ...
                  className="fancy-hover-effect-orange flex h-[52px] w-[554px] items-center justify-center rounded-[6px] bg-[#D61324] text-[16px] font-semibold text-white transition-all duration-200 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  <span className="text-container">
                    <span className="text">
        ...
        <div className="order-1 h-max rounded-[5px] bg-[#101010] p-5 md:sticky md:top-4 md:order-2">
          <div className="mb-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <span className="text-xs md:text-sm">
                {t('status')}:{' '}
                <span className="text-[#D61324]">{t('status_online')}</span>
              </span>
              <Image
                src="https://d3emlo5tm9es2f.cloudfront.net/next/icons/green-check.svg"
                alt="online"
          ...
          <div className="mt-4 text-[12px]">
            <span className="font-semibold text-[#D61324]">{t('note')}:</span>

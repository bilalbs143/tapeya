...
function Statistics() {
  ...
  return (
    <div className="pt-6 md:pt-10">
      <section className="relative rounded-[10px] bg-[url('https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/statistics-bg-mob-6.webp')] bg-cover bg-bottom bg-no-repeat py-12 pb-20 sm:py-16 sm:pb-44 md:bg-[url('https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/statistics-bg-6.webp')] md:bg-center lg:py-20">
        {/* Background should be full width */}
        <div className="absolute inset-0 w-full" />

        <div className="relative z-10 container mx-auto max-w-full px-3 pt-0 sm:px-4 md:max-w-full md:pt-8 lg:px-8 xl:px-12">
          <div className="grid grid-cols-1 gap-4 sm:gap-6 lg:grid-cols-12 lg:gap-8">
            {/* Left Column - Tabs and Table */}
            <div className="w-full md:w-auto lg:col-span-9 xl:col-span-10">
              ...
              >
                {tabs.map((tab) => (
                  <button
                    ...
                    style={{
                      backgroundColor:
                        activeTab === tab.id ? '#D61324' : 'transparent',
              ...
              {/* Table Container */}
              <div
                className="relative flex h-[250px] w-full flex-col overflow-hidden rounded-[5px] border sm:h-[300px]"
                style={{
                  backgroundColor: '#0F131CB2',
              ...
              >
                <div className="stats-table-scroll max-h-[250px] overflow-x-auto overflow-y-auto sm:max-h-[300px]">
                  <table className="w-full min-w-[500px] rounded-[5px]">
                    <thead>
                      <tr
                        style={{

...
import PendingExchangeAlert from '@/dynamic-components/template6/components/AlertSections/PendingExchangeAlert';
import UnreadNotesAlert from '@/dynamic-components/template6/components/AlertSections/UnreadNotesAlert';
...
export default function Alert() {
  ...
  if (isLoading) {
    return (
      <div className="mx-auto w-full max-w-[400px] transform rounded-[24px] bg-[#D61324] p-4 text-white shadow-xl">
  ...
  return (
    <div
      className={`mx-auto w-full max-w-[400px] transform rounded-[5px] border-[#FB63214D] bg-[#000000] text-white shadow-xl transition-all duration-300 ease-out sm:max-w-[500px] lg:max-w-[590px] ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'}`}
    >
        ...
        <div className="space-y-4 sm:space-y-6">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={handleCloseModal}
              aria-label={t('close')}
              className="group flex h-[30px] w-[30px] flex-shrink-0 cursor-pointer items-center justify-center rounded-md bg-[#D61324] text-black transition-all duration-300 sm:h-[33px] sm:w-[33px]"
            >
              <svg
                width="16"
                height="16"
          ...
          <div className="space-y-6">
                ...
                <div className="text-center">
                  ...
                  {modalProps.data?.exchangeRequest && (
                    <div className="mt-4 space-y-3">
                      {/* Amount Details */}
                      <div className="border border-[#FB63214D] bg-transparent px-6 py-6">
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                          <div
                            className={`rounded-[5px] border border-[#272727] bg-[#101010] px-3 py-3 ${modalProps.type !== 'exchange_approved' || !modalProps.data.exchangeRequest.approved_money ? 'md:col-span-2' : ''}`}
                          >
                          ...
                          {modalProps.type === 'exchange_approved' &&
                            ...
                            <div className="rounded-[10px] border border-[#272727] bg-[#101010] px-3 py-3">
                              <div className="text-center text-base font-bold text-white md:text-lg">
                                {formatCurrency(
                                  modalProps.data.exchangeRequest
                                    .approved_money,
            ...
            {isCustomerInquiryReplyAlert && (
              <div className="space-y-4">
                <div className="border border-[#FB63214D] bg-transparent px-3 py-4">
                  <h3 className="border-b border-[#D61324] bg-transparent pb-1 text-sm font-medium text-[#D61324]">
                  ...
                  {modalProps?.data?.customerInquiry && (
                    <div className="mt-4 space-y-3">
                      <div className="border border-[#272727] bg-[#101010] px-6 py-4">
                        <div className="mb-2 text-[14px] font-bold text-white">
                          {t('inquiry_title')}
                        </div>
                        <div className="text-center text-base font-medium text-[#D61324]">
                  ...
                  <div className="mt-4">
                    <button
                      ...
                      className="flex w-full cursor-pointer items-center justify-center rounded-[10px] bg-[#D61324] px-4 pt-3 pb-3 text-sm font-semibold text-white active:scale-95"

...
export default function LaunchGame() {
  ...
  return (
    <div className="mx-auto w-full max-w-[400px] transform rounded-[5px] bg-[#000000] text-white shadow-xl transition-all duration-300 ease-out sm:max-w-[520px] lg:max-w-[600px]">
        ...
        <div className="space-y-5 sm:space-y-6">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={handleCloseModal}
              aria-label={t('close')}
              className="group flex h-[30px] w-[30px] flex-shrink-0 cursor-pointer items-center justify-center rounded-[7px] bg-[#D61324] text-black transition-all duration-300 focus:ring-0 focus:outline-none focus-visible:outline-none sm:h-[40px] sm:w-[40px]"
            >
              <svg
                width="16"
                height="16"
          ...
          <div className="space-y-4 rounded-[6px] border border-[#FB63214D] p-4 sm:p-6">
            {/* Game Image */}
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <button
                ...
                className="fancy-hover-effect-orange flex w-full cursor-pointer items-center justify-center rounded-[10px] bg-[#D61324] px-4 py-4 text-base font-extrabold tracking-wide text-white uppercase transition-all duration-200 active:scale-95 disabled:opacity-50"

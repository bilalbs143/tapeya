...
export default function Register(props) {
  ...
  return (
    <div
      className={`register-modal scrollbar-hide mx-auto w-full max-w-[400px] transform overflow-visible rounded-[5px] bg-[#000000] text-white shadow-xl transition-all duration-300 ease-out sm:max-w-[600px] lg:max-w-[800px] xl:max-w-[890px] ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'}`}
    >
        ...
        <div className="space-y-4 sm:space-y-6">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              aria-label={t('close')}
              className="group flex h-[30px] w-[30px] flex-shrink-0 cursor-pointer items-center justify-center rounded-md bg-[#D61324] text-black transition-all duration-300 sm:h-[40px] sm:w-[40px]"
            >
              <svg
                width="16"
                height="16"
          ...
          <form
            className="relative space-y-3 overflow-visible rounded-[6px] border border-[#FB63214D] p-4 sm:space-y-4 sm:p-6"
          ...
          >
            ...
            <hr className="border-0 border-t-[0.5px] border-[#272727]" />
              ...
              <div className="relative">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    ...
                    >
                      <SelectTrigger className="relative block h-[46px] w-full items-center justify-between rounded-[5px] border border-[#FB63214D] bg-transparent px-3 py-3 text-white shadow-none focus:border-[#D61324] focus:ring-0 focus:ring-transparent focus:outline-none lg:h-[55px]">
                        <SelectValue
                      ...
                      <SelectContent
                        className="z-[60] max-h-[105px] w-full border-[#FB63214D] bg-[#000000]"
                        side="bottom"
                        align="start"
                      >
                        {allBanksLoader ? (
                          ...
                          allBanksData.map((bank) => (
                            <SelectItem
                              ...
                              className="text-white hover:bg-[#D61324]"
                            >
                              {getBankName(bank)}
                            </SelectItem>
                          ))

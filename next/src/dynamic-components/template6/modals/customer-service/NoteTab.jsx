...
export default function NoteTab({ openMessageId }) {
  ...
  return (
    <div className="flex h-full flex-col">
      <h3 className="mb-4 text-[20px] font-bold text-white md:text-[30px]">
        {t('notes')}
      </h3>
                    ...
                    notesData.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-2 py-2 text-center text-white md:px-2 md:py-3">
                          <button className="btn-hover-outline rounded-[6px] border border-[#D61324] bg-transparent px-3 py-1 text-xs font-medium text-white transition-colors duration-200 hover:bg-[#D61324] hover:text-white">
                            {t('details')}
                          </button>
                        </td>
                      </tr>

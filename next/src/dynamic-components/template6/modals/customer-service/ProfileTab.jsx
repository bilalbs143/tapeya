...
export default function ProfileTab() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        <h4 className="text-[15px] font-normal text-white md:text-[19px]">
          {t('change_password')}
        </h4>
        <form onSubmit={handleSubmit(handlePasswordChange)}>
          ...
          <div className="mt-6 flex justify-end">
            <button
              ...
              className="filled-hover-effect hidden cursor-pointer items-center justify-center rounded-[4px] bg-[#D61324] px-8 pt-3 pb-3 text-[14px] font-extrabold text-white transition-all duration-200 hover:bg-[#D61324] active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 sm:flex"
              data-hover={
            ...
            <button
              type="submit"
              disabled={updatePasswordLoader}
              className="filled-hover-effect mx-auto flex w-[98%] cursor-pointer items-center justify-center rounded-[4px] bg-[#D61324] pt-3 pb-3 text-[14px] font-extrabold text-white transition-all duration-200 hover:bg-[#D61324] active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 sm:hidden"
              data-hover={
                updatePasswordLoader ? t('processing') : t('change_password')
              }
            >

...
import ContentDetail from '@/dynamic-components/template6/components/ContentDetail/ContentDetail';
import Pagination from '@/dynamic-components/template6/components/Pagination/Pagination';
    ...
    <>
      {showInquiryDetails ? (
        ...
        <div className="space-y-6">
          <div className="rounded-[5px] bg-[#101010] p-3 md:p-4 lg:p-6">
            <form
            ...
            >
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <textarea
                      ...
                      rows="4"
                      className="relative block min-h-[46px] w-full resize-none appearance-none rounded-[5px] border border-[#FB63214D] bg-transparent px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFF66] focus:border-[#D61324] focus:bg-black focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:min-h-[55px]"
                    />
                  )}
                />
              ...
              <div className="mt-6 hidden justify-end md:flex">
                <button
                  type="submit"
                  className="fancy-hover-effect-orange flex cursor-pointer items-center justify-center rounded-[10px] bg-[#D61324] px-8 pt-2 pb-2 text-[16px] font-semibold text-white transition-all duration-200 active:scale-95"
                  data-hover={t('submit')}
                >
              ...
              <div className="mt-6 flex justify-center md:hidden">
                <button
                  type="submit"
                  className="fancy-hover-effect-orange flex w-full cursor-pointer items-center justify-center rounded-[3px] bg-[#D61324] px-8 py-2 text-[16px] font-semibold text-white transition-all duration-200 active:scale-95 md:w-auto"
                  data-hover={t('submit')}
                >
                  <span className="text-container">
                    <span className="text">{t('submit')}</span>
          ...
          <div className="space-y-4">
            ...
            <div className="overflow-hidden rounded-[5px] border border-[#FB63214D]">
              <div className="show-scrollbar h-[400px] overflow-x-auto overflow-y-auto md:h-[500px]">
                <table className="w-full min-w-[720px] table-fixed text-[11px] md:text-sm">
                  <thead>
                    <tr className="border-b-0 border-[#FFFFFF66] bg-[#101010]">
                  ...
                  <tbody>
                    {allCustomerInquiriesLoader ? (
                      ...
                      inquiriesData.map((inquiry, index) => (
                        <tr
                          key={`row-${inquiry.id}`}
                          className="cursor-pointer border border-[#FB63214D] transition-all duration-300 hover:border-[#D61324] hover:shadow-[inset_0_4.402px_26.412px_0_#E70011]"
                        ...
                        >
                          ...
                          <td className="px-2 py-2 text-center text-white md:px-2 md:py-3">
                            <button className="btn-hover-outline rounded-[6px] border border-[#FB63214D] bg-transparent px-3 py-1 text-xs font-medium text-white transition-colors duration-200 hover:bg-[#D61324] hover:text-white">
                              {t('details')}
                            </button>
                          </td>
                          <td className="px-1 py-2 text-[#FFFFFF99] md:px-2 md:py-3">

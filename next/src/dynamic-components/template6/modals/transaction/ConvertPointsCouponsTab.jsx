      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2 md:gap-4">
        <div>
          ...
          <div className="relative" ref={convertDropdownRef}>
            <div
              id="convert-select"
              className="relative flex h-[46px] w-full cursor-pointer appearance-none items-center justify-between rounded-[5px] border border-[#3E1D88] bg-transparent px-3 py-3 text-[12px] text-white focus:border-[#661BB5] focus:ring-1 focus:ring-[#661BB5] focus:outline-none md:text-[14px] lg:h-[55px]"
            ...
            {isConvertDropdownOpen && (
              <div className="scrollbar-hide absolute z-[99999] mt-1 max-h-[150px] w-full overflow-y-auto rounded-[5px] border border-[#FB63214D] bg-black shadow-lg">
                <div
                  className="cursor-pointer px-3 py-2 text-[12px] text-white transition-colors duration-150 hover:bg-[#D61324] md:text-[14px]"
                  onClick={() => {
                    setConvertType('points_exchange');
                    setIsConvertDropdownOpen(false);
                  }}
        ...
        <div>
          ...
          <div
            id="available-amount"
            className="flex h-[46px] w-full items-center rounded-[5px] border border-[#FB63214D] bg-transparent px-3 py-3 text-[12px] text-[#FFFFFF80] sm:text-sm md:placeholder:text-sm lg:h-[55px]"
          >
            {convertType === 'points_exchange' ? (
        ...
        <form onSubmit={handleSubmitConvert} className="space-y-4">
          ...
          <div className="flex justify-end">
            <button
              ...
              className="fancy-hover-effect-orange flex cursor-pointer items-center justify-center rounded-[10px] bg-[#D61324] px-6 pt-3 pb-3 text-[16px] font-extrabold text-white transition-all duration-200 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
            >

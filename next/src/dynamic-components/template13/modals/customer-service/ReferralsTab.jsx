      ...
      <div className="mb-5 grid grid-cols-1 gap-4 md:grid-cols-12">
        <div className="md:col-span-9">
          ...
          <div className="mt-2 pt-4 text-[14px] font-extrabold text-[#FFFFFF99] italic lg:pt-8 lg:text-[15px]">
            <span className="font-semibold text-[#20C5FE] not-italic">
              {t('note')}:
            </span>{' '}
          ...
          <div className="flex h-full flex-col items-center justify-center md:items-end">
            <div className="flex flex-col items-center gap-2">
              ...
              <button
                ...
                className="filled-hover-effect mt-2 flex w-[291px] cursor-pointer items-center justify-center gap-2 rounded-[3px] bg-[#20C5FE] px-4 pt-3 pb-3 text-[13px] font-extrabold text-black active:scale-95 md:w-[191px] md:rounded-[5px]"
              >
        ...
        <div className="flex h-[400px] flex-col md:h-[500px]">
          <div className="overflow-x-auto md:overflow-x-visible">
            <div className="inline-block w-full min-w-[900px] align-top md:min-w-[1100px]">
              {/* Table Header */}
              <div className="overflow-hidden rounded-t-[10px] border border-b-0 border-[#00374A]">
              ...
              {/* Table Body */}
              <div className="show-scrollbar flex-1 overflow-y-auto rounded-b-[10px] border border-t-0 border-[#00374A]">
                {referralsLoader ? (
                    ...
                    <tbody>
                      {items.length === 0 ? (
                        ...
                        items.map((item, index) => (
                          <tr
                            key={item.id || index}
                            className="border-b border-[#00374A] transition-all duration-300 last:border-b-0 hover:border-[#20C5FE] hover:shadow-[0_5px_30px_0_rgba(32,197,254,0.46)_inset]"
                          >

...
import ContentDetail from '@/dynamic-components/template13/components/ContentDetail/ContentDetail';
    ...
    <>
      {showInquiryDetails ? (
        ...
        <div className="space-y-6">
          <div className="rounded-[5px] bg-[#18202D] p-3 md:p-4 lg:p-6">
            <form
              onSubmit={handleSubmit(handleSubmitSupport)}
              className="space-y-4"
            >
              <div>
                <Label className="mb-2 block text-[16px] font-bold text-white">
                  {t('title')}
                </Label>
                <Controller
                  name="title"
                  ...
                  render={({ field }) => (
                    <Input
                      ...
                      type="text"
                      placeholder={t('title')}
                      className="relative block h-[46px] w-full appearance-none rounded-[5px] border border-[#00374A] bg-transparent px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFF66] focus:border-[#20C5FE] focus:bg-black focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:h-[55px]"
                      error={
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <textarea
                      ...
                      rows="4"
                      className="relative block min-h-[46px] w-full resize-none appearance-none rounded-[5px] border border-[#00374A] bg-transparent px-3 py-3 text-white shadow-none placeholder:text-xs placeholder:text-[#FFFFFF66] focus:border-[#20C5FE] focus:bg-black focus:ring-0 focus:ring-transparent focus:outline-none sm:text-sm md:placeholder:text-sm lg:min-h-[55px]"
                    />
                  )}
                />
              ...
              <div className="mt-6 hidden justify-end md:flex">
                <button
                  type="submit"
                  className="filled-button-hover-effect-5 flex cursor-pointer items-center justify-center rounded-[10px] bg-[#20C5FE] px-10 pt-2 pb-2 text-[16px] font-semibold text-white transition-all duration-200 hover:bg-[#1AB0E5] hover:shadow-[0_4px_15px_rgba(26,176,229,0.5)] active:scale-95"
                  data-hover={t('submit')}
                >
                  <span>{t('submit')}</span>
                </button>
              ...
              <div className="mt-6 flex justify-center md:hidden">
                <button
                  type="submit"
                  className="filled-button-hover-effect-5 flex w-full cursor-pointer items-center justify-center rounded-[3px] bg-[#20C5FE] px-8 py-2 text-[16px] font-semibold text-white transition-all duration-200 hover:bg-[#1AB0E5] hover:shadow-[0_4px_15px_rgba(26,176,229,0.5)] active:scale-95 md:w-auto"
                  data-hover={t('submit')}
                >
                  <span>{t('submit')}</span>
                </button>
          ...
          <div className="space-y-4">
            ...
            <div className="overflow-hidden rounded-[5px] border border-[#00374A]">
              <div className="show-scrollbar h-[400px] overflow-x-auto overflow-y-auto md:h-[500px]">
                <table className="w-full min-w-[720px] table-fixed text-[11px] md:text-sm">
                  <thead>
                    <tr className="border-b-0 border-[#FFFFFF66] bg-[#18202D]">
                  ...
                  <tbody>
                    {allCustomerInquiriesLoader ? (
                      ...
                      inquiriesData.map((inquiry, index) => (
                        <tr
                          key={`row-${inquiry.id}`}
                          className="cursor-pointer border border-[#00374A] transition-all duration-300 hover:border-[#20C5FE] hover:shadow-[0_5px_30px_0_rgba(32,197,254,0.46)_inset]"
                        ...
                        >
                          ...
                          <td className="px-2 py-2 text-center text-white md:px-2 md:py-3">
                            <button className="btn-hover-outline rounded-[6px] border border-[#20C5FE] bg-transparent px-3 py-1 text-xs font-medium text-white transition-colors duration-200 hover:bg-[#20C5FE] hover:text-white">
                              {t('details')}
                            </button>
                          </td>
                          <td className="px-1 py-2 text-[#FFFFFF99] md:px-2 md:py-3">

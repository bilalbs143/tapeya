...
import { registrationSchema } from '@/validations/template13/registration.validation';
...
export default function Register(props) {
  ...
  return (
    <div
      className={`register-modal scrollbar-hide mx-auto w-full max-w-[400px] transform overflow-visible rounded-[5px] bg-[#001724] text-white shadow-xl transition-all duration-300 ease-out sm:max-w-[600px] lg:max-w-[800px] xl:max-w-[1037px] ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'}`}
    >
      <div className="p-4 sm:p-6 lg:p-7">
        <div className="space-y-4 sm:space-y-6">
          <div className="flex items-center justify-between">
            <h2 className="text-[20px] font-bold text-[#D9D9D9] sm:text-[23px]">
          ...
          <form
            className="relative space-y-3 overflow-visible rounded-[5px] border border-[#00374A] p-4 sm:space-y-4 sm:p-6"
          ...
          >
            ...
            {/* Divider */}
            <hr className="border-0 border-t-[0.5px] border-[#FFFFFF33]" />
              ...
              <div className="relative">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    ...
                    >
                      <SelectTrigger className="relative block h-[46px] w-full items-center justify-between rounded-[5px] border border-[#00374A] bg-transparent px-3 py-3 text-white shadow-none focus:border-[#20C5FE] focus:ring-0 focus:ring-transparent focus:outline-none lg:h-[55px]">
                        <SelectValue
                      ...
                      <SelectContent
                        className="z-[9999] max-h-[105px] w-full border-[#00374A] bg-[#001724]"
                        side="bottom"
                        align="start"
                        position="popper"
                      >
            ...
            <div className="mt-6">
              <button
                ...
                className="filled-hover-effect filled-button-hover-effect-5 flex w-full cursor-pointer items-center justify-center rounded-[10px] bg-[#20C5FE] px-4 pt-4 pb-4 text-base text-[16px] font-extrabold text-black transition-all duration-200 active:scale-95 disabled:opacity-50"
                data-hover={registerLoader ? 'Processing...' : 'Register'}
              >
                <span>{registerLoader ? 'Processing...' : 'Register'}</span>
              </button>
            </div>
          </form>
        </div>

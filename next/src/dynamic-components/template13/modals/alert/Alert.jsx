...
import PendingExchangeAlert from '@/dynamic-components/template13/components/AlertSections/PendingExchangeAlert';
import UnreadNotesAlert from '@/dynamic-components/template13/components/AlertSections/UnreadNotesAlert';
...
export default function Alert() {
  ...
  return (
    <div
      className={`mx-auto w-full max-w-[400px] transform rounded-[5px] border-[#00374A] bg-[#001724] text-white shadow-xl transition-all duration-300 ease-out sm:max-w-[500px] lg:max-w-[590px] ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'}`}
    >
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="space-y-6">
                ...
                <div className="text-center">
                  ...
                  {modalProps.data?.exchangeRequest && (
                    <div className="mt-4 space-y-3">
                      {/* Amount Details */}
                      <div className="border border-[#00374A] bg-transparent px-6 py-6">
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                          <div
                            className={`rounded-[5px] bg-[#18202D] px-3 py-3 ${modalProps.type !== 'exchange_approved' || !modalProps.data.exchangeRequest.approved_money ? 'md:col-span-2' : ''}`}
                          >
                          ...
                          {modalProps.type === 'exchange_approved' &&
                            ...
                            <div className="rounded-[10px] bg-[#18202D] px-3 py-3">
                              <div className="text-center text-base font-bold text-white md:text-lg">
                                {formatCurrency(
                                  modalProps.data.exchangeRequest
                                    .approved_money,
            ...
            {isCustomerInquiryReplyAlert && (
              <div className="space-y-4">
                <div className="border border-[#00374A] bg-transparent px-3 py-4">
                  <h3 className="border-b border-[#20C5FE] bg-transparent pb-1 text-sm font-medium text-[#20C5FE]">

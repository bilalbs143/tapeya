...
import CryptoSelect from '@/dynamic-components/template13/components/CryptoSelect/CryptoSelect';
import CryptoWithdrawalDetails from '@/dynamic-components/template13/components/CryptoWithdrawalDetails/CryptoWithdrawalDetails';
...
export default function WithdrawalCryptoTab() {
  ...
  const verifyButtonClassName = useMemo(() => {
    ...
    return `${baseClasses} bg-[#20C5FE] text-black font-semibold  hover:shadow-[0_5px_30px_0_rgba(32,197,254,0.46)_inset]`;
  }, [addressVerificationStatus]);
      ...
      <div className="mt-2 rounded-lg bg-[#1a1a2e] p-3">
        {exchangeRateLoader ? (
          ...
          <>
            ...
            <p className="text-base font-bold text-[#20C5FE] md:text-lg">
  ...
  return (
    <div className="space-y-6">
      ...
      <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="space-y-2">
          ...
          >
            {renderAmountLabel()}
            {currency && (
              <span className="text-xs text-[#20C5FE]">
                {' '}
                (
                {minimumAmountLoader
                  ? t('loading')
          ...
          <div className="flex flex-col gap-3">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Input
                    ...
                    className="relative block h-[46px] w-full appearance-none rounded-[5px] border border-[#00374A] bg-transparent px-3 py-3 text-white placeholder:text-xs placeholder:text-[#FFFFFF66] focus:border-[#20C5FE] focus:ring-0 sm:text-sm md:placeholder:text-sm lg:h-[55px]"
            ...
            <button
              ...
              className="filled-button-hover-effect-5 flex w-full cursor-pointer items-center justify-center rounded-[10px] bg-[#20C5FE] px-12 pt-4 pb-4 text-[14px] font-semibold text-white transition-all duration-200 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 md:w-auto md:self-end"
            >
      ...
      <div className="mt-8">
        <h3 className="mb-4 text-[15px] font-bold text-white md:text-[17px]">
          {t('withdraw_history')}
        </h3>

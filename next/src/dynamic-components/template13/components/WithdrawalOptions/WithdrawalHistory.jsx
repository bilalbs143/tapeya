...
import TransactionDetail from '@/dynamic-components/template13/components/TransactionDetail/TransactionDetail.jsx';
    ...
    <div className="space-y-6">
      {showDetails ? (
        ...
        <>
          ...
          <div className="overflow-hidden rounded-2xl border border-[#00374A]">
                    ...
                    requestInfoData.data.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-1 py-2 md:px-2 md:py-3">
                          <span className="text-[#20C5FE] transition-all duration-200">
                        ...
                        <td className="px-2 py-2 text-center md:px-2 md:py-3">
                          <button className="btn-hover-outline rounded-[6px] border border-[#20C5FE] bg-transparent px-3 py-1 text-xs font-medium text-white transition-colors duration-200 hover:bg-[#20C5FE] hover:text-black">
                            {t('details')}
                          </button>
                        </td>
                      </tr>

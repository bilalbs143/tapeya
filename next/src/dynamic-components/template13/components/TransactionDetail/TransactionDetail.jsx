...
const TransactionDetail = ({ title, data, onClose, type = 'deposit' }) => {
      ...
      <div className={`flex flex-col gap-2 ${className}`}>
        ...
        <div className="flex-1">
          <input
            ...
            value={displayValue}
            readOnly
            className={`h-[46px] w-full cursor-not-allowed rounded-[5px] border border-[#00374A] bg-transparent px-3 py-3 text-[12px] text-[#FFFFFF80] placeholder:text-[#FFFFFF66] sm:text-sm md:placeholder:text-sm lg:h-[55px] ${contentClassName}`}
          />
        </div>
      </div>
    );
  ...
  return (
    <div className="rounded-[10px] border border-[#00374A] bg-transparent p-5">
      ...
      <div className="">
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-1">
          {/* Transaction Details */}
          <div className="rounded-[9px] border-[0.8px] border-[#00374A] p-4">

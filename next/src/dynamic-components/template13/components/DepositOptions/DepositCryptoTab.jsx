...
import CryptoPaymentDetails from '@/dynamic-components/template13/components/CryptoPaymentDetails/CryptoPaymentDetails';
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-center">
            ...
            <button
              ...
              className="filled-button-hover-effect-5 flex w-full cursor-pointer items-center justify-center rounded-[10px] bg-[#20C5FE] px-10 pt-4.5 pb-4 text-[14px] font-semibold text-white transition-all duration-200 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 md:w-auto"
            >

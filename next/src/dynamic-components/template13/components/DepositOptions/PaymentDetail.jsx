    ...
    <div className="space-y-6 text-white">
      ...
      {isQRPreviewOpen && accountDetails?.qrCode && (
        ...
        >
          ...
          {/* Modal content */}
          <div
            className="relative z-10 flex flex-col items-center justify-center rounded-lg border border-[#00374A] bg-[#00111A] p-4"
          ...
          >
            ...
            <button
              type="button"
              onClick={() => setIsQRPreviewOpen(false)}
              className="absolute top-2 right-2 flex h-8 w-8 items-center justify-center rounded-full bg-[#20C5FE] text-black transition-opacity hover:opacity-80"

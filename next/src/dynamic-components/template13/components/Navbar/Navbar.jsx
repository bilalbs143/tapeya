...
import { LanguageSwitcher } from '@/dynamic-components/template13/components/LanguageSwitcher/LanguageSwitcher';
import LazyImage from '@/dynamic-components/template13/components/LazyImage/LazyImage';
import WalletDropdown from '@/dynamic-components/template13/components/WalletDropdown/WalletDropdown';
          ...
          >
            ...
            <div className="space-y-0">
              ...
              <Link
                ...
                className="group mb-2 flex items-center border-b border-[#00374A] bg-transparent px-6 py-4 text-white transition-all duration-300 hover:bg-white/5"
                onClick={(e) => handleMobileNavigation(e, '/sports')}
              >
                <div className="flex items-center gap-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="mt-auto space-y-3 p-4">
              ...
              <div className="relative mb-8">
                ...
                <div className="absolute top-[15%] left-[5%] z-10">
                  ...
                  {/* Download APK Button */}
                  <a
                    href="https://thestaticfile.com/uploads/Sumobet188.apk"
                    download

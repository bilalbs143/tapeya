    ...
    return (
      <div ref={dropdownRef} className="relative z-[1001] inline-block">
        <button
          ...
          className={`group inline-flex h-full w-full items-center justify-center gap-2 rounded-[50px] border-0 bg-transparent px-3 py-2 transition-all duration-300 ${
            appearance === 'outline' ? 'text-white' : 'text-black'
        ...
        {open && !isSavingToBackend && (
          <div className="absolute right-0 z-[1002] mt-2 w-34">
            <div className="rounded-[10px] border border-[#20C5FE] shadow-xl">
                  ...
                  >
                    {locales.map((locale, idx) => (
                      <button
                        ...
                        className={`group flex w-full items-center justify-between px-3 py-2 text-left text-white transition-all hover:bg-[#20C5FE] ${
                          idx < locales.length - 1
                            ? 'border-b border-[#20C5FE]'
                            : ''

import '@/app/styles/template12.css';
...
const templateConfig = getTemplateConfig(TEMPLATE_NAMES.TEMPLATE12);
...
export const metadata = {
  ...
  other: {
    template: TEMPLATE_NAMES.TEMPLATE12,
...
export default function Template12Layout({ children }) {
  return (
    <html lang="en" suppressHydrationWarning={true} className="template12-html">
      <head>
        ...
        <meta name="template" content={TEMPLATE_NAMES.TEMPLATE12} />
        <meta name="template-name" content={templateConfig.name} />
      </head>
      <body
        className={`${urbanist.className} ${urbanist.variable} template12-app template12-body antialiased`}
      >

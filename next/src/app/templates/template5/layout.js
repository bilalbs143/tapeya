import '@/app/styles/template5.css';
...
const templateConfig = getTemplateConfig(TEMPLATE_NAMES.TEMPLATE5);
...
export const metadata = {
  ...
  other: {
    template: TEMPLATE_NAMES.TEMPLATE5,
...
export default function Template5Layout({ children }) {
  return (
    <html lang="en" suppressHydrationWarning={true} className="template5-html">
      <head>
        ...
        <meta name="template" content={TEMPLATE_NAMES.TEMPLATE5} />
        <meta name="template-name" content={templateConfig.name} />
      </head>
      <body
        className={`${urbanist.className} ${urbanist.variable} template5-app template5-body antialiased`}
      >

import '@/app/styles/template4.css';
...
const templateConfig = getTemplateConfig(TEMPLATE_NAMES.TEMPLATE4);

// Template 4 uses Urbanist font
...
export const metadata = {
  ...
  other: {
    template: TEMPLATE_NAMES.TEMPLATE4,
  ...
  return (
    <html lang="en" suppressHydrationWarning={true} className="template4-html">
      <head>
        ...
        <meta name="template" content={TEMPLATE_NAMES.TEMPLATE4} />
        <meta name="template-name" content={templateConfig.name} />
      </head>
      <body
        className={`${urbanist.className} ${urbanist.variable} template4-app template4-body antialiased`}
      >

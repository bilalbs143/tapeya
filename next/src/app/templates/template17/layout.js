import '@/app/styles/template17.css';
...
const templateConfig = getTemplateConfig(TEMPLATE_NAMES.TEMPLATE17);
...
export const metadata = {
  ...
  other: {
    template: TEMPLATE_NAMES.TEMPLATE17,
...
export default function Template17Layout({ children }) {
  return (
    <html lang="en" suppressHydrationWarning={true} className="template17-html">
      <head>
        ...
        <meta name="template" content={TEMPLATE_NAMES.TEMPLATE17} />
        <meta name="template-name" content={templateConfig.name} />
      </head>
      <body
        className={`${urbanist.className} ${urbanist.variable} template17-app template17-body antialiased`}
      >

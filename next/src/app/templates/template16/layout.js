import '@/app/styles/template16.css';
...
const templateConfig = getTemplateConfig(TEMPLATE_NAMES.TEMPLATE16);
...
export const metadata = {
  ...
  other: {
    template: TEMPLATE_NAMES.TEMPLATE16,
...
export default function Template16Layout({ children }) {
  return (
    <html lang="en" suppressHydrationWarning={true} className="template16-html">
      <head>
        ...
        <meta name="template" content={TEMPLATE_NAMES.TEMPLATE16} />
        <meta name="template-name" content={templateConfig.name} />
      </head>
      <body
        className={`${urbanist.className} ${urbanist.variable} template16-app template16-body antialiased`}
      >

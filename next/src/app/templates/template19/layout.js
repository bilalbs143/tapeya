import '@/app/styles/template19.css';
...
const templateConfig = getTemplateConfig(TEMPLATE_NAMES.TEMPLATE19);
...
const kingTown = localFont({
  src: '../../fonts/template19/king-town.otf',
...
export const metadata = {
  ...
  other: {
    template: TEMPLATE_NAMES.TEMPLATE19,
...
export default function Template19Layout({ children }) {
  return (
    <html lang="en" suppressHydrationWarning={true} className="template19-html">
      <head>
        ...
        <meta name="template" content={TEMPLATE_NAMES.TEMPLATE19} />
        <meta name="template-name" content={templateConfig.name} />
      </head>
      <body
        className={`${urbanist.className} ${urbanist.variable} ${kingTown.className} ${kingTown.variable} template19-app template19-body antialiased`}
      >

import '@/app/styles/template7.css';
...
const templateConfig = getTemplateConfig(TEMPLATE_NAMES.TEMPLATE7);
...
const bringRace = localFont({
  src: '../../fonts/template7/bring-race.otf',
...
export const metadata = {
  ...
  other: {
    template: TEMPLATE_NAMES.TEMPLATE7,
...
export default function Template7Layout({ children }) {
  return (
    <html lang="en" suppressHydrationWarning={true} className="template7-html">
      <head>
        ...
        <meta name="template" content={TEMPLATE_NAMES.TEMPLATE7} />
        <meta name="template-name" content={templateConfig.name} />
      </head>
      <body
        className={`${urbanist.className} ${urbanist.variable} ${rammettoOne.variable} ${bringRace.variable} template7-app template7-body antialiased`}
      >

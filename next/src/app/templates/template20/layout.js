import '@/app/styles/template20.css';
...
const templateConfig = getTemplateConfig(TEMPLATE_NAMES.TEMPLATE20);
...
const kingTown = localFont({
  src: '../../fonts/template20/king-town.otf',
...
export const metadata = {
  ...
  other: {
    template: TEMPLATE_NAMES.TEMPLATE20,
...
export default function Template20Layout({ children }) {
  return (
    <html lang="en" suppressHydrationWarning={true} className="template20-html">
      <head>
        ...
        <meta name="template" content={TEMPLATE_NAMES.TEMPLATE20} />
        <meta name="template-name" content={templateConfig.name} />
      </head>
      <body
        className={`${urbanist.className} ${urbanist.variable} ${kingTown.className} ${kingTown.variable} template20-app template20-body antialiased`}
      >

import '@/app/styles/template10.css';
...
const templateConfig = getTemplateConfig(TEMPLATE_NAMES.TEMPLATE10);
...
const spyAgency = localFont({
  src: '../../fonts/template10/spy-agency.ttf',
...
const cravend = localFont({
  src: '../../fonts/template10/Cravend.otf',
...
export const metadata = {
  ...
  other: {
    template: TEMPLATE_NAMES.TEMPLATE10,
...
export default function Template10Layout({ children }) {
  return (
    <html lang="en" suppressHydrationWarning={true} className="template10-html">
      <head>
        ...
        <meta name="template" content={TEMPLATE_NAMES.TEMPLATE10} />
        <meta name="template-name" content={templateConfig.name} />
      </head>
      <body
        className={`${urbanist.className} ${urbanist.variable} ${rammettoOne.variable} ${spyAgency.variable} ${cravend.variable} template10-app template10-body antialiased`}
      >

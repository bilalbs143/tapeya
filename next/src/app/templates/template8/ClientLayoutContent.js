...
import FloatingButtons from '@/dynamic-components/template8/components/FloatingButtons/FloatingButtons';
import Footer from '@/dynamic-components/template8/components/Footer/Footer';
import GlobalPageLoader from '@/dynamic-components/template8/components/GlobalPageLoader/GlobalPageLoader';
import LeftSidebar from '@/dynamic-components/template8/components/LeftSidebar/LeftSidebar';
import Navbar from '@/dynamic-components/template8/components/Navbar/Navbar';
...
const LayoutContent = memo(function LayoutContent({ children }) {
  ...
  const mainClassName = useMemo(
    () => `flex-1 template8-main ${isMobilePlatform ? 'pb-safe-bottom' : ''}`,
    [isMobilePlatform],
  );

  return (
    <div
      className="template8-layout flex min-h-screen"
      style={{ backgroundColor: '#060D0D' }}
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url(https://d3emlo5tm9es2f.cloudfront.net/next/backgrounds/home-bg-pattern-8.webp)',
      ...
      >
        ...
        <div className="template8-header z-50 w-full">
          <Navbar />
        </div>
...
const ClientLayoutContent = memo(function ClientLayoutContent({ children }) {
  return (
    <div
      className="template8-app antialiased"
      style={{ backgroundColor: '#060D0D' }}
    >
      <ThemeProvider
        attribute="class"

...
class ValidateDuplicateRefundTransaction
{
    /**
    ...
    public function handle(Collection|BaseAntechipRequest $collection, Closure $next)
    {
        ...
        $existingTransaction = Transaction::refund()->byTxnId($request->getTransactionId())->first();
        if ($existingTransaction) {
            ...
            ], antechipStatus: AntechipSeamlessService::getStatus('Duplicate Refund Transaction', success: true, refund_success: true));
        }

...
class ValidateDuplicatePromoWinTransaction
{
    /**
    ...
    public function handle(Collection|BaseAntechipRequest $collection, Closure $next)
    {
        ...
        $existingTransaction = Transaction::promoWin()->byTxnId($request->getTransactionId())->first();
        if ($existingTransaction) {
            ...
            ], antechipStatus: AntechipSeamlessService::getStatus('Duplicate Promo Win Transaction', success: true, promo_win_success: true));
        }

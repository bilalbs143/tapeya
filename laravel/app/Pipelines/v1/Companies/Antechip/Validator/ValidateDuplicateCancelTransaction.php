...
class ValidateDuplicateCancelTransaction
{
    ...
    public function handle(Collection|BaseAntechipRequest $collection, Closure $next)
    {
        ...
        $existingTransaction = Transaction::cancel()->byTxnId($request->getTransactionId())->first();
        if ($existingTransaction) {
            ...
            ], antechipStatus: AntechipSeamlessService::getStatus('Duplicate Cancel Transaction', success: true, cancel_success: true));
        }

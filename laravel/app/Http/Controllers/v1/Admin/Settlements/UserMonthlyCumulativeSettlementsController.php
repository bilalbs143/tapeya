...
use App\Http\Resources\v1\Settlements\UserMonthlyCumulativeSettlementResource;
use App\Models\Settlements\UserMonthlyCumulativeSettlement;
use Illuminate\Support\Facades\DB;
use Spatie\QueryBuilder\QueryBuilder;

class UserMonthlyCumulativeSettlementsController extends BaseAdminController
{
    public function __construct()
    {
        parent::__construct(UserMonthlyCumulativeSettlement::class, UserMonthlyCumulativeSettlementResource::class);
    }

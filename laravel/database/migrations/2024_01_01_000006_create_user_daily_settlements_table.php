...
return new class extends Migration
{
    ...
    {
        Schema::create('user_daily_settlements', function (Blueprint $table) {
            $table->id();
            ...
            $table->double('points')->default(0)->comment('User total points till that day');
            ...
            $table->double('coupon_points')->default(0)->comment('User total coupon points till that day');
    ...
    {
        Schema::dropIfExists('user_daily_settlements');
    }
};

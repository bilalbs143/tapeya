...
https://tapeya.com/live/broadcast/44
tapeya://live/broadcast/44
...
**Live watch (`/live/broadcast/:id`):** guests see thumbnail + play; play opens login and returns to the stream. Playback, chat, and hearts require auth. Share from watch or go-live uses this URL.
...
3. [x] `AndroidManifest` HTTPS `pathPrefix`: `/reels`, `/feed`, `/live/go-live`, `/live/broadcast`, `/scorecard` on `tapeya.com` only  
...
2. [x] Paths cover `/reels/*`, `/feed/*`, `/live/go-live/*`, `/live/broadcast/*`, `/scorecard/*`

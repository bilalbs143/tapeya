...
> **Orientation follow-up:** v1 ships portrait 9:16 encode only. Dual **Portrait (9:16) / Landscape (16:9)** — form picker, selected indicator on camera preview, native encode tiers, and viewer branching — is specified in [LIVE_STREAM_ORIENTATION.md](./LIVE_STREAM_ORIENTATION.md).
...
- [LIVE_STREAM_ORIENTATION.md](./LIVE_STREAM_ORIENTATION.md) — Portrait (9:16) + Landscape (16:9) Go Live: form choice, selected preview indicator, native encode tiers, viewer layout

...
@Component({
  selector: 'app-agent-basic-info-detailed',
  imports: [
    CommonModule,
    MatCardModule,
    RouterLink,
  ...
  templateUrl: './agent-basic-info-detailed.component.html',
})
export class AgentBasicInfoDetailedComponent implements OnInit {

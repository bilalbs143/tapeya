...
@Component({
  selector: 'app-money-withdraw-action-dialog',
  templateUrl: './action-dialog.component.html',
  standalone: false,
})
export class MoneyWithdrawActionDialogComponent implements OnInit {
  data = inject(MAT_DIALOG_DATA);
  private dialogRef = inject<MatDialogRef<MoneyWithdrawActionDialogComponent>>(MatDialogRef);

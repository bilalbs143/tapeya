...
export class MoneyWithdrawComponent implements AfterViewInit, OnInit {
  ...
  public openActionDialog(type: string, _row: any): void {
    if (type === 'ACCEPT') {
      ...
      this.messageService.openDialog(MoneyWithdrawActionDialogComponent, data, () => this.afterDialogClosed(), {
        widthSize: 'md',
      });
    } else {

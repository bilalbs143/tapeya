...
@Component({
  ...
  templateUrl: './losing-money-withdraw-dialog.component.html',
  standalone: false,
})
export class LosingMoneyWithdrawDialogComponent implements OnInit {
  data = inject(MAT_DIALOG_DATA);
  private dialogRef = inject<MatDialogRef<LosingMoneyWithdrawDialogComponent>>(MatDialogRef);

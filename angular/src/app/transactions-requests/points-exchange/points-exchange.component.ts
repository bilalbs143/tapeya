...
@Component({
  selector: 'app-points-exchange',
  templateUrl: './points-exchange.component.html',
  standalone: false,
})
export class PointsExchangeComponent implements AfterViewInit, OnInit {
  ...
  public loadHttpData(currentPageView = this.currentPage, perPageLimit = this.pageSize): void {
    ...
    requestParams = addUsernameFilter(requestParams, this.searchForm, 'creator.')
      ...
      .set('filter[type]', 'points_exchange');

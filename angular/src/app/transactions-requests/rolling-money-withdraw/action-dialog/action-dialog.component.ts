...
@Component({
  selector: 'app-rolling-money-withdraw-action-dialog',
  templateUrl: './action-dialog.component.html',
  standalone: false,
})
export class RollingMoneyWithdrawActionDialogComponent implements OnInit {
  data = inject(MAT_DIALOG_DATA);
  private dialogRef = inject<MatDialogRef<RollingMoneyWithdrawActionDialogComponent>>(MatDialogRef);

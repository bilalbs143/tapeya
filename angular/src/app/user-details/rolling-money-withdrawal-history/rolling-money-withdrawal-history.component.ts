...
@Component({
  selector: 'app-rolling-money-withdrawal-history',
  templateUrl: './rolling-money-withdrawal-history.component.html',
  styles: ``,
  standalone: false,
})
export class RollingMoneyWithdrawalHistoryComponent implements AfterViewInit, OnInit {

...
@Component({
  selector: 'app-coupon-points-history',
  templateUrl: './coupon-points-history.component.html',
  styles: ``,
  standalone: false,
})
export class CouponPointsHistoryComponent implements AfterViewInit, OnInit {

...
@Component({
  selector: 'app-rolling-money-history',
  templateUrl: './rolling-money-history.component.html',
  styles: ``,
  standalone: false,
})
export class RollingMoneyHistoryComponent implements AfterViewInit, OnInit {

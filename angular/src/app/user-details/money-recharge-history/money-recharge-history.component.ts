...
@Component({
  selector: 'app-money-recharge-history',
  templateUrl: './money-recharge-history.component.html',
  styles: ``,
  standalone: false,
})
export class MoneyRechargeHistoryComponent implements AfterViewInit, OnInit {

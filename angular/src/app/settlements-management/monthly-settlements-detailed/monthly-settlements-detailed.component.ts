...
@Component({
  selector: 'app-monthly-settlements-detailed',
  templateUrl: './monthly-settlements-detailed.component.html',
  standalone: false,
})
export class MonthlySettlementsDetailedComponent implements OnInit {

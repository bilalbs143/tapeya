...
@Component({
  selector: 'app-daily-settlements-detailed',
  templateUrl: './daily-settlements-detailed.component.html',
  standalone: false,
})
export class DailySettlementsDetailedComponent implements OnInit {
  ...
  public displayedColumns: string[] = [
    ...
    'netWinningAmount',
    'bettingDifference',
    'netBettingDifference',
    'depositedMoney',
    'depositedMoneyCount',
    'depositedMoneyByAdmin',
    'depositedMoneyByAdminCount',
    'withdrawalMoney',
    'withdrawalMoneyCount',
    'withdrawalMoneyByAdmin',
    'withdrawalMoneyByAdminCount',
    'pointsCreditedByAdmin',
    'pointsCreditedByAdminCount',
    'pointsDebitedByAdmin',
    'pointsDebitedByAdminCount',
    'pointsExchange',
    'pointsExchangeCount',
    'couponPointsCreditedByAdmin',
    'couponPointsCreditedByAdminCount',
    'couponPointsDebitedByAdmin',
    'couponPointsDebitedByAdminCount',
    'couponPointsCreditedByAgent',
    'couponPointsCreditedByAgentCount',
    'couponPointsDebitedByAgent',
    'couponPointsDebitedByAgentCount',
    'couponPointsDistributionPaymentByAgent',
    'couponPointsDistributionPaymentByAgentCount',
    'couponPointsDistributionRecoveryByAgent',
    'couponPointsDistributionRecoveryByAgentCount',
    'couponPointsExchange',
    'couponPointsExchangeCount',
    'rollingMoneyCredited',
    'rollingMoneyCreditedCount',
    'rollingMoneyWithdrawal',
    'rollingMoneyWithdrawalCount',
    'losingMoneyCredited',
    'losingMoneyCreditedCount',
    'losingMoneyDebited',
    'losingMoneyDebitedCount',
    'losingMoneyWithdrawal',
    'losingMoneyWithdrawalCount',
    'firstRechargeBonusPointsAfterSignup',
    'firstRechargeBonusPointsAfterSignupCount',
    'firstRechargeBonusPointsOfDay',
    'firstRechargeBonusPointsOfDayCount',
    'perRechargeBonusPoints',
    'perRechargeBonusPointsCount',
  ];
  ...
  public loadHttpData(currentPageView = this.currentPage, perPageLimit = this.pageSize): void {
    ...
    this.settlementsManagementService.daily(requestParams).subscribe(
      (response) => {
